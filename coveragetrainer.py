...
class CoverageTrainer (gtk.HBox):
    ...
    def __init__(self, view_resources):
        ...
        label_text = _(u"Now that you can palpate to proper depth, practice covering the entire abdomen.") + "\n\n" \
                     + _(u"It's better to make several passes instead of covering each centimeter in one pass.") \
                     + "\n\n" + _(u"Make several trips around the abdomen to get full coverage.") + "\n\n" \
                     + _(u"Especially ensure you check the marked locations, where abdominal abnormalities are most "
                        u"likely to occur.")
