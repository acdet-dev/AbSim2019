...
void setup() 
{
  ...
  maxpsia[4] = 0.60; // liver
  maxpsia[5] = 0.20; // spleen
  maxpsia[6] = 0.25; // bladder
...
void loop ()
{
  ...
  for(i=0;i<7;i++)
  {
    if(state[i] == 1)
    {
      ...
      if(MPX5010_psi(i) < maxpsia[i]+0.01) { digitalWrite(i*2+22, HIGH); pump = 15; }
  ...
  if(pump-- > 0) digitalWrite(37, HIGH);
  else
  {
     digitalWrite(37, LOW);
     pump = 0;
