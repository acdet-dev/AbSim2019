...
<repository version="1.2"
  ...
  <namespace name="TelepathyLogger"
             version="0.2"
             shared-library="libtelepathy-logger-3.dll"
    ...
    <class name="CallEvent"
      ...
      <method name="get_duration" c:identifier="tpl_call_event_get_duration">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same duration as the #TplCallEvent:duration property</doc>
      ...
      <method name="get_end_actor" c:identifier="tpl_call_event_get_end_actor">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same #TplEntity
      ...
      <method name="get_end_reason"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same #TpCallStateChangeReason as #TplCallEvent:end-reason property</doc>
    ...
    <class name="Entity"
      ...
      <doc xml:space="preserve">An object representing a contact or room.</doc>
      ...
      <constructor name="new_from_room_id"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a TplEntity instance with identifier, alias copied from
...
the #TplEntity returned.</doc>
        ...
        <parameters>
          <parameter name="room_id" transfer-ownership="none">
            <doc xml:space="preserve">the room id which will be the identifier for the entity</doc>
            <type name="utf8" c:type="const gchar*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_from_tp_contact"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a TplEntity instance with identifier, alias and
...
%TPL_ENTITY_UNKNOWN with id set to "unknown" is returned.</doc>
        ...
        <parameters>
          <parameter name="contact" transfer-ownership="none">
            <doc xml:space="preserve">the TpContact instance to create the TplEntity from</doc>
            <type name="TelepathyGLib.Contact" c:type="TpContact*"/>
          </parameter>
          <parameter name="type" transfer-ownership="none">
            <doc xml:space="preserve">the #TplEntity type</doc>
            <type name="EntityType" c:type="TplEntityType"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="get_alias" c:identifier="tpl_entity_get_alias">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the alias of the entity, or %NULL</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">a #TplEntity</doc>
            <type name="Entity" c:type="TplEntity*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_avatar_token"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a token representing the avatar of the token, or %NULL</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_entity_type" c:identifier="tpl_entity_get_entity_type">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the type of the entity</doc>
          <type name="EntityType" c:type="TplEntityType"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_identifier" c:identifier="tpl_entity_get_identifier">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the identifier of the entity</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <property name="alias"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The entity's alias</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="avatar-token"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The entity's avatar token</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="identifier"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The entity's identifier</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="type"
                writable="1"
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The entity's type (see #TplEntityType).</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <field name="parent">
    ...
    <enumeration name="EntityType" c:type="TplEntityType">
      <member name="unknown" value="0" c:identifier="TPL_ENTITY_UNKNOWN">
        <doc xml:space="preserve">the current contact's type is unknown</doc>
      </member>
      <member name="contact" value="1" c:identifier="TPL_ENTITY_CONTACT">
        <doc xml:space="preserve">the contact's type represents a user (buddy), but not
   the account's owner for which @TPL_ENTITY_SELF is used</doc>
      </member>
      <member name="room" value="2" c:identifier="TPL_ENTITY_ROOM">
        <doc xml:space="preserve">a named room (#TP_HANDLE_TYPE_ROOM)</doc>
      </member>
      <member name="self" value="3" c:identifier="TPL_ENTITY_SELF">
        <doc xml:space="preserve">the contact's type represents the owner of the account
   ...
   represents any other user</doc>
    ...
    <class name="Event"
      ...
      <doc xml:space="preserve">An object representing a generic log event.</doc>
      <method name="equal" c:identifier="tpl_event_equal">
        <doc xml:space="preserve">Checks if two instances of TplEvent represent the same data</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @data is the same type of @self and they hold the same
data, %FALSE otherwise</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">TplEvent subclass instance</doc>
            <type name="Event" c:type="TplEvent*"/>
          </instance-parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">an instance of the same TplEvent subclass of @self</doc>
            <type name="Event" c:type="TplEvent*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_account" c:identifier="tpl_event_get_account">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same account as the #TplEvent:account property</doc>
          <type name="TelepathyGLib.Account" c:type="TpAccount*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">a #TplEvent</doc>
            <type name="Event" c:type="TplEvent*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_account_path"
        ...
        <doc xml:space="preserve">&lt;!-- no more to say --&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the path as the #TplEvent:account property</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_receiver" c:identifier="tpl_event_get_receiver">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same #TplEntity as the #TplEvent:receiver property</doc>
          <type name="Entity" c:type="TplEntity*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_sender" c:identifier="tpl_event_get_sender">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same #TplEntity as the #TplEvent:sender property</doc>
          <type name="Entity" c:type="TplEntity*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_timestamp" c:identifier="tpl_event_get_timestamp">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same timestamp as the #TplEvent:timestamp property</doc>
          <type name="gint64" c:type="gint64"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
    ...
    <bitfield name="EventTypeMask" c:type="TplEventTypeMask">
      <doc xml:space="preserve">Mask used to filter type of #TplEvent returned.</doc>
      <member name="text" value="1" c:identifier="TPL_EVENT_MASK_TEXT">
        <doc xml:space="preserve">Mask to #TplTextEvent</doc>
      </member>
      <member name="call" value="2" c:identifier="TPL_EVENT_MASK_CALL">
        <doc xml:space="preserve">Mask to #TplCallEvent</doc>
      </member>
      <member name="any" value="65535" c:identifier="TPL_EVENT_MASK_ANY">
        <doc xml:space="preserve">Special value to select all type of #TplEvent</doc>
      </member>
    </bitfield>
    <callback name="LogEventFilter" c:type="TplLogEventFilter">
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if @event should appear in the result</doc>
        <type name="gboolean" c:type="gboolean"/>
      </return-value>
      <parameters>
        <parameter name="event" transfer-ownership="none">
          <doc xml:space="preserve">the #TplEvent to filter</doc>
          <type name="Event" c:type="TplEvent*"/>
        </parameter>
    ...
    <class name="LogManager"
      ...
      <doc xml:space="preserve">An object used to access logs</doc>
      <function name="dup_singleton"
                c:identifier="tpl_log_manager_dup_singleton">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new reference on the log manager</doc>
      ...
      <function name="errors_quark"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the #GQuark associated with the error domain of #TplLogManager</doc>
      ...
      <function name="search_free"
                ...
                introspectable="0">
        <doc xml:space="preserve">Free @hits and its content.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <parameter name="hits" transfer-ownership="none">
            <doc xml:space="preserve">a #GList of #TplLogSearchHit</doc>
      ...
      <method name="exists" c:identifier="tpl_log_manager_exists">
        <doc xml:space="preserve">Checks if logs exist for @target.

It applies for any registered TplLogStore with the TplLogStore:readable
property %TRUE.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE logs exist for @target, otherwise %FALSE</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="manager" transfer-ownership="none">
            <doc xml:space="preserve">TplLogManager</doc>
            <type name="LogManager" c:type="TplLogManager*"/>
          </instance-parameter>
          <parameter name="account" transfer-ownership="none">
            <doc xml:space="preserve">TpAccount</doc>
            <type name="TelepathyGLib.Account" c:type="TpAccount*"/>
          </parameter>
          <parameter name="target" transfer-ownership="none">
            <doc xml:space="preserve">a non-NULL #TplEntity</doc>
            <type name="Entity" c:type="TplEntity*"/>
          </parameter>
          <parameter name="type_mask" transfer-ownership="none">
            <doc xml:space="preserve">event type filter see #TplEventTypeMask</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_dates_async"
        ...
        <doc xml:space="preserve">Retrieves a list of #GDate corresponding to each day where
...
property %TRUE.</doc>
        ...
        <parameters>
          <instance-parameter name="manager" transfer-ownership="none">
            <doc xml:space="preserve">a #TplLogManager</doc>
            <type name="LogManager" c:type="TplLogManager*"/>
          </instance-parameter>
          <parameter name="account" transfer-ownership="none">
 ...
 #GList used to return the list of #GDate</doc>
      ...
      <method name="get_entities_async"
        ...
        <doc xml:space="preserve">Start a query looking for all entities for which you have logs in the @account.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
 ...
 using something like g_list_free_full (lst, g_object_unref)</doc>
      ...
      <method name="get_events_for_date_async"
        ...
        <doc xml:space="preserve">Retrieve a list of #TplEvent at @date with @target.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
 ...
 pointer to a #GList used to return the list of #TplEvent</doc>
      ...
      <method name="get_filtered_events_async"
        ...
        <doc xml:space="preserve">Retrieve the most recent @num_event events exchanged with @target.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="num_events" transfer-ownership="none">
            <doc xml:space="preserve">number of maximum events to fetch</doc>
          ...
          <parameter name="filter"
                     ...
                     scope="call"
                     closure="5">
            <doc xml:space="preserve">an optional filter function</doc>
            <type name="LogEventFilter" c:type="TplLogEventFilter"/>
          </parameter>
          <parameter name="filter_user_data" transfer-ownership="none">
            <doc xml:space="preserve">user data to pass to @filter</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
          <parameter name="callback"
                     transfer-ownership="none"
...
the request is satisfied</doc>
 ...
 a pointer to a #GList used to return the list #TplEvent</doc>
      ...
      <method name="search_async" c:identifier="tpl_log_manager_search_async">
        <doc xml:space="preserve">Search for all the conversations containing @text.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="text" transfer-ownership="none">
            <doc xml:space="preserve">the pattern to search</doc>
            <type name="utf8" c:type="const gchar*"/>
          </parameter>
          <parameter name="type_mask" transfer-ownership="none">
            <doc xml:space="preserve">event type filter see #TplEventTypeMask</doc>
 ...
 pointer to a #GList used to return the list of #TplLogSearchHit</doc>
      ...
      <method name="walk_filtered_events"
        ...
        <doc xml:space="preserve">Create a #TplLogWalker to traverse all the events exchanged with @target.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #TplLogWalker</doc>
    ...
    <enumeration name="LogManagerError" c:type="TplLogManagerError">
      <member name="log_manager_error_add_event"
        ...
        <doc xml:space="preserve">Error return when adding logs fails</doc>
      </member>
    </enumeration>
    <record name="LogSearchHit" c:type="TplLogSearchHit">
      <doc xml:space="preserve">Represent the context where the search has results.</doc>
      <field name="account" writable="1">
        <doc xml:space="preserve">the #TpAccount</doc>
        <type name="TelepathyGLib.Account" c:type="TpAccount*"/>
      </field>
      <field name="target" writable="1">
        <doc xml:space="preserve">the #TplEntity</doc>
        <type name="Entity" c:type="TplEntity*"/>
      </field>
      <field name="date" writable="1">
        <doc xml:space="preserve">the #GDate</doc>
    ...
    <class name="LogWalker"
      ...
      <doc xml:space="preserve">An object used to iterate over the logs</doc>
      <method name="get_events_async"
              c:identifier="tpl_log_walker_get_events_async"
              version="0.8.0">
        <doc xml:space="preserve">Walk the logs to retrieve the next most recent @num_event events.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
the request is satisfied</doc>
 ...
 a pointer to a #GList used to return the list #TplEvent</doc>
      ...
      <method name="is_end"
              ...
              version="0.8.0">
        <doc xml:space="preserve">Determines whether @walker has run out of events. This is the case
when @walker has returned all the events from the logs.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @walker has run out of events, otherwise #FALSE.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="walker" transfer-ownership="none">
      ...
      <method name="is_start"
              ...
              version="0.8.0">
        <doc xml:space="preserve">Determines whether @walker is pointing at the most recent event in
the logs. This is the case when @walker has not yet returned any
events or has been rewound completely.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @walker is pointing at the most recent event,
otherwise #FALSE.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="rewind_async"
              ...
              version="0.8.0">
        <doc xml:space="preserve">Move the @walker back by the last @num_event events that were
returned by tpl_log_walker_get_events_async().</doc>
        ...
        <parameters>
          ...
          <parameter name="num_events" transfer-ownership="none">
            <doc xml:space="preserve">number of events to move back</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
          <parameter name="callback"
                     transfer-ownership="none"
...
the request is satisfied</doc>
    ...
    <record name="LogWalkerPriv" c:type="TplLogWalkerPriv" disguised="1">
    </record>
    <class name="TextEvent"
      ...
      <doc xml:space="preserve">An object representing a text log event.</doc>
      <method name="get_edit_timestamp"
              c:identifier="tpl_text_event_get_edit_timestamp">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same value as the #TplTextEvent:edit-timestamp property</doc>
          <type name="gint64" c:type="gint64"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">a #TplTextEvent</doc>
      ...
      <method name="get_message" c:identifier="tpl_text_event_get_message">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same message as the #TplTextEvent:message property</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_message_token"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same message as the #TplTextEvent:message-token property</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="get_message_type"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same message as the #TplTextEvent:message-type property</doc>
...
supersedes.</doc>
      ...
      <method name="get_supersedes_token"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the same message as the #TplTextEvent:supersedes-token property</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
