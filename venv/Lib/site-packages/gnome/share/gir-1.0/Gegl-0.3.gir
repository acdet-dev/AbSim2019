...
<repository version="1.2"
  ...
  <namespace name="Gegl"
             version="0.3"
             shared-library="libgegl-0.3-0.dll"
...
to 0</doc>
      ...
      <method name="copy" c:identifier="gegl_buffer_copy">
        <doc xml:space="preserve">copies a region from source buffer to destination buffer.
...
will create copy-on-write clones in the new buffer.</doc>
      ...
      <method name="flush" c:identifier="gegl_buffer_flush">
        <doc xml:space="preserve">Flushes all unsaved data to disk, this is not neccesary for shared
...
Returns TRUE if the change of abyss was succesful.</doc>
        <return-value transfer-ownership="none">
...
Returns TRUE if the change of extent was succesful.</doc>
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
...
the original format.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the new babl format or NULL if it the passed in buffer was
      ...
      <method name="calc_values"
        ...
        <parameters>
          ...
          <parameter name="x_max" transfer-ownership="none">
            <doc xml:space="preserve">the maxmimum value to compute for</doc>
            <type name="gdouble" c:type="gdouble"/>
          </parameter>
...
Returns the number of points for the coordinates in the curve.</doc>
    ...
    <constant name="MICRO_VERSION" value="14" c:type="GEGL_MICRO_VERSION">
      <type name="gint" c:type="gint"/>
    </constant>
      ...
      <method name="copy" c:identifier="gegl_matrix3_copy">
        ...
        <parameters>
          <instance-parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">a #GeglMatrix</doc>
            <type name="Matrix3" c:type="GeglMatrix3*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="multiply" c:identifier="gegl_matrix3_multiply">
        ...
        <parameters>
          ...
          <parameter name="product" transfer-ownership="none">
            <doc xml:space="preserve">a #GeglMatrix to store the result in.</doc>
            <type name="Matrix3" c:type="GeglMatrix3*"/>
          </parameter>
        </parameters>
      </method>
      <method name="originate" c:identifier="gegl_matrix3_originate">
        <doc xml:space="preserve">Hmm not quite sure what this does.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
transform strings allowed by SVG)</doc>
      ...
      <method name="to_string" c:identifier="gegl_matrix3_to_string">
        <doc xml:space="preserve">Serialize a #GeglMatrix to a string.
...
coordinates after scale has been applied.</doc>
          ...
          <parameter name="destination_buf" transfer-ownership="none">
...
Returns TRUE if the connection was succesfully made.</doc>
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
...
assoicated with this node or NULL if there is no op associated.</doc>
...
counting is easiest.)</doc>
        ...
        <parameters>
          ...
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">first property value, optionally followed by more key/value pairs, ended
...
If @tail is %NULL then this behaves just like #gegl_node_to_xml.</doc>
    ...
    <class name="Operation"
      ...
      <function name="find_property"
                ...
                introspectable="0">
        <return-value>
          <doc xml:space="preserve">The paramspec of the matching property - or NULL if there as
no match.</doc>
          <type name="GObject.ParamSpec" c:type="GParamSpec*"/>
        </return-value>
        <parameters>
...
numbers</doc>
          ...
          <parameter name="max" transfer-ownership="none">
            <doc xml:space="preserve">maxmimum value</doc>
            <type name="gfloat" c:type="gfloat"/>
          </parameter>
        </parameters>
      </method>
...
numbers</doc>
          ...
          <parameter name="max" transfer-ownership="none">
            <doc xml:space="preserve">maxmimum value+1</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
        </parameters>
      </method>
...
is destroyed. If false unwritten data will be discarded.</doc>
    ...
    <class name="TileSource"
      ...
      <field name="command" introspectable="0">
        <callback name="command" introspectable="0">
          <return-value>
            <type name="gpointer" c:type="gpointer"/>
          </return-value>
          <parameters>
...
Returns a pointer to the allocated memory.</doc>
    ...
    <function name="memset_pattern"
      ...
      <parameters>
        <parameter name="dst_ptr" transfer-ownership="none">
          <doc xml:space="preserve">pointer to copy to</doc>
          <type name="gpointer" c:type="void*"/>
        </parameter>
        <parameter name="src_ptr" transfer-ownership="none">
