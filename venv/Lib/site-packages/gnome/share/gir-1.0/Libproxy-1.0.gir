  ...
  <namespace name="Libproxy"
    ...
    <record name="ProxyFactory" c:type="pxProxyFactory" disguised="1">
      ...
      <method name="get_proxies" c:identifier="px_proxy_factory_get_proxies">
        <doc xml:space="preserve">Get which proxies to use for the specified URL.
...
- rtsp://[username:password@]proxy:port</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A NULL-terminated array of proxy strings to use</doc>
          <array c:type="char**">
            <type name="utf8"/>
          </array>
        </return-value>
        <parameters>
          <parameter name="url" transfer-ownership="none">
            <doc xml:space="preserve">The URL we are trying to reach</doc>
    ...
    <function name="proxy_factory_new" c:identifier="px_proxy_factory_new">
      <doc xml:space="preserve">Creates a new pxProxyFactory instance. This instance should be kept
...
cache lifespan is handled automatically.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A new pxProxyFactory instance or NULL on error</doc>
