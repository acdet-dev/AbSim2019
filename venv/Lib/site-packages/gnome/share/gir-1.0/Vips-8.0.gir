...
See also: vips_foreign_find_load_buffer(), vips_image_new_from_file().</doc>
      ...
      <function name="find_load_buffer"
        ...
        <doc xml:space="preserve">Searches for an operation you could use to load a memory buffer. To see the
...
the tiff library.</doc>
    ...
    <enumeration name="ForeignWebpPreset"
      ...
      <doc xml:space="preserve">Tune lossy encoder settings for different image types.</doc>
      <member name="default"
              value="0"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_DEFAULT"
              glib:nick="default">
        <doc xml:space="preserve">default preset</doc>
      </member>
      <member name="picture"
              value="1"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_PICTURE"
              glib:nick="picture">
        <doc xml:space="preserve">digital picture, like portrait, inner shot</doc>
      </member>
      <member name="photo"
              value="2"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_PHOTO"
              glib:nick="photo">
        <doc xml:space="preserve">outdoor photograph, with natural lighting</doc>
      </member>
      <member name="drawing"
              value="3"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_DRAWING"
              glib:nick="drawing">
        <doc xml:space="preserve">hand or line drawing, with high-contrast details</doc>
      </member>
      <member name="icon"
              value="4"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_ICON"
              glib:nick="icon">
        <doc xml:space="preserve">small-sized colorful images</doc>
      </member>
      <member name="text"
              value="5"
              c:identifier="VIPS_FOREIGN_WEBP_PRESET_TEXT"
              glib:nick="text">
        <doc xml:space="preserve">text-like</doc>
      </member>
      <member name="last"
              value="6"
...
field of that name.</doc>
      ...
      <method name="guess_format" c:identifier="vips_image_guess_format">
        <doc xml:space="preserve">Return the #VipsBandFormat for an image, guessing a sane value if
the set value looks crazy.

For example, for a float image tagged as rgb16, we'd return ushort.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a sensible #VipsBandFormat for the image.</doc>
          <type name="BandFormat" c:type="VipsBandFormat"/>
        </return-value>
        <parameters>
          <instance-parameter name="image" transfer-ownership="none">
...
new numbers from the end.</doc>
    ...
    <enumeration name="Kernel"
                 ...
                 c:type="VipsKernel">
      <doc xml:space="preserve">The resampling kernels vips supports. See vips_reduce(), for example.

The Lanczos kernels vary in size with the downsampling ratio.</doc>
      <member name="nearest"
              value="0"
              c:identifier="VIPS_KERNEL_NEAREST"
              glib:nick="nearest">
        <doc xml:space="preserve">The nearest pixel to the point.</doc>
      </member>
      <member name="linear"
              value="1"
              c:identifier="VIPS_KERNEL_LINEAR"
              glib:nick="linear">
        <doc xml:space="preserve">Calculate a pixel value using linear interpolation.</doc>
      </member>
      <member name="cubic"
              value="2"
              c:identifier="VIPS_KERNEL_CUBIC"
              glib:nick="cubic">
        <doc xml:space="preserve">Calculate using a 4-element cubic kernel.</doc>
      </member>
      <member name="lanczos2"
              value="3"
              c:identifier="VIPS_KERNEL_LANCZOS2"
              glib:nick="lanczos2">
        <doc xml:space="preserve">Calculate with a two-lobe Lanczos kernel.</doc>
      </member>
      <member name="lanczos3"
              value="4"
              c:identifier="VIPS_KERNEL_LANCZOS3"
              glib:nick="lanczos3">
        <doc xml:space="preserve">Calculate with a three-lobe Lanczos kernel.</doc>
      </member>
      <member name="last"
              value="5"
...
and for debugging.</doc>
    ...
    <constant name="META_ORIENTATION"
      ...
      <doc xml:space="preserve">The orientation tag for this image. An int from 1 - 8 using the standard
exif/tiff meanings.
...
setting the environment variable VIPS_PROGRESS.</doc>
    ...
    <record name="Rect" c:type="VipsRect">
      <doc xml:space="preserve">A #VipsRect is a rectangular area of pixels. This is a struct for
performing simple rectangle algebra.</doc>
      <field name="left" writable="1">
        <doc xml:space="preserve">left edge of rectangle</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="top" writable="1">
        <doc xml:space="preserve">top edge of rectangle</doc>
        <type name="gint" c:type="int"/>
      </field>
      ...
      <method name="dup" c:identifier="vips_rect_dup" introspectable="0">
        <doc xml:space="preserve">Duplicate a rect to the heap. You need to free the result with vips_free().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a pointer to copy of @r allocated on the heap.</doc>
          <type name="Rect" c:type="VipsRect*"/>
        </return-value>
        <parameters>
          <instance-parameter name="r" transfer-ownership="none">
            <doc xml:space="preserve">rectangle to duplicate</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="equalsrect" c:identifier="vips_rect_equalsrect">
        <doc xml:space="preserve">Is @r1 equal to @r2?</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @r1 is equal to @r2.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="r1" transfer-ownership="none">
            <doc xml:space="preserve">first rectangle</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </instance-parameter>
          <parameter name="r2" transfer-ownership="none">
            <doc xml:space="preserve">second rectangle</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </parameter>
        </parameters>
      </method>
      <method name="includespoint" c:identifier="vips_rect_includespoint">
        <doc xml:space="preserve">Does @r contain point (@x, @y)?</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @r contains (@x, @y).</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="r" transfer-ownership="none">
            <doc xml:space="preserve">rectangle to test</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </instance-parameter>
          <parameter name="x" transfer-ownership="none">
            <doc xml:space="preserve">position to test for</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="y" transfer-ownership="none">
            <doc xml:space="preserve">position to test for</doc>
      ...
      <method name="includesrect" c:identifier="vips_rect_includesrect">
        <doc xml:space="preserve">Is @r2 a subset of @r1?</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @r2 is a subset of @r1.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="r1" transfer-ownership="none">
            <doc xml:space="preserve">outer rectangle</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </instance-parameter>
          <parameter name="r2" transfer-ownership="none">
            <doc xml:space="preserve">inner rectangle</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </parameter>
        </parameters>
      </method>
      <method name="intersectrect" c:identifier="vips_rect_intersectrect">
        <doc xml:space="preserve">Fill @out with the intersection of @r1 and @r2. @out can equal @r1 or @r2.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="r1" transfer-ownership="none">
            <doc xml:space="preserve">input rectangle 1</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </instance-parameter>
          <parameter name="r2" transfer-ownership="none">
            <doc xml:space="preserve">input rectangle 2</doc>
            <type name="Rect" c:type="const VipsRect*"/>
          </parameter>
          <parameter name="out" transfer-ownership="none">
            <doc xml:space="preserve">output rectangle</doc>
            <type name="Rect" c:type="VipsRect*"/>
          </parameter>
        </parameters>
      </method>
      <method name="isempty" c:identifier="vips_rect_isempty">
        <doc xml:space="preserve">Is @r empty? ie. zero width or height.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @r contains no pixels.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="r" transfer-ownership="none">
      ...
      <method name="marginadjust" c:identifier="vips_rect_marginadjust">
        <doc xml:space="preserve">Enlarge @r by @n. +1 means out one pixel.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="r" transfer-ownership="none">
            <doc xml:space="preserve">rectangle to adjust</doc>
            <type name="Rect" c:type="VipsRect*"/>
          </instance-parameter>
          <parameter name="n" transfer-ownership="none">
            <doc xml:space="preserve">enlarge by</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="normalise" c:identifier="vips_rect_normalise">
        <doc xml:space="preserve">Make sure width and height are &gt;0 by moving the origin and flipping the
rect.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="r" transfer-ownership="none">
            <doc xml:space="preserve">rect to normalise</doc>
            <type name="Rect" c:type="VipsRect*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="unionrect" c:identifier="vips_rect_unionrect">
        <doc xml:space="preserve">Fill @out with the bounding box of @r1 and @r2. @out can equal @r1 or @r2.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
See also: vips_region_prepare().</doc>
      ...
      <function name="prepare_many" c:identifier="vips_region_prepare_many">
        <return-value transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
...
the same sizeof( pel ).</doc>
      ...
      <method name="shrink" c:identifier="vips_region_shrink">
...
See also: vips_autorot_get_angle(), vips_autorot_remove_angle(), vips_rot().</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">0 on success, -1 on error</doc>
        <type name="gint" c:type="int"/>
      </return-value>
...
See also: vips_autorot().</doc>
    ...
    <function name="autorot_remove_angle"
              c:identifier="vips_autorot_remove_angle">
      <doc xml:space="preserve">Remove the orientation tag on @image. Also remove any exif orientation tags.

See also: vips_autorot_get_angle().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="image" transfer-ownership="none">
          <doc xml:space="preserve">image to remove orientation from</doc>
          <type name="Image" c:type="VipsImage*"/>
        </parameter>
      </parameters>
    </function>
...
#VIPS_FORMAT_DOUBLE.</doc>
    ...
    <function name="concurrency_get" c:identifier="vips_concurrency_get">
      <doc xml:space="preserve">Returns the number of worker threads that vips should use when running a
#VipsThreadPool.
...
See also: vips_concurrency_get().</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">number of worker threads to use.</doc>
        <type name="gint" c:type="int"/>
      </return-value>
    </function>
    <function name="concurrency_set" c:identifier="vips_concurrency_set">
      <doc xml:space="preserve">Sets the number of worker threads that vips should use when running a
#VipsThreadPool.
...
See also: vips_concurrency_get().</doc>
      ...
      <parameters>
        <parameter name="concurrency" transfer-ownership="none">
          <doc xml:space="preserve">number of threads to run</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
...
See also: vips_convsep().</doc>
    ...
    <function name="conva" c:identifier="vips_conva" introspectable="0">
      <doc xml:space="preserve">Optional arguments:
...
See also: vips_conv().</doc>
    ...
    <function name="convasep" c:identifier="vips_convasep" introspectable="0">
      <doc xml:space="preserve">Optional arguments:
...
See also: vips_convsep().</doc>
    ...
    <function name="convf" c:identifier="vips_convf" introspectable="0">
      <doc xml:space="preserve">Convolution. This is a low-level operation, see vips_conv() for something
more convenient.
...
See also: vips_conv().</doc>
    ...
    <function name="convi" c:identifier="vips_convi" introspectable="0">
      <doc xml:space="preserve">Integer convolution. This is a low-level operation, see vips_conv() for
...
@loader is something like "tiffload" or "VipsForeignLoadTiff".</doc>
    ...
    <function name="format_sizeof_unsafe"
              ...
              introspectable="0">
      <doc xml:space="preserve">A fast but dangerous version of vips_format_sizeof(). You must have
...
See also: vips_pdfload().</doc>
    ...
    <function name="pngload" c:identifier="vips_pngload" introspectable="0">
      <doc xml:space="preserve">Read a PNG file into a VIPS image. It can read all png images, including 8-
...
See also: vips_image_write_to_file().</doc>
    ...
    <function name="radsave_buffer"
              c:identifier="vips_radsave_buffer"
              introspectable="0">
      <doc xml:space="preserve">As vips_radsave(), but save to a memory buffer.
