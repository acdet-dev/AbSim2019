...
<repository version="1.2"
  ...
  <namespace name="Gsf"
             version="1"
             shared-library="libgsf-1-114.dll"
             c:identifier-prefixes="Gsf"
             c:symbol-prefixes="gsf">
    <alias name="gsf_off_t" c:type="gsf_off_t">
      <doc xml:space="preserve">Data type to represent offsets (positions) within a data stream.
...
to on the platform</doc>
    ...
    <class name="Blob"
      ...
      <constructor name="new" c:identifier="gsf_blob_new" throws="1">
        <doc xml:space="preserve">Creates a new #GsfBlob object to hold the specified data.  The blob can then
...
of memory.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly-created #GsfBlob, or %NULL if the data could not be copied.
...
Data which will be copied into the blob, or %NULL if @size is zero.</doc>
      ...
      <method name="get_size" c:identifier="gsf_blob_get_size">
        <doc xml:space="preserve">Queries the size in bytes of the data stored in the blob.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Size in bytes, or 0 if the data is %NULL.</doc>
          <type name="gsize" c:type="gsize"/>
        </return-value>
        <parameters>
          <instance-parameter name="blob" transfer-ownership="none">
            <doc xml:space="preserve">A #GsfBlob.</doc>
            <type name="Blob" c:type="GsfBlob*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="peek_data" c:identifier="gsf_blob_peek_data">
        <doc xml:space="preserve">Queries a pointer to the data stored in the blob.  This does not
...
on your own.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Pointer to the data stored in the
blob, or %NULL if the size of the data is zero.</doc>
    ...
    <class name="ClipData"
      ...
      <constructor name="new" c:identifier="gsf_clip_data_new">
        <doc xml:space="preserve">Creates a new #GsfClipData object.  This function acquires a reference to the
@data_blob, so you should unref the blob on your own if you no longer need it
directly.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly-created #GsfClipData.</doc>
          <type name="ClipData" c:type="GsfClipData*"/>
        </return-value>
        <parameters>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">Format for the data inside the @data_blob</doc>
            <type name="ClipFormat" c:type="GsfClipFormat"/>
          </parameter>
          <parameter name="data_blob" transfer-ownership="none">
            <doc xml:space="preserve">Object which holds the binary contents for the #GsfClipData</doc>
            <type name="Blob" c:type="GsfBlob*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="get_data_blob" c:identifier="gsf_clip_data_get_data_blob">
        <doc xml:space="preserve">Queries the data blob that actually stores a #GsfClipData's binary data.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new reference to the #GsfBlob that stores this @clip_data's
...
you are done with it.</doc>
        ...
        <parameters>
          <instance-parameter name="clip_data" transfer-ownership="none">
            <doc xml:space="preserve">A #GsfClipData.</doc>
            <type name="ClipData" c:type="GsfClipData*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_format" c:identifier="gsf_clip_data_get_format">
        <doc xml:space="preserve">Queries the clipboard data format of a #GsfClipData.  The format refers to the data
blob inside the @clip_data; use gsf_clip_data_get_data_blob() to get that data blob.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The format in which the #GsfClipData's data blob is stored.</doc>
          <type name="ClipFormat" c:type="GsfClipFormat"/>
        </return-value>
        <parameters>
          <instance-parameter name="clip_data" transfer-ownership="none">
      ...
      <method name="get_windows_clipboard_format"
              ...
              throws="1">
        <doc xml:space="preserve">Queries the Windows clipboard data format for a #GsfClipData.  The @clip_data must
have been created with #GSF_CLIP_FORMAT_WINDOWS_CLIPBOARD.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A #GsfClipFormatWindows value.
...
smaller than it should be; in this case GSF_CLIP_FORMAT_WINDOWS_ERROR will be returned.</doc>
      ...
      <method name="peek_real_data"
              ...
              throws="1">
        <doc xml:space="preserve">Queries a pointer directly to the clipboard data of a #GsfClipData.  The
...
those header bytes if necessary and return a pointer to the "real" data.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Pointer to the real clipboard data.  The size in bytes of this
buffer is returned in the @ret_size argument.</doc>
        ...
        <parameters>
          ...
          <parameter name="ret_size" transfer-ownership="none">
            <doc xml:space="preserve">Location to return the size of the returned data buffer.</doc>
            <type name="gsize" c:type="gsize*"/>
          </parameter>
        </parameters>
      </method>
    ...
    <class name="DocMetaData"
      ...
      <doc xml:space="preserve">Class representing information about a document, such as creator and time of
last modification.</doc>
      <constructor name="new" c:identifier="gsf_doc_meta_data_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new metadata property collection</doc>
          <type name="DocMetaData" c:type="GsfDocMetaData*"/>
        </return-value>
      </constructor>
      <method name="foreach" c:identifier="gsf_doc_meta_data_foreach">
        <doc xml:space="preserve">Iterate through each (key, value) pair in this collection</doc>
        <return-value transfer-ownership="none">
        ...
        <parameters>
          ...
          <parameter name="func"
                     ...
                     scope="call"
                     closure="1">
            <doc xml:space="preserve">the function called once for each element in the collection</doc>
            <type name="GLib.HFunc" c:type="GHFunc"/>
          </parameter>
          <parameter name="user_data" transfer-ownership="none">
            <doc xml:space="preserve">any supplied user data or %NULL</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
      <method name="insert" c:identifier="gsf_doc_meta_data_insert">
        <doc xml:space="preserve">Take ownership of @name and @value and insert a property into @meta.
If a property exists with @name, it is replaced (The link is lost)</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">#GValue</doc>
      ...
      <method name="lookup" c:identifier="gsf_doc_meta_data_lookup">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the property with name @id in @meta.  The caller can modify the
property value and link but not the name.</doc>
      ...
      <method name="odf_subtree"
              ...
              version="1.14.24">
        <doc xml:space="preserve">Extend @xin so that it can parse a subtree in OpenDoc metadata format</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="doc" transfer-ownership="none">
            <doc xml:space="preserve">#GsfXMLInDoc</doc>
      ...
      <method name="read_from_msole"
              ...
              version="1.14.24">
        <doc xml:space="preserve">Read a stream formated as a set of MS OLE properties from @in and store the
results in @accum.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A #GError if there was an error.</doc>
      ...
      <method name="read_from_odf"
              ...
              version="1.14.24">
        <doc xml:space="preserve">Read an OpenDocument metadata stream from @input and store the properties
into @md.  Overwrite any existing properties with the same id.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #GError if there is a problem.</doc>
          <type name="GLib.Error" c:type="GError*"/>
        </return-value>
        <parameters>
          <instance-parameter name="md" transfer-ownership="none">
      ...
      <method name="remove" c:identifier="gsf_doc_meta_data_remove">
        <doc xml:space="preserve">If @name does not exist in the collection, do nothing. If @name does exist,
remove it and its value from the collection</doc>
        ...
        <parameters>
          ...
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">the non-null string name of the property</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="size" c:identifier="gsf_doc_meta_data_size">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of items in this collection</doc>
          <type name="gsize" c:type="gsize"/>
        </return-value>
        <parameters>
          <instance-parameter name="meta" transfer-ownership="none">
      ...
      <method name="store" c:identifier="gsf_doc_meta_data_store">
        ...
        <parameters>
          ...
          <parameter name="prop" transfer-ownership="none">
            <doc xml:space="preserve">#GsfDocProp</doc>
            <type name="DocProp" c:type="GsfDocProp*"/>
          </parameter>
        </parameters>
      </method>
      <method name="write_to_msole"
        ...
        <parameters>
          ...
          <parameter name="out" transfer-ownership="none">
            <doc xml:space="preserve">#GsfOutput</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </parameter>
          <parameter name="doc_not_component" transfer-ownership="none">
            <doc xml:space="preserve">a kludge to differentiate DocumentSummary from Summary</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="write_to_odf"
              ...
              version="1.14.24">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if no error occured.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="md" transfer-ownership="none">
          ...
          <parameter name="output" transfer-ownership="none">
            <doc xml:space="preserve">a pointer to a #GsfOutput.</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
    ...
    <record name="DocProp"
      ...
      <doc xml:space="preserve">Class representing a properties of a document.</doc>
      <constructor name="new" c:identifier="gsf_doc_prop_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GsfDocProp.</doc>
          <type name="DocProp" c:type="GsfDocProp*"/>
        </return-value>
        <parameters>
      ...
      <method name="dump" c:identifier="gsf_doc_prop_dump">
        <doc xml:space="preserve">A debugging utility to dump @prop as text via g_print
New in 1.14.2</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="free" c:identifier="gsf_doc_prop_free">
        <doc xml:space="preserve">If @prop is non %NULL free the memory associated with it</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_link" c:identifier="gsf_doc_prop_get_link">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the current link descriptor of @prop.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="prop" transfer-ownership="none">
      ...
      <method name="get_val" c:identifier="gsf_doc_prop_get_val">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the value of the property, the caller should not modify the result.</doc>
          <type name="GObject.Value" c:type="GValue*"/>
        </return-value>
        <parameters>
          <instance-parameter name="prop" transfer-ownership="none">
      ...
      <method name="set_link" c:identifier="gsf_doc_prop_set_link">
        <doc xml:space="preserve">Sets @prop's link to @link</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_val" c:identifier="gsf_doc_prop_set_val">
        <doc xml:space="preserve">Assigns @val to @prop, and unsets and frees the current value.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="swap_val" c:identifier="gsf_doc_prop_swap_val">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the current value of @prop, and replaces
	it with @val.</doc>
          <type name="GObject.Value" c:type="GValue*"/>
        </return-value>
        <parameters>
    ...
    <class name="DocPropVector"
      ...
      <constructor name="new" c:identifier="gsf_docprop_vector_new">
        <doc xml:space="preserve">This function creates a new gsf_docprop_vector object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">GsfDocPropVector*</doc>
          <type name="DocPropVector" c:type="GsfDocPropVector*"/>
        </return-value>
      </constructor>
      <method name="append" c:identifier="gsf_docprop_vector_append">
        <doc xml:space="preserve">Insert a copy of @value as the last element of @vector.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="vector" transfer-ownership="none">
            <doc xml:space="preserve">The vector to which the GValue will be added</doc>
            <type name="DocPropVector" c:type="GsfDocPropVector*"/>
          </instance-parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">The GValue to add to @vector</doc>
            <type name="GObject.Value" c:type="GValue*"/>
          </parameter>
        </parameters>
      </method>
      <method name="as_string" c:identifier="gsf_docprop_vector_as_string">
        <doc xml:space="preserve">This function returns a string which represents all the GValues in @vector.
The caller is responsible for freeing the result.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a string of comma-separated values</doc>
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="vector" transfer-ownership="none">
            <doc xml:space="preserve">The #GsfDocPropVector from which GValues will be extracted.</doc>
            <type name="DocPropVector" c:type="GsfDocPropVector*"/>
          </instance-parameter>
        </parameters>
      </method>
    ...
    <enumeration name="Error"
      ...
      <member name="out_of_memory"
        ...
        <doc xml:space="preserve">Memory allocation failed</doc>
      </member>
      <member name="invalid_data"
              value="1"
              c:identifier="GSF_ERROR_INVALID_DATA">
        <doc xml:space="preserve">Invalid data encountered (e.g. not enough data)</doc>
      </member>
    </enumeration>
    <class name="Infile"
      ...
      <virtual-method name="name_by_index" invoker="name_by_index">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the utf8 encoded name of the @i-th child</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="infile" transfer-ownership="none">
            <doc xml:space="preserve">An #GsfInfile</doc>
            <type name="Infile" c:type="GsfInfile*"/>
          </instance-parameter>
          <parameter name="i" transfer-ownership="none">
            <doc xml:space="preserve">zero-based index of child to find.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </virtual-method>
      <virtual-method name="num_children" invoker="num_children">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of children the storage has, or -1 if the storage can not
	have children.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="infile" transfer-ownership="none">
            <doc xml:space="preserve">the structured storage</doc>
            <type name="Infile" c:type="GsfInfile*"/>
          </instance-parameter>
        </parameters>
      </virtual-method>
      <method name="child_by_aname" c:identifier="gsf_infile_child_by_aname">
        <doc xml:space="preserve">This function finds a child that is several directory levels down
...
New in 1.14.9.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly created child which must be unrefed.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="infile" transfer-ownership="none">
            <doc xml:space="preserve">#GsfInfile</doc>
            <type name="Infile" c:type="GsfInfile*"/>
          </instance-parameter>
          <parameter name="names" transfer-ownership="none">
            <doc xml:space="preserve">A %NULL terminated array of names (e.g. from g_strsplit)</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="child_by_index" c:identifier="gsf_infile_child_by_index">
        <doc xml:space="preserve">TODO : For 2.0 api will change to include a #GError.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly created child which must be unrefed.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          ...
          <parameter name="i" transfer-ownership="none">
            <doc xml:space="preserve">target index</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="child_by_name" c:identifier="gsf_infile_child_by_name">
        <doc xml:space="preserve">The function returns a named child of the given infile.  This only
...
TODO : For 2.0 api will change to include a #GError.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly created child which must be
unrefed.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
      ...
      <method name="child_by_vaname"
              ...
              introspectable="0">
        <doc xml:space="preserve">Apart from argument types, this is the same as gsf_infile_child_by_aname.
...
New in 1.14.9.</doc>
      ...
      <method name="child_by_vname"
              ...
              introspectable="0">
        <doc xml:space="preserve">Apart from the way arguments are specified, this is the same as
gsf_infile_child_by_aname.  Please see the documentation there.</doc>
        ...
        <parameters>
          <instance-parameter name="infile" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfInfile</doc>
            <type name="Infile" c:type="GsfInfile*"/>
          </instance-parameter>
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">A %NULL terminated list of names</doc>
            <varargs/>
          </parameter>
        </parameters>
      </method>
    ...
    <class name="InfileMSOle"
      ...
      <constructor name="new" c:identifier="gsf_infile_msole_new" throws="1">
        <doc xml:space="preserve">Opens the root directory of an MS OLE file.
&lt;note&gt;This adds a reference to @source.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the new ole file handler</doc>
          <type name="Infile" c:type="GsfInfile*"/>
        </return-value>
        <parameters>
      ...
      <method name="get_class_id" c:identifier="gsf_infile_msole_get_class_id">
        <doc xml:space="preserve">Retrieves the 16 byte indentifier (often a GUID in MS Windows apps)
stored within the directory associated with @ole and stores it in @res.</doc>
        ...
        <parameters>
          <instance-parameter name="ole" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfInfileMSOle</doc>
            <type name="InfileMSOle" c:type="GsfInfileMSOle*"/>
          </instance-parameter>
          <parameter name="res" transfer-ownership="none">
            <doc xml:space="preserve">16 byte identifier (often a GUID in MS Windows apps)</doc>
    ...
    <class name="InfileMSVBA"
      ...
      <method name="get_modules" c:identifier="gsf_infile_msvba_get_modules">
        <doc xml:space="preserve">a collection of names and source code.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%NULL, or a hashtable of names and source code (unknown encoding).</doc>
      ...
      <method name="steal_modules"
        ...
        <doc xml:space="preserve">A collection of names and source code which the caller is responsible for destroying.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">%NULL, or a hashtable of names and source code (unknown encoding).</doc>
          <type name="GLib.HashTable" c:type="GHashTable*">
            <type name="gpointer" c:type="gpointer"/>
    ...
    <class name="InfileStdio"
      ...
      <constructor name="new" c:identifier="gsf_infile_stdio_new" throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new file or %NULL.</doc>
          <type name="Infile" c:type="GsfInfile*"/>
        </return-value>
        <parameters>
          <parameter name="root" transfer-ownership="none">
            <doc xml:space="preserve">in locale dependent encoding</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="InfileTar"
      ...
      <constructor name="new" c:identifier="gsf_infile_tar_new" throws="1">
        <doc xml:space="preserve">Opens the root directory of a Tar file.
&lt;note&gt;This adds a reference to @source.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the new tar file handler</doc>
          <type name="Infile" c:type="GsfInfile*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
            <doc xml:space="preserve">A base #GsfInput</doc>
            <type name="Input" c:type="GsfInput*"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="InfileZip"
      ...
      <constructor name="new" c:identifier="gsf_infile_zip_new" throws="1">
        <doc xml:space="preserve">Opens the root directory of a Zip file.
&lt;note&gt;This adds a reference to @source.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the new zip file handler</doc>
          <type name="Infile" c:type="GsfInfile*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
      ...
      <property name="compression-level" transfer-ownership="none">
        <doc xml:space="preserve">Controls the level of compression used for new members.</doc>
    ...
    <class name="Input"
      ...
      <doc xml:space="preserve">Class representing an input stream.</doc>
      <constructor name="mmap_new"
                   c:identifier="gsf_input_mmap_new"
                   throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GsfInputMemory</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">The file on disk that you want to mmap</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
      <function name="error_id" c:identifier="gsf_input_error_id">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A utility quark to flag a #GError as being an input problem.</doc>
      ...
      <method name="container" c:identifier="gsf_input_container">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">@input's container, potentially %NULL.</doc>
          <type name="Infile" c:type="GsfInfile*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="copy" c:identifier="gsf_input_copy">
        <doc xml:space="preserve">Copy the contents from @input to @output from their respective
...
gsf_output_seek (output, 0, G_SEEK_SET) first, if applicable.</doc>
        ...
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">a non-null #GsfInput</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
          <parameter name="output" transfer-ownership="none">
            <doc xml:space="preserve">a non-null #GsfOutput</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </parameter>
        </parameters>
      </method>
      <method name="dump" c:identifier="gsf_input_dump">
        <doc xml:space="preserve">Dumps @input's contents to STDOUT, optionally in hex format.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfInput</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
          <parameter name="dump_as_hex" transfer-ownership="none">
            <doc xml:space="preserve">If %TRUE, dump in hexidecmal format</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="dup" c:identifier="gsf_input_dup" throws="1">
        <doc xml:space="preserve">Duplicates input @src leaving the new one at the same offset.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the duplicate, or %NULL on error</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">The input to duplicate</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="eof" c:identifier="gsf_input_eof">
        <doc xml:space="preserve">Are we at the end of the file?</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the input is at the eof.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">the input</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="find_vba" c:identifier="gsf_input_find_vba" throws="1">
        <doc xml:space="preserve">A utility routine that attempts to find the VBA file withint a stream.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a GsfInfile</doc>
          <type name="InfileMSVBA" c:type="GsfInfileMSVBA*"/>
        </return-value>
      ...
      <method name="get_modtime" c:identifier="gsf_input_get_modtime">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A #GDateTime representing when the input
was last modified, or %NULL if not known.</doc>
      ...
      <method name="name" c:identifier="gsf_input_name">
        <doc xml:space="preserve">The name of the input stream.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">@input's name in utf8 form, or %NULL if it
has no name.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
      ...
      <method name="read"
              ...
              shadowed-by="read0"
              introspectable="0">
        <doc xml:space="preserve">Read at least @num_bytes.  Does not change the current position if there
...
the buffer associated with previous calls to gsf_input_read.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">pointer to the buffer or %NULL if there is an error or 0
bytes are requested.</doc>
          <type name="guint8" c:type="guint8*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
          ...
          <parameter name="num_bytes" transfer-ownership="none">
            <doc xml:space="preserve">number of bytes to read</doc>
            <type name="gulong" c:type="size_t"/>
          </parameter>
          <parameter name="optional_buffer" transfer-ownership="none">
            <doc xml:space="preserve">Pointer to destination memory area</doc>
            <type name="guint8" c:type="guint8*"/>
          </parameter>
        </parameters>
      </method>
      <method name="read0" c:identifier="gsf_input_read0" shadows="read">
        <doc xml:space="preserve">Read @num_bytes.  Does not change the current position if there
...
the data read.</doc>
        ...
        <parameters>
          ...
          <parameter name="bytes_read"
            ...
            <doc xml:space="preserve">copy of @num_bytes</doc>
            <type name="gulong" c:type="size_t*"/>
          </parameter>
        </parameters>
      </method>
      <method name="remaining" c:identifier="gsf_input_remaining">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bytes left in the file.</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="seek" c:identifier="gsf_input_seek">
        <doc xml:space="preserve">Move the current location in the input stream.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE on error.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
          ...
          <parameter name="offset" transfer-ownership="none">
            <doc xml:space="preserve">target offset</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
          <parameter name="whence" transfer-ownership="none">
            <doc xml:space="preserve">determines whether the offset is relative to the beginning or
      ...
      <method name="seek_emulate" c:identifier="gsf_input_seek_emulate">
        <doc xml:space="preserve">Emulate forward seeks by reading.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the emulation failed.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">stream to emulate seek for</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
          <parameter name="pos" transfer-ownership="none">
            <doc xml:space="preserve">absolute position to seek to</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_container" c:identifier="gsf_input_set_container">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the assignment was ok.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="set_modtime" c:identifier="gsf_input_set_modtime">
        <doc xml:space="preserve">protected.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the assignment was ok.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          ...
          <parameter name="modtime"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">the new modification time.</doc>
            <type name="GLib.DateTime" c:type="GDateTime*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="set_name_from_filename"
        ...
        <parameters>
          ...
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">the (fs-sys encoded) filename</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_size" c:identifier="gsf_input_set_size">
        ...
        <parameters>
          ...
          <parameter name="size" transfer-ownership="none">
            <doc xml:space="preserve">the size of the stream</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
        </parameters>
      </method>
      <method name="sibling" c:identifier="gsf_input_sibling" throws="1">
        <doc xml:space="preserve">UNIMPLEMENTED BY ANY BACKEND
...
managing the resulting object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A related #GsfInput or %NULL on failure.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="size" c:identifier="gsf_input_size">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the total number of bytes in the input or -1 on error</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="tell" c:identifier="gsf_input_tell">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the current offset in the file.</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
      ...
      <method name="uncompress" c:identifier="gsf_input_uncompress">
        <doc xml:space="preserve">This functions takes ownership of the incoming reference and yields a
new one as its output.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A stream equivalent to the source stream,
but uncompressed if the source was compressed.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="src" transfer-ownership="full">
            <doc xml:space="preserve">stream to be uncompressed.</doc>
            <type name="Input" c:type="GsfInput*"/>
          </instance-parameter>
        </parameters>
      </method>
      <property name="container" transfer-ownership="none">
        <doc xml:space="preserve">The container, optionally %NULL, in which this input lives.</doc>
        <type name="Infile"/>
      </property>
      <property name="eof" transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the end of the file has been reached.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="modtime" transfer-ownership="none">
        <doc xml:space="preserve">The time the input was last updated.  This represents the
...
It is not supported by all derived classes.</doc>
      ...
      <property name="position" transfer-ownership="none">
        <doc xml:space="preserve">The current position in the input.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <property name="remaining" transfer-ownership="none">
        <doc xml:space="preserve">The number of bytes remaining in the file.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <property name="size" transfer-ownership="none">
        <doc xml:space="preserve">The total number of bytes in the file.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <field name="g_object">
        <type name="GObject.Object" c:type="GObject"/>
    ...
    <class name="InputGZip"
      ...
      <constructor name="new" c:identifier="gsf_input_gzip_new" throws="1">
        <doc xml:space="preserve">Adds a reference to @source.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new file or %NULL.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
            <doc xml:space="preserve">The underlying data source.</doc>
            <type name="Input" c:type="GsfInput*"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="InputGio"
      ...
      <constructor name="new" c:identifier="gsf_input_gio_new" throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GsfInputGio or %NULL</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
    ...
    <class name="InputHTTP"
      ...
      <constructor name="new" c:identifier="gsf_input_http_new" throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">an open HTTP connection, ready for reading.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="url" transfer-ownership="none">
            <doc xml:space="preserve">A string containing the URL to retrieve</doc>
            <type name="utf8" c:type="gchar*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="get_content_type"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">an allocated string containing the Content-Type field of the HTTP response.</doc>
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">#GsfInputHTTP</doc>
      ...
      <method name="get_url" c:identifier="gsf_input_http_get_url">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">an allocated string containing the URL used for input.</doc>
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="input" transfer-ownership="none">
    ...
    <class name="InputMemory"
      ...
      <constructor name="new" c:identifier="gsf_input_memory_new">
        ...
        <parameters>
          <parameter name="buf" transfer-ownership="none">
            <doc xml:space="preserve">The input bytes</doc>
            <type name="guint8" c:type="guint8*"/>
          </parameter>
          <parameter name="length" transfer-ownership="none">
            <doc xml:space="preserve">The length of @buf</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
          <parameter name="needs_free" transfer-ownership="none">
            <doc xml:space="preserve">Whether you want this memory to be free'd at object destruction</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </constructor>
      ...
      <constructor name="new_from_bzip"
                   ...
                   throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GsfInputMemory or %NULL.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
    ...
    <class name="InputProxy"
      ...
      <constructor name="new" c:identifier="gsf_input_proxy_new">
        <doc xml:space="preserve">This creates a new proxy to the entire, given input source.  See
gsf_input_proxy_new_section for details.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new input object.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
      ...
      <constructor name="new_section"
        ...
        <doc xml:space="preserve">This creates a new proxy to a section of the given source.  The new
...
This function will ref the source.</doc>
        ...
        <parameters>
          ...
          <parameter name="offset" transfer-ownership="none">
            <doc xml:space="preserve">Offset into source for start of section.</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
          <parameter name="size" transfer-ownership="none">
            <doc xml:space="preserve">Length of section.</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="InputStdio"
      ...
      <constructor name="new" c:identifier="gsf_input_stdio_new" throws="1">
        ...
        <parameters>
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">in utf8.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_FILE" c:identifier="gsf_input_stdio_new_FILE">
        <doc xml:space="preserve">Assumes ownership of @file when succeeding.  If @keep_open is true,
ownership reverts to caller when the #GsfInput is closed.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GsfInput wrapper for @file.  Note that if the file is not
	seekable, this function will make a local copy of the entire file.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">The filename corresponding to @file.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="file" transfer-ownership="full">
            <doc xml:space="preserve">an existing stdio &lt;type&gt;FILE&lt;/type&gt; *</doc>
            <type name="gpointer" c:type="FILE*"/>
          </parameter>
          <parameter name="keep_open" transfer-ownership="none">
            <doc xml:space="preserve">Should @file be closed when the wrapper is closed</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="InputTextline"
      ...
      <constructor name="new" c:identifier="gsf_input_textline_new">
        <doc xml:space="preserve">&lt;note&gt;This adds a reference to @source.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new file or %NULL.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <parameter name="source" transfer-ownership="none">
            <doc xml:space="preserve">in some combination of ascii and utf8</doc>
            <type name="Input" c:type="GsfInput*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="ascii_gets" c:identifier="gsf_input_textline_ascii_gets">
        <doc xml:space="preserve">A utility routine to read things line by line from the underlying source.
Trailing newlines and carriage returns are stripped, and the resultant buffer
can be edited.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the string read, or %NULL on eof.</doc>
          <type name="guint8" c:type="unsigned char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="textline" transfer-ownership="none">
            <doc xml:space="preserve">#GsfInputTextline</doc>
...
can be edited.</doc>
    ...
    <constant name="META_NAME_BYTE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of bytes in the document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_CASE_SENSITIVE"
              value="gsf:case-sensitivity"
              c:type="GSF_META_NAME_CASE_SENSITIVE">
      <doc xml:space="preserve">(Unsigned Integer) Identifier representing the case-sensitiveness.
&lt;note&gt;of what ?? why is it an integer ??&lt;/note&gt;</doc>
    ...
    <constant name="META_NAME_CATEGORY"
      ...
      <doc xml:space="preserve">(String) Category of the document. &lt;note&gt;example???&lt;/note&gt;</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_CELL_COUNT"
              value="gsf:cell-count"
              c:type="GSF_META_NAME_CELL_COUNT">
      <doc xml:space="preserve">(Integer) Count of cells in the spread-sheet document, if appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_CHARACTER_COUNT"
              value="gsf:character-count"
              c:type="GSF_META_NAME_CHARACTER_COUNT">
      <doc xml:space="preserve">(Integer) Count of characters in the document.
...
TODO See how to sync this with ODF's document-statistic</doc>
    ...
    <constant name="META_NAME_CODEPAGE"
      ...
      <doc xml:space="preserve">(UnsignedShort) The MS codepage to encode strings for metadata
1.14.0	Clarified that this is unique from _NAME_CODEPAGE in msole</doc>
    ...
    <constant name="META_NAME_COMPANY"
      ...
      <doc xml:space="preserve">(String) Name of the company/organization that the "CREATOR" entity is
associated with.
...
1.14.1	Moved from "gsf:company" to "dc:publisher".</doc>
    ...
    <constant name="META_NAME_CREATOR"
      ...
      <doc xml:space="preserve">(String) An entity primarily responsible for making the content of the
...
1.14.0	Moved from "gsf" to "dc".</doc>
    ...
    <constant name="META_NAME_DATE_CREATED"
      ...
      <doc xml:space="preserve">(Date as ISO String) A date associated with an event in the life cycle of
...
by OpenDocument and Gnumeric.</doc>
    ...
    <constant name="META_NAME_DATE_MODIFIED"
      ...
      <doc xml:space="preserve">(GsfTimestamp) The last time this document was saved.
...
1.14.0	Moved from dc:date-modified to dc:date.</doc>
    ...
    <constant name="META_NAME_DESCRIPTION"
      ...
      <doc xml:space="preserve">(String) An account of the content of the resource.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_DICTIONARY"
              value="gsf:dictionary"
              c:type="GSF_META_NAME_DICTIONARY">
      <doc xml:space="preserve">(None) Reserved name (PID) for Dictionary</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_DOCUMENT_PARTS"
              value="gsf:document-parts"
              c:type="GSF_META_NAME_DOCUMENT_PARTS">
      <doc xml:space="preserve">(Vector of strings) Names of the 'interesting' parts of the document.  In
...
From MSOLE</doc>
    ...
    <constant name="META_NAME_EDITING_DURATION"
      ...
      <doc xml:space="preserve">(Date as ISO String) The total-time taken until the last modification.
...
and Gnumeric.</doc>
    ...
    <constant name="META_NAME_GENERATOR"
      ...
      <doc xml:space="preserve">(String) The application that generated this document. AbiWord, Gnumeric,
etc...
...
1.14.0 Moved from "gsf" to "meta".</doc>
    ...
    <constant name="META_NAME_HEADING_PAIRS"
      ...
      <doc xml:space="preserve">(Vector of string value pairs stored in alternating elements) Store the
...
From MSOLE</doc>
    ...
    <constant name="META_NAME_HIDDEN_SLIDE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of hidden-slides in the presentation document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_IMAGE_COUNT"
              value="gsf:image-count"
              c:type="GSF_META_NAME_IMAGE_COUNT">
      <doc xml:space="preserve">(Integer) Count of images in the document, if appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_INITIAL_CREATOR"
              value="meta:initial-creator"
              c:type="GSF_META_NAME_INITIAL_CREATOR">
      <doc xml:space="preserve">(String) Specifies the name of the person who created the document
initially.
1.14.0 Moved from "gsf" to "meta".</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_KEYWORD"
      ...
      <doc xml:space="preserve">(String) Searchable, indexable keywords. Similar to PDF keywords or HTML's
meta block.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_KEYWORDS"
      ...
      <doc xml:space="preserve">(GsfDocPropVector of String) Searchable, indexable keywords. Similar to PDF
keywords or HTML's meta block.</doc>
    ...
    <constant name="META_NAME_LANGUAGE"
      ...
      <doc xml:space="preserve">(String) The locale language of the intellectual content of the resource
...
1.14.0	Clarified that this is unique from _NAME_CODEPAGE in msole</doc>
    ...
    <constant name="META_NAME_LAST_PRINTED"
      ...
      <doc xml:space="preserve">(GSF_META_NAME_HEADING_PAIRS) The last time this document was printed.
...
1.14.1	Moved back to "gsf" from "dc".</doc>
    ...
    <constant name="META_NAME_LAST_SAVED_BY"
      ...
      <doc xml:space="preserve">(String) The entity that made the last change to the document, typically a
person, organization, or service.</doc>
    ...
    <constant name="META_NAME_LINE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of liness in the document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    ...
    <constant name="META_NAME_LOCALE_SYSTEM_DEFAULT"
      ...
      <doc xml:space="preserve">(Unsigned Integer) Identifier representing the default system locale.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_MANAGER"
              value="gsf:manager"
              c:type="GSF_META_NAME_MANAGER">
      <doc xml:space="preserve">(String) Name of the manager of "CREATOR" entity.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_MM_CLIP_COUNT"
              value="gsf:MM-clip-count"
              c:type="GSF_META_NAME_MM_CLIP_COUNT">
      <doc xml:space="preserve">(Integer) Count of "multi-media" clips in the document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_MSOLE_UNKNOWN_17"
              value="msole:unknown-doc-17"
              c:type="GSF_META_NAME_MSOLE_UNKNOWN_17">
      <doc xml:space="preserve">(Unknown) User-defined name</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    ...
    <constant name="META_NAME_MSOLE_UNKNOWN_19"
      ...
      <doc xml:space="preserve">(Boolean) User-defined name</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    ...
    <constant name="META_NAME_MSOLE_UNKNOWN_23"
      ...
      <doc xml:space="preserve">(i4) User-defined name</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_NOTE_COUNT"
              value="gsf:note-count"
              c:type="GSF_META_NAME_NOTE_COUNT">
      <doc xml:space="preserve">(Integer) Count of "notes" in the document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_OBJECT_COUNT"
              value="gsf:object-count"
              c:type="GSF_META_NAME_OBJECT_COUNT">
      <doc xml:space="preserve">(Integer) Count of objects (OLE and other graphics) in the document, if
appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_PAGE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of pages in the document, if appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_PARAGRAPH_COUNT"
              value="gsf:paragraph-count"
              c:type="GSF_META_NAME_PARAGRAPH_COUNT">
      <doc xml:space="preserve">(Integer) Count of paragraphs in the document, if appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_PRESENTATION_FORMAT"
              value="gsf:presentation-format"
              c:type="GSF_META_NAME_PRESENTATION_FORMAT">
      <doc xml:space="preserve">(String) Type of presentation, like "On-screen Show", "SlideView" etc.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_PRINTED_BY"
              value="meta:printed-by"
              c:type="GSF_META_NAME_PRINTED_BY">
      <doc xml:space="preserve">(String) Specifies the name of the last person who printed the document.
...
1.14.0	Moved from "gsf" to "meta".</doc>
    ...
    <constant name="META_NAME_PRINT_DATE"
      ...
      <doc xml:space="preserve">(GsfTimestamp) Specifies the date and time when the document was last
printed.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_REVISION_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of revision on the document, if appropriate.
...
correctly by OpenDocument and Gnumeric.</doc>
    ...
    <constant name="META_NAME_SECURITY"
      ...
      <doc xml:space="preserve">(Integer) Level of security.
...
&lt;/tbody&gt;&lt;/tgroup&gt;&lt;/informaltable&gt;</doc>
    ...
    <constant name="META_NAME_SLIDE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of slides in the presentation document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    ...
    <constant name="META_NAME_SUBJECT"
      ...
      <doc xml:space="preserve">(String) The topic of the content of the resource,
&lt;emphasis&gt;typically&lt;/emphasis&gt; including keywords.</doc>
    ...
    <constant name="META_NAME_TABLE_COUNT"
      ...
      <doc xml:space="preserve">(Integer) Count of tables in the document, if appropriate.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_TEMPLATE"
              value="meta:template"
              c:type="GSF_META_NAME_TEMPLATE">
      <doc xml:space="preserve">(String) The template file that is been used to generate this document.
...
1.14.0 Moved from "gsf" to "meta"</doc>
    ...
    <constant name="META_NAME_THUMBNAIL"
      ...
      <doc xml:space="preserve">(GsfClipData) Thumbnail data of the document, typically a
preview image of the document.</doc>
    ...
    <constant name="META_NAME_TITLE"
      ...
      <doc xml:space="preserve">(String) A formal name given to the resource.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <constant name="META_NAME_WORD_COUNT"
              value="gsf:word-count"
              c:type="GSF_META_NAME_WORD_COUNT">
      <doc xml:space="preserve">(Integer) Count of words in the document.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    ...
    <record name="OpenPkgRel" c:type="GsfOpenPkgRel" disguised="1">
      <method name="get_target" c:identifier="gsf_open_pkg_rel_get_target">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The target of @rel.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="rel" transfer-ownership="none">
            <doc xml:space="preserve">#GsfOpenPkgRel</doc>
            <type name="OpenPkgRel" c:type="GsfOpenPkgRel*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_type" c:identifier="gsf_open_pkg_rel_get_type">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The type of @rel.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="rel" transfer-ownership="none">
      ...
      <method name="is_extern" c:identifier="gsf_open_pkg_rel_is_extern">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @rel has mode 'External'</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="rel" transfer-ownership="none">
    ...
    <class name="Outfile"
      ...
      <doc xml:space="preserve">Class representing an output file, counterpart to #GsfInfile.</doc>
      ...
      <method name="new_child" c:identifier="gsf_outfile_new_child">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly created child</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="outfile" transfer-ownership="none">
            <doc xml:space="preserve">A #GsfOutfile</doc>
            <type name="Outfile" c:type="GsfOutfile*"/>
          </instance-parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">The name of the new child to create</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="is_dir" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE to create a directory, %FALSE to create a plain file</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="open_pkg_add_rel"
        ...
        <doc xml:space="preserve">A convenience wrapper to create a child in @dir of @content_type then create
a @type relation to @parent</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the new part.</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="dir" transfer-ownership="none">
            <doc xml:space="preserve">#GsfOutfile</doc>
            <type name="Outfile" c:type="GsfOutfile*"/>
          </instance-parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">target name</doc>
          ...
          <parameter name="content_type" transfer-ownership="none">
            <doc xml:space="preserve">non-%NULL content type</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
    ...
    <class name="OutfileMSOle"
      ...
      <constructor name="new" c:identifier="gsf_outfile_msole_new">
        <doc xml:space="preserve">Creates the root directory of an MS OLE file and manages the addition of
children.
...
&lt;note&gt;This adds a reference to @sink.&lt;/note&gt;</doc>
        ...
        <parameters>
          <parameter name="sink" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfOutput to hold the OLE2 file</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </parameter>
        </parameters>
      </constructor>
...
&lt;note&gt;This adds a reference to @sink.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="bb_size" transfer-ownership="none">
            <doc xml:space="preserve">size of large blocks.</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
          <parameter name="sb_size" transfer-ownership="none">
            <doc xml:space="preserve">size of small blocks.</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="set_class_id"
        ...
        <doc xml:space="preserve">Write @clsid to the directory associated with @ole.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE on success.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="ole" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfOutfileMSOle</doc>
            <type name="OutfileMSOle" c:type="GsfOutfileMSOle*"/>
          </instance-parameter>
          <parameter name="clsid" transfer-ownership="none">
            <doc xml:space="preserve">Identifier (often a GUID in MS Windows apps)</doc>
    ...
    <class name="OutfileOpenPkg"
      ...
      <constructor name="new" c:identifier="gsf_outfile_open_pkg_new">
        <doc xml:space="preserve">Convenience routine to create a GsfOutfileOpenPkg inside @sink.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a GsfOutfile that the caller is responsible for.</doc>
          <type name="Outfile" c:type="GsfOutfile*"/>
        </return-value>
        <parameters>
          <parameter name="sink" transfer-ownership="none">
      ...
      <method name="add_extern_rel"
        ...
        <doc xml:space="preserve">Add an external relation to @parent.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The id of the relation.  The string is
...
caller.</doc>
        ...
        <parameters>
          <instance-parameter name="parent" transfer-ownership="none">
            <doc xml:space="preserve">#GsfOutfileOpenPkg</doc>
          ...
          <parameter name="content_type" transfer-ownership="none">
            <doc xml:space="preserve">target content</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="relate" c:identifier="gsf_outfile_open_pkg_relate">
        <doc xml:space="preserve">Create a relationship between @child and @parent of @type.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the relID which the caller does not own
	but will live as long as @parent.</doc>
      ...
      <method name="set_sink" c:identifier="gsf_outfile_open_pkg_set_sink">
        <doc xml:space="preserve">Assigns a GsfOutput (@sink) to store the package into.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <class name="OutfileStdio"
      ...
      <constructor name="new" c:identifier="gsf_outfile_stdio_new" throws="1">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new outfile or %NULL.</doc>
          <type name="Outfile" c:type="GsfOutfile*"/>
        </return-value>
        <parameters>
          <parameter name="root" transfer-ownership="none">
            <doc xml:space="preserve">root directory in utf8.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_full"
        ...
        <parameters>
          ...
          <parameter name="err"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">place to store a #GError if anything goes wrong</doc>
            <type name="GLib.Error" c:type="GError**"/>
          </parameter>
          <parameter name="first_property_name" transfer-ownership="none">
          ...
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">value of first property, followed by more properties,
		%NULL-terminated</doc>
            <varargs/>
          </parameter>
        </parameters>
      ...
      <constructor name="new_valist"
        ...
        <parameters>
          ...
          <parameter name="var_args" transfer-ownership="none">
            <doc xml:space="preserve">a %NULL-terminated #va_list</doc>
            <type name="va_list" c:type="va_list"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="OutfileZip"
      ...
      <constructor name="new" c:identifier="gsf_outfile_zip_new" throws="1">
        <doc xml:space="preserve">Creates the root directory of a Zip file and manages the addition of
children.
...
&lt;note&gt;This adds a reference to @sink.&lt;/note&gt;</doc>
        ...
        <parameters>
          <parameter name="sink" transfer-ownership="none">
            <doc xml:space="preserve">a #GsfOutput to hold the ZIP file</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="Output"
      ...
      <doc xml:space="preserve">Class representing an output stream, counterpart to #GsfInput.</doc>
      ...
      <function name="unwrap" c:identifier="gsf_output_unwrap">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the unwrapping succeeded.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <function name="wrap" c:identifier="gsf_output_wrap">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the wrapping succeeded.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <parameter name="wrapper" transfer-ownership="none">
      ...
      <method name="close" c:identifier="gsf_output_close">
        <doc xml:space="preserve">Close a stream.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="container" c:identifier="gsf_output_container">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">@output's container, potentially %NULL.</doc>
          <type name="Outfile" c:type="GsfOutfile*"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="error" c:identifier="gsf_output_error">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the last error logged on the output, or %NULL.</doc>
          <type name="GLib.Error" c:type="GError*"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="get_modtime" c:identifier="gsf_output_get_modtime">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A #GDateTime representing when the output
was last modified, or %NULL if not known.</doc>
          <type name="GLib.DateTime" c:type="GDateTime*"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
            <doc xml:space="preserve">the output stream</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="is_closed" c:identifier="gsf_output_is_closed">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @output has already been closed.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="name" c:identifier="gsf_output_name">
        <doc xml:space="preserve">Give the name of @output.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">@output's name in utf8 form.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="printf"
              ...
              introspectable="0">
        <doc xml:space="preserve">Output @Varargs to @output using the format string @format, similar to
&lt;citerefentry&gt;&lt;refentrytitle&gt;printf&lt;/refentrytitle&gt;
&lt;manvolnum&gt;3&lt;/manvolnum&gt;&lt;/citerefentry&gt;.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if successful, %FALSE if not</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
            <doc xml:space="preserve">A #GsfOutput</doc>
            <type name="Output" c:type="GsfOutput*"/>
          </instance-parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">The printf-style format string</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">the arguments for @format</doc>
            <varargs/>
          </parameter>
        </parameters>
      </method>
      <method name="puts" c:identifier="gsf_output_puts">
        <doc xml:space="preserve">Like fputs, this assumes that the line already ends with a newline</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if successful, %FALSE if not</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          ...
          <parameter name="line" transfer-ownership="none">
            <doc xml:space="preserve">Nul terminated string to write</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="seek" c:identifier="gsf_output_seek">
        <doc xml:space="preserve">Reposition in output stream @output. @whence specifies what the offset is
...
&lt;manvolnum&gt;3&lt;/manvolnum&gt;&lt;/citerefentry&gt;.</doc>
        ...
        <parameters>
          ...
          <parameter name="offset" transfer-ownership="none">
            <doc xml:space="preserve">Relative amount to reposition</doc>
            <type name="gsf_off_t" c:type="gsf_off_t"/>
          </parameter>
          <parameter name="whence" transfer-ownership="none">
            <doc xml:space="preserve">What the offset is relative to.</doc>
            <type name="GLib.SeekType" c:type="GSeekType"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_container" c:identifier="gsf_output_set_container">
        <doc xml:space="preserve">&lt;note&gt;This is a utility routine that should only be used by derived
outputs.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the assignment was ok.</doc>
          <type name="gboolean" c:type="gboolean"/>
...
outputs.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Always returns %FALSE to facilitate its use.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
          ...
          <parameter name="code" transfer-ownership="none">
            <doc xml:space="preserve">The error id</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
...
outputs.&lt;/note&gt;</doc>
      ...
      <method name="size" c:identifier="gsf_output_size">
        <doc xml:space="preserve">Determine the size of the output stream @output.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the size of the output, or -1 if it does not have a size.</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="tell" c:identifier="gsf_output_tell">
        <doc xml:space="preserve">Tell the current position in @output, similar to
...
&lt;manvolnum&gt;3&lt;/manvolnum&gt;&lt;/citerefentry&gt;.</doc>
      ...
      <method name="vprintf"
              ...
              introspectable="0">
        <doc xml:space="preserve">Output @args to @output using the format string @format, similar to
&lt;citerefentry&gt;&lt;refentrytitle&gt;vprintf&lt;/refentrytitle&gt;
&lt;manvolnum&gt;3&lt;/manvolnum&gt;&lt;/citerefentry&gt;.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">number of bytes printed, a negative value if not successful</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="write" c:identifier="gsf_output_write">
        <doc xml:space="preserve">Write @num_bytes of @data to @output.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%FALSE on error.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <property name="container" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The container, optionally %NULL, in which this output lives.</doc>
        <type name="Outfile"/>
      </property>
      <property name="is-closed" transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the output has been closed.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="modtime"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The time the output was last updated.  This must be set on object
...
do anything with this property.</doc>
      ...
      <property name="position" transfer-ownership="none">
        <doc xml:space="preserve">The current position in the output.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <property name="size" transfer-ownership="none">
        <doc xml:space="preserve">The current file size.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <field name="g_object">
        <type name="GObject.Object" c:type="GObject"/>
    ...
    <class name="OutputBzip"
      ...
      <constructor name="new" c:identifier="gsf_output_bzip_new" throws="1">
        <doc xml:space="preserve">Adds a reference to @sink.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new file or %NULL.</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
    ...
    <enumeration name="OutputCsvQuotingMode"
      ...
      <doc xml:space="preserve">Controls when to add quotes around fields.</doc>
      <member name="never"
              value="0"
              c:identifier="GSF_OUTPUT_CSV_QUOTING_MODE_NEVER"
              glib:nick="never">
        <doc xml:space="preserve">never add quotes around fields</doc>
      </member>
      <member name="auto"
              value="1"
              c:identifier="GSF_OUTPUT_CSV_QUOTING_MODE_AUTO"
              glib:nick="auto">
        <doc xml:space="preserve">add quotes around fields when needed</doc>
      </member>
      <member name="always"
              value="2"
              c:identifier="GSF_OUTPUT_CSV_QUOTING_MODE_ALWAYS"
              glib:nick="always">
        <doc xml:space="preserve">always add quotes around fields</doc>
      </member>
    </enumeration>
    ...
    <class name="OutputGio"
      ...
      <constructor name="new" c:identifier="gsf_output_gio_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GsfOutputGio or %NULL</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
        <parameters>
          <parameter name="file" transfer-ownership="none">
            <doc xml:space="preserve">an existing GFile</doc>
            <type name="Gio.File" c:type="GFile*"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="OutputIconv"
      ...
      <constructor name="new" c:identifier="gsf_output_iconv_new">
        <doc xml:space="preserve">Adds a reference to @sink.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new GsfOutput object or %NULL.</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
        <parameters>
          <parameter name="sink" transfer-ownership="none">
          ...
          <parameter name="dst" transfer-ownership="none">
            <doc xml:space="preserve">The target character set.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="src" transfer-ownership="none">
            <doc xml:space="preserve">The source character set.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
      <property name="fallback" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Either NULL or a UTF-8 string (representable in the target encoding)
...
in the target encoding.  NULL means use \u1234 or \U12345678 format.</doc>
    ...
    <class name="OutputMemory"
      ...
      <method name="get_bytes" c:identifier="gsf_output_memory_get_bytes">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The data that has been written to @mem, or %NULL</doc>
          <type name="guint8" c:type="const guint8*"/>
        </return-value>
        <parameters>
          <instance-parameter name="mem" transfer-ownership="none">
            <doc xml:space="preserve">the output device.</doc>
    ...
    <class name="OutputStdio"
      ...
      <constructor name="new" c:identifier="gsf_output_stdio_new" throws="1">
        ...
        <parameters>
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">name of file to create or replace.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_FILE"
                   ...
                   introspectable="0">
        <doc xml:space="preserve">Assumes ownership of @file.  If @keep_open is true, ownership reverts
to caller when the GsfOutput is closed.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new GsfOutput wrapper for @file.  Warning: the result will be
...
current location at the time the GsfOutput object is created.</doc>
      ...
      <constructor name="new_full"
        ...
        <parameters>
          ...
          <parameter name="first_property_name" transfer-ownership="none">
            <doc xml:space="preserve">%NULL terminated list of properties</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="..." transfer-ownership="none">
            <varargs/>
    ...
    <class name="StructuredBlob"
      ...
      <function name="read" c:identifier="gsf_structured_blob_read">
        <doc xml:space="preserve">Create a tree of binary blobs with unknown content from a #GsfInput or
#GsfInfile and store it in a newly created #GsfStructuredBlob.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GsfStructuredBlob object which the caller is responsible for.</doc>
          <type name="StructuredBlob" c:type="GsfStructuredBlob*"/>
        </return-value>
        <parameters>
          <parameter name="input" transfer-ownership="none">
            <doc xml:space="preserve">An input (potentially a GsfInfile) holding the blob</doc>
            <type name="Input" c:type="GsfInput*"/>
          </parameter>
        </parameters>
      </function>
      <method name="write" c:identifier="gsf_structured_blob_write">
        <doc xml:space="preserve">Dumps structured blob @blob onto the @container.  Will fail if the output is
not an Outfile and blob has multiple streams.</doc>
        ...
        <parameters>
          <instance-parameter name="blob" transfer-ownership="none">
            <doc xml:space="preserve">#GsfStructuredBlob</doc>
            <type name="StructuredBlob" c:type="GsfStructuredBlob*"/>
          </instance-parameter>
          <parameter name="container" transfer-ownership="none">
            <doc xml:space="preserve">#GsfOutfile</doc>
    ...
    <record name="Timestamp"
      ...
      <doc xml:space="preserve">A point in time.</doc>
      <field name="date" writable="1">
        <doc xml:space="preserve">#GDate in local timezone</doc>
        <type name="GLib.Date" c:type="GDate"/>
      </field>
      <field name="seconds" writable="1">
        <doc xml:space="preserve">#glong number of seconds since @date.</doc>
        <type name="glong" c:type="glong"/>
      </field>
      <field name="time_zone" writable="1">
        <doc xml:space="preserve">possibly blank #GString of the timezone</doc>
        <type name="GLib.String" c:type="GString"/>
      </field>
      <field name="timet" writable="1">
        <doc xml:space="preserve">as from mktime.</doc>
      ...
      <method name="as_string" c:identifier="gsf_timestamp_as_string">
        <doc xml:space="preserve">Produce a string representation (ISO 8601 format) of @stamp.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a string representation of @stamp. When @stamp is %NULL, the
representation is "&amp;lt;invalid&amp;gt;".</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="stamp" transfer-ownership="none">
            <doc xml:space="preserve">timestamp to be converted.</doc>
            <type name="Timestamp" c:type="GsfTimestamp*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="copy" c:identifier="gsf_timestamp_copy">
        <doc xml:space="preserve">Copies a timestamp.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a separate copy of @stamp.</doc>
          <type name="Timestamp" c:type="GsfTimestamp*"/>
        </return-value>
        <parameters>
          <instance-parameter name="stamp" transfer-ownership="none">
            <doc xml:space="preserve">timestamp to be copied</doc>
            <type name="Timestamp" c:type="GsfTimestamp*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="equal" c:identifier="gsf_timestamp_equal">
        <doc xml:space="preserve">Compare timestamps @a and @b.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">true if @a and @b represent the same point in time; false otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="a" transfer-ownership="none">
          ...
          <parameter name="b" transfer-ownership="none">
            <doc xml:space="preserve">another timestamp</doc>
            <type name="Timestamp" c:type="GsfTimestamp*"/>
          </parameter>
        </parameters>
      </method>
      <method name="free" c:identifier="gsf_timestamp_free">
        <doc xml:space="preserve">Releases the memory in use for @stamp (if any).</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="stamp" transfer-ownership="none">
            <doc xml:space="preserve">timestamp to be freed</doc>
            <type name="Timestamp" c:type="GsfTimestamp*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="load_from_string"
              ...
              version="1.14.24">
        <doc xml:space="preserve">Very simple parser for time stamps.  Currently requires a format of
	'YYYY-MM-DDThh:mm:ss'
and does only rudimentary range checking</doc>
        ...
        <parameters>
          <instance-parameter name="stamp" transfer-ownership="none">
            <doc xml:space="preserve">#GsfTimestamp</doc>
            <type name="Timestamp" c:type="GsfTimestamp*"/>
          </instance-parameter>
      ...
      <method name="to_value"
              ...
              version="1.14.24">
        <doc xml:space="preserve">Calls g_value_set_box (value, stamp);</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <enumeration name="XMLContent" c:type="GsfXMLContent">
      <doc xml:space="preserve">Controls the handling of character data within a parser node.</doc>
      <member name="no_content" value="0" c:identifier="GSF_XML_NO_CONTENT">
        <doc xml:space="preserve">node has no cstr contents</doc>
      </member>
      <member name="content" value="1" c:identifier="GSF_XML_CONTENT">
        <doc xml:space="preserve">node has cstr contents</doc>
      </member>
      <member name="shared_content"
              value="2"
              c:identifier="GSF_XML_SHARED_CONTENT">
        <doc xml:space="preserve">node has contents that is shared with children</doc>
      </member>
      <member name="2nd" value="3" c:identifier="GSF_XML_2ND">
        <doc xml:space="preserve">node is second or later occurrence</doc>
      </member>
    </enumeration>
    <record name="XMLIn" c:type="GsfXMLIn">
      ...
      <field name="content" writable="1">
        <doc xml:space="preserve">the current node content</doc>
        <type name="GLib.String" c:type="GString*"/>
      </field>
      ...
      <field name="node" writable="1">
        <doc xml:space="preserve">current node (not on the stack)</doc>
      ...
      <method name="check_ns" c:identifier="gsf_xml_in_check_ns">
        <doc xml:space="preserve">According to @state is @str in the namespace @ns_id ?</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a pointer to @str after the namespace if
successful, otherwise %NULL.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          ...
          <parameter name="str" transfer-ownership="none">
            <doc xml:space="preserve">string to check</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="ns_id" transfer-ownership="none">
            <doc xml:space="preserve">the namespace id</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_input" c:identifier="gsf_xml_in_get_input">
        <doc xml:space="preserve">(New in 1.14.2)</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">(but does not reference) the stream being parsed.</doc>
          <type name="Input" c:type="GsfInput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="xin" transfer-ownership="none">
      ...
      <method name="namecmp" c:identifier="gsf_xml_in_namecmp">
        <doc xml:space="preserve">Checks to see if @str is the same as @ns_id::@name with either an explicit
namespace or the current default namespace.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @str == @ns_id:@name according to @state.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="xin" transfer-ownership="none">
            <doc xml:space="preserve">The #GsfXMLIn we are reading from.</doc>
            <type name="XMLIn" c:type="GsfXMLIn*"/>
          </instance-parameter>
          <parameter name="str" transfer-ownership="none">
            <doc xml:space="preserve">The potentially namespace qualified node name.</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="ns_id" transfer-ownership="none">
            <doc xml:space="preserve">The name space id to check</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">The target node name</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="push_state" c:identifier="gsf_xml_in_push_state">
        <doc xml:space="preserve">Take the first node from @doc as the current node and call its start handler.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="new_state" transfer-ownership="none">
            <doc xml:space="preserve">arbitrary content for the parser</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
          <parameter name="dtor" transfer-ownership="none" scope="call">
            <doc xml:space="preserve">#GsfXMLInExtDtor</doc>
            <type name="XMLInExtDtor" c:type="GsfXMLInExtDtor"/>
          </parameter>
          <parameter name="attrs" transfer-ownership="none">
            <doc xml:space="preserve">array of xmlChar const *</doc>
      ...
      <method name="set_silent_unknowns"
        ...
        <doc xml:space="preserve">(New in 1.14.33)
...
they are expected.</doc>
        ...
        <parameters>
          ...
          <parameter name="silent" transfer-ownership="none">
            <doc xml:space="preserve">whether to be silent about unknown tags</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
    ...
    <record name="XMLInDoc"
      ...
      <constructor name="new" c:identifier="gsf_xml_in_doc_new">
        <doc xml:space="preserve">Combine the nodes in the %NULL terminated array starting at @nodes with the
...
data structures necessary to validate a doument based on that description.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">%NULL on error</doc>
          <type name="XMLInDoc" c:type="GsfXMLInDoc*"/>
        </return-value>
        <parameters>
          <parameter name="nodes" transfer-ownership="none">
            <doc xml:space="preserve">an array of node descriptors</doc>
            <type name="XMLInNode" c:type="GsfXMLInNode*"/>
          </parameter>
          <parameter name="ns" transfer-ownership="none">
            <doc xml:space="preserve">an array of namespace identifiers</doc>
            <type name="XMLInNS" c:type="GsfXMLInNS*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="add_nodes" c:identifier="gsf_xml_in_doc_add_nodes">
        <doc xml:space="preserve">Adds additional nodes to the structure of @doc</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="nodes" transfer-ownership="none">
            <doc xml:space="preserve">%NULL terminated array of #GsfXMLInNode</doc>
            <type name="XMLInNode" c:type="GsfXMLInNode*"/>
          </parameter>
        </parameters>
      </method>
      <method name="free" c:identifier="gsf_xml_in_doc_free">
        <doc xml:space="preserve">Free up resources</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="parse" c:identifier="gsf_xml_in_doc_parse">
        <doc xml:space="preserve">Read an xml document from @input and parse based on the the descriptor in
@doc</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%FALSE on error</doc>
          <type name="gboolean" c:type="gboolean"/>
        ...
        <parameters>
          ...
          <parameter name="user_state" transfer-ownership="none">
            <doc xml:space="preserve">arbitrary content stored in the parser</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_unknown_handler"
        ...
        <doc xml:space="preserve">Call the function @handler when an unexpected child node is found</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <record name="XMLInNode" c:type="GsfXMLInNode">
      <field name="id" writable="1">
        <doc xml:space="preserve">identifier unique in the entire tree</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="ns_id" writable="1">
        <doc xml:space="preserve">namespace identifier</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="name" writable="1">
        <doc xml:space="preserve">node name</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="parent_id" writable="1">
        <doc xml:space="preserve">parent node identifier</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="start">
        <callback name="start">
      ...
      <field name="has_content" writable="1">
        <doc xml:space="preserve">whether the node has content</doc>
        <type name="XMLContent" c:type="GsfXMLContent"/>
      </field>
      <field name="check_children_for_ns" writable="1" bits="1">
        <doc xml:space="preserve">whether to check namespace for children</doc>
        <type name="guint" c:type="unsigned"/>
      </field>
      <field name="share_children_with_parent" writable="1" bits="1">
        <doc xml:space="preserve">whether to share children with parent.</doc>
        <type name="guint" c:type="unsigned"/>
      </field>
    </record>
    ...
    <class name="XMLOut"
      ...
      <constructor name="new" c:identifier="gsf_xml_out_new">
        <doc xml:space="preserve">Create an XML output stream.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">#GsfXMLOut</doc>
          <type name="XMLOut" c:type="GsfXMLOut*"/>
        </return-value>
        <parameters>
          <parameter name="output" transfer-ownership="none">
      ...
      <method name="add_base64" c:identifier="gsf_xml_out_add_base64">
        <doc xml:space="preserve">Dump @len bytes in @data into the content of node @id using base64</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="id"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">tag id or %NULL for content</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">Data to be written</doc>
            <type name="guint8" c:type="guint8*"/>
          </parameter>
          <parameter name="len" transfer-ownership="none">
      ...
      <method name="add_bool" c:identifier="gsf_xml_out_add_bool">
        <doc xml:space="preserve">dump boolean value @val to an attribute named @id or as the nodes content
Use '1' or '0' to simplify import</doc>
      ...
      <method name="add_color" c:identifier="gsf_xml_out_add_color">
        <doc xml:space="preserve">dump Color @r.@g.@b to an attribute named @id or as the nodes content</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="add_cstr" c:identifier="gsf_xml_out_add_cstr">
        <doc xml:space="preserve">dump @val_utf8 to an attribute named @id or as the nodes content escaping
...
output)</doc>
        ...
        <parameters>
          ...
          <parameter name="val_utf8"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">a utf8 encoded string</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="add_cstr_unchecked"
        ...
        <doc xml:space="preserve">dump @val_utf8 to an attribute named @id without checking to see if
...
@val_utf8 is %NULL do nothing (no warning, no output)</doc>
        ...
        <parameters>
          ...
          <parameter name="val_utf8"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">a utf8 encoded string to export</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="add_enum" c:identifier="gsf_xml_out_add_enum">
        <doc xml:space="preserve">Output the name of value @val of enumeration type @etype.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="etype" transfer-ownership="none">
            <doc xml:space="preserve">#GType</doc>
            <type name="GType" c:type="GType"/>
          </parameter>
          <parameter name="val" transfer-ownership="none">
            <doc xml:space="preserve">enum element number</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
        </parameters>
      </method>
      <method name="add_float" c:identifier="gsf_xml_out_add_float">
        <doc xml:space="preserve">dump float value @val to an attribute named @id or as the nodes
...
according to the "C" locale.</doc>
        ...
        <parameters>
          ...
          <parameter name="precision" transfer-ownership="none">
            <doc xml:space="preserve">the number of significant digits to use, -1 meaning "enough".</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="add_gvalue" c:identifier="gsf_xml_out_add_gvalue">
        <doc xml:space="preserve">Output the value of @val as a string.  Does NOT store any type information
with the string, just thevalue.</doc>
      ...
      <method name="add_int" c:identifier="gsf_xml_out_add_int">
        <doc xml:space="preserve">dump integer value @val to an attribute named @id or as the nodes content</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="add_uint" c:identifier="gsf_xml_out_add_uint">
        <doc xml:space="preserve">dump unsigned integer value @val to an attribute named @id or as the nodes
content</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="end_element" c:identifier="gsf_xml_out_end_element">
        <doc xml:space="preserve">Closes/ends an XML element.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the element that has been closed.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="xout" transfer-ownership="none">
      ...
      <method name="get_output" c:identifier="gsf_xml_out_get_output">
        <doc xml:space="preserve">Get the #GsfOutput we are writing to..</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#GsfInput or %NULL.</doc>
          <type name="Output" c:type="GsfOutput*"/>
        </return-value>
        <parameters>
          <instance-parameter name="xout" transfer-ownership="none">
      ...
      <method name="get_pretty_print"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the current state of the pretty-print flag.  Note, that
gsf_xml_out_set_pretty_print will return the same value.</doc>
      ...
      <method name="set_doc_type" c:identifier="gsf_xml_out_set_doc_type">
        <doc xml:space="preserve">Store some optional &amp;lt;!DOCTYPE .. &amp;gt; content</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="type" transfer-ownership="none">
            <doc xml:space="preserve">the document type declaration</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_pretty_print"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the previous state of the pretty-print flag.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="xout" transfer-ownership="none">
          ...
          <parameter name="pp" transfer-ownership="none">
            <doc xml:space="preserve">new state of pretty-print flag.</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="simple_element" c:identifier="gsf_xml_out_simple_element">
        <doc xml:space="preserve">Convenience routine to output a simple @id element with content @content.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="content" transfer-ownership="none">
            <doc xml:space="preserve">Content of the element</doc>
            <type name="utf8" c:type="char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="simple_float_element"
        ...
        <doc xml:space="preserve">Convenience routine to output an element @id with float value @val using
@precision significant digits.</doc>
        ...
        <parameters>
          ...
          <parameter name="val" transfer-ownership="none">
            <doc xml:space="preserve">Element value</doc>
            <type name="gdouble" c:type="double"/>
          </parameter>
          <parameter name="precision" transfer-ownership="none">
            <doc xml:space="preserve">the number of significant digits to use, -1 meaning "enough".</doc>
      ...
      <method name="simple_int_element"
        ...
        <doc xml:space="preserve">Convenience routine to output an element @id with integer value @val.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="start_element" c:identifier="gsf_xml_out_start_element">
        <doc xml:space="preserve">Output a start element @id, if necessary preceeded by an XML declaration.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <function name="base64_decode_simple"
      ...
      <doc xml:space="preserve">Decodes a chunk of base64 encoded data from @data back into @data.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the number of bytes converted</doc>
        <type name="gulong" c:type="size_t"/>
      </return-value>
      <parameters>
        <parameter name="data" transfer-ownership="none">
          <doc xml:space="preserve">data stream</doc>
          <type name="guint8" c:type="guint8*"/>
        </parameter>
        <parameter name="len" transfer-ownership="none">
    ...
    <function name="base64_encode_close"
      ...
      <doc xml:space="preserve">This funcion should be called to when finished encoding everything, to
flush off the last little bit.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">a count of the number of bytes in the final block.</doc>
        <type name="gulong" c:type="size_t"/>
      </return-value>
      <parameters>
        <parameter name="in" transfer-ownership="none">
          <doc xml:space="preserve">Data to be encoded</doc>
          <type name="guint8" c:type="guint8*"/>
        </parameter>
        <parameter name="inlen" transfer-ownership="none">
          <doc xml:space="preserve">Length of data to be encoded</doc>
          <type name="gulong" c:type="size_t"/>
        </parameter>
        <parameter name="break_lines" transfer-ownership="none">
          <doc xml:space="preserve">Whether to use line breaks</doc>
          <type name="gboolean" c:type="gboolean"/>
        </parameter>
        <parameter name="out" transfer-ownership="none">
    ...
    <function name="base64_encode_simple"
      ...
      <doc xml:space="preserve">Encodes data from @data back into @data using base64 encoding.</doc>
      <return-value transfer-ownership="none">
      ...
      <parameters>
        ...
        <parameter name="len" transfer-ownership="none">
          <doc xml:space="preserve">max length of data to encode</doc>
          <type name="gulong" c:type="size_t"/>
        </parameter>
      </parameters>
    </function>
    <function name="base64_encode_step" c:identifier="gsf_base64_encode_step">
      <doc xml:space="preserve">Performs an 'encode step', only encodes blocks of 3 characters from @in into
...
(initialise to 0 on first invocation).</doc>
    ...
    <function name="doc_meta_dump" c:identifier="gsf_doc_meta_dump">
      <doc xml:space="preserve">A debugging utility to dump the content of @meta via g_print</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
    ...
    <function name="error_quark" c:identifier="gsf_error_quark">
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the #GQuark used to identify libgsf errors in #GError structures.
    ...
    <function name="extension_pointer" c:identifier="gsf_extension_pointer">
      <doc xml:space="preserve">Extracts the extension from the end of a filename (the part after the final
'.' in the filename).</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A pointer to the extension part of the
...
does not have an extension.</doc>
      ...
      <parameters>
        <parameter name="path" transfer-ownership="none">
          <doc xml:space="preserve">A filename or file path.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
    <function name="filename_to_utf8" c:identifier="gsf_filename_to_utf8">
      <doc xml:space="preserve">A utility wrapper to make sure filenames are valid utf8.
Caller must g_free the result.</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">@filename using utf-8 encoding for display</doc>
        <type name="utf8" c:type="char*"/>
      </return-value>
      <parameters>
        <parameter name="filename" transfer-ownership="none">
          <doc xml:space="preserve">file name suitable for open(2).</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
        <parameter name="quoted" transfer-ownership="none">
          <doc xml:space="preserve">if %TRUE, the resulting utf8 file name will be quoted
   (unless it is invalid).</doc>
    ...
    <function name="iconv_close" c:identifier="gsf_iconv_close">
      <doc xml:space="preserve">A utility wrapper to safely close an iconv handle.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="handle" transfer-ownership="none">
          <doc xml:space="preserve">handle to be closed.</doc>
          <type name="GLib.IConv" c:type="GIConv"/>
        </parameter>
      </parameters>
    </function>
    <function name="init" c:identifier="gsf_init">
      <doc xml:space="preserve">Initializes the GSF library</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
    </function>
    <function name="init_dynamic" c:identifier="gsf_init_dynamic">
      <doc xml:space="preserve">Initializes the GSF library and associates it with a type module @mod.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="module" transfer-ownership="none">
          <doc xml:space="preserve">#GTypeModule.</doc>
          <type name="GObject.TypeModule" c:type="GTypeModule*"/>
        </parameter>
      </parameters>
    </function>
    <function name="le_get_double" c:identifier="gsf_le_get_double">
      <doc xml:space="preserve">Interpret binary data as a double in little endian order.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">interpreted data</doc>
        <type name="gdouble" c:type="double"/>
      </return-value>
      <parameters>
        <parameter name="p" transfer-ownership="none">
          <doc xml:space="preserve">pointer to storage</doc>
          <type name="gpointer" c:type="void*"/>
        </parameter>
      </parameters>
    </function>
    <function name="le_get_float" c:identifier="gsf_le_get_float">
      <doc xml:space="preserve">Interpret binary data as a float in little endian order.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">interpreted data</doc>
    ...
    <function name="le_get_guint64" c:identifier="gsf_le_get_guint64">
      <doc xml:space="preserve">Interpret binary data as a guint64 (8 byte unsigned integer type) in little
endian order.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">interpreted data</doc>
        <type name="guint64" c:type="guint64"/>
    ...
    <function name="le_set_double" c:identifier="gsf_le_set_double">
      <doc xml:space="preserve">Store a value of type double in memory in little endian order</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="d" transfer-ownership="none">
          <doc xml:space="preserve">double to be stored</doc>
          <type name="gdouble" c:type="double"/>
        </parameter>
      </parameters>
    </function>
    <function name="le_set_float" c:identifier="gsf_le_set_float">
      <doc xml:space="preserve">Store a value of type float in memory in little endian order.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="f" transfer-ownership="none">
          <doc xml:space="preserve">float to be stored</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
      </parameters>
    </function>
    <function name="mem_dump" c:identifier="gsf_mem_dump">
      <doc xml:space="preserve">Dump @len bytes from the memory location given by @ptr.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="ptr" transfer-ownership="none">
          <doc xml:space="preserve">memory area to be dumped.</doc>
          <type name="guint8" c:type="guint8*"/>
        </parameter>
        <parameter name="len" transfer-ownership="none">
          <doc xml:space="preserve">how many bytes will be dumped.</doc>
          <type name="gulong" c:type="size_t"/>
        </parameter>
      </parameters>
    </function>
    ...
    <function name="msole_iconv_open_codepage_for_export"
              ...
              introspectable="0">
      <doc xml:space="preserve">NOTE: skipped since GIConv is not exported to introspection.</doc>
      <return-value>
        <doc xml:space="preserve">an iconv converter to go from utf8 -&gt; to our best guess at a useful
	windows codepage.</doc>
        <type name="GLib.IConv" c:type="GIConv"/>
      </return-value>
      <parameters>
        <parameter name="codepage_to" transfer-ownership="none">
          <doc xml:space="preserve">the target code page.</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
    <function name="msole_iconv_open_codepage_for_import"
      ...
      <doc xml:space="preserve">NOTE: skipped since GIConv is not exported to introspection.</doc>
      <return-value>
        <doc xml:space="preserve">an iconv converter for @codepage -&gt; utf8.</doc>
        <type name="GLib.IConv" c:type="GIConv"/>
      </return-value>
      <parameters>
        <parameter name="to" transfer-ownership="none">
          <doc xml:space="preserve">the target encoding.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
        <parameter name="codepage" transfer-ownership="none">
          <doc xml:space="preserve">the source code page.</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
	...
	windows codepage.</doc>
      ...
      <parameters>
        ...
        <parameter name="from" transfer-ownership="none">
          <doc xml:space="preserve">the source encoding.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
    <function name="msole_iconv_open_for_export"
      ...
      <doc xml:space="preserve">NOTE: skipped since GIConv is not exported to introspection.</doc>
      <return-value>
        <doc xml:space="preserve">an iconv convert to go from utf8 -&gt; to our best guess at a useful
	windows codepage.</doc>
        <type name="GLib.IConv" c:type="GIConv"/>
      </return-value>
    </function>
    <function name="msole_iconv_open_for_import"
      ...
      <doc xml:space="preserve">NOTE: skipped since GIConv is not exported to introspection.</doc>
      <return-value>
        <doc xml:space="preserve">an iconv converter for single byte encodings @codepage -&gt; utf8.
    ...
    <function name="msole_iconv_win_codepage"
      ...
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">our best guess at the applicable windows code page based on an
	environment variable or the current locale.</doc>
        <type name="gint" c:type="int"/>
      </return-value>
    </function>
    <function name="msole_inflate" c:identifier="gsf_msole_inflate">
      <doc xml:space="preserve">Decompresses an LZ compressed stream.</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">A GByteArray that the caller is responsible for freeing</doc>
      ...
      <parameters>
        <parameter name="input" transfer-ownership="none">
          <doc xml:space="preserve">stream to read from</doc>
          <type name="Input" c:type="GsfInput*"/>
        </parameter>
        <parameter name="offset" transfer-ownership="none">
          <doc xml:space="preserve">offset into it for start byte of compresse stream</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </parameter>
      </parameters>
    </function>
    <function name="msole_language_for_lid"
      ...
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the xx_YY style string (can be just xx or
...
or is set to 0x0000, will return "-none-"</doc>
      ...
      <parameters>
        <parameter name="lid" transfer-ownership="none">
          <doc xml:space="preserve">numerical language id</doc>
          <type name="guint" c:type="guint"/>
        </parameter>
      </parameters>
    </function>
    <function name="msole_lid_for_language"
      ...
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the LID (Language Identifier) for the input language.
	If lang is %NULL, return 0x0400 ("-none-"), and not 0x0000 ("no proofing")</doc>
      ...
      <parameters>
        <parameter name="lang"
                   ...
                   nullable="1"
                   allow-none="1">
          <doc xml:space="preserve">Language id, i.e., locale name.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
    <function name="msole_lid_to_codepage"
      ...
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">our best guess at the codepage for the given language id</doc>
        <type name="gint" c:type="int"/>
      </return-value>
      <parameters>
        <parameter name="lid" transfer-ownership="none">
    ...
    <function name="msole_lid_to_codepage_str"
      ...
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">the Iconv codepage string for the given
LID.</doc>
        <type name="utf8" c:type="gchar*"/>
      </return-value>
      <parameters>
    ...
    <function name="odf_get_ns"
              ...
              version="1.14.24">
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">the used ODF namespace</doc>
        <type name="XMLInNS" c:type="GsfXMLInNS*"/>
      </return-value>
    </function>
    <function name="odf_get_version"
              ...
              version="1.14.24">
      <doc xml:space="preserve">Gives the ODF version used by libgsf when writing Open Document files.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the ODF version: 102.</doc>
    ...
    <function name="odf_get_version_string"
      ...
      <doc xml:space="preserve">Gives the ODF version used by libgsf when writing Open Document files.</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">the ODF version as a string: "1.2".</doc>
        <type name="utf8" c:type="char*"/>
      </return-value>
    </function>
    ...
    <function name="open_pkg_foreach_rel"
      ...
      <doc xml:space="preserve">New in 1.14.9
...
Walks each relationship associated with @opkg and calls @func with @user_data.</doc>
      ...
      <parameters>
        ...
        <parameter name="func"
                   ...
                   scope="call"
                   closure="2">
          <doc xml:space="preserve">#GsfOpenPkgIter</doc>
...
NOTE: skipping because gsf_open_pkg_rel_get_type() does not return a GType.</doc>
      ...
      <parameters>
        ...
        <parameter name="id" transfer-ownership="none">
          <doc xml:space="preserve">identifier.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
...
NOTE: skipping because gsf_open_pkg_rel_get_type() does not return a GType.</doc>
    ...
    <function name="open_pkg_open_rel"
              ...
              throws="1">
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">a new #GsfInput which the called needs to unref, or %NULL and sets @err</doc>
        <type name="Input" c:type="GsfInput*"/>
      </return-value>
      <parameters>
        <parameter name="opkg" transfer-ownership="none">
    ...
    <function name="open_pkg_open_rel_by_id"
              ...
              throws="1">
      <doc xml:space="preserve">New in 1.14.7

Open @opkg's relation @id</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">A new GsfInput or %NULL, and sets @err if possible.</doc>
        <type name="Input" c:type="GsfInput*"/>
      </return-value>
      <parameters>
        <parameter name="opkg" transfer-ownership="none">
        ...
        <parameter name="id" transfer-ownership="none">
          <doc xml:space="preserve">target id</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
...
Open one of @opkg's relationships with type=@type.</doc>
    ...
    <function name="open_pkg_parse_rel_by_id"
      ...
      <doc xml:space="preserve">Convenience function to parse a related part.</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">%NULL on success or a #GError on failure.</doc>
        <type name="GLib.Error" c:type="GError*"/>
      </return-value>
      <parameters>
        <parameter name="xin" transfer-ownership="none">
        ...
        <parameter name="dtd" transfer-ownership="none">
          <doc xml:space="preserve">#GsfXMLInNode</doc>
          <type name="XMLInNode" c:type="GsfXMLInNode*"/>
        </parameter>
        <parameter name="ns" transfer-ownership="none">
          <doc xml:space="preserve">#GsfXMLInNS</doc>
          <type name="XMLInNS" c:type="GsfXMLInNS*"/>
        </parameter>
      </parameters>
    </function>
    ...
    <function name="property_settings_collect_valist"
              ...
              introspectable="0">
      <doc xml:space="preserve">This function builds a GParameter array suitable for g_object_newv.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="object_type" transfer-ownership="none">
          <doc xml:space="preserve">the GType for which the properties are being set.</doc>
          <type name="GType" c:type="GType"/>
        </parameter>
        <parameter name="p_params" transfer-ownership="none">
          <doc xml:space="preserve">a pointer to the GParameter array that holds the properties.
  (Used for both input and output.  This may point to a %NULL pointer if
  there are no properties collected yet.)</doc>
          <type name="GObject.Parameter" c:type="GParameter**"/>
        </parameter>
        <parameter name="p_n_params" transfer-ownership="none">
          <doc xml:space="preserve">a pointer to the number of properties collected.  (Used for
  both input and output.)</doc>
          <type name="gulong" c:type="size_t*"/>
        </parameter>
        <parameter name="first_property_name" transfer-ownership="none">
          <doc xml:space="preserve">the name of the first property being set, or %NULL.</doc>
          <type name="utf8" c:type="const gchar*"/>
        </parameter>
        <parameter name="var_args" transfer-ownership="none">
          <doc xml:space="preserve">a va_list holding the remainder of the property names and
  values, terminated by a %NULL.</doc>
    ...
    <function name="shutdown" c:identifier="gsf_shutdown">
      <doc xml:space="preserve">De-intializes the GSF library
Currently does nothing.</doc>
    ...
    <function name="shutdown_dynamic" c:identifier="gsf_shutdown_dynamic">
      <doc xml:space="preserve">De-intializes the GSF library from a type module.
Currently does nothing.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
    ...
    <function name="value_get_docprop_vector"
      ...
      <doc xml:space="preserve">This function returns a pointer to the GsfDocPropVector structure in @value.
No additional references are created.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A pointer to the #GsfDocPropVector structure in @value</doc>
        <type name="DocPropVector" c:type="GsfDocPropVector*"/>
      </return-value>
      <parameters>
        <parameter name="value" transfer-ownership="none">
          <doc xml:space="preserve">A GValue of type #GsfDocPropVector.</doc>
          <type name="GObject.Value" c:type="GValue*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vba_inflate" c:identifier="gsf_vba_inflate">
      <doc xml:space="preserve">Decompresses VBA stream.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A pointer to guint8 array</doc>
        <type name="guint8" c:type="guint8*"/>
      </return-value>
      <parameters>
        <parameter name="input" transfer-ownership="none">
        ...
        <parameter name="offset" transfer-ownership="none">
          <doc xml:space="preserve">offset into it for start byte of compressed stream</doc>
          <type name="gsf_off_t" c:type="gsf_off_t"/>
        </parameter>
        <parameter name="size" transfer-ownership="none">
        ...
        <parameter name="add_null_terminator" transfer-ownership="none">
          <doc xml:space="preserve">whenever add or not null at the end of array</doc>
          <type name="gboolean" c:type="gboolean"/>
        </parameter>
      </parameters>
    </function>
    <function name="xmlDocFormatDump" c:identifier="gsf_xmlDocFormatDump">
      <doc xml:space="preserve">Dumps the document @cur into @output.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">status from xmlSaveFormatFileTo.</doc>
        <type name="gint" c:type="int"/>
      </return-value>
      <parameters>
        <parameter name="output" transfer-ownership="none">
        ...
        <parameter name="cur" transfer-ownership="none">
          <doc xml:space="preserve">#xmlDocPtr</doc>
        ...
        <parameter name="encoding"
                   ...
                   nullable="1"
                   allow-none="1">
          <doc xml:space="preserve">The encoding to use.</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
        <parameter name="format" transfer-ownership="none">
          <doc xml:space="preserve">%TRUE to reformat the output.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </parameter>
      </parameters>
    </function>
    <function name="xml_gvalue_from_str"
      ...
      <doc xml:space="preserve">Try to parse @str as a value of type @t into @res.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">True when parsing of @str as a value of type @t was succesfull;
false otherwise.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </return-value>
      <parameters>
        <parameter name="res" transfer-ownership="none">
          <doc xml:space="preserve">Result value</doc>
          <type name="GObject.Value" c:type="GValue*"/>
        </parameter>
        <parameter name="t" transfer-ownership="none">
          <doc xml:space="preserve">Type of data</doc>
          <type name="GType" c:type="GType"/>
        </parameter>
        <parameter name="str" transfer-ownership="none">
          <doc xml:space="preserve">Value string</doc>
          <type name="utf8" c:type="char*"/>
        </parameter>
      </parameters>
    </function>
    <function name="xml_parser_context"
              ...
              introspectable="0">
      <doc xml:space="preserve">Create a libxml2 pull style parser context wrapper around gsf input @input.
...
NOTE: skipped since xmlParserCtxt is not exported to introspection.</doc>
      <return-value>
        <doc xml:space="preserve">A parser context or %NULL</doc>
    ...
    <function name="xml_probe" c:identifier="gsf_xml_probe">
      ...
      <parameters>
        ...
        <parameter name="func" transfer-ownership="none" scope="call">
          <doc xml:space="preserve">#GsfXMLProbeFunc</doc>
