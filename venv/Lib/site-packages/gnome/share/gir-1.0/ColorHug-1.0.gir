...
<repository version="1.2"
  ...
  <namespace name="ColorHug"
             version="1.0"
             shared-library="libcolorhug-2.dll"
...
NOTE: This command is available on hardware version: 2</doc>
      ...
      <field name="priv">
        <type name="DeviceQueuePrivate" c:type="ChDeviceQueuePrivate*"/>
      </field>
    ...
    <record name="DeviceQueuePrivate"
            c:type="ChDeviceQueuePrivate"
            disguised="1">
      <doc xml:space="preserve">Private #ChDeviceQueue data</doc>
    </record>
