...
<repository version="1.2"
  ...
  <namespace name="GtkSource"
             version="3.0"
             shared-library="libgtksourceview-3.0-1.dll"
...
If @max_undo_levels is -1, no limit is set.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
brackets style.</doc>
      ...
      <glib:signal name="bracket-matched" when="last" version="2.12">
        <doc xml:space="preserve">Sets @iter to a valid iterator pointing to the matching bracket
...
updated (e.g. the no-spell-check context class).</doc>
      ...
      <glib:signal name="source-mark-updated" when="last">
        <doc xml:space="preserve">The ::source_mark_updated signal is emitted each time
...
#GtkSourceGutterRendererText.</doc>
        ...
        <parameters>
          ...
          <parameter name="width"
                     ...
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">The width of the text in pixels</doc>
            <type name="gint" c:type="gint*"/>
          </parameter>
          <parameter name="height"
                     ...
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">The height of the text in pixels</doc>
            <type name="gint" c:type="gint*"/>
          </parameter>
        </parameters>
      </method>
...
specified lines.</doc>
      ...
      <property name="draw-spaces"
                ...
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Set if and how the spaces should be visualized.</doc>
