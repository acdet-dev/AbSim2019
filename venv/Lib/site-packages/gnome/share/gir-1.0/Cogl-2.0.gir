...
same key.</doc>
    ...
    <class name="AtlasTexture"
      ...
      <constructor name="new_from_bitmap"
                   ...
                   version="1.16"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a new #CoglAtlasTexture texture based on data residing in a
...
for more details.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglAtlasTexture object.</doc>
      ...
      <constructor name="new_from_data"
                   ...
                   stability="Unstable"
                   throws="1">
        <doc xml:space="preserve">Creates a new #CoglAtlasTexture texture based on data residing in
...
#CoglMetaTexture for more details.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglAtlasTexture object or
         %NULL on failure and @error will be updated.</doc>
          <type name="AtlasTexture" c:type="CoglAtlasTexture*"/>
        </return-value>
        <parameters>
          <parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglContext</doc>
            <type name="Context" c:type="CoglContext*"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">width of texture in pixels</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">height of texture in pixels</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">the #CoglPixelFormat the buffer is stored in in RAM</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
          <parameter name="rowstride" transfer-ownership="none">
            <doc xml:space="preserve">the memory offset in bytes between the start of each
   row in @data. A value of 0 will make Cogl automatically
   calculate @rowstride from @width and @format.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">pointer to the memory region where the source buffer resides</doc>
      ...
      <constructor name="new_from_file"
                   ...
                   stability="Unstable"
                   throws="1">
        <doc xml:space="preserve">Creates a #CoglAtlasTexture from an image file. A #CoglAtlasTexture
...
for more details.&lt;/note&gt;</doc>
      ...
      <constructor name="new_with_size"
                   ...
                   version="1.16"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a #CoglAtlasTexture with a given @width and @height. A
...
for more details.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The width of your atlased texture.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The height of your atlased texture.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="Attribute"
      ...
      <constructor name="new"
                   ...
                   version="1.4"
                   stability="Unstable">
        <doc xml:space="preserve">Describes the layout for a list of vertex attribute values (For
...
a large number of vertices.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglAttribute
        ...
        <parameters>
          <parameter name="attribute_buffer" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglAttributeBuffer containing the actual
                   attribute data</doc>
            <type name="AttributeBuffer" c:type="CoglAttributeBuffer*"/>
          </parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">The name of the attribute (used to reference it from GLSL)</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
      ...
      <constructor name="new_const_1f"
        ...
        <doc xml:space="preserve">Creates a new, single component, attribute whose value remains
...
|]</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">The constant value for the attribute</doc>
      ...
      <constructor name="new_const_2f"
        ...
        <doc xml:space="preserve">Creates a new, 2 component, attribute whose value remains
constant across all the vertices of a primitive without needing to
duplicate the value for each vertex.
...
|]</doc>
        ...
        <parameters>
          ...
          <parameter name="component0" transfer-ownership="none">
            <doc xml:space="preserve">The first component of a 2 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component1" transfer-ownership="none">
            <doc xml:space="preserve">The second component of a 2 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </constructor>
...
|]</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 2 component float vector</doc>
      ...
      <constructor name="new_const_2x2fv"
        ...
        <doc xml:space="preserve">Creates a new matrix attribute whose value remains constant
...
becomes the first row and the second column becomes the second row.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix2x2" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 2 by 2 matrix</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
          <parameter name="transpose" transfer-ownership="none">
            <doc xml:space="preserve">Whether the matrix should be transposed on upload or
            not</doc>
      ...
      <constructor name="new_const_3f"
        ...
        <doc xml:space="preserve">Creates a new, 3 component, attribute whose value remains
constant across all the vertices of a primitive without needing to
duplicate the value for each vertex.
...
explicit GLSL declaration need be made.</doc>
        ...
        <parameters>
          ...
          <parameter name="component0" transfer-ownership="none">
            <doc xml:space="preserve">The first component of a 3 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component1" transfer-ownership="none">
            <doc xml:space="preserve">The second component of a 3 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component2" transfer-ownership="none">
            <doc xml:space="preserve">The third component of a 3 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </constructor>
...
explicit GLSL declaration need be made.</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 3 component float vector</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </constructor>
...
etc.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix3x3" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 3 by 3 matrix</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
          <parameter name="transpose" transfer-ownership="none">
            <doc xml:space="preserve">Whether the matrix should be transposed on upload or
      ...
      <constructor name="new_const_4f"
        ...
        <doc xml:space="preserve">Creates a new, 4 component, attribute whose value remains
constant across all the vertices of a primitive without needing to
duplicate the value for each vertex.
...
no explicit GLSL declaration need be made.</doc>
        ...
        <parameters>
          ...
          <parameter name="component0" transfer-ownership="none">
            <doc xml:space="preserve">The first component of a 4 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component1" transfer-ownership="none">
            <doc xml:space="preserve">The second component of a 4 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component2" transfer-ownership="none">
            <doc xml:space="preserve">The third component of a 4 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="component3" transfer-ownership="none">
            <doc xml:space="preserve">The fourth component of a 4 component vector</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </constructor>
...
no explicit GLSL declaration need be made.</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 4 component float vector</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </constructor>
...
etc.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix4x4" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a 4 by 4 matrix</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
          <parameter name="transpose" transfer-ownership="none">
            <doc xml:space="preserve">Whether the matrix should be transposed on upload or
      ...
      <method name="get_normalized"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the value of the normalized property set with
cogl_attribute_set_normalized().</doc>
      ...
      <method name="set_buffer"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets a new #CoglAttributeBuffer for the attribute.</doc>
        <return-value transfer-ownership="none">
        ...
        <parameters>
          ...
          <parameter name="attribute_buffer" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglAttributeBuffer</doc>
            <type name="AttributeBuffer" c:type="CoglAttributeBuffer*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_normalized"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets whether fixed point attribute types are mapped to the range
...
will default to FALSE.</doc>
        ...
        <parameters>
          ...
          <parameter name="normalized" transfer-ownership="none">
            <doc xml:space="preserve">The new value for the normalized property.</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
    ...
    <class name="AttributeBuffer"
      ...
      <constructor name="new"
                   ...
                   introspectable="0"
                   stability="Unstable">
        <doc xml:space="preserve">Describes a new #CoglAttributeBuffer of @size bytes to contain
...
cogl_buffer_map().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglAttributeBuffer (never %NULL)</doc>
          <type name="AttributeBuffer" c:type="CoglAttributeBuffer*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
  ...
  an unsigned short integer</doc>
    ...
    <class name="Bitmap"
      ...
      <constructor name="new_for_data"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a bitmap using some existing data. The data is not copied
...
into an application buffer with the specified rowstride.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglBitmap.</doc>
          <type name="Bitmap" c:type="CoglBitmap*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The width of the bitmap.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The height of the bitmap.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">The format of the pixel data.</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
          <parameter name="rowstride" transfer-ownership="none">
            <doc xml:space="preserve">The rowstride of the bitmap (the number of bytes from
  the start of one row of the bitmap to the next).</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to the data. The bitmap will take ownership of this data.</doc>
      ...
      <constructor name="new_from_buffer"
                   ...
                   version="1.8"
                   stability="Unstable">
        <doc xml:space="preserve">Wraps some image data that has been uploaded into a #CoglBuffer as
a #CoglBitmap. The data is not copied in this process.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #CoglBitmap encapsulating the given @buffer.</doc>
          <type name="Bitmap" c:type="CoglBitmap*"/>
        </return-value>
        <parameters>
          <parameter name="buffer" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglBuffer containing image data</doc>
            <type name="Buffer" c:type="CoglBuffer*"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglPixelFormat defining the format of the image data
         in the given @buffer.</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The width of the image data in the given @buffer.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The height of the image data in the given @buffer.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="rowstride" transfer-ownership="none">
            <doc xml:space="preserve">The rowstride in bytes of the image data in the given @buffer.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="offset" transfer-ownership="none">
            <doc xml:space="preserve">The offset into the given @buffer to the first pixel that
...
within a thread.</doc>
      ...
      <constructor name="new_with_size"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a new #CoglBitmap with the given width, height and format.
...
cogl_bitmap_get_rowstride().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #CoglPixelBuffer representing the
        ...
        <parameters>
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">width of the bitmap in pixels</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">height of the bitmap in pixels</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">the format of the pixels the array will store</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
        </parameters>
      </constructor>
...
of the bitmap.</doc>
      ...
      <method name="get_buffer"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the #CoglPixelBuffer that this
  ...
  pixel buffer and this function will return %NULL.</doc>
        ...
        <parameters>
          <instance-parameter name="bitmap" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglBitmap</doc>
            <type name="Bitmap" c:type="CoglBitmap*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_format"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the #CoglPixelFormat that the data for the bitmap is in.</doc>
          <type name="PixelFormat" c:type="CoglPixelFormat"/>
        </return-value>
        <parameters>
          <instance-parameter name="bitmap" transfer-ownership="none">
      ...
      <method name="get_rowstride"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the rowstride of the bitmap. This is the number of
...
will be used directly.</doc>
  ...
  supported by the GPU</doc>
    ...
    <bitfield name="BufferAccess"
      ...
      <doc xml:space="preserve">The access hints for cogl_buffer_set_update_hint()</doc>
      <member name="read" value="1" c:identifier="COGL_BUFFER_ACCESS_READ">
        <doc xml:space="preserve">the buffer will be read</doc>
      </member>
      <member name="write" value="2" c:identifier="COGL_BUFFER_ACCESS_WRITE">
        <doc xml:space="preserve">the buffer will written to</doc>
      </member>
      <member name="read_write"
              value="3"
              c:identifier="COGL_BUFFER_ACCESS_READ_WRITE">
        <doc xml:space="preserve">the buffer will be used for both reading and
  writing</doc>
      </member>
    </bitfield>
    ...
    <enumeration name="BufferError"
      ...
      <doc xml:space="preserve">Error enumeration for #CoglBuffer</doc>
      <member name="buffer_error_map"
              value="0"
              c:identifier="COGL_BUFFER_ERROR_MAP">
        <doc xml:space="preserve">A buffer could not be mapped either
   ...
   limitation was hit.</doc>
    ...
    <bitfield name="BufferMapHint"
      ...
      <doc xml:space="preserve">Hints to Cogl about how you are planning to modify the data once it
is mapped.</doc>
      <member name="" value="1" c:identifier="COGL_BUFFER_MAP_HINT_DISCARD">
        <doc xml:space="preserve">Tells Cogl that you plan to replace
   ...
   if only a subregion of the buffer is mapped.</doc>
      ...
      <member name="_range"
        ...
        <doc xml:space="preserve">Tells Cogl that you plan to
   ...
   map a buffer.</doc>
    ...
    <enumeration name="BufferUpdateHint"
      ...
      <doc xml:space="preserve">The update hint on a buffer allows the user to give some detail on how often
the buffer data is going to be updated.</doc>
      <member name="static"
              value="0"
              c:identifier="COGL_BUFFER_UPDATE_HINT_STATIC">
        <doc xml:space="preserve">the buffer will not change over time</doc>
      </member>
      <member name="dynamic"
              value="1"
              c:identifier="COGL_BUFFER_UPDATE_HINT_DYNAMIC">
        <doc xml:space="preserve">the buffer will change from time to time</doc>
      </member>
      <member name="stream"
              value="2"
              c:identifier="COGL_BUFFER_UPDATE_HINT_STREAM">
        <doc xml:space="preserve">the buffer will be used once or a couple of
  times</doc>
      </member>
    </enumeration>
    <record name="Color"
...
drawing something.</doc>
    ...
    <class name="Context"
      ...
      <constructor name="new"
                   ...
                   stability="Unstable"
                   throws="1">
        <doc xml:space="preserve">Creates a new #CoglContext which acts as an application sandbox
for any state objects that are allocated.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglContext</doc>
          <type name="Context" c:type="CoglContext*"/>
        </return-value>
        <parameters>
          <parameter name="display"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">A #CoglDisplay pointer</doc>
      ...
      <method name="get_display"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the #CoglDisplay that is internally associated with the
...
display that was automatically setup internally.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The #CoglDisplay associated with the
              given @context.</doc>
          <type name="Display" c:type="CoglDisplay*"/>
        </return-value>
        <parameters>
          <instance-parameter name="context" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglContext pointer</doc>
            <type name="Context" c:type="CoglContext*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_renderer"
              ...
              version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the #CoglRenderer that is internally associated with the
...
internally.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The #CoglRenderer associated with the
              given @context.</doc>
    ...
    <callback name="DebugObjectForeachTypeCallback"
              ...
              version="1.8"
              stability="Unstable">
      <doc xml:space="preserve">A callback function to use for cogl_debug_object_foreach_type().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="info" transfer-ownership="none">
          <doc xml:space="preserve">A pointer to a struct containing information about the type.</doc>
    ...
    <record name="DebugObjectTypeInfo"
            ...
            version="1.8"
            stability="Unstable">
      <doc xml:space="preserve">This struct is used to pass information to the callback when
cogl_debug_object_foreach_type() is called.</doc>
      <field name="name" writable="1">
        <doc xml:space="preserve">A human readable name for the type.</doc>
        <type name="utf8" c:type="const char*"/>
      </field>
      <field name="instance_count" writable="1">
        <doc xml:space="preserve">The number of objects of this type that are
  currently in use</doc>
    ...
    <record name="DepthState" c:type="CoglDepthState" version="2.0">
      ...
      <method name="get_range"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Gets the current range to which normalized depth values are mapped
...
set with cogl_depth_state_set_range().</doc>
        ...
        <parameters>
          <instance-parameter name="state" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglDepthState object</doc>
            <type name="DepthState" c:type="CoglDepthState*"/>
          </instance-parameter>
          <parameter name="near_val" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to store the near component of the depth range</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
          <parameter name="far_val" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to store the far component of the depth range</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_test_enabled"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Gets the current depth test enabled state as previously set by
cogl_depth_state_set_test_enabled().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pipeline's current depth test enabled state.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="state" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglDepthState struct</doc>
            <type name="DepthState" c:type="CoglDepthState*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_test_function"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Gets the current depth test enable state as previously set via
cogl_depth_state_set_test_enabled().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The current depth test enable state.</doc>
          <type name="DepthTestFunction" c:type="CoglDepthTestFunction"/>
        </return-value>
        <parameters>
          <instance-parameter name="state" transfer-ownership="none">
      ...
      <method name="get_write_enabled"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Gets the depth writing enable state as set by the corresponding
cogl_depth_state_set_write_enabled().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The current depth writing enable state</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="state" transfer-ownership="none">
      ...
      <method name="init"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Initializes the members of @state to their default values.
...
to cogl_pipeline_set_depth_state().</doc>
      ...
      <method name="set_range"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the range to map depth values in normalized device coordinates
...
cogl_pipeline_set_depth_state().</doc>
        ...
        <parameters>
          ...
          <parameter name="near_val" transfer-ownership="none">
            <doc xml:space="preserve">The near component of the desired depth range which will be
clamped to the range [0, 1]</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="far_val" transfer-ownership="none">
            <doc xml:space="preserve">The far component of the desired depth range which will be
clamped to the range [0, 1]</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      ...
      <method name="set_test_enabled"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Enables or disables depth testing according to the value of
@enable.
...
cogl_pipeline_set_depth_state()</doc>
        ...
        <parameters>
          ...
          <parameter name="enable" transfer-ownership="none">
            <doc xml:space="preserve">The enable state you want</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_test_function"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the #CoglDepthTestFunction used to compare the depth value of
...
cogl_pipeline_set_depth_state()</doc>
        ...
        <parameters>
          ...
          <parameter name="function" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglDepthTestFunction to set</doc>
            <type name="DepthTestFunction" c:type="CoglDepthTestFunction"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_write_enabled"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Enables or disables depth buffer writing according to the value of
...
value greater than or equal to the value currently in the depth buffer.</doc>
    ...
    <class name="Display"
      ...
      <constructor name="new"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Explicitly allocates a new #CoglDisplay object to encapsulate the
...
options then relying on the implicit setup can be fine.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglDisplay
        ...
        <parameters>
          ...
          <parameter name="onscreen_template" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglOnscreenTemplate</doc>
      ...
      <method name="get_renderer"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Queries the #CoglRenderer associated with the given @display.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The associated #CoglRenderer</doc>
          <type name="Renderer" c:type="CoglRenderer*"/>
        </return-value>
        <parameters>
          <instance-parameter name="display" transfer-ownership="none">
            <doc xml:space="preserve">a #CoglDisplay</doc>
            <type name="Display" c:type="CoglDisplay*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="set_onscreen_template"
              ...
              version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Specifies a template for creating #CoglOnscreen framebuffers.
...
framebuffers then it can try to make sure to setup the display accordingly.</doc>
        ...
        <parameters>
          ...
          <parameter name="onscreen_template" transfer-ownership="none">
            <doc xml:space="preserve">A template for creating #CoglOnscreen framebuffers</doc>
            <type name="OnscreenTemplate" c:type="CoglOnscreenTemplate*"/>
          </parameter>
        </parameters>
      </method>
      <method name="setup"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">Explicitly sets up the given @display object. Use of this api is
...
fallback options this behaviour may be fine.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Returns %TRUE if there was no error, else it returns
    ...
    <enumeration name="Driver"
                 ...
                 stability="Unstable"
                 c:type="CoglDriver">
      <doc xml:space="preserve">Identifiers for underlying hardware drivers that may be used by
Cogl for rendering.</doc>
      <member name="any" value="0" c:identifier="COGL_DRIVER_ANY">
        <doc xml:space="preserve">Implies no preference for which driver is used</doc>
      </member>
      <member name="nop" value="1" c:identifier="COGL_DRIVER_NOP">
        <doc xml:space="preserve">A No-Op driver.</doc>
      </member>
      <member name="gl" value="2" c:identifier="COGL_DRIVER_GL">
        <doc xml:space="preserve">An OpenGL driver.</doc>
      </member>
      <member name="gl3" value="3" c:identifier="COGL_DRIVER_GL3">
        <doc xml:space="preserve">An OpenGL driver using the core GL 3.1 profile</doc>
      </member>
      <member name="gles1" value="4" c:identifier="COGL_DRIVER_GLES1">
        <doc xml:space="preserve">An OpenGL ES 1.1 driver.</doc>
      </member>
      <member name="gles2" value="5" c:identifier="COGL_DRIVER_GLES2">
        <doc xml:space="preserve">An OpenGL ES 2.0 driver.</doc>
      </member>
      <member name="webgl" value="6" c:identifier="COGL_DRIVER_WEBGL">
        <doc xml:space="preserve">A WebGL driver.</doc>
      </member>
    </enumeration>
    <record name="Euler"
            c:type="CoglEuler"
      ...
      <doc xml:space="preserve">Represents an ordered rotation first of @heading degrees around an
...
you want to do interpolation between 3d rotations.</doc>
      <field name="heading" writable="1">
        <doc xml:space="preserve">Angle to rotate around an object's y axis</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="pitch" writable="1">
        <doc xml:space="preserve">Angle to rotate around an object's x axis</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="roll" writable="1">
        <doc xml:space="preserve">Angle to rotate around an object's z axis</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      ...
      <method name="copy" c:identifier="cogl_euler_copy" version="2.0">
        <doc xml:space="preserve">Allocates a new #CoglEuler and initilizes it with the component
angles of @src. The newly allocated euler should be freed using
cogl_euler_free().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglEuler</doc>
          <type name="Euler" c:type="CoglEuler*"/>
        </return-value>
        <parameters>
          <instance-parameter name="src" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglEuler to copy</doc>
            <type name="Euler" c:type="const CoglEuler*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="free" c:identifier="cogl_euler_free" version="2.0">
        <doc xml:space="preserve">Frees a #CoglEuler that was previously allocated using
cogl_euler_copy().</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="euler" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglEuler allocated via cogl_euler_copy()</doc>
            <type name="Euler" c:type="CoglEuler*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="init" c:identifier="cogl_euler_init" version="2.0">
        <doc xml:space="preserve">Initializes @euler to represent a rotation of @x_angle degrees
...
@z_angle degrees around the z axis.</doc>
        ...
        <parameters>
          <instance-parameter name="euler" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglEuler angle to initialize</doc>
            <type name="Euler" c:type="CoglEuler*"/>
          </instance-parameter>
      ...
      <method name="init_from_matrix"
        ...
        <doc xml:space="preserve">Extracts a euler rotation from the given @matrix and
initializses @euler with the component x, y and z rotation angles.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglMatrix containing a rotation, but no scaling,
      ...
      <method name="init_from_quaternion"
        ...
        <doc xml:space="preserve">Initializes a @euler rotation with the equivalent rotation
represented by the given @quaternion.</doc>
        ...
        <parameters>
          ...
          <parameter name="quaternion" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglEuler with the rotation to initialize with</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
        </parameters>
      </method>
      <function name="equal" c:identifier="cogl_euler_equal" version="2.0">
        <doc xml:space="preserve">Compares the two given euler angles @v1 and @v1 and it they are
...
can be represented with different component rotations&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @v1 and @v2 are equal else %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <parameter name="v1" transfer-ownership="none">
    ...
    <callback name="FeatureCallback"
              ...
              version="0.10"
              stability="Unstable">
      <doc xml:space="preserve">A callback used with cogl_foreach_feature() for enumerating all
context level features supported by Cogl.</doc>
   ...
   and %COGL_FEATURE_TEXTURE_NPOT_REPEAT features combined.</doc>
    ...
    <enumeration name="FeatureID" version="1.10" c:type="CoglFeatureID">
      <doc xml:space="preserve">All the capabilities that can vary between different GPUs supported
...
check for them using cogl_has_feature() or cogl_has_features().</doc>
   ...
   and %COGL_FEATURE_ID_TEXTURE_NPOT_REPEAT features combined.</doc>
      ...
      <member name="ogl_feature_id_texture_rectangle"
        ...
        <doc xml:space="preserve">Support for rectangular
   ...
   supported.</doc>
    ...
    cogl_indices_new().</doc>
      ...
      <member name="ogl_feature_id_depth_range"
        ...
        <doc xml:space="preserve">cogl_pipeline_set_depth_range() support</doc>
      </member>
   ...
   %COGL_PIPELINE_WRAP_MODE_MIRRORED_REPEAT is supported.</doc>
      ...
      <member name="ogl_feature_id_swap_buffers_event"
        ...
        <doc xml:space="preserve">Available if the window system supports reporting an event
    for swap buffer completions.</doc>
      </member>
      <member name="ogl_feature_id_gles2_context"
              value="19"
              c:identifier="COGL_FEATURE_ID_GLES2_CONTEXT">
        <doc xml:space="preserve">Whether creating new GLES2 contexts is
   suported.</doc>
      </member>
      <member name="ogl_feature_id_depth_texture"
              value="20"
              c:identifier="COGL_FEATURE_ID_DEPTH_TEXTURE">
        <doc xml:space="preserve">Whether #CoglFramebuffer support rendering
    the depth buffer to a texture.</doc>
      ...
      <member name="ogl_feature_id_presentation_time"
        ...
        <doc xml:space="preserve">Whether frame presentation
   time stamps will be recorded in #CoglFrameInfo objects.</doc>
      ...
      <member name="ogl_feature_id_per_vertex_point_size"
        ...
        <doc xml:space="preserve">Whether cogl_point_size_in
    can be used as an attribute to set a per-vertex point size.</doc>
      ...
      <member name="ogl_feature_id_texture_rg"
        ...
        <doc xml:space="preserve">Support for
   ...
   texture.</doc>
      ...
      <member name="ogl_feature_id_buffer_age"
        ...
        <doc xml:space="preserve">Available if the age of #CoglOnscreen back
   ...
   expected to return age values other than 0.</doc>
    ...
    <record name="Fence"
            ...
            version="2.0"
            stability="Unstable">
      <doc xml:space="preserve">An opaque object representing a fence. This type is currently
...
about the fence completion.</doc>
    ...
    <callback name="FenceCallback"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">The callback prototype used with
...
command completion.</doc>
      ...
      <parameters>
        <parameter name="fence" transfer-ownership="none">
          <doc xml:space="preserve">Unused. In the future this parameter may be used to pass
...
|[
  f = e ^ -(density * eye_distance)^2
    ...
    <callback name="FrameCallback"
              ...
              version="1.14"
              stability="Unstable">
      <doc xml:space="preserve">Is a callback that can be registered via
...
events can be notified.</doc>
      ...
      <parameters>
        <parameter name="onscreen" transfer-ownership="none">
          <doc xml:space="preserve">The onscreen that the frame is associated with</doc>
          <type name="Onscreen" c:type="CoglOnscreen*"/>
        </parameter>
        <parameter name="event" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglFrameEvent notifying how the frame has progressed</doc>
          <type name="FrameEvent" c:type="CoglFrameEvent"/>
        </parameter>
        <parameter name="info" transfer-ownership="none">
          <doc xml:space="preserve">The meta information, such as timing information, about
    ...
    <record name="FrameClosure"
      ...
      <doc xml:space="preserve">An opaque type that tracks a #CoglFrameCallback and associated user
...
callback later using cogl_onscreen_remove_frame_callback().</doc>
    ...
    <enumeration name="FrameEvent"
      ...
      <doc xml:space="preserve">Identifiers that are passed to #CoglFrameCallback functions
...
a particular frame before they can start a new frame.&lt;/note&gt;</doc>
      <member name="sync" value="1" c:identifier="COGL_FRAME_EVENT_SYNC">
        <doc xml:space="preserve">Notifies that the system compositor has
      ...
      <member name="complete"
        ...
        <doc xml:space="preserve">Notifies that a frame has ended. This
    ...
    <class name="FrameInfo"
      ...
      <method name="get_frame_counter"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the frame counter for the #CoglOnscreen that corresponds
to this frame.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The frame counter value</doc>
          <type name="gint64" c:type="int64_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
            <doc xml:space="preserve">a #CoglFrameInfo object</doc>
            <type name="FrameInfo" c:type="CoglFrameInfo*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_output"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the #CoglOutput that the swapped frame was presented to.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The #CoglOutput that the frame was
      ...
      <method name="get_presentation_time"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the presentation time for the frame. This is the time at which
...
incorrectly report non-monotonic timestamps.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the presentation time for the frame</doc>
          <type name="gint64" c:type="int64_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
      ...
      <method name="get_refresh_rate"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the refresh rate in Hertz for the output that the frame was on
...
cogl_output_get_refresh_rate().&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the refresh rate in Hertz</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
    ...
    <interface name="Framebuffer"
      ...
      <method name="add_fence_callback"
              ...
              introspectable="0"
              stability="Unstable">
        <doc xml:space="preserve">Calls the provided callback when all previously-submitted commands have
...
callback is called, or cancelled.</doc>
        ...
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglFramebuffer the commands have been submitted to</doc>
          ...
          <parameter name="callback"
                     ...
                     scope="notified"
                     closure="1">
            <doc xml:space="preserve">A #CoglFenceCallback to be called when
      ...
      <method name="allocate"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">Explicitly allocates a configured #CoglFramebuffer allowing developers to
...
automatic allocation.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if there were no error allocating the framebuffer, else %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglFramebuffer</doc>
            <type name="Framebuffer" c:type="CoglFramebuffer*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="cancel_fence_callback"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Removes a fence previously submitted with
...
called.</doc>
        ...
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglFramebuffer the commands were submitted to</doc>
            <type name="Framebuffer" c:type="CoglFramebuffer*"/>
          </instance-parameter>
          <parameter name="closure" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglFenceClosure returned from
...
that includes the color buffer then the specified @color is used.</doc>
  ...
  buffers to clear</doc>
          ...
          <parameter name="color" transfer-ownership="none">
            <doc xml:space="preserve">The color to clear the color buffer too if specified in
        @buffers.</doc>
            <type name="Color" c:type="const CoglColor*"/>
          </parameter>
        </parameters>
...
that includes the color buffer then the specified @color is used.</doc>
  ...
  buffers to clear</doc>
          ...
          <parameter name="red" transfer-ownership="none">
            <doc xml:space="preserve">The red component of color to clear the color buffer too if
      specified in @buffers.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="green" transfer-ownership="none">
            <doc xml:space="preserve">The green component of color to clear the color buffer too if
        specified in @buffers.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="blue" transfer-ownership="none">
            <doc xml:space="preserve">The blue component of color to clear the color buffer too if
       specified in @buffers.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="alpha" transfer-ownership="none">
            <doc xml:space="preserve">The alpha component of color to clear the color buffer too if
        specified in @buffers.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      ...
      <method name="discard_buffers"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Declares that the specified @buffers no longer need to be referenced
...
a #CoglOffscreen framebuffer since they are single-buffered.</doc>
        ...
        <parameters>
          ...
          <parameter name="buffers" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglBufferBit mask of which ancillary buffers you want
          to discard.</doc>
            <type name="gulong" c:type="unsigned long"/>
          </parameter>
        </parameters>
      ...
      <method name="draw_attributes"
              ...
              stability="Unstable">
        <doc xml:space="preserve">First defines a geometry primitive by grouping a set of vertex @attributes;
...
cogl_program_use()&lt;/note&gt;</doc>
        ...
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">A destination #CoglFramebuffer</doc>
            <type name="Framebuffer" c:type="CoglFramebuffer*"/>
          </instance-parameter>
          <parameter name="pipeline" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPipeline state object</doc>
            <type name="Pipeline" c:type="CoglPipeline*"/>
          </parameter>
          <parameter name="mode" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglVerticesMode defining the topology of vertices</doc>
            <type name="VerticesMode" c:type="CoglVerticesMode"/>
          </parameter>
          <parameter name="first_vertex" transfer-ownership="none">
            <doc xml:space="preserve">The vertex offset within the given attributes to draw from</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="n_vertices" transfer-ownership="none">
            <doc xml:space="preserve">The number of vertices to draw from the given attributes</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="attributes" transfer-ownership="none">
            <doc xml:space="preserve">An array of pointers to #CoglAttribute&lt;-- --&gt;s defining vertex
             geometry</doc>
            <type name="Attribute" c:type="CoglAttribute**"/>
          </parameter>
          <parameter name="n_attributes" transfer-ownership="none">
            <doc xml:space="preserve">The number of attributes in the @attributes array.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="draw_indexed_attributes"
              ...
              deprecated-version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Behaves the same as cogl_framebuffer_draw_attributes() except that
...
cogl_set_backface_culling_enabled() or cogl_program_use()&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="indices" transfer-ownership="none">
            <doc xml:space="preserve">The array of indices used by the GPU to lookup attribute
      ...
      <method name="draw_multitextured_rectangle"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Draws a textured rectangle to @framebuffer with the given @pipeline
...
texture coordinates (0.0, 0.0, 1.0, 1.0) are generated.</doc>
  ...
  bottom right.</doc>
          ...
          <parameter name="tex_coords_len" transfer-ownership="none">
            <doc xml:space="preserve">The length of the @tex_coords array. (For one layer
  and one group of texture coordinates, this would be 4)</doc>
      ...
      <method name="draw_primitive"
              ...
              deprecated-version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Draws the given @primitive geometry to the specified destination
...
cogl_program_use()&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="primitive" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPrimitive geometry object</doc>
      ...
      <method name="draw_rectangle"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Draws a rectangle to @framebuffer with the given @pipeline state
...
cogl_framebuffer_draw_textured_rectangle().&lt;/note&gt;</doc>
      ...
      <method name="draw_rectangles"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Draws a series of rectangles to @framebuffer with the given
...
same @pipeline state.</doc>
        ...
        <parameters>
          ...
          <parameter name="coordinates" transfer-ownership="none">
            <doc xml:space="preserve">an array of coordinates
  ...
  rectangle (x2, y2).</doc>
          ...
          <parameter name="n_rectangles" transfer-ownership="none">
            <doc xml:space="preserve">number of rectangles defined in @coordinates.</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
        </parameters>
      </method>
      <method name="draw_textured_rectangle"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Draws a textured rectangle to @framebuffer using the given
...
passed normalized texture coordinates.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="s_1" transfer-ownership="none">
            <doc xml:space="preserve">S texture coordinate of the top-left coorner</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="t_1" transfer-ownership="none">
            <doc xml:space="preserve">T texture coordinate of the top-left coorner</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="s_2" transfer-ownership="none">
            <doc xml:space="preserve">S texture coordinate of the bottom-right coorner</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="t_2" transfer-ownership="none">
            <doc xml:space="preserve">T texture coordinate of the bottom-right coorner</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
...
coordinates.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="coordinates" transfer-ownership="none">
            <doc xml:space="preserve">an array containing
  ...
  cogl_framebuffer_draw_textured_rectangle().</doc>
          ...
          <parameter name="n_rectangles" transfer-ownership="none">
            <doc xml:space="preserve">number of rectangles to @coordinates to draw</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
        </parameters>
      </method>
      <method name="finish"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This blocks the CPU until all pending rendering associated with the
...
takes to queue rendering commands.</doc>
        ...
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglFramebuffer pointer</doc>
            <type name="Framebuffer" c:type="CoglFramebuffer*"/>
          </instance-parameter>
        </parameters>
      </method>
...
all cross through the origin and 2 near and far clip planes.</doc>
  ...
  the near clipping plane</doc>
      ...
      <method name="get_alpha_bits"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of alpha bits of @framebuffer</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bits</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
            <doc xml:space="preserve">a pointer to a #CoglFramebuffer</doc>
            <type name="Framebuffer" c:type="CoglFramebuffer*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_blue_bits"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of blue bits of @framebuffer</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bits</doc>
          <type name="gint" c:type="int"/>
        </return-value>
      ...
      <method name="get_color_mask"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Gets the current #CoglColorMask of which channels would be written to the
current framebuffer. Each bit set in the mask means that the
corresponding color would be written.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A #CoglColorMask</doc>
      ...
      <method name="get_context"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Can be used to query the #CoglContext a given @framebuffer was
instantiated within. This is the #CoglContext that was passed to
cogl_onscreen_new() for example.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The #CoglContext that the given
      ...
      <method name="get_depth_bits"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of depth bits of @framebuffer</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bits</doc>
          <type name="gint" c:type="int"/>
        </return-value>
      ...
      <method name="get_depth_texture"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the depth buffer of @framebuffer as a #CoglTexture. You need to
...
valid.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the depth texture</doc>
      ...
      <method name="get_depth_texture_enabled"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Queries whether texture based depth buffer has been enabled via
cogl_framebuffer_set_depth_texture_enabled().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if a depth texture has been enabled, else
              %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
      ...
      <method name="get_depth_write_enabled"
              ...
              version="1.18"
              stability="Unstable">
        <doc xml:space="preserve">Queries whether depth buffer writing is enabled for @framebuffer. This
can be controlled via cogl_framebuffer_set_depth_write_enabled().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if depth writing is enabled or %FALSE if not.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="get_dither_enabled"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Returns whether dithering has been requested for the given @framebuffer.
...
the user's request for dithering.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if dithering has been requested or %FALSE if not.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="get_green_bits"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of green bits of @framebuffer</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bits</doc>
          <type name="gint" c:type="int"/>
        </return-value>
      ...
      <method name="get_height"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the current height of the given @framebuffer.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The height of @framebuffer.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="get_red_bits"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of red bits of @framebuffer</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of bits</doc>
          <type name="gint" c:type="int"/>
        </return-value>
      ...
      <method name="get_samples_per_pixel"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Gets the number of points that are sampled per-pixel when
...
number of samples that will be made by the GPU.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of point samples made per pixel when
      ...
      <method name="get_stereo_mode"
              ...
              version="1.20"
              stability="Unstable">
        <doc xml:space="preserve">Gets the current #CoglStereoMode, which defines which stereo buffers
should be drawn to. See cogl_framebuffer_set_stereo_mode().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A #CoglStereoMode</doc>
      ...
      <method name="get_viewport4fv"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the x, y, width and height components of the current viewport as set
...
given @viewport array.</doc>
      ...
      <method name="get_viewport_height"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the height of the viewport as set using cogl_framebuffer_set_viewport()
or the default value which is the height of the framebuffer.</doc>
      ...
      <method name="get_viewport_width"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the width of the viewport as set using cogl_framebuffer_set_viewport()
or the default value which is the width of the framebuffer.</doc>
      ...
      <method name="get_viewport_x"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the x coordinate of the viewport origin as set using cogl_framebuffer_set_viewport()
or the default value which is 0.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The x coordinate of the viewport origin.</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="get_viewport_y"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the y coordinate of the viewport origin as set using cogl_framebuffer_set_viewport()
or the default value which is 0.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The y coordinate of the viewport origin.</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="get_width"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the current width of the given @framebuffer.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The width of @framebuffer.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
      ...
      <method name="identity_matrix"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Resets the current model-view matrix to the identity matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
matrix.</doc>
        ...
        <parameters>
          ...
          <parameter name="x_1" transfer-ownership="none">
            <doc xml:space="preserve">The x coordinate for the first vertical clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="y_1" transfer-ownership="none">
            <doc xml:space="preserve">The y coordinate for the first horizontal clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="x_2" transfer-ownership="none">
            <doc xml:space="preserve">The x coordinate for the second vertical clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="y_2" transfer-ownership="none">
            <doc xml:space="preserve">The y coordinate for the second horizontal clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
...
cogl_framebuffer_push_path_clip(), or cogl_framebuffer_push_primitive_clip().</doc>
      ...
      <method name="pop_matrix"
              ...
              version="1.10">
        <doc xml:space="preserve">Restores the model-view matrix on the top of the matrix stack.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="push_matrix"
              ...
              version="1.10">
        <doc xml:space="preserve">Copies the current model-view matrix onto the matrix stack. The matrix
...
cogl_framebuffer_pop_clip().</doc>
        ...
        <parameters>
          ...
          <parameter name="bounds_x2" transfer-ownership="none">
            <doc xml:space="preserve">x coordinate for the bottom-right corner of the
      ...
      <method name="push_rectangle_clip"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Specifies a modelview transformed rectangular clipping area for all
...
the effect of this function, call cogl_framebuffer_pop_clip().</doc>
      ...
      <method name="read_pixels"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This is a convenience wrapper around
...
cogl_object_unref (bitmap);
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the read succeeded or %FALSE otherwise.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="framebuffer" transfer-ownership="none">
          ...
          <parameter name="x" transfer-ownership="none">
            <doc xml:space="preserve">The x position to read from</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="y" transfer-ownership="none">
            <doc xml:space="preserve">The y position to read from</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The width of the region of rectangles to read</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The height of the region of rectangles to read</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">The pixel format to store the data in</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
          <parameter name="pixels" transfer-ownership="none">
            <doc xml:space="preserve">The address of the buffer to store the data in</doc>
            <type name="guint8" c:type="uint8_t*"/>
          </parameter>
        </parameters>
      </method>
      <method name="read_pixels_into_bitmap"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This reads a rectangle of pixels from the given framebuffer where
...
use one of the formats ending in PRE.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the read succeeded or %FALSE otherwise. The
 ...
 buffer and it could not be mapped.</doc>
        ...
        <parameters>
         ...
         (only COGL_READ_PIXELS_COLOR_BUFFER supported currently)</doc>
          ...
          <parameter name="bitmap" transfer-ownership="none">
            <doc xml:space="preserve">The bitmap to store the results in.</doc>
            <type name="Bitmap" c:type="CoglBitmap*"/>
          </parameter>
        </parameters>
      </method>
      <method name="resolve_samples"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">When point sample rendering (also known as multisample rendering)
...
other samples may be implicitly resolved.</doc>
        ...
        <parameters>
          ...
          <parameter name="x" transfer-ownership="none">
            <doc xml:space="preserve">top-left x coordinate of region to resolve</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="y" transfer-ownership="none">
            <doc xml:space="preserve">top-left y coordinate of region to resolve</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">width of region to resolve</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">height of region to resolve</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
...
counter-clockwise rotation.</doc>
      ...
      <method name="rotate_euler"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Multiplies the current model-view matrix by one that rotates
according to the rotation described by @euler.</doc>
        ...
        <parameters>
          ...
          <parameter name="euler" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglEuler</doc>
            <type name="Euler" c:type="const CoglEuler*"/>
          </parameter>
        </parameters>
      </method>
...
y and z axes by the given values.</doc>
      ...
      <method name="set_color_mask"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Defines a bit mask of which color channels should be written to the
...
color will be written.</doc>
        ...
        <parameters>
          ...
          <parameter name="color_mask" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglColorMask of which color channels to write to
      ...
      <method name="set_depth_texture_enabled"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">If @enabled is #TRUE, the depth buffer used when rendering to @framebuffer
...
&lt;/note&gt;</doc>
      ...
      <method name="set_depth_write_enabled"
              ...
              version="1.18"
              stability="Unstable">
        <doc xml:space="preserve">Enables or disables depth buffer writing when rendering to @framebuffer.
...
Depth buffer writing is enabled by default.</doc>
        ...
        <parameters>
          ...
          <parameter name="depth_write_enabled" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE to enable depth writing or %FALSE to disable</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dither_enabled"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Enables or disabled dithering if supported by the hardware.
...
Dithering is enabled by default.</doc>
        ...
        <parameters>
          ...
          <parameter name="dither_enabled" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE to enable dithering or %FALSE to disable</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_modelview_matrix"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets @matrix as the new model-view matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_projection_matrix"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets @matrix as the new projection matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_samples_per_pixel"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Requires that when rendering to @framebuffer then @n point samples
...
framebuffer has changed this can lead to redundant work being
        ...
        <parameters>
          ...
          <parameter name="samples_per_pixel" transfer-ownership="none">
            <doc xml:space="preserve">The minimum number of samples per pixel</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_stereo_mode"
              ...
              version="1.20"
              stability="Unstable">
        <doc xml:space="preserve">Sets which stereo buffers should be drawn to. The default
...
cogl_framebuffer_get_is_stereo().)</doc>
        ...
        <parameters>
          ...
          <parameter name="stereo_mode" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglStereoMode specifying which stereo buffers
      ...
      <method name="set_viewport"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Defines a scale and offset for everything rendered relative to the
...
point values will be exposed via a checkable feature.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="x" transfer-ownership="none">
            <doc xml:space="preserve">The top-left x coordinate of the viewport origin (only integers
    supported currently)</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="y" transfer-ownership="none">
            <doc xml:space="preserve">The top-left y coordinate of the viewport origin (only integers
    supported currently)</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The width of the viewport (only integers supported currently)</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The height of the viewport (only integers supported currently)</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
...
are associated with layers of the given @pipeline.</doc>
        ...
        <parameters>
          ...
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">A set of vertex #CoglAttribute&lt;!-- --&gt;s defining vertex geometry</doc>
            <varargs/>
          </parameter>
        </parameters>
      </method>
      <method name="vdraw_indexed_attributes"
              ...
              deprecated-version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Behaves the same as cogl_framebuffer_vdraw_attributes() except that
instead of reading vertex data sequentially from the specified
attributes the @indices provide an indirection for how the data
should be indexed allowing a random access order to be
specified.
...
actual arguments and return type may be different.</doc>
    ...
    <class name="GLES2Context"
           ...
           glib:fundamental="1">
      <doc xml:space="preserve">Represents an OpenGLES 2.0 api context used as a sandbox for
...
who have used OpenGLES 2.0 with EGL before.</doc>
      <constructor name="new"
                   ...
                   stability="Unstable"
                   throws="1">
        <doc xml:space="preserve">Allocates a new OpenGLES 2.0 context that can be used to render to
...
feature isn't available.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglGLES2Context or %NULL if there
      ...
      <method name="get_vtable"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Queries the OpenGLES 2.0 api function pointers that should be
...
provided by any system OpenGLES 2.0 driver.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A pointer to a #CoglGLES2Vtable providing pointers
        ...
        <parameters>
          <instance-parameter name="gles2_ctx" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglGLES2Context allocated with
    ...
    <enumeration name="GLES2ContextError" c:type="CoglGLES2ContextError">
      <doc xml:space="preserve">Error codes that relate to the cogl_gles2_context api.</doc>
      <member name="unsupported"
              value="0"
              c:identifier="COGL_GLES2_CONTEXT_ERROR_UNSUPPORTED">
        <doc xml:space="preserve">Creating GLES2 contexts
   ...
   check for the %COGL_FEATURE_ID_GLES2_CONTEXT.</doc>
      ...
      <member name="driver"
        ...
        <doc xml:space="preserve">An underlying driver error
   occured.</doc>
      </member>
    </enumeration>
    <record name="GLES2Vtable"
            ...
            version="1.12"
            stability="Unstable">
      <doc xml:space="preserve">Provides function pointers for the full OpenGLES 2.0 api. The
...
symbols of any system OpenGLES 2.0 api.</doc>
    ...
    <class name="IndexBuffer"
      ...
      <constructor name="new"
                   ...
                   version="1.4"
                   stability="Unstable">
        <doc xml:space="preserve">Declares a new #CoglIndexBuffer of @size bytes to contain vertex
indices. Once declared, data can be set using
cogl_buffer_set_data() or by mapping it into the application's
address space using cogl_buffer_map().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglIndexBuffer</doc>
...
avoid costly inversion calculations.&lt;/note&gt;</doc>
  ...
  @inverse matrix will simply be initialized with the identity matrix)</doc>
      ...
      <method name="init_from_euler"
        ...
        <doc xml:space="preserve">Initializes @matrix from a #CoglEuler rotation.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="init_from_quaternion"
        ...
        <doc xml:space="preserve">Initializes @matrix from a #CoglQuaternion rotation.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
objects near to each other.&lt;/note&gt;</doc>
  ...
  and must not be 0)</doc>
      ...
      <method name="project_points"
              ...
              stability="Unstable">
        <doc xml:space="preserve">Projects an array of input points and writes the result to another
...
cogl_matrix_project_points (&amp;matrix,
        ...
        <parameters>
          <instance-parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">A projection matrix</doc>
            <type name="Matrix" c:type="const CoglMatrix*"/>
          </instance-parameter>
          <parameter name="n_components" transfer-ownership="none">
            <doc xml:space="preserve">The number of position components for each input point.
               (either 2, 3 or 4)</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          ...
          <parameter name="points_in" transfer-ownership="none">
          ...
          <parameter name="points_out" transfer-ownership="none">
          ...
          <parameter name="n_points" transfer-ownership="none">
            <doc xml:space="preserve">The number of points to transform.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
...
of @angle degrees around the specified 3D vector.</doc>
      ...
      <method name="rotate_euler"
              ...
              version="2.0">
        <doc xml:space="preserve">Multiplies @matrix with a rotation transformation described by the
given #CoglEuler.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="euler" transfer-ownership="none">
            <doc xml:space="preserve">A euler describing a rotation</doc>
            <type name="Euler" c:type="const CoglEuler*"/>
          </parameter>
        </parameters>
      </method>
...
given #CoglQuaternion.</doc>
        ...
        <parameters>
          ...
          <parameter name="quaternion" transfer-ownership="none">
            <doc xml:space="preserve">A quaternion describing a rotation</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
        </parameters>
      </method>
...
components.</doc>
      ...
      <method name="transform_points"
              ...
              stability="Unstable">
        <doc xml:space="preserve">Transforms an array of input points and writes the result to
...
new matrix is taken from element (j,i) in the old matrix.</doc>
      ...
      <method name="view_2d_in_frustum"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Multiplies @matrix by a view transform that maps the 2D coordinates
...
view frustum.</doc>
        ...
        <parameters>
          ...
          <parameter name="left" transfer-ownership="none">
            <doc xml:space="preserve">coord of left vertical clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="right" transfer-ownership="none">
            <doc xml:space="preserve">coord of right vertical clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="bottom" transfer-ownership="none">
            <doc xml:space="preserve">coord of bottom horizontal clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="top" transfer-ownership="none">
            <doc xml:space="preserve">coord of top horizontal clipping plane</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="z_near" transfer-ownership="none">
            <doc xml:space="preserve">The distance to the near clip plane. Never pass 0 and always pass
  a positive number.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="z_2d" transfer-ownership="none">
            <doc xml:space="preserve">The distance to the 2D plane. (Should always be positive and
  ...
  cogl_matrix_frustum())</doc>
          ...
          <parameter name="width_2d" transfer-ownership="none">
            <doc xml:space="preserve">The width of the 2D coordinate system</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="height_2d" transfer-ownership="none">
            <doc xml:space="preserve">The height of the 2D coordinate system</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
...
view frustum.</doc>
        ...
        <parameters>
          ...
          <parameter name="fov_y" transfer-ownership="none">
            <doc xml:space="preserve">A field of view angle for the Y axis</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="aspect" transfer-ownership="none">
            <doc xml:space="preserve">The ratio of width to height determining the field of view angle
  for the x axis.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="z_near" transfer-ownership="none">
...
inverse matrix these are not considered in the comparison.</doc>
    ...
    <record name="MatrixEntry"
      ...
      <doc xml:space="preserve">Represents a single immutable transformation that was retrieved
...
cogl_object_ref() and cogl_object_unref().&lt;/note&gt;</doc>
      <method name="calculate_translation"
        ...
        <doc xml:space="preserve">Determines if the only difference between two transforms is a
...
other than a translation then the function returns %FALSE.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the only difference between the transform of
        ...
        <parameters>
          <instance-parameter name="entry0" transfer-ownership="none">
            <doc xml:space="preserve">The first reference transform</doc>
            <type name="MatrixEntry" c:type="CoglMatrixEntry*"/>
          </instance-parameter>
          <parameter name="entry1" transfer-ownership="none">
            <doc xml:space="preserve">A second reference transform</doc>
            <type name="MatrixEntry" c:type="CoglMatrixEntry*"/>
          </parameter>
          <parameter name="x"
                     direction="out"
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">The destination for the x-component of the translation</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
          <parameter name="y"
                     direction="out"
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">The destination for the y-component of the translation</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
          <parameter name="z"
                     direction="out"
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">The destination for the z-component of the translation</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="equal" c:identifier="cogl_matrix_entry_equal">
        <doc xml:space="preserve">Compares two arbitrary #CoglMatrixEntry transforms for equality
...
cheaper too.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @entry0 represents the same transform as
              @entry1, otherwise %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="entry0" transfer-ownership="none">
            <doc xml:space="preserve">The first #CoglMatrixEntry to compare</doc>
            <type name="MatrixEntry" c:type="CoglMatrixEntry*"/>
          </instance-parameter>
          <parameter name="entry1" transfer-ownership="none">
            <doc xml:space="preserve">A second #CoglMatrixEntry to compare</doc>
            <type name="MatrixEntry" c:type="CoglMatrixEntry*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get" c:identifier="cogl_matrix_entry_get">
        <doc xml:space="preserve">Resolves the current @entry transform into a #CoglMatrix by
...
returned.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A direct pointer to a #CoglMatrix transform or %NULL
        ...
        <parameters>
          <instance-parameter name="entry" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglMatrixEntry</doc>
            <type name="MatrixEntry" c:type="CoglMatrixEntry*"/>
          </instance-parameter>
          <parameter name="matrix"
                     direction="out"
                     caller-allocates="1"
                     transfer-ownership="none">
            <doc xml:space="preserve">The potential destination for the transform as
                a matrix</doc>
            <type name="Matrix" c:type="CoglMatrix*"/>
          </parameter>
        </parameters>
      ...
      <method name="is_identity" c:identifier="cogl_matrix_entry_is_identity">
        <doc xml:space="preserve">Determines whether @entry is known to represent an identity
transform.
...
matrix but no expensive comparison is performed to verify it.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @entry is definitely an identity transform,
              otherwise %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
      ...
      <method name="ref" c:identifier="cogl_matrix_entry_ref">
        <doc xml:space="preserve">Takes a reference on the given @entry to ensure the @entry stays
...
cogl_object_unref()</doc>
      ...
      <method name="unref" c:identifier="cogl_matrix_entry_unref">
        <doc xml:space="preserve">Releases a reference on @entry either taken by calling
...
calling cogl_matrix_stack_get_entry().</doc>
    ...
    <class name="MatrixStack"
           ...
           glib:fundamental="1">
      <doc xml:space="preserve">Tracks your current position within a hierarchy and lets you build
...
immutable transform.</doc>
      <constructor name="new" c:identifier="cogl_matrix_stack_new">
        <doc xml:space="preserve">Allocates a new #CoglMatrixStack that can be used to build up
...
cogl_matrix_stack_translate().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglMatrixStack</doc>
      ...
      <method name="frustum" c:identifier="cogl_matrix_stack_frustum">
        <doc xml:space="preserve">Replaces the current matrix with a perspective matrix for a given
...
through the origin and 2 near and far clip planes.</doc>
        ...
        <parameters>
          <instance-parameter name="stack" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglMatrixStack</doc>
            <type name="MatrixStack" c:type="CoglMatrixStack*"/>
          </instance-parameter>
          <parameter name="left" transfer-ownership="none">
            <doc xml:space="preserve">X position of the left clipping plane where it
  ...
  the near clipping plane</doc>
      ...
      <method name="get" c:identifier="cogl_matrix_stack_get">
        <doc xml:space="preserve">Resolves the current @stack transform into a #CoglMatrix by
...
returned.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A direct pointer to the current transform or %NULL
              and in that case @matrix will be initialized with
        ...
        <parameters>
          ...
          <parameter name="matrix"
                     ...
                     caller-allocates="1"
                     transfer-ownership="none">
            <doc xml:space="preserve">The potential destination for the current matrix</doc>
            <type name="Matrix" c:type="CoglMatrix*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_entry" c:identifier="cogl_matrix_stack_get_entry">
        <doc xml:space="preserve">Gets a reference to the current transform represented by a
...
and entry you get via cogl_matrix_stack_get_entry().&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A pointer to the #CoglMatrixEntry
      ...
      <method name="get_inverse" c:identifier="cogl_matrix_stack_get_inverse">
        <doc xml:space="preserve">Gets the inverse transform of the current matrix and uses it to
initialize a new #CoglMatrix.</doc>
  ...
  @inverse matrix will simply be initialized with the identity matrix)</doc>
      ...
      <method name="load_identity"
        ...
        <doc xml:space="preserve">Resets the current matrix to the identity matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="multiply" c:identifier="cogl_matrix_stack_multiply">
        <doc xml:space="preserve">Multiplies the current matrix by the given matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="orthographic"
        ...
        <doc xml:space="preserve">Replaces the current matrix with an orthographic projection matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="perspective" c:identifier="cogl_matrix_stack_perspective">
        <doc xml:space="preserve">Replaces the current matrix with a perspective matrix based on the
provided values.
...
objects near to each other.&lt;/note&gt;</doc>
  ...
  and must not be 0)</doc>
      ...
      <method name="pop" c:identifier="cogl_matrix_stack_pop">
        <doc xml:space="preserve">Restores the previous transform that was last saved by calling
...
return up one level in the graph towards the root node.</doc>
      ...
      <method name="push" c:identifier="cogl_matrix_stack_push">
        <doc xml:space="preserve">Saves the current transform and starts a new transform that derives
...
transform of an ancestor.</doc>
      ...
      <method name="rotate" c:identifier="cogl_matrix_stack_rotate">
        <doc xml:space="preserve">Multiplies the current matrix by one that rotates the around the
...
rotation.</doc>
      ...
      <method name="rotate_euler"
        ...
        <doc xml:space="preserve">Multiplies the current matrix by one that rotates according to the
...
rotation described by @quaternion.</doc>
      ...
      <method name="scale" c:identifier="cogl_matrix_stack_scale">
        <doc xml:space="preserve">Multiplies the current matrix by one that scales the x, y and z
axes by the given values.</doc>
      ...
      <method name="set" c:identifier="cogl_matrix_stack_set">
        <doc xml:space="preserve">Replaces the current @stack matrix value with the value of @matrix.
...
the stack was initialized.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglMatrix replace the current matrix value with</doc>
            <type name="Matrix" c:type="const CoglMatrix*"/>
          </parameter>
        </parameters>
      </method>
      <method name="translate" c:identifier="cogl_matrix_stack_translate">
        <doc xml:space="preserve">Multiplies the current matrix by one that translates along all
three axes according to the given values.</doc>
    ...
    <callback name="MetaTextureCallback"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">A callback used with cogl_meta_texture_foreach_in_region() to
...
make up a given #CoglMetaTexture.</doc>
      ...
      <parameters>
        <parameter name="sub_texture" transfer-ownership="none">
          <doc xml:space="preserve">A low-level #CoglTexture making up part of a
              #CoglMetaTexture.</doc>
          <type name="Texture" c:type="CoglTexture*"/>
        </parameter>
        <parameter name="sub_texture_coords" transfer-ownership="none">
          <doc xml:space="preserve">A float 4-tuple ordered like
        ...
        <parameter name="meta_coords" transfer-ownership="none">
          <doc xml:space="preserve">A float 4-tuple ordered like (tx1,ty1,tx2,ty2)
    ...
    <class name="Object"
      ...
      <function name="unref"
                ...
                introspectable="0">
        <doc xml:space="preserve">Drecreases the reference count of @object by 1; if the reference
  ...
  data is found.</doc>
        ...
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">The object with associated private data to query</doc>
            <type name="Object" c:type="CoglObject*"/>
          </instance-parameter>
          <parameter name="key" transfer-ownership="none">
            <doc xml:space="preserve">The address of a #CoglUserDataKey which provides a unique value
      ...
      <method name="set_user_data"
              ...
              version="1.4"
              introspectable="0">
        <doc xml:space="preserve">Associates some private @user_data with a given #CoglObject. To
...
the same @key but NULL for the @user_data.</doc>
        ...
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">The object to associate private data with</doc>
            <type name="Object" c:type="CoglObject*"/>
          </instance-parameter>
          <parameter name="key" transfer-ownership="none">
            <doc xml:space="preserve">The address of a #CoglUserDataKey which provides a unique value
  ...
  or %NULL to remove a previous association.</doc>
          ...
          <parameter name="destroy" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglUserDataDestroyCallback to call if the object is
  ...
  %NULL data for the same key.</doc>
    ...
    <class name="Onscreen"
      ...
      <constructor name="new"
                   ...
                   version="1.8"
                   stability="Unstable">
        <doc xml:space="preserve">Instantiates an "unallocated" #CoglOnscreen framebuffer that may be
...
it is first used or explicitly via cogl_framebuffer_allocate().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly instantiated #CoglOnscreen framebuffer</doc>
          <type name="Onscreen" c:type="CoglOnscreen*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The desired framebuffer width</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The desired framebuffer height</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="add_dirty_callback"
              ...
              version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Installs a @callback function that will be called whenever the
...
for rendering.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #CoglOnscreenDirtyClosure pointer that can be used to
        ...
        <parameters>
          <instance-parameter name="onscreen" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglOnscreen framebuffer</doc>
            <type name="Onscreen" c:type="CoglOnscreen*"/>
          </instance-parameter>
          <parameter name="callback"
                     transfer-ownership="none"
                     scope="notified"
                     closure="1">
            <doc xml:space="preserve">A callback function to call for dirty events</doc>
          ...
          <parameter name="destroy"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">An optional callback to destroy @user_data when the
      ...
      <method name="add_frame_callback"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Installs a @callback function that will be called for significant
...
can display.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #CoglFrameClosure pointer that can be used to
              remove the callback and associated @user_data later.</doc>
        ...
        <parameters>
          ...
          <parameter name="destroy"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">An optional callback to destroy @user_data
      ...
      <method name="add_resize_callback"
              ...
              version="2.0">
        <doc xml:space="preserve">Registers a @callback with @onscreen that will be called whenever
...
example.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a #CoglOnscreenResizeClosure pointer that can be used to
              remove the callback and associated @user_data later.</doc>
        ...
        <parameters>
          ...
          <parameter name="callback"
                     ...
                     scope="notified"
                     closure="1">
            <doc xml:space="preserve">A #CoglOnscreenResizeCallback to call when
      ...
      <method name="add_swap_buffers_callback"
              ...
              stability="Unstable">
        <doc xml:space="preserve">Installs a @callback function that should be called whenever a swap buffers
...
throttling when you request to swap buffers too quickly.</doc>
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a unique identifier that can be used to remove to remove
        ...
        <parameters>
          ...
          <parameter name="callback"
                     ...
                     scope="notified"
                     closure="1">
            <doc xml:space="preserve">A callback function to call when a swap
           has completed</doc>
      ...
      <method name="get_buffer_age"
              ...
              version="1.14"
              stability="Stable">
        <doc xml:space="preserve">Gets the current age of the buffer contents.
...
missing then this function will always return 0.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The age of the buffer contents or 0 when the buffer
      ...
      <method name="get_frame_counter"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the value of the framebuffers frame counter. This is
a counter that increases by one each time
cogl_onscreen_swap_buffers() or cogl_onscreen_swap_region()
is called.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the current frame counter value</doc>
          <type name="gint64" c:type="int64_t"/>
        </return-value>
        <parameters>
          <instance-parameter name="onscreen" transfer-ownership="none">
      ...
      <method name="get_resizable"
              ...
              version="2.0">
        <doc xml:space="preserve">Lets you query whether @onscreen has been marked as resizable via
...
been marked as resizable.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Returns whether @onscreen has been marked as
      ...
      <method name="hide"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">This requests to make @onscreen invisible to the user.
...
hide windows without confusing Cogl.&lt;/note&gt;</doc>
        ...
        <parameters>
          <instance-parameter name="onscreen" transfer-ownership="none">
            <doc xml:space="preserve">The onscreen framebuffer to make invisible</doc>
            <type name="Onscreen" c:type="CoglOnscreen*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="remove_dirty_callback"
              ...
              version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Removes a callback and associated user data that were previously
...
this will also get called.</doc>
        ...
        <parameters>
          <instance-parameter name="onscreen" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglOnscreen</doc>
            <type name="Onscreen" c:type="CoglOnscreen*"/>
          </instance-parameter>
          <parameter name="closure" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglOnscreenDirtyClosure returned from
...
this will get called.</doc>
        ...
        <parameters>
          ...
          <parameter name="closure" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglFrameClosure returned from
          cogl_onscreen_add_frame_callback()</doc>
            <type name="FrameClosure" c:type="CoglFrameClosure*"/>
          </parameter>
        </parameters>
      ...
      <method name="remove_resize_callback"
              ...
              version="2.0">
        <doc xml:space="preserve">Removes a resize @callback and @user_data pair that were previously
associated with @onscreen via cogl_onscreen_add_resize_callback().</doc>
        ...
        <parameters>
          ...
          <parameter name="closure" transfer-ownership="none">
            <doc xml:space="preserve">An identifier returned from cogl_onscreen_add_resize_callback()</doc>
            <type name="OnscreenResizeClosure"
                  c:type="CoglOnscreenResizeClosure*"/>
          </parameter>
        </parameters>
      ...
      <method name="remove_swap_buffers_callback"
              ...
              deprecated-version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Removes a callback that was previously registered
using cogl_onscreen_add_swap_buffers_callback().</doc>
        ...
        <parameters>
          ...
          <parameter name="id" transfer-ownership="none">
            <doc xml:space="preserve">An identifier returned from cogl_onscreen_add_swap_buffers_callback()</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_resizable"
              ...
              version="2.0">
        <doc xml:space="preserve">Lets you request Cogl to mark an @onscreen framebuffer as
resizable or not.
...
can track when the viewport has been changed automatically.&lt;/note&gt;</doc>
      ...
      <method name="set_swap_throttled"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Requests that the given @onscreen framebuffer should have swap buffer
...
environment.</doc>
        ...
        <parameters>
          ...
          <parameter name="throttled" transfer-ownership="none">
            <doc xml:space="preserve">Whether swap throttling is wanted or not.</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
      <method name="show"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">This requests to make @onscreen visible to the user.
...
hide windows without confusing Cogl.&lt;/note&gt;</doc>
        ...
        <parameters>
          <instance-parameter name="onscreen" transfer-ownership="none">
            <doc xml:space="preserve">The onscreen framebuffer to make visible</doc>
            <type name="Onscreen" c:type="CoglOnscreen*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="swap_buffers"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Swaps the current back buffer being rendered too, to the front for display.
...
render a full buffer for every frame.&lt;/note&gt;</doc>
      ...
      <method name="swap_buffers_with_damage"
              ...
              version="1.16"
              stability="Unstable">
        <doc xml:space="preserve">Swaps the current back buffer being rendered too, to the front for
...
perform incremental rendering based on old back buffers.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="rectangles" transfer-ownership="none">
            <doc xml:space="preserve">An array of integer 4-tuples representing damaged
             rectangles as (x, y, width, height) tuples.</doc>
            <type name="gint" c:type="const int*"/>
          </parameter>
          <parameter name="n_rectangles" transfer-ownership="none">
            <doc xml:space="preserve">The number of 4-tuples to be read from @rectangles</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="swap_region"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Swaps a region of the back buffer being rendered too, to the front for
...
frame.</doc>
        ...
        <parameters>
          ...
          <parameter name="rectangles" transfer-ownership="none">
            <doc xml:space="preserve">An array of integer 4-tuples representing rectangles as
...
lost and the application should redraw it.</doc>
      ...
      <parameters>
        ...
        <parameter name="info" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglOnscreenDirtyInfo struct containing the details of the
  dirty area</doc>
    ...
    <record name="OnscreenDirtyClosure"
      ...
      <doc xml:space="preserve">An opaque type that tracks a #CoglOnscreenDirtyCallback and associated
...
callback later using cogl_onscreen_remove_dirty_callback().</doc>
    ...
    <record name="OnscreenDirtyInfo"
            ...
            version="1.16"
            stability="Unstable">
      <doc xml:space="preserve">A structure passed to callbacks registered using
...
rectangle within the onscreen buffer that should be redrawn.</doc>
      <field name="x" writable="1">
        <doc xml:space="preserve">Left edge of the dirty rectangle</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="y" writable="1">
        <doc xml:space="preserve">Top edge of the dirty rectangle, measured from the top of the window</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="width" writable="1">
        <doc xml:space="preserve">Width of the dirty rectangle</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="height" writable="1">
        <doc xml:space="preserve">Height of the dirty rectangle</doc>
        <type name="gint" c:type="int"/>
      </field>
    </record>
    <callback name="OnscreenResizeCallback"
              c:type="CoglOnscreenResizeCallback"
              version="2.0">
      <doc xml:space="preserve">Is a callback type used with the
...
example.&lt;/note&gt;</doc>
      ...
      <parameters>
        <parameter name="onscreen" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglOnscreen framebuffer that was resized</doc>
          <type name="Onscreen" c:type="CoglOnscreen*"/>
        </parameter>
        <parameter name="width" transfer-ownership="none">
          <doc xml:space="preserve">The new width of @onscreen</doc>
          <type name="gint" c:type="int"/>
        </parameter>
        <parameter name="height" transfer-ownership="none">
    ...
    <record name="OnscreenResizeClosure"
      ...
      <doc xml:space="preserve">An opaque type that tracks a #CoglOnscreenResizeCallback and
...
cogl_onscreen_remove_resize_callback().</doc>
    ...
    <class name="OnscreenTemplate"
      ...
      <method name="set_samples_per_pixel"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Requires that any future CoglOnscreen framebuffers derived from
...
rendering.&lt;/note&gt;</doc>
        ...
        <parameters>
          <instance-parameter name="onscreen_template"
                              transfer-ownership="none">
            <doc xml:space="preserve">A #CoglOnscreenTemplate template framebuffer</doc>
            <type name="OnscreenTemplate" c:type="CoglOnscreenTemplate*"/>
          </instance-parameter>
          <parameter name="n" transfer-ownership="none">
            <doc xml:space="preserve">The minimum number of samples per pixel</doc>
      ...
      <method name="set_stereo_enabled"
              ...
              version="1.20"
              stability="Unstable">
        <doc xml:space="preserve">Sets whether future #CoglOnscreen framebuffers derived from this
...
fail.</doc>
        ...
        <parameters>
          ...
          <parameter name="enabled" transfer-ownership="none">
            <doc xml:space="preserve">Whether framebuffers are created with stereo buffers</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_swap_throttled"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Requests that any future #CoglOnscreen framebuffers derived from this
...
@throttled argument.</doc>
        ...
        <parameters>
          ...
          <parameter name="throttled" transfer-ownership="none">
            <doc xml:space="preserve">Whether throttling should be enabled</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
    ...
    <class name="Output"
      ...
      <method name="get_height"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the height of the output in pixels.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the height of the output in pixels</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
            <doc xml:space="preserve">a #CoglOutput</doc>
            <type name="Output" c:type="CoglOutput*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_mm_height"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the physical height of the output. In some cases (such as
as a projector), the value returned here might correspond to
nominal resolution rather than the actual physical size of the
output device.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the height of the output in millimeters. A value
 of 0 indicates that the height is unknown</doc>
      ...
      <method name="get_mm_width"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the physical width of the output. In some cases (such as
as a projector), the value returned here might correspond to
nominal resolution rather than the actual physical size of the
output device.</doc>
        <return-value transfer-ownership="none">
 ...
 of 0 indicates the width is unknown</doc>
      ...
      <method name="get_refresh_rate"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the number of times per second that the output device refreshes
the display contents.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the refresh rate of the output device. A value of zero
 indicates that the refresh rate is unknown.</doc>
      ...
      <method name="get_subpixel_order"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">For an output device where each pixel is made up of smaller components
with different colors, returns the layout of the subpixel
components.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the order of subpixel components for the output device</doc>
      ...
      <method name="get_width"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the width of the output in pixels.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the width of the output in pixels</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="output" transfer-ownership="none">
      ...
      <method name="get_x"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the X position of the output with respect to the coordinate
system of the screen.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the X position of the output as a pixel offset
 from the left side of the screen coordinate space</doc>
      ...
      <method name="get_y"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Gets the Y position of the output with respect to the coordinate
system of the screen.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the Y position of the output as a pixel offset
 from the top side of the screen coordinate space</doc>
    ...
    <callback name="OutputCallback"
              ...
              version="1.14"
              stability="Unstable">
      <doc xml:space="preserve">A callback type that can be passed to
...
given renderer.</doc>
    ...
    <class name="Pipeline"
      ...
      <constructor name="new"
                   ...
                   version="2.0"
                   stability="Unstable">
        <doc xml:space="preserve">Allocates and initializes a default simple pipeline that will color
a primitive white.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a pointer to a new #CoglPipeline</doc>
          <type name="Pipeline" c:type="CoglPipeline*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
      ...
      <method name="add_layer_snippet"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Adds a shader snippet that will hook on to the given layer of the
...
and need to be added with cogl_pipeline_add_snippet() instead.</doc>
        ...
        <parameters>
          ...
          <parameter name="layer" transfer-ownership="none">
            <doc xml:space="preserve">The layer to hook the snippet to</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="snippet" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglSnippet</doc>
      ...
      <method name="add_snippet"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Adds a shader snippet to @pipeline. The snippet will wrap around or
...
must be added with cogl_pipeline_add_layer_snippet() instead.</doc>
        ...
        <parameters>
          ...
          <parameter name="snippet" transfer-ownership="none">
            <doc xml:space="preserve">The #CoglSnippet to add to the vertex processing hook</doc>
            <type name="Snippet" c:type="CoglSnippet*"/>
          </parameter>
        </parameters>
      </method>
      <method name="copy"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Creates a new pipeline with the configuration copied from the
source pipeline.
...
state changes.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a pointer to the newly allocated #CoglPipeline</doc>
          <type name="Pipeline" c:type="CoglPipeline*"/>
        </return-value>
        <parameters>
          <instance-parameter name="source" transfer-ownership="none">
            <doc xml:space="preserve">a #CoglPipeline object to copy</doc>
            <type name="Pipeline" c:type="CoglPipeline*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="foreach_layer"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Iterates all the layer indices of the given @pipeline.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPipeline object</doc>
            <type name="Pipeline" c:type="CoglPipeline*"/>
          </instance-parameter>
          <parameter name="callback"
                     transfer-ownership="none"
                     scope="call"
                     closure="1">
            <doc xml:space="preserve">A #CoglPipelineLayerCallback to be
      ...
      <method name="get_alpha_test_function"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The alpha test function of @pipeline.</doc>
      ...
      <method name="get_alpha_test_reference"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The alpha test reference value of @pipeline.</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
      ...
      <method name="get_ambient"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the current ambient color for @pipeline</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_color"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the current pipeline color.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
corresponding color would be written.</doc>
      ...
      <method name="get_cull_face_mode"
              ...
              version="2.0">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the cull face mode that was previously set with
...
Status: Unstable</doc>
      ...
      <method name="get_depth_state"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the current depth state configuration for the given
@pipeline as previously set using cogl_pipeline_set_depth_state().</doc>
        ...
        <parameters>
          ...
          <parameter name="state_out"
                     ...
                     caller-allocates="1"
                     transfer-ownership="none">
            <doc xml:space="preserve">A destination #CoglDepthState struct</doc>
            <type name="DepthState" c:type="CoglDepthState*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_diffuse"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the current diffuse color for @pipeline</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_emission"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the pipelines current emission color.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_front_face_winding"
              ...
              version="2.0">
        <doc xml:space="preserve">The order of the vertices within a primitive specifies whether it
...
%COGL_WINDING_COUNTER_CLOCKWISE.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The @pipeline front face winding
...
Status: Unstable</doc>
      ...
      <method name="get_layer_mag_filter"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the currently set magnification #CoglPipelineFilter set on
...
changed using cogl_pipeline_set_layer_filters().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The magnification #CoglPipelineFilter for the
              specified layer.</doc>
      ...
      <method name="get_layer_min_filter"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the currently set minification #CoglPipelineFilter set on
...
changed using cogl_pipeline_set_layer_filters().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The minification #CoglPipelineFilter for the
              specified layer.</doc>
          <type name="PipelineFilter" c:type="CoglPipelineFilter"/>
        </return-value>
        <parameters>
...
point sprite coordinates.</doc>
      ...
      <method name="get_layer_texture"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the texture that was set for the
...
this layer.</doc>
      ...
      <method name="get_n_layers"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the number of layers defined for the given @pipeline</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="get_per_vertex_point_size"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the pipeline has per-vertex point size
  ...
  enabled with cogl_pipeline_set_per_vertex_point_size().</doc>
        ...
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
            <doc xml:space="preserve">a #CoglPipeline pointer</doc>
            <type name="Pipeline" c:type="CoglPipeline*"/>
          </instance-parameter>
        </parameters>
      </method>
...
used with the vertex buffer API.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the point size of the @pipeline.</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
      ...
      <method name="get_shininess"
        ...
        <doc xml:space="preserve">Retrieves the pipelines current emission color.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pipelines current shininess value</doc>
          <type name="gfloat" c:type="float"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
      ...
      <method name="get_specular"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the pipelines current specular color.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_uniform_location"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">This is used to get an integer representing the uniform with the
...
before calling this function.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">A integer representing the location of the given uniform.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
...
@pipeline using cogl_pipeline_set_user_program().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The current user program or %COGL_INVALID_HANDLE.</doc>
      ...
      <method name="remove_layer"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This function removes a layer from your pipeline</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
The default is %COGL_PIPELINE_ALPHA_FUNC_ALWAYS</doc>
        ...
        <parameters>
          ...
          <parameter name="alpha_func" transfer-ownership="none">
            <doc xml:space="preserve">A @CoglPipelineAlphaFunc constant</doc>
            <type name="PipelineAlphaFunc" c:type="CoglPipelineAlphaFunc"/>
          </parameter>
  ...
  to compare incoming fragments to.</doc>
      ...
      <method name="set_ambient"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the pipeline's ambient color, in the standard OpenGL lighting
...
The default value is (0.2, 0.2, 0.2, 1.0)</doc>
      ...
      <method name="set_ambient_and_diffuse"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Conveniently sets the diffuse and ambient color of @pipeline at the same
...
blending will depend on the constant set with this function.</doc>
      ...
      <method name="set_color"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the basic color of the pipeline, used when no lighting is enabled.
...
color will be written.</doc>
      ...
      <method name="set_cull_face_mode"
              ...
              version="2.0">
        <doc xml:space="preserve">Sets which faces will be culled when drawing. Face culling can be
...
Status: Unstable</doc>
      ...
      <method name="set_depth_state"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">This commits all the depth state configured in @state struct to the
...
it is possible for this function to fail and report an @error.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">TRUE if the GPU supports all the given @state else %FALSE
      ...
      <method name="set_diffuse"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the pipeline's diffuse color, in the standard OpenGL lighting
...
The default value is (0.8, 0.8, 0.8, 1.0)</doc>
      ...
      <method name="set_emission"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the pipeline's emissive color, in the standard OpenGL lighting
...
Status: Unstable</doc>
        ...
        <parameters>
          ...
          <parameter name="front_winding" transfer-ownership="none">
            <doc xml:space="preserve">the winding order</doc>
            <type name="Winding" c:type="CoglWinding"/>
          </parameter>
        </parameters>
      </method>
...
and rotate a single layer of a pipeline used to fill your geometry.</doc>
        ...
        <parameters>
          ...
          <parameter name="layer_index" transfer-ownership="none">
            <doc xml:space="preserve">the index for the layer inside @pipeline</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="matrix" transfer-ownership="none">
      ...
      <method name="set_layer_null_texture"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets the texture for this layer to be the default texture for the
...
internal texture type state for efficiency.</doc>
        ...
        <parameters>
          ...
          <parameter name="layer_index" transfer-ownership="none">
            <doc xml:space="preserve">The layer number to modify</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="texture_type" transfer-ownership="none">
            <doc xml:space="preserve">The type of the default texture to use</doc>
...
this layer. 'p' is the third coordinate.</doc>
      ...
      <method name="set_per_vertex_point_size"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">Sets whether to use a per-vertex point size or to use the value set
...
a #CoglError.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the change suceeded or %FALSE otherwise</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <instance-parameter name="pipeline" transfer-ownership="none">
          ...
          <parameter name="enable" transfer-ownership="none">
            <doc xml:space="preserve">whether to enable per-vertex point size</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </method>
...
pipeline that has an explicit point size set on it.</doc>
      ...
      <method name="set_shininess"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the shininess of the pipeline, in the standard OpenGL lighting
...
The default value is 0.0</doc>
      ...
      <method name="set_specular"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets the pipeline's specular color, in the standard OpenGL lighting
...
The default value is (0.0, 0.0, 0.0, 1.0)</doc>
      ...
      <method name="set_uniform_1f"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets a new value for the uniform at @uniform_location. If this
...
uniform.</doc>
        ...
        <parameters>
          ...
          <parameter name="uniform_location" transfer-ownership="none">
            <doc xml:space="preserve">The uniform's location identifier</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">The new value for the uniform</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
...
uniform or a sampler uniform.</doc>
      ...
      <method name="set_uniform_float"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Sets new values for the uniform at @uniform_location. If this
pipeline has a user program attached and is later used as a source
...
@n_components and 8 for @count.</doc>
        ...
        <parameters>
          ...
          <parameter name="n_components" transfer-ownership="none">
            <doc xml:space="preserve">The number of components in the corresponding uniform's type</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="count" transfer-ownership="none">
            <doc xml:space="preserve">The number of values to set</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">Pointer to the new values to set</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </method>
...
@transpose to %FALSE.</doc>
        ...
        <parameters>
          ...
          <parameter name="dimensions" transfer-ownership="none">
            <doc xml:space="preserve">The size of the matrix</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="count" transfer-ownership="none">
            <doc xml:space="preserve">The number of values to set</doc>
          ...
          <parameter name="transpose" transfer-ownership="none">
            <doc xml:space="preserve">Whether to transpose the matrix</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">Pointer to the new values to set</doc>
      ...
      <method name="set_user_program"
              ...
              version="2.0"
              stability="Unstable">
        <doc xml:space="preserve">Associates a linked CoglProgram with the given pipeline so that the
...
determines how the comparison is done.</doc>
  ...
  alpha value is greater than or equal to the reference alpha value.</doc>
    ...
    <enumeration name="PipelineCullFaceMode" c:type="CoglPipelineCullFaceMode">
      <doc xml:space="preserve">Specifies which faces should be culled. This can be set on a
pipeline using cogl_pipeline_set_cull_face_mode().</doc>
      <member name="none"
              value="0"
              c:identifier="COGL_PIPELINE_CULL_FACE_MODE_NONE">
        <doc xml:space="preserve">Neither face will be
 culled. This is the default.</doc>
      </member>
      <member name="front"
              value="1"
              c:identifier="COGL_PIPELINE_CULL_FACE_MODE_FRONT">
        <doc xml:space="preserve">Front faces will be culled.</doc>
      </member>
      <member name="back"
              value="2"
              c:identifier="COGL_PIPELINE_CULL_FACE_MODE_BACK">
        <doc xml:space="preserve">Back faces will be culled.</doc>
      </member>
      <member name="both"
              value="3"
              c:identifier="COGL_PIPELINE_CULL_FACE_MODE_BOTH">
        <doc xml:space="preserve">All faces will be culled.</doc>
      </member>
    </enumeration>
...
average or simply using the nearest texel.</doc>
  ...
  their weighted average</doc>
    ...
    <callback name="PipelineLayerCallback"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">The callback prototype used with cogl_pipeline_foreach_layer() for
iterating all the layers of a @pipeline.</doc>
      ...
      <parameters>
        <parameter name="pipeline" transfer-ownership="none">
          <doc xml:space="preserve">The #CoglPipeline whos layers are being iterated</doc>
          <type name="Pipeline" c:type="CoglPipeline*"/>
        </parameter>
        <parameter name="layer_index" transfer-ownership="none">
  ...
  is the default value.</doc>
    ...
    <class name="PixelBuffer"
      ...
      <constructor name="new"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Declares a new #CoglPixelBuffer of @size bytes to contain arrays of
...
immediately copied into the new buffer.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly allocated #CoglPixelBuffer</doc>
          <type name="PixelBuffer" c:type="CoglPixelBuffer*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
...
internally and convert the texture data if necessary.</doc>
  ...
  See cogl_texture_set_components() for details.</doc>
    ...
    <record name="PollFD"
            ...
            version="1.10"
            stability="Unstable">
      <doc xml:space="preserve">A struct for describing the state of a file descriptor that Cogl
...
pollfd on Unix so that it can simply be cast when calling poll.</doc>
      <field name="fd" writable="1">
        <doc xml:space="preserve">The file descriptor to block on</doc>
        <type name="gint" c:type="int"/>
      </field>
      <field name="events" writable="1">
        <doc xml:space="preserve">A bitmask of events to block on</doc>
        <type name="gshort" c:type="short"/>
      </field>
      <field name="revents" writable="1">
        <doc xml:space="preserve">A bitmask of returned events</doc>
        <type name="gshort" c:type="short"/>
      </field>
    </record>
    <enumeration name="PollFDEvent"
      ...
      <doc xml:space="preserve">A bitmask of events that Cogl may need to wake on for a file
...
may be directly passed to poll.</doc>
      ...
      <member name="hup" value="16" c:identifier="COGL_POLL_FD_EVENT_HUP">
        <doc xml:space="preserve">hung up (the connection has been broken, usually
    ...
    <class name="Primitive"
      ...
      <constructor name="new"
                   ...
                   introspectable="0"
                   stability="Unstable">
        <doc xml:space="preserve">Combines a set of #CoglAttribute&lt;!-- --&gt;s with a specific draw @mode
...
the number of vertices to read when drawing.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglPrimitive object</doc>
          <type name="Primitive" c:type="CoglPrimitive*"/>
        </return-value>
        <parameters>
          <parameter name="mode" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglVerticesMode defining how to draw the vertices</doc>
            <type name="VerticesMode" c:type="CoglVerticesMode"/>
          </parameter>
          <parameter name="n_vertices" transfer-ownership="none">
            <doc xml:space="preserve">The number of vertices to process when drawing</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="..." transfer-ownership="none">
      ...
      <constructor name="new_p2"
                   ...
                   version="1.6"
                   stability="Unstable">
        <doc xml:space="preserve">Provides a convenient way to describe a primitive, such as a single
...
power-of-two size (though they don't have to be square)&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglPrimitive
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="n_vertices" transfer-ownership="none">
            <doc xml:space="preserve">The number of vertices to read from @data and also
             the number of vertices to read when later drawing.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP2): An array
       of #CoglVertexP2 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP2*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP2C4): An array
       of #CoglVertexP2C4 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP2C4*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP2T2): An array
       of #CoglVertexP2T2 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP2T2*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP2T2C4): An
       array of #CoglVertexP2T2C4 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP2T2C4*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP3): An array of
       #CoglVertexP3 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP3*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP3C4): An array
       of #CoglVertexP3C4 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP3C4*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP3T2): An array
       of #CoglVertexP3T2 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP3T2*">
...
with a reference of 1. This can be freed using cogl_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">(type Cogl.VertexP3T2C4): An
       array of #CoglVertexP3T2C4 vertices</doc>
            <array length="2" zero-terminated="0" c:type="CoglVertexP3T2C4*">
...
the number of vertices to read when drawing.</doc>
        ...
        <parameters>
          ...
          <parameter name="attributes" transfer-ownership="none">
            <doc xml:space="preserve">An array of CoglAttribute</doc>
            <type name="Attribute" c:type="CoglAttribute**"/>
          </parameter>
          <parameter name="n_attributes" transfer-ownership="none">
      ...
      <function name="texture_set_auto_mipmap"
                ...
                version="2.0"
                stability="Unstable">
        <doc xml:space="preserve">Sets whether the texture will automatically update the smaller
...
levels. By default auto mipmapping is enabled.</doc>
        ...
        <parameters>
          <parameter name="primitive_texture" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPrimitiveTexture</doc>
            <type name="PrimitiveTexture" c:type="CoglPrimitiveTexture*"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">The new value for whether to auto mipmap</doc>
            <type name="Bool" c:type="CoglBool"/>
          </parameter>
        </parameters>
      </function>
      <method name="copy"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Makes a copy of an existing #CoglPrimitive. Note that the primitive
is a shallow copy which means it will use the same attributes and
attribute buffers as the original primitive.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the new primitive</doc>
          <type name="Primitive" c:type="CoglPrimitive*"/>
        </return-value>
        <parameters>
          <instance-parameter name="primitive" transfer-ownership="none">
            <doc xml:space="preserve">A primitive copy</doc>
            <type name="Primitive" c:type="CoglPrimitive*"/>
          </instance-parameter>
        </parameters>
      </method>
...
are associated with layers of the given @pipeline.</doc>
      ...
      <method name="foreach_attribute"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Iterates all the attributes of the given #CoglPrimitive.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="primitive" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPrimitive object</doc>
            <type name="Primitive" c:type="CoglPrimitive*"/>
          </instance-parameter>
          <parameter name="callback"
                     transfer-ownership="none"
                     scope="call"
                     closure="1">
            <doc xml:space="preserve">A #CoglPrimitiveAttributeCallback to be
      ...
      <method name="get_indices"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the indices that were set with
cogl_primitive_set_indices() or %NULL if no indices were set.</doc>
          <type name="Indices" c:type="CoglIndices*"/>
        </return-value>
        <parameters>
          <instance-parameter name="primitive" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglPrimitive</doc>
            <type name="Primitive" c:type="CoglPrimitive*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="get_n_vertices"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries the number of vertices to read when drawing the given
...
of vertices to read and draw.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of vertices to read when drawing.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="primitive" transfer-ownership="none">
      ...
      <method name="set_attributes"
              ...
              version="1.6"
              stability="Unstable">
        <doc xml:space="preserve">Replaces all the attributes of the given #CoglPrimitive object.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="attributes" transfer-ownership="none">
            <doc xml:space="preserve">an array of #CoglAttribute pointers</doc>
            <type name="Attribute" c:type="CoglAttribute**"/>
          </parameter>
          <parameter name="n_attributes" transfer-ownership="none">
            <doc xml:space="preserve">the number of elements in @attributes</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="set_indices"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Associates a sequence of #CoglIndices with the given @primitive.
...
indices to start drawing from.&lt;/note&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="indices" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglIndices array</doc>
            <type name="Indices" c:type="CoglIndices*"/>
          </parameter>
          <parameter name="n_indices" transfer-ownership="none">
            <doc xml:space="preserve">The number of indices to reference when drawing</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="set_n_vertices"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Specifies how many vertices should be read when drawing the given
@primitive.
...
of vertices to read and draw.&lt;/note&gt;</doc>
    ...
    <callback name="PrimitiveAttributeCallback"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">The callback prototype used with cogl_primitive_foreach_attribute()
...
stop.</doc>
      ...
      <parameters>
        <parameter name="primitive" transfer-ownership="none">
          <doc xml:space="preserve">The #CoglPrimitive whose attributes are being iterated</doc>
          <type name="Primitive" c:type="CoglPrimitive*"/>
        </parameter>
    ...
    <record name="Quaternion"
      ...
      <doc xml:space="preserve">A quaternion is comprised of a scalar component and a 3D vector
...
&lt;/itemizedlist&gt;</doc>
      <field name="w" writable="1">
        <doc xml:space="preserve">based on the angle of rotation it is cos(𝜃/2)</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="x" writable="1">
        <doc xml:space="preserve">based on the angle of rotation and x component of the axis of
    rotation it is sin(𝜃/2)*axis.x</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="y" writable="1">
        <doc xml:space="preserve">based on the angle of rotation and y component of the axis of
    rotation it is sin(𝜃/2)*axis.y</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="z" writable="1">
        <doc xml:space="preserve">based on the angle of rotation and z component of the axis of
    rotation it is sin(𝜃/2)*axis.z</doc>
      ...
      <method name="copy" c:identifier="cogl_quaternion_copy" version="2.0">
        <doc xml:space="preserve">Allocates a new #CoglQuaternion on the stack and initializes it with
the same values as @src.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglQuaternion which should be freed
using cogl_quaternion_free()</doc>
      ...
      <method name="free" c:identifier="cogl_quaternion_free" version="2.0">
        <doc xml:space="preserve">Frees a #CoglQuaternion that was previously allocated via
      ...
      <method name="get_rotation_axis"
        ...
        <parameters>
          ...
          <parameter name="vector3"
                     ...
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">an allocated 3-float array</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init" c:identifier="cogl_quaternion_init" version="2.0">
        <doc xml:space="preserve">Initializes a quaternion that rotates @angle degrees around the
...
rotated @angle degrees around the axis vector (@x, @y, @z)</doc>
        ...
        <parameters>
          <instance-parameter name="quaternion" transfer-ownership="none">
            <doc xml:space="preserve">An uninitialized #CoglQuaternion</doc>
            <type name="Quaternion" c:type="CoglQuaternion*"/>
          </instance-parameter>
          <parameter name="angle" transfer-ownership="none">
            <doc xml:space="preserve">The angle you want to rotate around the given axis</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="x" transfer-ownership="none">
            <doc xml:space="preserve">The x component of your axis vector about which you want to
rotate.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="y" transfer-ownership="none">
            <doc xml:space="preserve">The y component of your axis vector about which you want to
rotate.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="z" transfer-ownership="none">
            <doc xml:space="preserve">The z component of your axis vector about which you want to
rotate.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
...
rotated @angle degrees around the given @axis vector.</doc>
        ...
        <parameters>
          ...
          <parameter name="angle" transfer-ownership="none">
            <doc xml:space="preserve">The angle to rotate around @axis3f</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
          <parameter name="axis3f" transfer-ownership="none">
            <doc xml:space="preserve">your 3 component axis vector about which you want to rotate.</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_array"
              ...
              version="2.0">
        <doc xml:space="preserve">Initializes a [w (x, y,z)] quaternion directly from an array of 4
floats: [w,x,y,z].</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="array" transfer-ownership="none">
            <doc xml:space="preserve">An array of 4 floats w,(x,y,z)</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_euler"
        ...
        <parameters>
          ...
          <parameter name="euler" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglEuler with which to initialize the quaternion</doc>
            <type name="Euler" c:type="const CoglEuler*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_matrix"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Initializes a quaternion from a rotation matrix.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="quaternion" transfer-ownership="none">
            <doc xml:space="preserve">A Cogl Quaternion</doc>
            <type name="Quaternion" c:type="CoglQuaternion*"/>
          </instance-parameter>
          <parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">A rotation matrix with which to initialize the quaternion</doc>
            <type name="Matrix" c:type="const CoglMatrix*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_quaternion"
        ...
        <parameters>
          ...
          <parameter name="src" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglQuaternion with which to initialize @quaternion</doc>
            <type name="Quaternion" c:type="CoglQuaternion*"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_x_rotation"
              ...
              version="2.0">
        <doc xml:space="preserve">XXX: check which direction this rotates</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="angle" transfer-ownership="none">
            <doc xml:space="preserve">The angle to rotate around the x axis</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_y_rotation"
        ...
        <parameters>
          ...
          <parameter name="angle" transfer-ownership="none">
            <doc xml:space="preserve">The angle to rotate around the y axis</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_from_z_rotation"
        ...
        <parameters>
          ...
          <parameter name="angle" transfer-ownership="none">
            <doc xml:space="preserve">The angle to rotate around the z axis</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
      <method name="init_identity"
              ...
              version="2.0">
        <doc xml:space="preserve">Initializes the quaternion with the canonical quaternion identity
...
cogl_get_static_identity_quaternion().</doc>
      ...
      <method name="multiply"
              ...
              version="2.0">
        <doc xml:space="preserve">This combines the rotations of two quaternions into @result. The
...
@result can be equal to @a but can't be equal to @b.&lt;/note&gt;</doc>
        ...
        <parameters>
          <instance-parameter name="result" transfer-ownership="none">
            <doc xml:space="preserve">The destination #CoglQuaternion</doc>
            <type name="Quaternion" c:type="CoglQuaternion*"/>
          </instance-parameter>
          <parameter name="left" transfer-ownership="none">
            <doc xml:space="preserve">The second #CoglQuaternion rotation to apply</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
          <parameter name="right" transfer-ownership="none">
            <doc xml:space="preserve">The first #CoglQuaternion rotation to apply</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
        </parameters>
      </method>
      <method name="nlerp" c:identifier="cogl_quaternion_nlerp">
        <doc xml:space="preserve">Performs a normalized linear interpolation between two quaternions.
...
&lt;/itemizedlist&gt;</doc>
        ...
        <parameters>
          ...
          <parameter name="a" transfer-ownership="none">
            <doc xml:space="preserve">The first #CoglQuaternion</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
          <parameter name="b" transfer-ownership="none">
            <doc xml:space="preserve">The second #CoglQuaternion</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
          <parameter name="t" transfer-ownership="none">
            <doc xml:space="preserve">The factor in the range [0,1] used to interpolate between
      ...
      <method name="pow" c:identifier="cogl_quaternion_pow" version="2.0">
        ...
        <parameters>
          ...
          <parameter name="exponent" transfer-ownership="none">
            <doc xml:space="preserve">the exponent</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
      <method name="slerp" c:identifier="cogl_quaternion_slerp">
        <doc xml:space="preserve">Performs a spherical linear interpolation between two quaternions.
      ...
      <method name="squad" c:identifier="cogl_quaternion_squad" version="2.0">
        ...
        <parameters>
          ...
          <parameter name="prev" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglQuaternion used before @a</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
          <parameter name="a" transfer-ownership="none">
            <doc xml:space="preserve">The first #CoglQuaternion</doc>
          ...
          <parameter name="next" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglQuaternion that will be used after @b</doc>
            <type name="Quaternion" c:type="const CoglQuaternion*"/>
          </parameter>
          <parameter name="t" transfer-ownership="none">
            <doc xml:space="preserve">The factor in the range [0,1] used to interpolate between
quaternion @a and @b.</doc>
      ...
      <function name="equal"
                ...
                version="2.0">
        <doc xml:space="preserve">Compares that all the components of quaternions @a and @b are
equal.
...
equal.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the quaternions are equal else %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          <parameter name="v1" transfer-ownership="none">
    ...
    <class name="Renderer"
      ...
      <constructor name="new"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Instantiates a new (unconnected) #CoglRenderer object. A
...
display.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly created #CoglRenderer.</doc>
          <type name="Renderer" c:type="CoglRenderer*"/>
        </return-value>
      </constructor>
      <method name="add_constraint"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This adds a renderer selection @constraint.
...
depend on to ensure maximum portability.</doc>
        ...
        <parameters>
          <instance-parameter name="renderer" transfer-ownership="none">
            <doc xml:space="preserve">An unconnected #CoglRenderer</doc>
            <type name="Renderer" c:type="CoglRenderer*"/>
          </instance-parameter>
          <parameter name="constraint" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglRendererConstraint to add</doc>
      ...
      <method name="check_onscreen_template"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">Tests if a given @onscreen_template can be supported with the given
@renderer.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the @onscreen_template can be supported,
              else %FALSE.</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
      ...
      <method name="connect"
              ...
              stability="Unstable"
              throws="1">
        <doc xml:space="preserve">Connects the configured @renderer. Renderer connection isn't a
...
usable driver and window system backend can be found.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if there was no error while connecting the
      ...
      <method name="foreach_output"
              ...
              version="1.14"
              stability="Unstable">
        <doc xml:space="preserve">Iterates all known display outputs for the given @renderer and
...
for each one, along with the given @user_data.</doc>
        ...
        <parameters>
          <instance-parameter name="renderer" transfer-ownership="none">
            <doc xml:space="preserve">A connected #CoglRenderer</doc>
            <type name="Renderer" c:type="CoglRenderer*"/>
          </instance-parameter>
          <parameter name="callback"
                     transfer-ownership="none"
                     scope="call"
                     closure="1">
            <doc xml:space="preserve">A #CoglOutputCallback to be called for
      ...
      <method name="get_driver"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Queries what underlying driver is being used by Cogl.
...
This may only be called on a connected #CoglRenderer.</doc>
      ...
      <method name="get_n_fragment_texture_units"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Queries how many texture units can be used from fragment programs</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the number of texture image units.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="renderer" transfer-ownership="none">
      ...
      <method name="get_winsys_id" c:identifier="cogl_renderer_get_winsys_id">
        <doc xml:space="preserve">Queries which window system backend Cogl has chosen to use.

This may only be called on a connected #CoglRenderer.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The #CoglWinsysID corresponding to the chosen window
         system backend.</doc>
      ...
      <method name="remove_constraint"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">This removes a renderer selection @constraint.
...
depend on to ensure maximum portability.</doc>
        ...
        <parameters>
          ...
          <parameter name="constraint" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglRendererConstraint to remove</doc>
            <type name="RendererConstraint" c:type="CoglRendererConstraint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_driver"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Requests that Cogl should try to use a specific underlying driver
for rendering.
...
This may only be called on an un-connected #CoglRenderer.</doc>
      ...
      <method name="set_winsys_id" c:identifier="cogl_renderer_set_winsys_id">
        <doc xml:space="preserve">This allows you to explicitly select a winsys backend to use instead
...
This may only be called on an un-connected #CoglRenderer.</doc>
        ...
        <parameters>
          ...
          <parameter name="winsys_id" transfer-ownership="none">
            <doc xml:space="preserve">An ID of the winsys you explicitly want to use.</doc>
            <type name="WinsysID" c:type="CoglWinsysID"/>
          </parameter>
        </parameters>
      </method>
    ...
    <bitfield name="RendererConstraint"
      ...
      <doc xml:space="preserve">These constraint flags are hard-coded features of the different renderer
...
they depend on to ensure maximum portability.</doc>
   ...
   code into Cogl based applications.</doc>
    ...
    <class name="Snippet"
      ...
      <constructor name="new"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Allocates and initializes a new snippet with the given source strings.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a pointer to a new #CoglSnippet</doc>
          <type name="Snippet" c:type="CoglSnippet*"/>
        </return-value>
        <parameters>
          <parameter name="hook" transfer-ownership="none">
            <doc xml:space="preserve">The point in the pipeline that this snippet will wrap around
  or replace.</doc>
            <type name="SnippetHook" c:type="CoglSnippetHook"/>
          </parameter>
          <parameter name="declarations" transfer-ownership="none">
            <doc xml:space="preserve">The source code for the declarations for this
  snippet or %NULL. See cogl_snippet_set_declarations().</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="post" transfer-ownership="none">
            <doc xml:space="preserve">The source code to run after the hook point where this
  shader snippet is attached or %NULL. See cogl_snippet_set_post().</doc>
      ...
      <method name="get_declarations"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the source string that was set with
  cogl_snippet_set_declarations() or %NULL if none was set.</doc>
      ...
      <method name="get_hook"
              ...
              stability="Unstable">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the hook that was set when cogl_snippet_new() was
  called.</doc>
          <type name="SnippetHook" c:type="CoglSnippetHook"/>
        </return-value>
        <parameters>
  ...
  cogl_snippet_set_replace() or %NULL if none was set.</doc>
      ...
      <method name="set_declarations"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets a source string that will be inserted in the global scope of
...
immutable.</doc>
        ...
        <parameters>
          ...
          <parameter name="declarations" transfer-ownership="none">
            <doc xml:space="preserve">The new source string for the declarations section
  of this snippet.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      ...
      <method name="set_post"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets a source string that will be inserted after the hook point in
...
immutable.</doc>
        ...
        <parameters>
          ...
          <parameter name="post" transfer-ownership="none">
            <doc xml:space="preserve">The new source string for the post section of this snippet.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_pre"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets a source string that will be inserted before the hook point in
the generated shader for the pipeline that this snippet is attached
to. Please see the documentation of each hook point in
#CoglPipeline for a description of how this string should be used.
...
immutable.</doc>
        ...
        <parameters>
          ...
          <parameter name="pre" transfer-ownership="none">
            <doc xml:space="preserve">The new source string for the pre section of this snippet.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_replace"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Sets a source string that will be used instead of any generated
...
immutable.</doc>
        ...
        <parameters>
          ...
          <parameter name="replace" transfer-ownership="none">
            <doc xml:space="preserve">The new source string for the replace section of this snippet.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
    ...
    <enumeration name="SnippetHook"
      ...
      <doc xml:space="preserve">#CoglSnippetHook is used to specify a location within a
...
&lt;/glosslist&gt;</doc>
      <member name="vertex" value="0" c:identifier="COGL_SNIPPET_HOOK_VERTEX">
        <doc xml:space="preserve">A hook for the entire vertex processing
  stage of the pipeline.</doc>
      </member>
      <member name="vertex_transform"
              value="1"
              c:identifier="COGL_SNIPPET_HOOK_VERTEX_TRANSFORM">
        <doc xml:space="preserve">A hook for the vertex transformation.</doc>
      </member>
      <member name="vertex_globals"
              value="2"
              c:identifier="COGL_SNIPPET_HOOK_VERTEX_GLOBALS">
        <doc xml:space="preserve">A hook for declaring global data
  ...
  hook.</doc>
      ...
      <member name="point_size"
        ...
        <doc xml:space="preserve">A hook for manipulating the point
  ...
  fragment hook.</doc>
      ...
      <member name="texture_coord_transform"
        ...
        <doc xml:space="preserve">A hook for applying the
...
of a stereo framebuffer. See cogl_framebuffer_set_stereo_mode().</doc>
    ...
    <class name="SubTexture"
      ...
      <constructor name="new"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a high-level #CoglSubTexture representing a sub-region of
...
low-level texture before drawing.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglSubTexture
        ...
        <parameters>
          ...
          <parameter name="parent_texture" transfer-ownership="none">
            <doc xml:space="preserve">The full texture containing a sub-region you want
                 to make a #CoglSubTexture from.</doc>
            <type name="Texture" c:type="CoglTexture*"/>
          </parameter>
          <parameter name="sub_x" transfer-ownership="none">
            <doc xml:space="preserve">The top-left x coordinate of the parent region to make
        a texture from.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="sub_y" transfer-ownership="none">
            <doc xml:space="preserve">The top-left y coordinate of the parent region to make
        a texture from.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="sub_width" transfer-ownership="none">
            <doc xml:space="preserve">The width of the parent region to make a texture from.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="sub_height" transfer-ownership="none">
            <doc xml:space="preserve">The height of the parent region to make a texture
             from.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      ...
      <method name="get_parent"
              ...
              version="1.10"
              stability="Unstable">
        <doc xml:space="preserve">Retrieves the parent texture that @sub_texture derives its content
from.  This is the texture that was passed to
cogl_sub_texture_new() as the parent_texture argument.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The parent texture that @sub_texture
              derives its content from.</doc>
          <type name="Texture" c:type="CoglTexture*"/>
        </return-value>
        <parameters>
          <instance-parameter name="sub_texture" transfer-ownership="none">
            <doc xml:space="preserve">A pointer to a #CoglSubTexture</doc>
            <type name="SubTexture" c:type="CoglSubTexture*"/>
          </instance-parameter>
        </parameters>
      </method>
    ...
    <enumeration name="SubpixelOrder"
      ...
      <doc xml:space="preserve">Some output devices (such as LCD panels) display colors
...
pixel grid.</doc>
  ...
  match any of the values in the enumeration.</doc>
      ...
      <member name="horizontal_rgb"
        ...
        <doc xml:space="preserve">the device has
...
as the texture's components.</doc>
      ...
      <method name="set_data" c:identifier="cogl_texture_set_data" throws="1">
        <doc xml:space="preserve">@texture a #CoglTexture.
...
not enough memory to allocate storage for @texture.&lt;/note&gt;</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the data upload was successful, and
              %FALSE otherwise</doc>
          <type name="Bool" c:type="CoglBool"/>
        </return-value>
        <parameters>
          ...
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">the #CoglPixelFormat used in the source @data buffer.</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
          <parameter name="rowstride" transfer-ownership="none">
            <doc xml:space="preserve">rowstride of the source @data buffer (computed from
            the texture width and @format if it equals 0)</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">the source data, pointing to the first top-left pixel to set</doc>
            <type name="guint8" c:type="const uint8_t*"/>
          </parameter>
          <parameter name="level" transfer-ownership="none">
            <doc xml:space="preserve">The mipmap level to update (Normally 0 for the largest,
        base texture)</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
...
specified)</doc>
      ...
      <method name="set_region_from_bitmap"
              ...
              version="1.8"
              stability="Unstable">
        <doc xml:space="preserve">Copies a specified source region from @bitmap to the position
...
bitmap&lt;/note&gt;</doc>
  ...
  %FALSE otherwise</doc>
        ...
        <parameters>
          ...
          <parameter name="src_x" transfer-ownership="none">
            <doc xml:space="preserve">upper left coordinate to use from the source bitmap.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="src_y" transfer-ownership="none">
            <doc xml:space="preserve">upper left coordinate to use from the source bitmap</doc>
  ...
  than or equal to the bitmap height)</doc>
          ...
          <parameter name="bitmap" transfer-ownership="none">
            <doc xml:space="preserve">The source bitmap to read from</doc>
            <type name="Bitmap" c:type="CoglBitmap*"/>
          </parameter>
        </parameters>
      </method>
    ...
    <class name="Texture2D"
      ...
      <constructor name="gl_new_from_foreign"
                   ...
                   version="2.0">
        <doc xml:space="preserve">Wraps an existing GL_TEXTURE_2D texture object as a #CoglTexture2D.
...
geometry.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglTexture2D</doc>
        ...
        <parameters>
          ...
          <parameter name="gl_handle" transfer-ownership="none">
            <doc xml:space="preserve">A GL handle for a GL_TEXTURE_2D texture object</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">Width of the foreign GL texture</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">Height of the foreign GL texture</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="format" transfer-ownership="none">
            <doc xml:space="preserve">The format of the texture</doc>
            <type name="PixelFormat" c:type="CoglPixelFormat"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_from_bitmap"
                   ...
                   version="2.0"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a low-level #CoglTexture2D texture based on data residing
in a #CoglBitmap.
...
cogl_has_feature().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly allocated #CoglTexture2D, or if
        ...
        <parameters>
          ...
          <parameter name="rowstride" transfer-ownership="none">
            <doc xml:space="preserve">the memory offset in bytes between the starts of
   scanlines in @data. A value of 0 will make Cogl automatically
   calculate @rowstride from @width and @format.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">pointer the memory region where the source buffer resides</doc>
            <type name="guint8" c:type="const uint8_t*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_from_file"
                   ...
                   version="1.16"
                   throws="1">
        <doc xml:space="preserve">Creates a low-level #CoglTexture2D texture from an image file.
...
cogl_has_feature().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly created #CoglTexture2D or %NULL on failure
      ...
      <constructor name="new_with_size"
                   ...
                   version="2.0">
        <doc xml:space="preserve">Creates a low-level #CoglTexture2D texture with a given @width and
...
cogl_has_feature().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglTexture2D object with no storage yet allocated.</doc>
          <type name="Texture2D" c:type="CoglTexture2D*"/>
        </return-value>
        <parameters>
          <parameter name="ctx" transfer-ownership="none">
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">Width of the texture to allocate</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">Height of the texture to allocate</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </constructor>
    ...
    <class name="Texture2DSliced"
      ...
      <constructor name="new_from_bitmap"
                   ...
                   version="1.16">
        <doc xml:space="preserve">Creates a new #CoglTexture2DSliced texture based on data residing
in a bitmap.
...
the texture size would be too large to handle.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A newly created #CoglTexture2DSliced
        ...
        <parameters>
          ...
          <parameter name="max_waste" transfer-ownership="none">
            <doc xml:space="preserve">The threshold of how wide a strip of wasted texels
...
would be too large to handle.&lt;/note&gt;</doc>
   ...
   calculate @rowstride from @width and @format.</doc>
      ...
      <constructor name="new_from_file"
                   ...
                   version="1.16"
                   throws="1">
        <doc xml:space="preserve">Creates a #CoglTexture2DSliced from an image file.
...
the texture size would be too large to handle.&lt;/note&gt;</doc>
      ...
      <constructor name="new_with_size"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a #CoglTexture2DSliced that may internally be comprised of
...
the texture size would be too large to handle.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglTexture2DSliced object with no storage
         allocated yet.</doc>
          <type name="Texture2DSliced" c:type="CoglTexture2DSliced*"/>
        </return-value>
        <parameters>
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The virtual width of your sliced texture.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The virtual height of your sliced texture.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="max_waste" transfer-ownership="none">
            <doc xml:space="preserve">The threshold of how wide a strip of wasted texels
    ...
    <class name="Texture3D"
      ...
      <constructor name="new_from_bitmap"
                   ...
                   version="2.0"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a low-level 3D texture and initializes it with the images
...
GPU.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly created #CoglTexture3D</doc>
          <type name="Texture3D" c:type="CoglTexture3D*"/>
        </return-value>
        <parameters>
          <parameter name="bitmap" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglBitmap object.</doc>
            <type name="Bitmap" c:type="CoglBitmap*"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">height of the texture in pixels.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="depth" transfer-ownership="none">
            <doc xml:space="preserve">depth of the texture in pixels.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_from_data"
                   ...
                   stability="Unstable"
                   throws="1">
        <doc xml:space="preserve">Creates a low-level 3D texture and initializes it with @data. The
...
cogl_texture_3d_new_from_bitmap().&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">the newly created #CoglTexture3D or
        ...
        <parameters>
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">width of the texture in pixels.</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">height of the texture in pixels.</doc>
   ...
   scanlines in @data or 0 to infer it from the width and format</doc>
          ...
          <parameter name="image_stride" transfer-ownership="none">
            <doc xml:space="preserve">the number of bytes from one image to the next. This
   ...
   from the @height.</doc>
      ...
      <constructor name="new_with_size"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a low-level #CoglTexture3D texture with the specified
...
GPU.&lt;/note&gt;</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglTexture3D object with no storage yet allocated.</doc>
          <type name="Texture3D" c:type="CoglTexture3D*"/>
        </return-value>
        <parameters>
          <parameter name="context" transfer-ownership="none">
  ...
  the texture atlas used by Cogl</doc>
    ...
    <class name="TextureRectangle"
      ...
      <constructor name="new_from_bitmap"
                   ...
                   version="2.0"
                   stability="Unstable">
        <doc xml:space="preserve">Allocates a new #CoglTextureRectangle texture which will be
...
allocated.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A pointer to a new
      ...
      <constructor name="new_from_foreign"
        ...
        <doc xml:space="preserve">Wraps an existing GL_TEXTURE_RECTANGLE texture object as a
...
with cogl_texture_set_premultiplied().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #CoglTextureRectangle texture</doc>
          <type name="TextureRectangle" c:type="CoglTextureRectangle*"/>
        </return-value>
        <parameters>
          <parameter name="ctx" transfer-ownership="none">
          ...
          <parameter name="gl_handle" transfer-ownership="none">
            <doc xml:space="preserve">A GL handle for a GL_TEXTURE_RECTANGLE texture object</doc>
            <type name="guint" c:type="unsigned int"/>
          </parameter>
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">Width of the foreign GL texture</doc>
      ...
      <constructor name="new_with_size"
                   ...
                   version="1.10"
                   stability="Unstable">
        <doc xml:space="preserve">Creates a new #CoglTextureRectangle texture with a given @width,
...
allocated.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A pointer to a new #CoglTextureRectangle
        ...
        <parameters>
          ...
          <parameter name="width" transfer-ownership="none">
            <doc xml:space="preserve">The texture width to allocate</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="height" transfer-ownership="none">
            <doc xml:space="preserve">The texture height to allocate</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </constructor>
...
#CoglTexture.</doc>
  ...
  use_color is %FALSE when calling cogl_polygon()</doc>
    ...
    <record name="UserDataKey" c:type="CoglUserDataKey" version="1.4">
      <doc xml:space="preserve">A #CoglUserDataKey is used to declare a key for attaching data to a
...
my_path_set_data (CoglPath *path, void *data)
{
  cogl_object_set_user_data (COGL_OBJECT (path),
    ...
    <record name="VertexP2"
            ...
            version="1.6"
            stability="Unstable">
      <doc xml:space="preserve">A convenience vertex definition that can be used with
cogl_primitive_new_p2().</doc>
      <field name="x" writable="1">
        <doc xml:space="preserve">The x component of a position attribute</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="y" writable="1">
        <doc xml:space="preserve">The y component of a position attribute</doc>
        <type name="gfloat" c:type="float"/>
      </field>
    </record>
...
cogl_primitive_new_p2c4().</doc>
      ...
      <field name="r" writable="1">
        <doc xml:space="preserve">The red component of a color attribute</doc>
        <type name="guint8" c:type="uint8_t"/>
      </field>
      <field name="g" writable="1">
        <doc xml:space="preserve">The blue component of a color attribute</doc>
        <type name="guint8" c:type="uint8_t"/>
      </field>
      <field name="b" writable="1">
        <doc xml:space="preserve">The green component of a color attribute</doc>
        <type name="guint8" c:type="uint8_t"/>
      </field>
      <field name="a" writable="1">
        <doc xml:space="preserve">The alpha component of a color attribute</doc>
        <type name="guint8" c:type="uint8_t"/>
      </field>
    </record>
...
cogl_primitive_new_p2t2().</doc>
      ...
      <field name="s" writable="1">
        <doc xml:space="preserve">The s component of a texture coordinate attribute</doc>
        <type name="gfloat" c:type="float"/>
      </field>
      <field name="t" writable="1">
        <doc xml:space="preserve">The t component of a texture coordinate attribute</doc>
        <type name="gfloat" c:type="float"/>
      </field>
    </record>
...
cogl_primitive_new_p3().</doc>
      ...
      <field name="z" writable="1">
        <doc xml:space="preserve">The z component of a position attribute</doc>
        <type name="gfloat" c:type="float"/>
      </field>
    </record>
...
&lt;constant&gt;GL_TRIANGLE_STRIP&lt;/constant&gt;</doc>
    ...
    <callback name="Win32FilterFunc"
              c:type="CoglWin32FilterFunc"
              introspectable="0">
      <doc xml:space="preserve">A callback function that can be registered with
cogl_win32_renderer_add_filter(). The function should return
%COGL_FILTER_REMOVE if it wants to prevent further processing or
%COGL_FILTER_CONTINUE otherwise.</doc>
      <return-value transfer-ownership="none">
...
cogl_pipeline_set_front_face_winding().</doc>
    ...
    <enumeration name="WinsysID" c:type="CoglWinsysID">
      <doc xml:space="preserve">Identifies specific window system backends that Cogl supports.
...
explicitly select a backend to use.</doc>
      <member name="any" value="0" c:identifier="COGL_WINSYS_ID_ANY">
        <doc xml:space="preserve">Implies no preference for which backend is used</doc>
      </member>
      <member name="stub" value="1" c:identifier="COGL_WINSYS_ID_STUB">
        <doc xml:space="preserve">Use the no-op stub backend</doc>
      </member>
      <member name="glx" value="2" c:identifier="COGL_WINSYS_ID_GLX">
        <doc xml:space="preserve">Use the GLX window system binding API</doc>
      </member>
      <member name="egl_xlib" value="3" c:identifier="COGL_WINSYS_ID_EGL_XLIB">
        <doc xml:space="preserve">Use EGL with the X window system via XLib</doc>
      </member>
      <member name="egl_null" value="4" c:identifier="COGL_WINSYS_ID_EGL_NULL">
        <doc xml:space="preserve">Use EGL with the PowerVR NULL window system</doc>
      </member>
      <member name="egl_gdl" value="5" c:identifier="COGL_WINSYS_ID_EGL_GDL">
        <doc xml:space="preserve">Use EGL with the GDL platform</doc>
      </member>
      <member name="egl_wayland"
              value="6"
              c:identifier="COGL_WINSYS_ID_EGL_WAYLAND">
        <doc xml:space="preserve">Use EGL with the Wayland window system</doc>
      </member>
      <member name="egl_kms" value="7" c:identifier="COGL_WINSYS_ID_EGL_KMS">
        <doc xml:space="preserve">Use EGL with the KMS platform</doc>
      </member>
      <member name="egl_android"
              value="8"
              c:identifier="COGL_WINSYS_ID_EGL_ANDROID">
        <doc xml:space="preserve">Use EGL with the Android platform</doc>
      </member>
      <member name="egl_mir" value="9" c:identifier="COGL_WINSYS_ID_EGL_MIR">
        <doc xml:space="preserve">Use EGL with the Mir server</doc>
      </member>
      <member name="wgl" value="10" c:identifier="COGL_WINSYS_ID_WGL">
        <doc xml:space="preserve">Use the Microsoft Windows WGL binding API</doc>
      </member>
      <member name="sdl" value="11" c:identifier="COGL_WINSYS_ID_SDL">
        <doc xml:space="preserve">Use the SDL window system</doc>
      </member>
    </enumeration>
    ...
    <function name="buffer_get_size"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Retrieves the size of buffer</doc>
      <return-value transfer-ownership="none">
    ...
    <function name="buffer_get_update_hint"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Retrieves the update hints set using cogl_buffer_set_update_hint()</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the #CoglBufferUpdateHint currently used by the buffer</doc>
    ...
    <function name="buffer_map"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Maps the buffer into the application address space for direct
...
release your last reference while the buffer is mapped.</doc>
      ...
      <parameters>
        ...
        <parameter name="hints" transfer-ownership="none">
          <doc xml:space="preserve">A mask of #CoglBufferMapHint&lt;!-- --&gt;s that tell Cogl how
  the data will be modified once mapped.</doc>
    ...
    <function name="buffer_map_range"
              ...
              stability="Unstable"
              throws="1">
      <doc xml:space="preserve">Maps a sub-region of the buffer into the application's address space
for direct access.
...
release your last reference while the buffer is mapped.</doc>
  ...
  the data will be modified once mapped.</doc>
    ...
    <function name="buffer_set_data"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Updates part of the buffer with new data from @data. Where to put this new
data is controlled by @offset and @offset + @data should be less than the
buffer size.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE is the operation succeeded, %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        <parameter name="buffer" transfer-ownership="none">
    ...
    <function name="buffer_set_update_hint"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Sets the update hint on a buffer. See #CoglBufferUpdateHint for a description
of the available hints.</doc>
      ...
      <parameters>
        ...
        <parameter name="hint" transfer-ownership="none">
          <doc xml:space="preserve">the new hint</doc>
          <type name="BufferUpdateHint" c:type="CoglBufferUpdateHint"/>
        </parameter>
      </parameters>
    </function>
    <function name="buffer_unmap"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Unmaps a buffer previously mapped by cogl_buffer_map().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
...
values into a #CoglColor.</doc>
    ...
    <function name="debug_matrix_entry_print"
      ...
      <doc xml:space="preserve">Allows visualizing the operations that build up the given @entry
for debugging purposes by printing to stdout.</doc>
    ...
    <function name="debug_object_foreach_type"
              ...
              version="1.8"
              stability="Unstable">
      <doc xml:space="preserve">Invokes @func once for each type of object that Cogl uses and
...
issues with objects leaking.</doc>
      ...
      <parameters>
        <parameter name="func"
                   ...
                   scope="call"
                   closure="1">
          <doc xml:space="preserve">A callback function for each type</doc>
    ...
    <function name="debug_object_print_instances"
              ...
              version="1.8"
              stability="Unstable">
      <doc xml:space="preserve">Prints a list of all the object types that Cogl uses along with the
...
issues with objects leaking.</doc>
    ...
    <function name="error_copy" c:identifier="cogl_error_copy">
      <doc xml:space="preserve">Makes a copy of @error which can later be freed using
cogl_error_free().</doc>
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">A newly allocated #CoglError initialized to match the
              contents of @error.</doc>
        <type name="GLib.Error" c:type="GError*"/>
      </return-value>
      <parameters>
        <parameter name="error" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglError thrown by the Cogl api</doc>
          <type name="GLib.Error" c:type="GError*"/>
        </parameter>
      </parameters>
    </function>
    <function name="error_free" c:identifier="cogl_error_free">
      <doc xml:space="preserve">Frees a #CoglError and associated resources.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
    ...
    <function name="error_matches" c:identifier="cogl_error_matches">
      <doc xml:space="preserve">Returns %TRUE if error matches @domain and @code, %FALSE otherwise.
In particular, when error is %NULL, FALSE will be returned.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">whether the @error corresponds to the given @domain
              and @code.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        <parameter name="error" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglError thrown by the Cogl api or %NULL</doc>
          <type name="GLib.Error" c:type="GError*"/>
        </parameter>
...
can be represented with different component rotations&lt;/note&gt;</doc>
    ...
    <function name="foreach_feature"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Iterates through all the context level features currently supported
for a given @context and for each feature @callback is called.</doc>
      ...
      <parameters>
        ...
        <parameter name="callback"
                   ...
                   scope="call"
                   closure="2">
          <doc xml:space="preserve">A #CoglFeatureCallback called for each
    ...
    <function name="get_clock_time"
              ...
              version="1.14"
              stability="Unstable">
      <doc xml:space="preserve">Returns the current time value from Cogl's internal clock. This
...
may return 0 to indicate that Cogl has no active internal clock.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">the time value for the Cogl clock, in nanoseconds
 ...
 active internal clock.</doc>
    ...
    <function name="get_draw_framebuffer"
              ...
              version="1.8"
              stability="Unstable">
      <doc xml:space="preserve">Gets the current #CoglFramebuffer as set using
cogl_push_framebuffer()</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">The current #CoglFramebuffer</doc>
        <type name="Framebuffer" c:type="CoglFramebuffer*"/>
      </return-value>
    </function>
    ...
    <function name="get_static_identity_quaternion"
              ...
              version="2.0">
      <doc xml:space="preserve">Returns a pointer to a singleton quaternion constant describing the
...
get back the same value as the original quaternion.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A pointer to an identity quaternion</doc>
        <type name="Quaternion" c:type="const CoglQuaternion*"/>
      </return-value>
    </function>
    <function name="get_static_zero_quaternion"
              ...
              version="2.0">
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">a pointer to a singleton quaternion constant describing a
    ...
    <function name="gles2_get_current_vtable"
              ...
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Returns the OpenGL ES 2.0 api vtable for the currently pushed
#CoglGLES2Context (last pushed with cogl_push_gles2_context()) or
%NULL if no #CoglGLES2Context has been pushed.</doc>
      <return-value>
        <doc xml:space="preserve">The #CoglGLES2Vtable for the currently pushed
    ...
    <function name="gles2_texture_2d_new_from_handle"
              ...
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Creates a #CoglTexture2D from an OpenGL ES 2.0 texture handle that
...
api.&lt;/note&gt;</doc>
      ...
      <parameters>
        ...
        <parameter name="handle" transfer-ownership="none">
          <doc xml:space="preserve">An OpenGL ES 2.0 texture handle created with
         glGenTextures()</doc>
          <type name="guint" c:type="unsigned int"/>
        </parameter>
        <parameter name="width" transfer-ownership="none">
    ...
    <function name="gles2_texture_get_handle"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Gets an OpenGL ES 2.0 texture handle for a #CoglTexture that can
...
a #CoglGLES2Vtable or via libcogl-gles2.&lt;/note&gt;</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if a handle and target could be returned
      ...
      <parameters>
        ...
        <parameter name="handle" transfer-ownership="none">
          <doc xml:space="preserve">A return location for an OpenGL ES 2.0 texture handle</doc>
          <type name="guint" c:type="unsigned int*"/>
        </parameter>
        <parameter name="target" transfer-ownership="none">
          <doc xml:space="preserve">A return location for an OpenGL ES 2.0 texture target</doc>
          <type name="guint" c:type="unsigned int*"/>
        </parameter>
      </parameters>
    </function>
    <function name="glib_renderer_source_new"
              ...
              version="1.16"
              stability="Unstable">
      <doc xml:space="preserve">Creates a #GSource which handles Cogl's internal system event
...
g_source_attach().</doc>
      ...
      <parameters>
        ...
        <parameter name="priority" transfer-ownership="none">
          <doc xml:space="preserve">The priority of the #GSource</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
...
count reaches 0, the resources allocated by @handle will be freed</doc>
    ...
    <function name="has_feature"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Checks if a given @feature is currently available
...
that certain features are available before depending on them.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @feature is currently supported or %FALSE if
not.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        ...
        <parameter name="feature" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglFeatureID</doc>
          <type name="FeatureID" c:type="CoglFeatureID"/>
        </parameter>
      </parameters>
    </function>
    <function name="has_features"
              ...
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Checks if a list of features are all currently available.

This checks all of the listed features using cogl_has_feature() and
returns %TRUE if all the features are available or %FALSE
otherwise.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if all the features are available, %FALSE
otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        ...
        <parameter name="..." transfer-ownership="none">
          <doc xml:space="preserve">A 0 terminated list of CoglFeatureID&lt;!-- --&gt;s</doc>
          <varargs/>
        </parameter>
      </parameters>
    </function>
    <function name="is_atlas_texture"
              ...
              version="1.16"
              stability="Unstable">
      <doc xml:space="preserve">Checks whether the given object references a #CoglAtlasTexture</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the passed object represents an atlas
  texture and %FALSE otherwise</doc>
    ...
    <function name="is_attribute" c:identifier="cogl_is_attribute">
      <doc xml:space="preserve">Gets whether the given object references a #CoglAttribute.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglAttribute,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_attribute_buffer"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglAttributeBuffer.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if @object references a #CoglAttributeBuffer,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
  ...
  and %FALSE otherwise</doc>
    ...
    <function name="is_buffer"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Checks whether @buffer is a buffer object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the handle is a CoglBuffer, and %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        <parameter name="object" transfer-ownership="none">
    ...
    <function name="is_context"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references an existing context object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglContext,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_display"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglDisplay.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglDisplay
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_frame_info"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglFrameInfo.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglFrameInfo
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_framebuffer"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglFramebuffer.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglFramebuffer
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_gles2_context"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglGLES2Context.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglGLES2Context
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_index_buffer"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglIndexBuffer.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglIndexBuffer,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_indices"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglIndices.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglIndices
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_matrix_stack" c:identifier="cogl_is_matrix_stack">
      <doc xml:space="preserve">Determines if the given #CoglObject refers to a #CoglMatrixStack.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if @object is a #CoglMatrixStack, otherwise
              %FALSE.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_onscreen"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglOnscreen.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglOnscreen
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_onscreen_template"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglOnscreenTemplate.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglOnscreenTemplate
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_output"
              ...
              version="1.14"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglOutput.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglOutput
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_pipeline"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given @object references an existing pipeline object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglPipeline,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_pixel_buffer"
              ...
              version="1.2"
              stability="Unstable">
      <doc xml:space="preserve">Checks whether @object is a pixel buffer.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object is a pixel buffer, and %FALSE
  otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_primitive"
              ...
              version="1.6"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglPrimitive.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglPrimitive,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_primitive_texture"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a primitive texture object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the pointer references a primitive texture, and
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_renderer"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Determines if the given @object is a #CoglRenderer</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if @object is a #CoglRenderer, else %FALSE.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        <parameter name="object" transfer-ownership="none">
    ...
    <function name="is_snippet"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given @object references an existing snippet object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the @object references a #CoglSnippet,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_sub_texture"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Checks whether @object is a #CoglSubTexture.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the passed @object represents a
  ...
  %FALSE otherwise</doc>
    ...
    <function name="is_texture_2d" c:identifier="cogl_is_texture_2d">
      <doc xml:space="preserve">Gets whether the given object references an existing #CoglTexture2D
object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglTexture2D,
  %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_texture_2d_sliced"
              ...
              version="1.10"
              stability="Unstable">
      <doc xml:space="preserve">Gets whether the given object references a #CoglTexture2DSliced.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a #CoglTexture2DSliced
  and %FALSE otherwise.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_texture_3d"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Checks whether the given object references a #CoglTexture3D</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the passed object represents a 3D texture
  and %FALSE otherwise</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
    ...
    <function name="is_texture_rectangle"
      ...
      <doc xml:space="preserve">Gets whether the given object references an existing
#CoglTextureRectangle object.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the object references a
...
inverse matrix these are not considered in the comparison.</doc>
    ...
    <function name="meta_texture_foreach_in_region"
              ...
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Allows you to manually iterate the low-level textures that define a
...
low-level texture maps to the original region.</doc>
      ...
      <parameters>
        <parameter name="meta_texture" transfer-ownership="none">
          <doc xml:space="preserve">An object implementing the #CoglMetaTexture
               interface.</doc>
          <type name="MetaTexture" c:type="CoglMetaTexture*"/>
        </parameter>
        <parameter name="tx_1" transfer-ownership="none">
          <doc xml:space="preserve">The top-left x coordinate of the region to iterate</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="ty_1" transfer-ownership="none">
          <doc xml:space="preserve">The top-left y coordinate of the region to iterate</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="tx_2" transfer-ownership="none">
          <doc xml:space="preserve">The bottom-right x coordinate of the region to iterate</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="ty_2" transfer-ownership="none">
          <doc xml:space="preserve">The bottom-right y coordinate of the region to iterate</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="wrap_s" transfer-ownership="none">
          <doc xml:space="preserve">The wrap mode for the x-axis</doc>
          <type name="PipelineWrapMode" c:type="CoglPipelineWrapMode"/>
        </parameter>
        <parameter name="wrap_t" transfer-ownership="none">
          <doc xml:space="preserve">The wrap mode for the y-axis</doc>
          <type name="PipelineWrapMode" c:type="CoglPipelineWrapMode"/>
        </parameter>
        <parameter name="callback" transfer-ownership="none" closure="8">
          <doc xml:space="preserve">A #CoglMetaTextureCallback pointer to be called
    ...
    <function name="poll_renderer_dispatch"
              ...
              version="1.16"
              stability="Unstable">
      <doc xml:space="preserve">This should be called whenever an application is woken up from
...
cogl_get_renderer().&lt;/note&gt;</doc>
      ...
      <parameters>
        ...
        <parameter name="poll_fds" transfer-ownership="none">
          <doc xml:space="preserve">An array of #CoglPollFD&lt;!-- --&gt;s describing the events
        ...
        <parameter name="n_poll_fds" transfer-ownership="none">
          <doc xml:space="preserve">The length of the @poll_fds array.</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
    <function name="poll_renderer_get_info"
              ...
              version="1.16"
              stability="Unstable">
      <doc xml:space="preserve">Is used to integrate Cogl with an application mainloop that is based
...
Cogl needs to be woken up immediately.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A "poll fd state age" that changes whenever the set
      ...
      <parameters>
        ...
        <parameter name="poll_fds" transfer-ownership="none">
          <doc xml:space="preserve">A return location for a pointer to an array
           of #CoglPollFD&lt;!-- --&gt;s</doc>
          <type name="PollFD" c:type="CoglPollFD**"/>
        </parameter>
        <parameter name="n_poll_fds" transfer-ownership="none">
          <doc xml:space="preserve">A return location for the number of entries in *@poll_fds</doc>
          <type name="gint" c:type="int*"/>
        </parameter>
        <parameter name="timeout" transfer-ownership="none">
          <doc xml:space="preserve">A return location for the maximum length of time to wait
    ...
    <function name="pop_gles2_context"
              ...
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Restores the previously active #CoglGLES2Context if there
...
cogl_push_gles2_context().</doc>
    ...
    <function name="push_gles2_context"
              ...
              stability="Unstable"
              throws="1">
      <doc xml:space="preserve">Pushes the given @gles2_ctx onto a stack associated with @ctx so
...
an error through @error.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if operation was successfull or %FALSE
      ...
      <parameters>
        ...
        <parameter name="read_buffer" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglFramebuffer to access to read operations
              such as glReadPixels. (must be a #CoglOffscreen
              framebuffer currently)</doc>
          <type name="Framebuffer" c:type="CoglFramebuffer*"/>
        </parameter>
        <parameter name="write_buffer" transfer-ownership="none">
          <doc xml:space="preserve">A #CoglFramebuffer to access for drawing operations
...
equal.</doc>
    ...
    <function name="sdl_context_new"
              c:identifier="cogl_sdl_context_new"
              version="2.0"
              introspectable="0"
              stability="Unstable"
              throws="1">
      <doc xml:space="preserve">This is a convenience function for creating a new #CoglContext for
...
cogl_sdl_renderer_set_event_type().&lt;/note&gt;</doc>
      <return-value>
        <type name="Context" c:type="CoglContext*"/>
      </return-value>
      <parameters>
        <parameter name="type" transfer-ownership="none">
          <doc xml:space="preserve">An SDL user event type between &lt;constant&gt;SDL_USEREVENT&lt;/constant&gt; and
       &lt;constant&gt;SDL_NUMEVENTS&lt;/constant&gt; - 1</doc>
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </function>
    <function name="sdl_handle_event"
              c:identifier="cogl_sdl_handle_event"
              version="2.0"
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Passes control to Cogl so that it may dispatch any internal event
callbacks in response to the given SDL @event. This function must
be called for every SDL event.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="event" transfer-ownership="none">
          <doc xml:space="preserve">An SDL event</doc>
          <type c:type="SDL_Event*"/>
        </parameter>
      </parameters>
    </function>
    <function name="sdl_idle"
              c:identifier="cogl_sdl_idle"
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Notifies Cogl that the application is idle and about to call
...
tasks.</doc>
    ...
    <function name="sdl_renderer_get_event_type"
              c:identifier="cogl_sdl_renderer_get_event_type"
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Queries what SDL user event type Cogl is using as a way to
interrupt SDL_WaitEvent(). This is set either using
cogl_sdl_context_new or by using
cogl_sdl_renderer_set_event_type().</doc>
      <return-value transfer-ownership="none">
        <type name="gint" c:type="int"/>
      </return-value>
      <parameters>
    ...
    <function name="sdl_renderer_set_event_type"
              c:identifier="cogl_sdl_renderer_set_event_type"
              version="2.0"
              stability="Unstable">
      <doc xml:space="preserve">Tells Cogl what SDL user event type it can use as a way to
...
initialization.&lt;/note&gt;</doc>
    ...
    <function name="vector3_add"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Adds each of the corresponding components in vectors @a and @b
storing the results in @result.</doc>
      ...
      <parameters>
        <parameter name="result" transfer-ownership="none">
          <doc xml:space="preserve">Where you want the result written</doc>
          <type name="gfloat" c:type="float*"/>
        </parameter>
        <parameter name="a" transfer-ownership="none">
          <doc xml:space="preserve">The first vector operand</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
        <parameter name="b" transfer-ownership="none">
          <doc xml:space="preserve">The second vector operand</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_copy"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Allocates a new 3 component float vector on the heap initializing
...
cogl_vector3_free()</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">A newly allocated 3 component float vector</doc>
        <type name="gfloat" c:type="float*"/>
      </return-value>
      <parameters>
        <parameter name="vector" transfer-ownership="none">
          <doc xml:space="preserve">The 3 component vector you want to copy</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_cross_product"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Calculates the cross product between the two vectors @u and @v.
...
points along your extended thumb.</doc>
      ...
      <parameters>
        ...
        <parameter name="u" transfer-ownership="none">
          <doc xml:space="preserve">Your first 3 component vector</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
        <parameter name="v" transfer-ownership="none">
          <doc xml:space="preserve">Your second 3 component vector</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_distance"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">If you consider the two given vectors as (x,y,z) points instead
then this will compute the distance between those two points.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">The distance between two points given as 3 component
         vectors.</doc>
        <type name="gfloat" c:type="float"/>
      </return-value>
      <parameters>
        <parameter name="a" transfer-ownership="none">
          <doc xml:space="preserve">The first point</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
        <parameter name="b" transfer-ownership="none">
          <doc xml:space="preserve">The second point</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_divide_scalar"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Divides each of the @vector components by the given scalar.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="vector" transfer-ownership="none">
          <doc xml:space="preserve">The 3 component vector you want to manipulate</doc>
          <type name="gfloat" c:type="float*"/>
        </parameter>
        <parameter name="scalar" transfer-ownership="none">
          <doc xml:space="preserve">The scalar you want to divide the vector components by</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_dot_product"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Calculates the dot product of the two 3 component vectors. This
...
|[
 |a||b|cos𝜃
      ...
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">The dot product of two vectors.</doc>
        <type name="gfloat" c:type="float"/>
      </return-value>
      <parameters>
        <parameter name="a" transfer-ownership="none">
    ...
    <function name="vector3_equal"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Compares the components of two vectors and returns TRUE if they are
the same.
...
differences due to the way they have been manipulated.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">TRUE if the vectors are equal else FALSE.</doc>
        <type name="Bool" c:type="CoglBool"/>
      </return-value>
      <parameters>
        <parameter name="v1" transfer-ownership="none">
    ...
    <function name="vector3_equal_with_epsilon"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Compares the components of two vectors using the given epsilon and
  ...
  if (fabsf (vector0-&gt;x - vector1-&gt;x) &lt; epsilon)
      ...
      <parameters>
        ...
        <parameter name="epsilon" transfer-ownership="none">
          <doc xml:space="preserve">The allowable difference between components to still be
    ...
    <function name="vector3_free"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Frees a 3 component vector that was previously allocated with
cogl_vector3_copy()</doc>
      ...
      <parameters>
        <parameter name="vector" transfer-ownership="none">
          <doc xml:space="preserve">The 3 component you want to free</doc>
          <type name="gfloat" c:type="float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_init"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Initializes a 3 component, single precision float vector which can
...
can also be used in places where a "point" is often desired.</doc>
      ...
      <parameters>
        <parameter name="vector" transfer-ownership="none">
          <doc xml:space="preserve">The 3 component vector you want to initialize</doc>
          <type name="gfloat" c:type="float*"/>
        </parameter>
        <parameter name="x" transfer-ownership="none">
          <doc xml:space="preserve">The x component</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="y" transfer-ownership="none">
          <doc xml:space="preserve">The y component</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
        <parameter name="z" transfer-ownership="none">
          <doc xml:space="preserve">The z component</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_init_zero"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Initializes a 3 component, single precision float vector with zero
for each component.</doc>
    ...
    <function name="vector3_invert"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Inverts/negates all the components of the given @vector.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
    ...
    <function name="vector3_magnitude"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Calculates the scalar magnitude or length of @vector.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">The magnitude of @vector.</doc>
        <type name="gfloat" c:type="float"/>
      </return-value>
      <parameters>
        <parameter name="vector" transfer-ownership="none">
          <doc xml:space="preserve">The 3 component vector you want the magnitude for</doc>
          <type name="gfloat" c:type="const float*"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_multiply_scalar"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Multiplies each of the @vector components by the given scalar.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="scalar" transfer-ownership="none">
          <doc xml:space="preserve">The scalar you want to multiply the vector components by</doc>
          <type name="gfloat" c:type="float"/>
        </parameter>
      </parameters>
    </function>
    <function name="vector3_normalize"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Updates the vector so it is a "unit vector" such that the
...
untouched.&lt;/note&gt;</doc>
    ...
    <function name="vector3_subtract"
              ...
              version="1.4"
              stability="Unstable">
      <doc xml:space="preserve">Subtracts each of the corresponding components in vector @b from
@a storing the results in @result.</doc>
    ...
    <function name="win32_onscreen_get_window"
              c:identifier="cogl_win32_onscreen_get_window"
              version="1.10"
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Queries the internally created window HWND backing the given @onscreen
framebuffer.  If cogl_win32_onscreen_set_foreign_window() has been used then
it will return the same handle set with that API.</doc>
      <return-value>
        <type c:type="HWND"/>
      </return-value>
      <parameters>
    ...
    <function name="win32_onscreen_set_foreign_window"
              c:identifier="cogl_win32_onscreen_set_foreign_window"
              version="1.10"
              introspectable="0"
              stability="Unstable">
      <doc xml:space="preserve">Ideally we would recommend that you let Cogl be responsible for
...
foreign XID for your existing X window.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="hwnd" transfer-ownership="none">
          <doc xml:space="preserve">A win32 window handle</doc>
          <type c:type="HWND"/>
        </parameter>
      </parameters>
    </function>
    <function name="win32_renderer_add_filter"
              c:identifier="cogl_win32_renderer_add_filter"
              introspectable="0">
      <doc xml:space="preserve">Adds a callback function that will receive all native events. The
...
%COGL_FILTER_REMOVE.</doc>
    ...
    <function name="win32_renderer_handle_event"
              c:identifier="cogl_win32_renderer_handle_event"
              introspectable="0">
      <doc xml:space="preserve">This function processes a single event; it can be used to hook into
external event retrieval (for example that done by Clutter or
GDK).</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">#CoglFilterReturn. %COGL_FILTER_REMOVE indicates that
...
internal state without taking any exclusive action.</doc>
    ...
    <function name="win32_renderer_remove_filter"
              c:identifier="cogl_win32_renderer_remove_filter"
              introspectable="0">
      <doc xml:space="preserve">Removes a callback that was previously added with
cogl_win32_renderer_add_filter().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
    ...
    <function name="win32_renderer_set_event_retrieval_enabled"
              c:identifier="cogl_win32_renderer_set_event_retrieval_enabled"
              version="1.16"
              stability="Unstable">
      <doc xml:space="preserve">Sets whether Cogl should automatically retrieve messages from
...
each message if it disables automatic event retrieval.</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
