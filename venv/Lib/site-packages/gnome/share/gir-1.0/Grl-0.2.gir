...
<repository version="1.2"
  ...
  <namespace name="Grl"
             version="0.2"
             shared-library="libgrilo-0.2-1.dll"
...
freed. Use g_list_free() when done using the list.</doc>
      ...
      <method name="set_load_func" c:identifier="grl_plugin_set_load_func">
        ...
        <parameters>
          ...
          <parameter name="load_function" transfer-ownership="none">
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="set_register_keys_func"
        ...
        <parameters>
          ...
          <parameter name="register_keys_function" transfer-ownership="none">
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_unload_func" c:identifier="grl_plugin_set_unload_func">
        ...
        <parameters>
          ...
          <parameter name="unload_function" transfer-ownership="none">
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
...
Note that the @destroy_func callback is not called if @user_data is %NULL.</doc>
    ...
    <function name="operation_set_private_data"
      ...
      <parameters>
        ...
        <parameter name="private_data" transfer-ownership="none">
          <type name="gpointer" c:type="gpointer"/>
        </parameter>
