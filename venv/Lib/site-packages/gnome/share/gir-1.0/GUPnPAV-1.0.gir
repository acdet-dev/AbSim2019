...
<repository version="1.2"
  ...
  <namespace name="GUPnPAV"
             version="1.0"
             shared-library="libgupnp-av-1.0-2.dll"
    ...
    <record name="CDSLastChangeEntry"
      ...
      <doc xml:space="preserve">Opaque struct which contains information about the event.</doc>
      <method name="get_class"
              c:identifier="gupnp_cds_last_change_entry_get_class">
        <doc xml:space="preserve">Get the class of the object in this change entry. This is only
valid if gupnp_cds_last_change_entry_get_event() returns
%GUPNP_CDS_LAST_CHANGE_EVENT_OBJECT_ADDED.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The upnp class of the object of this entry.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="entry" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPCDSLastChangeEntry</doc>
      ...
      <method name="get_event"
        ...
        <doc xml:space="preserve">Get the type of the last change entry as defined in
#GUPnPCDSLastChangeEvent.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">An event from the #GUPnPCDSLastChangeEvent or
%GUPNP_CDS_LAST_CHANGE_EVENT_INVALID if the entry is not valid.</doc>
      ...
      <method name="get_object_id"
        ...
        <doc xml:space="preserve">Get the ID of the object in this change entry.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The id of the object of this entry.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="entry" transfer-ownership="none">
      ...
      <method name="get_parent_id"
        ...
        <doc xml:space="preserve">Get the parent object id of the object in this change entry. This is only
valid if gupnp_cds_last_change_entry_get_event() returns
%GUPNP_CDS_LAST_CHANGE_EVENT_OBJECT_ADDED.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The id of the object's parent of this entry.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="entry" transfer-ownership="none">
      ...
      <method name="get_update_id"
        ...
        <doc xml:space="preserve">Get the update id of the last change entry.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">update id of the entry or 0 if the entry is not valid.</doc>
      ...
      <method name="is_subtree_update"
        ...
        <doc xml:space="preserve">Returns whether this entry is part of a subtree update.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE, if the entry is part of a subtree update, %FALSE otherwise.</doc>
      ...
      <method name="ref" c:identifier="gupnp_cds_last_change_entry_ref">
        <doc xml:space="preserve">Increase reference count of a #GUPnPCDSLastChangeEntry.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The object passed in @entry.</doc>
          <type name="CDSLastChangeEntry" c:type="GUPnPCDSLastChangeEntry*"/>
        </return-value>
        <parameters>
          <instance-parameter name="entry" transfer-ownership="none">
      ...
      <method name="unref" c:identifier="gupnp_cds_last_change_entry_unref">
        <doc xml:space="preserve">Decrease reference count of a #GUPnPCDSLastChangeEntry. If the reference
...
is an object modification event.</doc>
      ...
      <member name="st_done"
        ...
        <doc xml:space="preserve">The #GUPnPCDSLastChangeEntry is a
subtree update done event.</doc>
    ...
    <class name="CDSLastChangeParser"
      ...
      <constructor name="new" c:identifier="gupnp_cds_last_change_parser_new">
        <doc xml:space="preserve">Create a new #GUPnPCDSLastChangeParser.

This parser is able to parse LastChange as defined in the
ContentDirectory:3 specification.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new instance of #GUPnPCDSLastChangeParser.</doc>
      ...
      <method name="parse"
              ...
              throws="1">
        <doc xml:space="preserve">Parse a LastChange XML document in the flavor defined by the
ContentDirectory:3 specification.</doc>
        <return-value transfer-ownership="full">
...
List of #GUPnPCDSLastChangeEntry&lt;!-- --&gt;s</doc>
        ...
        <parameters>
          <instance-parameter name="parser" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPCDSLastChangeParser</doc>
            <type name="CDSLastChangeParser"
                  c:type="GUPnPCDSLastChangeParser*"/>
          </instance-parameter>
          <parameter name="last_change" transfer-ownership="none">
            <doc xml:space="preserve">XML string to parse</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <field name="priv">
        <type name="CDSLastChangeParserPrivate"
              c:type="GUPnPCDSLastChangeParserPrivate*"/>
      </field>
    </class>
    ...
    <record name="CDSLastChangeParserPrivate"
            c:type="GUPnPCDSLastChangeParserPrivate"
            disguised="1">
    </record>
    <class name="DIDLLiteContainer"
      ...
      <method name="add_create_class"
        ...
        <doc xml:space="preserve">Add a new create class to the @container. includeDerived defaults to "0".</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="add_create_class_full"
        ...
        <doc xml:space="preserve">Add a new create class to the @container.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="include_derived" transfer-ownership="none">
            <doc xml:space="preserve">Whether object with dervied classes may be created in
this container or not.</doc>
      ...
      <method name="add_search_class"
        ...
        <doc xml:space="preserve">Add a new search class to the @container.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="search_class" transfer-ownership="none">
            <doc xml:space="preserve">The searchClass to add.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="add_search_class_full"
        ...
        <parameters>
          ...
          <parameter name="include_derived" transfer-ownership="none">
            <doc xml:space="preserve">includeDerived attribute of the DIDL</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="container_update_id_is_set"
        ...
        <doc xml:space="preserve">Get whether the container update ID of the @container is set.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if update ID is set, otherwise %FALSE</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="container" transfer-ownership="none">
      ...
      <method name="get_child_count"
        ...
        <doc xml:space="preserve">Get the child count of the @container.  If the child count is unknown, -1 is
returned.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The child count of the @container, or -1 if it is unknown.</doc>
      ...
      <method name="get_container_update_id"
        ...
        <doc xml:space="preserve">Get the container update ID of the @container.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The container update ID of the @container.</doc>
      ...
      <method name="get_create_classes"
        ...
        <doc xml:space="preserve">Gets the list of create classes of the @container.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list of create classes
...
#g_list_free the returned list after usage and unref each object in it.</doc>
      ...
      <method name="get_search_classes"
        ...
        <doc xml:space="preserve">Gets the list of search classes of the @container.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list of search classes
...
and #g_free each string in it.</doc>
      ...
      <method name="get_searchable"
        ...
        <doc xml:space="preserve">Checks whether @container is searchable.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @container is searchable.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="container" transfer-ownership="none">
      ...
      <method name="get_storage_used"
        ...
        <doc xml:space="preserve">Get the number of bytes used by all child items of the @container.
If storage used is unknown, -1 is returned.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of bytes used by all children of the @container,
or -1 if it is unknown.</doc>
      ...
      <method name="get_total_deleted_child_count"
        ...
        <doc xml:space="preserve">Get the total deleted child count of the @container.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The total deleted child count of the @container.</doc>
          <type name="guint" c:type="guint"/>
        </return-value>
        <parameters>
          <instance-parameter name="container" transfer-ownership="none">
      ...
      <method name="set_child_count"
        ...
        <doc xml:space="preserve">Set the child count of the @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="child_count" transfer-ownership="none">
            <doc xml:space="preserve">The child count</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_container_update_id"
        ...
        <doc xml:space="preserve">Set the container update ID of the @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="update_id" transfer-ownership="none">
            <doc xml:space="preserve">The container update ID</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_searchable"
        ...
        <doc xml:space="preserve">(Un)set the searchibility of @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="searchable" transfer-ownership="none">
            <doc xml:space="preserve">The searchibility</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_storage_used"
        ...
        <doc xml:space="preserve">Set the number of bytes used by all child items of the @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="storage_used" transfer-ownership="none">
            <doc xml:space="preserve">The number of bytes used by all child items of the
      ...
      <method name="total_deleted_child_count_is_set"
        ...
        <doc xml:space="preserve">Get whether the total deleted child conut of the @container is set.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if property is set, otherwise %FALSE</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="container" transfer-ownership="none">
      ...
      <method name="unset_container_update_id"
        ...
        <doc xml:space="preserve">Unset the container update ID property of the @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="unset_total_deleted_child_count"
        ...
        <doc xml:space="preserve">Unset the total deleted child count property of the @container.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <property name="child-count" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The child count of this container.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="container-update-id"
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Update ID of this container.</doc>
        <type name="guint" c:type="guint"/>
      </property>
      <property name="searchable" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Whether this container is searchable.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="storage-used" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The number of bytes used by all child items of this container.</doc>
        <type name="gint64" c:type="gint64"/>
      </property>
      <property name="total-deleted-child-count"
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Total deleted child count of this container.</doc>
        <type name="guint" c:type="guint"/>
      </property>
      <field name="parent">
    ...
    <class name="DIDLLiteContributor"
      ...
      <method name="get_name"
        ...
        <doc xml:space="preserve">Get the name of the @contributor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The name of the @contributor or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="contributor" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteContributor</doc>
      ...
      <method name="get_role"
        ...
        <doc xml:space="preserve">Get the role of the @contributor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The role of the @contributor, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="contributor" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPDIDLLiteContributor</doc>
            <type name="DIDLLiteContributor"
                  c:type="GUPnPDIDLLiteContributor*"/>
          </instance-parameter>
        </parameters>
      ...
      <method name="get_xml_node"
        ...
        <doc xml:space="preserve">Get the pointer to relevant node in XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to relevant node in XML document.</doc>
          <type name="libxml2.Node" c:type="xmlNode*"/>
        </return-value>
        <parameters>
          <instance-parameter name="contributor" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteContributor</doc>
            <type name="DIDLLiteContributor"
                  c:type="GUPnPDIDLLiteContributor*"/>
          </instance-parameter>
        </parameters>
      ...
      <method name="set_name"
        ...
        <doc xml:space="preserve">Set the name of the @contributor to @name.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">The name of the contributor</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_role"
        ...
        <doc xml:space="preserve">Set the role of the @contributor to @role.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="role" transfer-ownership="none">
            <doc xml:space="preserve">The role of the @contributor</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <property name="name" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The name of this contributor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="role" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The role of this contributor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="xml-doc"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The reference to XML document containing this object.
...
Internal property.</doc>
      ...
      <property name="xml-node"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The pointer to object node in XML document.</doc>
    ...
    <class name="DIDLLiteCreateClass"
      ...
      <method name="get_content"
        ...
        <doc xml:space="preserve">Get the content of the @create_class.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The Content of the @create_class, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="create_class" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPDIDLLiteCreateClass</doc>
            <type name="DIDLLiteCreateClass"
                  c:type="GUPnPDIDLLiteCreateClass*"/>
          </instance-parameter>
        </parameters>
      ...
      <method name="get_friendly_name"
        ...
        <doc xml:space="preserve">Get the friendly name of the @create_class.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The FriendlyName of the @create_class, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="create_class" transfer-ownership="none">
      ...
      <method name="get_include_derived"
        ...
        <doc xml:space="preserve">Checks whether @create_class can be derived.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @create_class can be derived.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="create_class" transfer-ownership="none">
      ...
      <method name="get_xml_node"
        ...
        <parameters>
          <instance-parameter name="create_class" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteCreateClass</doc>
            <type name="DIDLLiteCreateClass"
                  c:type="GUPnPDIDLLiteCreateClass*"/>
          </instance-parameter>
        </parameters>
      ...
      <method name="set_content"
        ...
        <doc xml:space="preserve">Set the content of the @create_class.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="content" transfer-ownership="none">
            <doc xml:space="preserve">The content</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_friendly_name"
        ...
        <doc xml:space="preserve">Set the friendly name of the @create_class.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="friendly_name" transfer-ownership="none">
            <doc xml:space="preserve">The friendly name</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_include_derived"
        ...
        <doc xml:space="preserve">(Un)set the derivability of create_class.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="include_derived" transfer-ownership="none">
            <doc xml:space="preserve">the derivability</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <property name="content" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The content of this create Class.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="friendly-name" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The friendly name of this create Class.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="include-derived" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Whether this create Class can be derived.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="xml-doc"
                stability="Private"
...
Internal property.</doc>
      ...
      <property name="xml-node"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The pointer to desc node in XML document.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <field name="parent">
        <type name="GObject.Object" c:type="GObject"/>
      ...
      <field name="priv" readable="0" private="1">
        <type name="DIDLLiteCreateClassPrivate"
              c:type="GUPnPDIDLLiteCreateClassPrivate*"/>
      </field>
    </class>
    ...
    <record name="DIDLLiteCreateClassPrivate"
            c:type="GUPnPDIDLLiteCreateClassPrivate"
            disguised="1">
    </record>
    <class name="DIDLLiteDescriptor"
      ...
      <method name="get_content"
        ...
        <doc xml:space="preserve">Get the content of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The content of the @descriptor or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="descriptor" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteDescriptor</doc>
      ...
      <method name="get_id" c:identifier="gupnp_didl_lite_descriptor_get_id">
        <doc xml:space="preserve">Get the ID of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The ID string or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="descriptor" transfer-ownership="none">
      ...
      <method name="get_metadata_type"
        ...
        <doc xml:space="preserve">Get the metadata type of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The type as string or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="descriptor" transfer-ownership="none">
      ...
      <method name="get_name_space"
        ...
        <doc xml:space="preserve">Get the name space associated with the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The name space or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="descriptor" transfer-ownership="none">
      ...
      <method name="get_xml_node"
        ...
        <doc xml:space="preserve">Get the pointer to desc node in XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to desc node in XML document.</doc>
          <type name="libxml2.Node" c:type="xmlNode*"/>
        </return-value>
        <parameters>
          <instance-parameter name="descriptor" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteDescriptor</doc>
            <type name="DIDLLiteDescriptor" c:type="GUPnPDIDLLiteDescriptor*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="set_content"
        ...
        <doc xml:space="preserve">Set the content of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="content" transfer-ownership="none">
            <doc xml:space="preserve">The content as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_id" c:identifier="gupnp_didl_lite_descriptor_set_id">
        <doc xml:space="preserve">Set the ID of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="id" transfer-ownership="none">
            <doc xml:space="preserve">The ID as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_metadata_type"
        ...
        <doc xml:space="preserve">Set the metadata type of the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="type" transfer-ownership="none">
            <doc xml:space="preserve">The metadata type as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_name_space"
        ...
        <doc xml:space="preserve">Set the name space associated with the @descriptor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="name_space" transfer-ownership="none">
            <doc xml:space="preserve">The name space URI as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <property name="content" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The content of this descriptor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="id" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The ID of this descriptor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="metadata-type" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The type of this descriptor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="name-space" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The name space associated with this descriptor.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="xml-doc"
                stability="Private"
...
Internal property.</doc>
    ...
    <enumeration name="DIDLLiteFragmentResult"
      ...
      <doc xml:space="preserve">Possible return values of the gupnp_didl_lite_object_apply_fragments() call.</doc>
      <member name="ok"
              value="0"
              c:identifier="GUPNP_DIDL_LITE_FRAGMENT_RESULT_OK">
        <doc xml:space="preserve">Operation succeeded.</doc>
      </member>
      <member name="current_bad_xml"
              value="1"
              c:identifier="GUPNP_DIDL_LITE_FRAGMENT_RESULT_CURRENT_BAD_XML">
        <doc xml:space="preserve">Current set of fragments
is bad XML</doc>
      </member>
      <member name="new_bad_xml"
              value="2"
              c:identifier="GUPNP_DIDL_LITE_FRAGMENT_RESULT_NEW_BAD_XML">
        <doc xml:space="preserve">New set of fragments is bad
XML</doc>
      </member>
...
of the others applies.</doc>
    ...
    <class name="DIDLLiteItem"
      ...
      <method name="get_lifetime"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">-1 if unset or the lifetime (in seconds) of the current item.</doc>
          <type name="glong" c:type="glong"/>
        </return-value>
        <parameters>
          <instance-parameter name="item" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPDIDLLiteItem</doc>
            <type name="DIDLLiteItem" c:type="GUPnPDIDLLiteItem*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_ref_id" c:identifier="gupnp_didl_lite_item_get_ref_id">
        <doc xml:space="preserve">Get the ref ID of the @item.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The ref ID of the @item, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="item" transfer-ownership="none">
      ...
      <method name="set_lifetime"
        ...
        <parameters>
          ...
          <parameter name="lifetime" transfer-ownership="none">
            <doc xml:space="preserve">The lifetime (in seconds) of this item in a media collection.</doc>
            <type name="glong" c:type="glong"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_ref_id" c:identifier="gupnp_didl_lite_item_set_ref_id">
        <doc xml:space="preserve">Set the ref ID of the @item.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="ref_id" transfer-ownership="none">
            <doc xml:space="preserve">The ref ID</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <property name="lifetime" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The lifetime in seconds of this DIDLLite item in a media collection.</doc>
        <type name="glong" c:type="glong"/>
      </property>
      <property name="ref-id" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The ref ID of this item.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <field name="parent">
        <type name="DIDLLiteObject" c:type="GUPnPDIDLLiteObject"/>
    ...
    <class name="DIDLLiteObject"
      ...
      <method name="add_artist"
        ...
        <doc xml:space="preserve">Add a new Artist node to the @object and return the associated
#GUPnPDIDLLiteContributor object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteContributor object. Unref after usage.</doc>
          <type name="DIDLLiteContributor" c:type="GUPnPDIDLLiteContributor*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteObject</doc>
            <type name="DIDLLiteObject" c:type="GUPnPDIDLLiteObject*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="add_author"
        ...
        <doc xml:space="preserve">Add a new author node to the @object and return the associated
#GUPnPDIDLLiteContributor object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteContributor object. Unref after usage.</doc>
          <type name="DIDLLiteContributor" c:type="GUPnPDIDLLiteContributor*"/>
      ...
      <method name="add_creator"
        ...
        <doc xml:space="preserve">Add a new creator node to the @object and return the associated
#GUPnPDIDLLiteContributor object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteContributor object. Unref after usage.</doc>
          <type name="DIDLLiteContributor" c:type="GUPnPDIDLLiteContributor*"/>
      ...
      <method name="add_descriptor"
        ...
        <doc xml:space="preserve">Creates a new descriptor, attaches it to @object and returns it.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteDescriptor object. Unref after usage.</doc>
          <type name="DIDLLiteDescriptor" c:type="GUPnPDIDLLiteDescriptor*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteObject</doc>
            <type name="DIDLLiteObject" c:type="GUPnPDIDLLiteObject*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="add_resource"
        ...
        <doc xml:space="preserve">Creates a new resource, attaches it to @object and returns it.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteResource object. Unref after usage.</doc>
      ...
      <method name="apply_fragments"
        ...
        <doc xml:space="preserve">Updates object by applying @new_fragments in places of
@current_fragments. For @current_size and @new_size -1 can be
passed when respectively @current_fragments and @new_fragments are
NULL terminated.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">Result of operation.</doc>
...
fragments of @object.</doc>
          ...
          <parameter name="current_size" transfer-ownership="none">
            <doc xml:space="preserve">Size of @current_fragments or -1.</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
          <parameter name="new_fragments" transfer-ownership="none">
            <doc xml:space="preserve">Substitutes
for @current_fragments.</doc>
          ...
          <parameter name="new_size" transfer-ownership="none">
            <doc xml:space="preserve">Size of @new_fragments or -1.</doc>
            <type name="gint" c:type="gint"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_album" c:identifier="gupnp_didl_lite_object_get_album">
        <doc xml:space="preserve">Get the album of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The album of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPDIDLLiteObject</doc>
            <type name="DIDLLiteObject" c:type="GUPnPDIDLLiteObject*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_album_art"
        ...
        <doc xml:space="preserve">Get the URI to album art of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The URI to album art of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_album_xml_string"
        ...
        <doc xml:space="preserve">Creates a string representation of the DIDL-Lite XML fragment related to the
object album.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A DIDL-Lite XML fragment string, or %NULL. #g_free after usage.</doc>
      ...
      <method name="get_artist"
        ...
        <doc xml:space="preserve">Get the artist of the @object. If role is not %NULL, it is set to the role
of the artist if available.</doc>
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The artist of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_artists"
        ...
        <doc xml:space="preserve">Get the artists of the @object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list
...
#g_list_free the returned list after usage and unref each object in it.</doc>
      ...
      <method name="get_artists_xml_string"
        ...
        <doc xml:space="preserve">Creates a string representation of the DIDL-Lite XML fragments related to the
object artists.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A DIDL-Lite XML fragment string, or %NULL. #g_free after usage.</doc>
          <type name="utf8" c:type="char*"/>
      ...
      <method name="get_author"
              ...
              deprecated="1"
              deprecated-version="0.5.3">
        <doc xml:space="preserve">Get the author of the @object.</doc>
        <doc-deprecated xml:space="preserve">Use #gupnp_didl_lite_object_get_authors instead.</doc-deprecated>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The author of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_authors"
        ...
        <doc xml:space="preserve">Get the authors of the @object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list
...
#g_list_free the returned list after usage and unref each object in it.</doc>
      ...
      <method name="get_compat_resource"
        ...
        <doc xml:space="preserve">Use this function to get a resource from the @object that is compatible with
...
%NULL if none of resources and protocols are found to be compatible.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The resource belonging to @object that is comaptible with
...
usage.</doc>
        ...
        <parameters>
          ...
          <parameter name="sink_protocol_info" transfer-ownership="none">
            <doc xml:space="preserve">The SinkProtocolInfo string from MediaRenderer</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="lenient" transfer-ownership="none">
            <doc xml:space="preserve">Enable lenient mode</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_creator"
        ...
        <doc xml:space="preserve">Get the creator of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The creator of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_creators"
        ...
        <doc xml:space="preserve">Get the creators of the @object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list
...
#g_list_free the returned list after usage and unref each object in it.</doc>
      ...
      <method name="get_date" c:identifier="gupnp_didl_lite_object_get_date">
        <doc xml:space="preserve">Get the date of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The date of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
...
object date.</doc>
      ...
      <method name="get_dc_namespace"
        ...
        <doc xml:space="preserve">Get the pointer to the DublinCore namespace registered with the XML document
containing this object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to DublinCore namespace in XML document.</doc>
      ...
      <method name="get_description"
        ...
        <doc xml:space="preserve">Get the description of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The description of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_descriptors"
        ...
        <doc xml:space="preserve">Get the descriptors of the @object.</doc>
        <return-value transfer-ownership="full">
...
#g_list_free the returned list after usage and unref each object in it.</doc>
      ...
      <method name="get_dlna_managed"
        ...
        <doc xml:space="preserve">Get the 'dlna:dlnaManaged' attribute of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The 'dlna:dlnaManaged' attribute of the @object.</doc>
      ...
      <method name="get_dlna_namespace"
        ...
        <doc xml:space="preserve">Get the pointer to the DLNA metadata namespace registered with the XML
document containing this object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to DLNA namespace in XML document.</doc>
          <type name="libxml2.NsPtr" c:type="xmlNsPtr"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_genre" c:identifier="gupnp_didl_lite_object_get_genre">
        <doc xml:space="preserve">Get the genre of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The genre of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_id" c:identifier="gupnp_didl_lite_object_get_id">
        <doc xml:space="preserve">Get the ID of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The ID of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_parent_id"
        ...
        <doc xml:space="preserve">Get the ID of the parent of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The ID of parent of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_properties"
        ...
        <doc xml:space="preserve">Use this function to retreive property nodes by name.</doc>
...
#g_list_free the returned list after usage but do not modify the contents.</doc>
        ...
        <parameters>
          ...
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">name of the properties</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_pv_namespace"
        ...
        <doc xml:space="preserve">Get the pointer to the PV metadata namespace registered with the XML
document containing this object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to PV namespace in XML document.</doc>
          <type name="libxml2.NsPtr" c:type="xmlNsPtr"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_resources"
        ...
        <doc xml:space="preserve">Use this function to retreive resources from the @object.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The list
      ...
      <method name="get_restricted"
        ...
        <doc xml:space="preserve">Whether the @object is restricted or not.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @object is restricted.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_title" c:identifier="gupnp_didl_lite_object_get_title">
        <doc xml:space="preserve">Get the title of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The title of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
...
object title.</doc>
      ...
      <method name="get_track_number"
        ...
        <doc xml:space="preserve">Get the original track number of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The original track number of the @object, or -1.</doc>
...
object track number.</doc>
      ...
      <method name="get_update_id"
        ...
        <doc xml:space="preserve">Get the update ID of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The update ID of the @object.</doc>
          <type name="guint" c:type="guint"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_upnp_class"
        ...
        <doc xml:space="preserve">Get the UPnP class of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The class of @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
...
object UPnP class.</doc>
      ...
      <method name="get_upnp_namespace"
        ...
        <doc xml:space="preserve">Get the pointer to the UPnP namespace registered with the XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to UPnP namespace in XML document.</doc>
          <type name="libxml2.NsPtr" c:type="xmlNsPtr"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_write_status"
        ...
        <doc xml:space="preserve">Get the write status of the @object.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The write status of the @object, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="get_xml_node"
        ...
        <doc xml:space="preserve">Get the pointer to object node in XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to object node in XML document.</doc>
          <type name="libxml2.Node" c:type="xmlNode*"/>
        </return-value>
      ...
      <method name="get_xml_string"
        ...
        <doc xml:space="preserve">Get the representation of this object as an XML string.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">XML representation of this object as string.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="object" transfer-ownership="none">
      ...
      <method name="set_album" c:identifier="gupnp_didl_lite_object_set_album">
        <doc xml:space="preserve">Set the album of the @object to @album.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="album" transfer-ownership="none">
            <doc xml:space="preserve">The album string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_album_art"
        ...
        <doc xml:space="preserve">Set the URI to album art of the @object to @album_art.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="album_art" transfer-ownership="none">
            <doc xml:space="preserve">The URI of album art</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_artist"
              ...
              deprecated="1"
              deprecated-version="0.5.3">
        <doc xml:space="preserve">Set the Artist of the @object to @artist.</doc>
      ...
      <method name="set_author"
              ...
              deprecated="1"
              deprecated-version="0.5.3">
        <doc xml:space="preserve">Set the Author of the @object to @author.</doc>
        ...
        <parameters>
          ...
          <parameter name="author" transfer-ownership="none">
            <doc xml:space="preserve">The Author</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_creator"
        ...
        <doc xml:space="preserve">Set the creator of the @object to @creator.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="creator" transfer-ownership="none">
            <doc xml:space="preserve">The creator</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_date" c:identifier="gupnp_didl_lite_object_set_date">
        <doc xml:space="preserve">Set the date of the @object to @date.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="date" transfer-ownership="none">
            <doc xml:space="preserve">The date string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_description"
        ...
        <doc xml:space="preserve">Set the description of the @object to @description.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="description" transfer-ownership="none">
            <doc xml:space="preserve">The description string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dlna_managed"
        ...
        <doc xml:space="preserve">Set the 'dlna:dlnaManaged' attribute of the @object to @dlna_managed.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="dlna_managed" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPOCMFlags.</doc>
            <type name="OCMFlags" c:type="GUPnPOCMFlags"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_genre" c:identifier="gupnp_didl_lite_object_set_genre">
        <doc xml:space="preserve">Set the genre of the @object to @genre.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="genre" transfer-ownership="none">
            <doc xml:space="preserve">The Genre</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_id" c:identifier="gupnp_didl_lite_object_set_id">
        <doc xml:space="preserve">Set the ID of the @object to @id.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_parent_id"
        ...
        <doc xml:space="preserve">Set the ID of the parent of the @object to @parent_id.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="parent_id" transfer-ownership="none">
            <doc xml:space="preserve">The parent ID</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_restricted"
        ...
        <doc xml:space="preserve">Set the restricted status of @object to @restricted.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="restricted" transfer-ownership="none">
            <doc xml:space="preserve">The restricted status</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_title" c:identifier="gupnp_didl_lite_object_set_title">
        <doc xml:space="preserve">Set the title of the @object to @title.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_track_number"
        ...
        <doc xml:space="preserve">Set the original track number of the @object to @track_number.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="track_number" transfer-ownership="none">
            <doc xml:space="preserve">The original track number</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_update_id"
        ...
        <doc xml:space="preserve">Set the update ID of the @object.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="update_id" transfer-ownership="none">
            <doc xml:space="preserve">Update ID</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_upnp_class"
        ...
        <doc xml:space="preserve">Set the UPnP class of the @object to @upnp_class.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="upnp_class" transfer-ownership="none">
            <doc xml:space="preserve">The UPnP class as string.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_write_status"
        ...
        <doc xml:space="preserve">Set the write status of the @object to @write_status.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="write_status" transfer-ownership="none">
            <doc xml:space="preserve">The write status string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="unset_artists"
        ...
        <doc xml:space="preserve">Unset the artists properties of the @object.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="unset_update_id"
        ...
        <doc xml:space="preserve">Unset the update ID property of the @object.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="update_id_is_set"
        ...
        <doc xml:space="preserve">Get whether the update ID of the @object is set.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if update ID is set, otherwise %FALSE</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <property name="album" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The album of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="album-art" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The URI to album art of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="artist"
                ...
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The artist of this object.</doc>
...
property, they are capable of dealing with multiple artist nodes.</doc-deprecated>
      ...
      <property name="author"
                ...
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The author of this object.</doc>
...
property, they are capable of dealing with multiple author nodes.</doc-deprecated>
      ...
      <property name="creator" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The creator of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="date" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The date of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="dc-namespace"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the DublinCore namespace registered with the XML document
containing this object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="description" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The description of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="dlna-managed" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The 'dlna:dlnaManaged' attribute.</doc>
        <type name="OCMFlags"/>
      </property>
      <property name="dlna-namespace"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the DLNA metadata namespace registered with the XML
document containing this object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="genre" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The genre of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="id" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The ID of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="parent-id" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The ID of the parent container of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="pv-namespace"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the PV metadata namespace registered with the XML
document containing this object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="restricted" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Whether this object is restricted.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="title" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The title of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="track-number" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The original track number of this object.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="update-id" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Update ID of this object.</doc>
        <type name="guint" c:type="guint"/>
      </property>
      <property name="upnp-class" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The UPnP class of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="upnp-namespace"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the UPnP namespace registered with the XML document
containing this object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="write-status" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The write status of this object.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="xml-doc"
                stability="Private"
...
Internal property.</doc>
    ...
    <class name="DIDLLiteParser"
      ...
      <constructor name="new" c:identifier="gupnp_didl_lite_parser_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteParser object.</doc>
      ...
      <method name="parse_didl"
              ...
              throws="1">
        <doc xml:space="preserve">Parses DIDL-Lite XML string @didl, emitting the ::object-available,
...
process.</doc>
        ...
        <parameters>
          <instance-parameter name="parser" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteParser</doc>
            <type name="DIDLLiteParser" c:type="GUPnPDIDLLiteParser*"/>
          </instance-parameter>
          <parameter name="didl" transfer-ownership="none">
            <doc xml:space="preserve">The DIDL-Lite XML string to be parsed</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <glib:signal name="container-available" when="last">
        <doc xml:space="preserve">The ::container-available signal is emitted each time a container is
found in the DIDL-Lite XML being parsed.</doc>
        ...
        <parameters>
          <parameter name="container" transfer-ownership="none">
            <doc xml:space="preserve">The now available #GUPnPDIDLLiteContainer</doc>
            <type name="DIDLLiteContainer"/>
          </parameter>
        </parameters>
      </glib:signal>
      <glib:signal name="item-available" when="last">
        <doc xml:space="preserve">The ::item-available signal is emitted each time an item is found in
the DIDL-Lite XML being parsed.</doc>
        ...
        <parameters>
          <parameter name="item" transfer-ownership="none">
            <doc xml:space="preserve">The now available #GUPnPDIDLLiteItem</doc>
            <type name="DIDLLiteItem"/>
          </parameter>
        </parameters>
      </glib:signal>
      <glib:signal name="object-available" when="last">
        <doc xml:space="preserve">The ::object-available signal is emitted each time an object is
found in the DIDL-Lite XML being parsed.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <parameter name="object" transfer-ownership="none">
            <doc xml:space="preserve">The now available #GUPnPDIDLLiteObject</doc>
    ...
    <class name="DIDLLiteResource"
      ...
      <method name="get_audio_channels"
        ...
        <doc xml:space="preserve">Get the number of audio channels in the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of audio channels in the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteResource</doc>
            <type name="DIDLLiteResource" c:type="GUPnPDIDLLiteResource*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_bitrate"
        ...
        <doc xml:space="preserve">Get the bitrate (in bytes per second) of the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The bitrate (in bytes per second) of the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_bits_per_sample"
        ...
        <doc xml:space="preserve">Get the sample size of the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of bits per sample of the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_cleartext_size"
        ...
        <doc xml:space="preserve">Get the size (in bytes) of the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The size (in bytes) of the @resource or -1.</doc>
          <type name="gint64" c:type="gint64"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_color_depth"
        ...
        <doc xml:space="preserve">Get the color-depth of this image/video resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The color depth of the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
...
document containing this object.</doc>
      ...
      <method name="get_duration"
        ...
        <doc xml:space="preserve">Get the duration (in seconds) of the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The duration (in seconds) of the @resource or -1.</doc>
      ...
      <method name="get_height"
        ...
        <doc xml:space="preserve">Get the height of this image/video resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The height of the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_import_uri"
        ...
        <doc xml:space="preserve">Get the import URI associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The import URI or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_protection"
        ...
        <doc xml:space="preserve">Get the protection system used by the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The protection system in use by the @resource or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_protocol_info"
        ...
        <doc xml:space="preserve">Get the protocol info associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The protocol info associated with the @resource or %NULL. The
returned object must not be unrefed.</doc>
...
document containing this object.</doc>
      ...
      <method name="get_sample_freq"
        ...
        <doc xml:space="preserve">Get the sample frequency of the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The sample frequency of the @resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_subtitle_file_type"
              ...
              version="0.12.4">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The content of the subtitleFileType property or %NULL</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_subtitle_file_uri"
              ...
              version="0.12.4">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The content of the subtitleFileUri property or %NULL when not set.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_track_total"
        ...
        <doc xml:space="preserve">Get the total track count of this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The total track count of the @resource.</doc>
          <type name="guint" c:type="guint"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_update_count"
        ...
        <doc xml:space="preserve">Get the update count of this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The update count of the @resource.</doc>
          <type name="guint" c:type="guint"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_uri" c:identifier="gupnp_didl_lite_resource_get_uri">
        <doc xml:space="preserve">Get the URI associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The of URI the @resource or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_width"
        ...
        <doc xml:space="preserve">Get the width of this image/video resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The width of this image/video resource or -1.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="get_xml_node"
        ...
        <doc xml:space="preserve">Get the pointer to res node in XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to res node in XML document.</doc>
          <type name="libxml2.Node" c:type="xmlNode*"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteResource</doc>
            <type name="DIDLLiteResource" c:type="GUPnPDIDLLiteResource*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="set_audio_channels"
        ...
        <doc xml:space="preserve">Set the number of audio channels in the @resource. Passing a negative number
will unset this property.</doc>
      ...
      <method name="set_bitrate"
        ...
        <doc xml:space="preserve">Set the bitrate (in bytes per second) of the @resource. Passing a negative
number will unset this property.</doc>
        ...
        <parameters>
          ...
          <parameter name="bitrate" transfer-ownership="none">
            <doc xml:space="preserve">The bitrate</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_bits_per_sample"
        ...
        <doc xml:space="preserve">Set the sample size of the @resource. Passing a negative number will unset
this property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        ...
        <parameters>
          ...
          <parameter name="sample_size" transfer-ownership="none">
            <doc xml:space="preserve">The number of bits per sample</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_cleartext_size"
        ...
        <doc xml:space="preserve">Set the size (in bytes) of the @resource. Passing a negative number will
unset this property.</doc>
      ...
      <method name="set_color_depth"
        ...
        <doc xml:space="preserve">Set the color-depth of this image/video resource. Passing a negative number
will unset this property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        ...
        <parameters>
          ...
          <parameter name="color_depth" transfer-ownership="none">
            <doc xml:space="preserve">The color-depth</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_duration"
        ...
        <doc xml:space="preserve">Set the duration (in seconds) of the @resource. Passing a negative number
will unset this property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
      ...
      <method name="set_height"
        ...
        <doc xml:space="preserve">Set the height of this image/video resource. Setting both width and height to
a negative number will unset the resolution property.</doc>
      ...
      <method name="set_import_uri"
        ...
        <doc xml:space="preserve">Set the import URI associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="import_uri" transfer-ownership="none">
            <doc xml:space="preserve">The URI as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_protection"
        ...
        <doc xml:space="preserve">Set the protection system used by the @resource. Passing a negative number
will unset this property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        ...
        <parameters>
          ...
          <parameter name="protection" transfer-ownership="none">
            <doc xml:space="preserve">The protection system identifier as string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_protocol_info"
        ...
        <doc xml:space="preserve">Set the protocol info associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="info" transfer-ownership="none">
            <doc xml:space="preserve">The protocol string</doc>
            <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_sample_freq"
        ...
        <doc xml:space="preserve">Set the sample frequency of the @resource. Passing a negative number will
unset this property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        ...
        <parameters>
          ...
          <parameter name="sample_freq" transfer-ownership="none">
            <doc xml:space="preserve">The sample frequency</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
...
unset this property.</doc>
      ...
      <method name="set_subtitle_file_type"
              ...
              version="0.12.4">
        <doc xml:space="preserve">Set the type of an external subtitle file, specified via
...
When @type is %NULL the value is removed.</doc>
        ...
        <parameters>
          ...
          <parameter name="type"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">An URI to an external subtitle file</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_subtitle_file_uri"
              ...
              version="0.12.4">
        <doc xml:space="preserve">Set the URI of an external subtitle file to be used with this resource.
When @uri is %NULL the value is removed.</doc>
        ...
        <parameters>
          ...
          <parameter name="uri"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">An URI to an external subtitle file or %NULL to remove.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_track_total"
        ...
        <doc xml:space="preserve">Set the total number of tracks in this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="track_total" transfer-ownership="none">
            <doc xml:space="preserve">The total number of tracks in this resource</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_update_count"
        ...
        <doc xml:space="preserve">Set the update count of this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="update_count" transfer-ownership="none">
            <doc xml:space="preserve">The update_count</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_uri" c:identifier="gupnp_didl_lite_resource_set_uri">
        <doc xml:space="preserve">Set the URI associated with the @resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="set_width"
        ...
        <doc xml:space="preserve">Set the width of this image/video resource. Setting both width and height to
a negative number will unset the resolution property.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
      ...
      <method name="track_total_is_set"
        ...
        <doc xml:space="preserve">Check whether the total track count property of this resource is set.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if set, otherwise %FALSE.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="resource" transfer-ownership="none">
      ...
      <method name="unset_track_total"
        ...
        <doc xml:space="preserve">Unset the total track count of this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="unset_update_count"
        ...
        <doc xml:space="preserve">Unset the update count of this resource.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="update_count_is_set"
        ...
        <doc xml:space="preserve">Check whether the update count property of this resource is set.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if set, otherwise %FALSE.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <property name="audio-channels" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The number of audio channels in this resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="bitrate" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The bitrate of this resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="bits-per-sample" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The sample size of this resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="cleartext-size" writable="1" transfer-ownership="none">
        <type name="gint64" c:type="gint64"/>
      </property>
      <property name="color-depth" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The color-depth of this image/video resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="dlna-namespace"
                writable="1"
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the DLNA metadata namespace registered with the
resource object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="duration" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The duration (in seconds) of this resource.</doc>
        <type name="glong" c:type="glong"/>
      </property>
      <property name="height" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The height of this image/video resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="import-uri" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The Import URI associated with this resource.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="protection" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The protection system used for this resource.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="protocol-info" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The protocol info associated with this resource.</doc>
      ...
      <property name="pv-namespace"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Pointer to the PV metadata namespace registered with the
resource object.</doc>
        <type name="gpointer" c:type="gpointer"/>
      </property>
      <property name="sample-freq" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The sample frequency of this resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="size" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The size (in bytes) of this resource.</doc>
        <type name="glong" c:type="glong"/>
      </property>
      ...
      <property name="subtitle-file-type"
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Type of external subtitle file. Usually SRT or SMI.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="subtitle-file-uri"
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Uri to external subtitle file.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="track-total" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Number of tracks in a DIDL_S or DIDL_V resource.</doc>
        <type name="guint" c:type="guint"/>
      </property>
      <property name="update-count" writable="1" transfer-ownership="none">
        <type name="guint" c:type="guint"/>
      </property>
      <property name="uri" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The URI associated with this resource.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="width" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The width of this image/video resource.</doc>
        <type name="gint" c:type="gint"/>
      </property>
      <property name="xml-doc"
                stability="Private"
...
Internal property.</doc>
    ...
    <class name="DIDLLiteWriter"
      ...
      <constructor name="new" c:identifier="gupnp_didl_lite_writer_new">
        <doc xml:space="preserve">Note: @language should always be set to %NULL, DLNA does not support the
language parameter.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteWriter object.</doc>
        ...
        <parameters>
          <parameter name="language"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">The language the DIDL-Lite fragment is in, or %NULL</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="add_container"
        ...
        <doc xml:space="preserve">Creates a new container, attaches it to @writer and returns it.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteContainer object. Unref after usage.</doc>
          <type name="DIDLLiteContainer" c:type="GUPnPDIDLLiteContainer*"/>
        </return-value>
        <parameters>
          <instance-parameter name="writer" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPDIDLLiteWriter</doc>
            <type name="DIDLLiteWriter" c:type="GUPnPDIDLLiteWriter*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="add_item" c:identifier="gupnp_didl_lite_writer_add_item">
        <doc xml:space="preserve">Creates a new item, attaches it to @writer and returns it.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteItem object. Unref after usage.</doc>
          <type name="DIDLLiteItem" c:type="GUPnPDIDLLiteItem*"/>
        </return-value>
        <parameters>
          <instance-parameter name="writer" transfer-ownership="none">
      ...
      <method name="filter" c:identifier="gupnp_didl_lite_writer_filter">
        <doc xml:space="preserve">Clears the DIDL-Lite XML document of the properties not specified in the
...
specification for details on this string.</doc>
        ...
        <parameters>
          ...
          <parameter name="filter" transfer-ownership="none">
            <doc xml:space="preserve">A filter string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_language"
        ...
        <doc xml:space="preserve">Get the language the DIDL-Lite fragment is in.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The language of the @writer, or %NULL.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="writer" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPDIDLLiteWriter</doc>
            <type name="DIDLLiteWriter" c:type="GUPnPDIDLLiteWriter*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_string"
        ...
        <doc xml:space="preserve">Creates a string representation of the DIDL-Lite XML document.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The DIDL-Lite XML string, or %NULL. #g_free after usage.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="writer" transfer-ownership="none">
      ...
      <method name="get_xml_node"
        ...
        <doc xml:space="preserve">Get the pointer to root node in XML document.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The pointer to root node in XML document.</doc>
          <type name="libxml2.Node" c:type="xmlNode*"/>
        </return-value>
        <parameters>
          <instance-parameter name="writer" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPDIDLLiteWriter</doc>
            <type name="DIDLLiteWriter" c:type="GUPnPDIDLLiteWriter*"/>
          </instance-parameter>
        </parameters>
      </method>
      <property name="language"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The language the DIDL-Lite fragment is in.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
    ...
    <bitfield name="DLNAConversion"
      ...
      <doc xml:space="preserve">The DLNA conversion flags for a resource.</doc>
      <member name="none"
              value="0"
              c:identifier="GUPNP_DLNA_CONVERSION_NONE"
              glib:nick="none">
        <doc xml:space="preserve">Content is in original source format</doc>
      </member>
      <member name="transcoded"
              value="1"
              c:identifier="GUPNP_DLNA_CONVERSION_TRANSCODED"
              glib:nick="transcoded">
        <doc xml:space="preserve">Content is transcoded</doc>
      </member>
    </bitfield>
    <bitfield name="DLNAFlags"
      ...
      <doc xml:space="preserve">The miscellaneous operations supported by a resource. For details on these
...
Updated DTCP Flags based on 2011 Guidelines, section 7.4.1.3.23.2</doc>
      ...
      <member name="sender_paced"
        ...
        <doc xml:space="preserve">Content source is the clock source during
                                transport</doc>
      </member>
      ...
      <member name="streaming_transfer_mode"
        ...
        <doc xml:space="preserve">Streaming transfer mode supported</doc>
      </member>
      <member name="interactive_transfer_mode"
        ...
        <doc xml:space="preserve">Interactive transfer mode
                                             supported</doc>
      </member>
      <member name="background_transfer_mode"
        ...
        <doc xml:space="preserve">Background transfer mode
                                            supported</doc>
      </member>
      ...
      <member name="cleartext_byteseek_full"
        ...
        <doc xml:space="preserve">Full byte seek on cleartext
      ...
      <member name="lop_cleartext_byteseek"
        ...
        <doc xml:space="preserve">Limited operations on
    ...
    <bitfield name="DLNAOperation"
      ...
      <doc xml:space="preserve">The seek operations supported by a resource.</doc>
      <member name="none"
              value="0"
              c:identifier="GUPNP_DLNA_OPERATION_NONE"
              glib:nick="none">
        <doc xml:space="preserve">Resource does not support seeking of any type</doc>
      </member>
      <member name="range"
              value="1"
              c:identifier="GUPNP_DLNA_OPERATION_RANGE"
              glib:nick="range">
        <doc xml:space="preserve">Resource supports byte-seek</doc>
      </member>
      <member name="timeseek"
              value="16"
              c:identifier="GUPNP_DLNA_OPERATION_TIMESEEK"
              glib:nick="timeseek">
        <doc xml:space="preserve">Resource supports time-seek</doc>
      </member>
    </bitfield>
    <class name="Feature"
      ...
      <method name="get_name" c:identifier="gupnp_feature_get_name">
        <doc xml:space="preserve">Get the name of the @feature.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The name of the @feature.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="feature" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPFeature</doc>
      ...
      <method name="get_object_ids"
        ...
        <doc xml:space="preserve">Get the object IDs related to the @feature.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The object IDs related to the @feature.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="feature" transfer-ownership="none">
      ...
      <method name="get_version" c:identifier="gupnp_feature_get_version">
        <doc xml:space="preserve">Get the version of the @feature.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The version of the @feature.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="feature" transfer-ownership="none">
      ...
      <property name="name"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The name of this feature.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="object-ids"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The object IDs related to this feature.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="version"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The version of this feature.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <field name="parent">
        <type name="GObject.Object" c:type="GObject"/>
      ...
      <field name="priv">
        <type name="FeaturePrivate" c:type="GUPnPFeaturePrivate*"/>
      </field>
    </class>
    ...
    <class name="FeatureListParser"
      ...
      <constructor name="new" c:identifier="gupnp_feature_list_parser_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPFeatureListParser object.</doc>
      ...
      <method name="parse_text"
              ...
              throws="1">
        <doc xml:space="preserve">Parses @text and returns the list of available features.
...
features or %NULL if an error occured.</doc>
        ...
        <parameters>
          <instance-parameter name="parser" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPFeatureListParser</doc>
            <type name="FeatureListParser" c:type="GUPnPFeatureListParser*"/>
          </instance-parameter>
          <parameter name="text" transfer-ownership="none">
            <doc xml:space="preserve">The feature list string to be parsed</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
    ...
    <record name="FeaturePrivate" c:type="GUPnPFeaturePrivate" disguised="1">
    </record>
    <class name="LastChangeParser"
      ...
      <constructor name="new" c:identifier="gupnp_last_change_parser_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPLastChangeParser</doc>
      ...
      <method name="parse_last_change"
              ...
              introspectable="0">
        <doc xml:space="preserve">Parses the xml fragment from a LastChange event.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">TRUE on success.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="parser" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPLastChangeParser</doc>
            <type name="LastChangeParser" c:type="GUPnPLastChangeParser*"/>
          </instance-parameter>
          <parameter name="instance_id" transfer-ownership="none">
            <doc xml:space="preserve">The ID of the AV instance caller is interested in</doc>
            <type name="guint" c:type="guint"/>
          </parameter>
          <parameter name="last_change_xml" transfer-ownership="none">
            <doc xml:space="preserve">The xml from the "LastChange" event to parse</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          ...
          <parameter name="..." transfer-ownership="none">
            <doc xml:space="preserve">tuples of state variable name, state variable type, and state
...
should be freed after use.</doc>
      ...
      <method name="parse_last_change_valist"
              ...
              introspectable="0">
        <doc xml:space="preserve">See gupnp_last_change_parser_parse_last_change(); this version takes a
va_list for use by language bindings.</doc>
        ...
        <parameters>
          ...
          <parameter name="var_args" transfer-ownership="none">
            <doc xml:space="preserve">A va_list of tuples of state variable name, state variable type,
...
values should be freed after use</doc>
    ...
    <class name="MediaCollection"
      ...
      <constructor name="new" c:identifier="gupnp_media_collection_new">
        <doc xml:space="preserve">Create a new writable media collection.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPMediaCollection.</doc>
          <type name="MediaCollection" c:type="GUPnPMediaCollection*"/>
        </return-value>
      </constructor>
      <constructor name="new_from_string"
                   c:identifier="gupnp_media_collection_new_from_string">
        <doc xml:space="preserve">Parse a new #GUPnPMediaCollection from a block of XML data.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPMediaCollection.</doc>
          <type name="MediaCollection" c:type="GUPnPMediaCollection*"/>
        </return-value>
        <parameters>
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">XML string.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="add_item" c:identifier="gupnp_media_collection_add_item">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPDIDLLiteItem object. Unref after
use.</doc>
          <type name="DIDLLiteItem" c:type="GUPnPDIDLLiteItem*"/>
        </return-value>
        <parameters>
          <instance-parameter name="collection" transfer-ownership="none">
            <doc xml:space="preserve">#GUPnPMediaCollection</doc>
            <type name="MediaCollection" c:type="GUPnPMediaCollection*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_author"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The author of this media collection or %NULL if not set.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="collection" transfer-ownership="none">
...
and free the list after use.</doc>
      ...
      <method name="get_mutable"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if the collections is modifiable, #FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="collection" transfer-ownership="none">
      ...
      <method name="get_string"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">XML string representing this media
...
copy of the original string.</doc>
      ...
      <method name="get_title" c:identifier="gupnp_media_collection_get_title">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The title of this media collection or %NULL if not set.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="collection" transfer-ownership="none">
      ...
      <method name="set_author"
        ...
        <doc xml:space="preserve">Set the author of the media collection</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="author" transfer-ownership="none">
            <doc xml:space="preserve">New author of this media collection.</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_title" c:identifier="gupnp_media_collection_set_title">
        <doc xml:space="preserve">Set the title of a #GUPnPMediaCollection.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="title" transfer-ownership="none">
            <doc xml:space="preserve">New Title of this collection;</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <property name="author"
                ...
                construct="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The author of this media collection.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="data"
                readable="0"
                ...
                construct-only="1"
                transfer-ownership="none">
        <doc xml:space="preserve">Block of data to parse a collection from. If data is set upon
construction it will override the other properties and create a
unmutable collection parsed from data.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="mutable" transfer-ownership="none">
        <doc xml:space="preserve">Whether this media collation is modifyable or not.</doc>
        <type name="gboolean" c:type="gboolean"/>
      </property>
      <property name="title"
                writable="1"
                construct="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The title of this media collection.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <field name="parent">
        <type name="GObject.Object" c:type="GObject"/>
      ...
      <field name="priv">
        <type name="MediaCollectionPrivate"
              c:type="GUPnPMediaCollectionPrivate*"/>
      </field>
    </class>
    ...
    <record name="MediaCollectionPrivate"
            c:type="GUPnPMediaCollectionPrivate"
            disguised="1">
    </record>
    <bitfield name="OCMFlags"
      ...
      <doc xml:space="preserve">The DLNA OCM flags supported by a DIDL-Lite Object. For details on these
...
Interoperability Guidelines Volume 1, October 2006.</doc>
      ...
      <member name="upload"
              ...
              glib:nick="upload">
        <doc xml:space="preserve">Indicates support for content upload.</doc>
      </member>
      <member name="create_container"
              value="2"
              c:identifier="GUPNP_OCM_FLAGS_CREATE_CONTAINER"
              glib:nick="create-container">
        <doc xml:space="preserve">Indicates support for creation of child
                                   container.</doc>
      </member>
      <member name="destroyable"
        ...
        <doc xml:space="preserve">This object is destroyable.</doc>
      </member>
      <member name="upload_destroyable"
              value="8"
              c:identifier="GUPNP_OCM_FLAGS_UPLOAD_DESTROYABLE"
              glib:nick="upload-destroyable">
        <doc xml:space="preserve">Indicates support for upload of
      ...
      <member name="change_metadata"
        ...
        <doc xml:space="preserve">Indicates support for changing metadata.</doc>
      </member>
    </bitfield>
    <enumeration name="ProtocolError"
                 c:type="GUPnPProtocolError"
                 glib:error-domain="gupnp-protocol-error">
      <doc xml:space="preserve">#GError codes used for errors in the #GUPNP_PROTOCOL_ERROR domain, upon any
protocol related errors.</doc>
      <member name="invalid_syntax"
              value="0"
              c:identifier="GUPNP_PROTOCOL_ERROR_INVALID_SYNTAX">
        <doc xml:space="preserve">Invalid syntax.</doc>
      </member>
      <member name="other" value="1" c:identifier="GUPNP_PROTOCOL_ERROR_OTHER">
        <doc xml:space="preserve">Unknown/unhandled protocol related errors.</doc>
      </member>
    </enumeration>
    <class name="ProtocolInfo"
      ...
      <constructor name="new" c:identifier="gupnp_protocol_info_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPProtocolInfo object. Unref after usage.</doc>
          <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
        </return-value>
      </constructor>
      <constructor name="new_from_string"
                   ...
                   throws="1">
        <doc xml:space="preserve">Parses the @protocol_info string and creates a new #GUPnPProtocolInfo object
as a result.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPProtocolInfo object. Unref after usage.</doc>
          <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
        ...
        <parameters>
          <parameter name="protocol_info" transfer-ownership="none">
            <doc xml:space="preserve">The protocol info string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="get_dlna_conversion"
        ...
        <doc xml:space="preserve">Get the DLNA conversion flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The DLNA conversion flags.</doc>
          <type name="DLNAConversion" c:type="GUPnPDLNAConversion"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPProtocolInfo</doc>
            <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_dlna_flags"
        ...
        <doc xml:space="preserve">Get the gereric DLNA flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The generic DLNA flags.</doc>
      ...
      <method name="get_dlna_operation"
        ...
        <doc xml:space="preserve">Get the DLNA operation flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The DLNA operation flags.</doc>
      ...
      <method name="get_dlna_profile"
        ...
        <doc xml:space="preserve">Get the DLNA profile of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The DLNA profile of this info or %NULL. This string should
not be freed.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
      ...
      <method name="get_mime_type"
        ...
        <doc xml:space="preserve">Get the MIME-type of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The MIME-type of this info or %NULL. This string should not
be freed.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
      ...
      <method name="get_network"
        ...
        <doc xml:space="preserve">Get the network this info is associated with.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The network string or %NULL. This string should not be freed.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
      ...
      <method name="get_play_speeds"
        ...
        <doc xml:space="preserve">Get the allowed play speeds on this info in the form of array of strings.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The allowed play speeds as array of strings or %NULL. This
return array and it's content must not be modified or freed.</doc>
      ...
      <method name="get_protocol"
        ...
        <doc xml:space="preserve">Get the protocol of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The protocol of this info or %NULL. This string should not
be freed.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
      ...
      <method name="is_compatible"
        ...
        <doc xml:space="preserve">Checks if the given protocolInfo string is compatible with @info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">#TRUE if @protocol_info is compatible with @info, otherwise
#FALSE.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="info1" transfer-ownership="none">
            <doc xml:space="preserve">The first #GUPnPProtocolInfo</doc>
            <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
          </instance-parameter>
          <parameter name="info2" transfer-ownership="none">
            <doc xml:space="preserve">The second #GUPnPProtocolInfo</doc>
            <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dlna_conversion"
        ...
        <doc xml:space="preserve">Set the DLNA conversion flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="conversion" transfer-ownership="none">
            <doc xml:space="preserve">The bitwise OR of one or more DLNA conversion flags</doc>
            <type name="DLNAConversion" c:type="GUPnPDLNAConversion"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dlna_flags"
        ...
        <doc xml:space="preserve">Set the gereric DLNA flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="flags" transfer-ownership="none">
            <doc xml:space="preserve">The bitwise OR of one or more generic DLNA flags</doc>
            <type name="DLNAFlags" c:type="GUPnPDLNAFlags"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dlna_operation"
        ...
        <doc xml:space="preserve">Set the DLNA operation flags.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="operation" transfer-ownership="none">
            <doc xml:space="preserve">The bitwise OR of one or more DLNA operation flags</doc>
            <type name="DLNAOperation" c:type="GUPnPDLNAOperation"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_dlna_profile"
        ...
        <doc xml:space="preserve">Set the DLNA profile of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="profile" transfer-ownership="none">
            <doc xml:space="preserve">The DLNA profile string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_mime_type"
        ...
        <doc xml:space="preserve">Set the MIME-type of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="mime_type" transfer-ownership="none">
            <doc xml:space="preserve">The MIME-type string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_network"
        ...
        <doc xml:space="preserve">Set the network this info is associated with.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="network" transfer-ownership="none">
            <doc xml:space="preserve">The network string</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_play_speeds"
        ...
        <doc xml:space="preserve">Set the allowed play speeds on this info in the form of array of strings.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="speeds" transfer-ownership="none">
            <doc xml:space="preserve">The allowed play speeds</doc>
            <type name="utf8" c:type="const char**"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_protocol"
        ...
        <doc xml:space="preserve">Set the protocol of this info.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">None.</doc>
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="to_string" c:identifier="gupnp_protocol_info_to_string">
        <doc xml:space="preserve">Provides the string representation of @info.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">String representation of @info. #g_free after usage.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="info" transfer-ownership="none">
            <doc xml:space="preserve">The #GUPnPProtocolInfo</doc>
            <type name="ProtocolInfo" c:type="GUPnPProtocolInfo*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <property name="dlna-flags" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">Various generic DLNA flags.</doc>
        <type name="DLNAFlags"/>
      </property>
      ...
      <property name="dlna-profile" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The DLNA profile of this info.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="mime-type" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The MIME-type of this info.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="network" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The network this info is associated with.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <property name="play-speeds" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The allowed play speeds on this info in the form of array of
strings.</doc>
        <array>
          <type name="utf8"/>
        </array>
      ...
      <property name="protocol" writable="1" transfer-ownership="none">
        <doc xml:space="preserve">The protocol of this info.</doc>
        <type name="utf8" c:type="gchar*"/>
      </property>
      <field name="parent">
        <type name="GObject.Object" c:type="GObject"/>
    ...
    <enumeration name="SearchCriteriaOp"
      ...
      <doc xml:space="preserve">The possible operators in SearchCriteria strings.</doc>
      <member name="EQ"
              value="271"
    ...
    <class name="SearchCriteriaParser"
      ...
      <constructor name="new" c:identifier="gupnp_search_criteria_parser_new">
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A new #GUPnPSearchCriteriaParser object.</doc>
      ...
      <method name="parse_text"
              ...
              throws="1">
        <doc xml:space="preserve">Parses @text, emitting the various defined signals on the way. If an
error occured @error will be set.</doc>
        ...
        <parameters>
          <instance-parameter name="parser" transfer-ownership="none">
            <doc xml:space="preserve">A #GUPnPSearchCriteriaParser</doc>
            <type name="SearchCriteriaParser"
                  c:type="GUPnPSearchCriteriaParser*"/>
          </instance-parameter>
          <parameter name="text" transfer-ownership="none">
            <doc xml:space="preserve">The search criteria string to be parsed</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <glib:signal name="begin-parens" when="last">
        <doc xml:space="preserve">The ::begin_parens signal is emitted to mark the beginning of a
parenthetical expression.</doc>
      ...
      <glib:signal name="conjunction" when="last">
        <doc xml:space="preserve">The ::conjuction signal is emitted whenever a conjuction marker
&amp;lpar;and&amp;rpar; is parsed.</doc>
      ...
      <glib:signal name="disjunction" when="last">
        <doc xml:space="preserve">The ::disjuction signal is emitted whenever a disjuction marker
&amp;lpar;or&amp;rpar is parsed.</doc>
      ...
      <glib:signal name="end-parens" when="last">
        <doc xml:space="preserve">The ::end_parens signal is emitted to mark the end of a parenthetical
expression.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <glib:signal name="expression" when="last">
        <doc xml:space="preserve">The ::expression signal is emitted whenever an expression is parsed.
Set @error and return %FALSE if an error occurred.</doc>
        ...
        <parameters>
          ...
          <parameter name="op" transfer-ownership="none">
            <doc xml:space="preserve">The operator as #GUPnPSearchCriteriaOp</doc>
            <type name="SearchCriteriaOp"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">The value as string</doc>
            <type name="utf8" c:type="gchar*"/>
          </parameter>
          <parameter name="error" transfer-ownership="none">
            <doc xml:space="preserve">Place-holder for any possible errors from handler</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </glib:signal>
    ...
    <enumeration name="SearchCriteriaParserError"
      ...
      <member name="search_criteria_parser_error_failed"
        ...
        <doc xml:space="preserve">Parsing the search criteria
failed.</doc>
      </member>
    </enumeration>
