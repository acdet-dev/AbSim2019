...
<repository version="1.2"
  ...
  <namespace name="GstValidate"
             version="1.0"
             shared-library="libgstvalidate-1.0-0.dll"
...
Only access it from the default main context.</doc>
      ...
      <field name="scenario" writable="1">
        <doc xml:space="preserve">The scenario for this action. This is not thread-safe
...
#gst_validate_action_get_scenario method</doc>
      ...
      <method name="get_scenario"
        ...
        <doc xml:space="preserve">Retrieve the scenario from which @action is executed.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">The scenario from which the action is being executed.</doc>
          <type name="Scenario" c:type="GstValidateScenario*"/>
        </return-value>
        <parameters>
          <instance-parameter name="action" transfer-ownership="none">
            <doc xml:space="preserve">The action from which to retrieve the scenario</doc>
...
value to a GstClockTime.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the time value could be retrieved/computed or %FALSE otherwise</doc>
...
string. It can be precisely describing how the typing works
      ...
      <field name="def" writable="1">
        <doc xml:space="preserve">The default value of a parameter as a string, should be %NULL
    ...
    <record name="ActionType"
      ...
      <field name="implementer_namespace" writable="1">
        <doc xml:space="preserve">The namespace of the implementer of the action type</doc>
        <type name="utf8" c:type="gchar*"/>
      </field>
      ...
      <field name="flags" writable="1">
        <doc xml:space="preserve">The flags of the action type</doc>
    ...
    <bitfield name="ActionTypeFlags" c:type="GstValidateActionTypeFlags">
      ...
      <member name="no_execution_not_fatal"
        ...
        <doc xml:space="preserve">Do not consider the non execution of the action
...
Class that wraps a #GstElement for Validate checks</doc>
      ...
      <constructor name="new" c:identifier="gst_validate_issue_new">
        ...
        <parameters>
          ...
          <parameter name="description" transfer-ownership="none">
            <doc xml:space="preserve">A more complete description of the issue</doc>
            <type name="utf8" c:type="const gchar*"/>
          </parameter>
    ...
    <class name="MediaDescriptor"
           c:symbol-prefix="media_descriptor"
           c:type="GstValidateMediaDescriptor"
           parent="Gst.Object"
           abstract="1"
           glib:type-name="GstValidateMediaDescriptor"
           glib:get-type="gst_validate_media_descriptor_get_type"
           glib:type-struct="MediaDescriptorClass">
      <implements name="Reporter"/>
      <method name="_compare"
              c:identifier="gst_validate_media_descriptors_compare"
              moved-to="media_descriptors_compare">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="detects_frames"
              c:identifier="gst_validate_media_descriptor_detects_frames">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_buffers"
              c:identifier="gst_validate_media_descriptor_get_buffers"
              introspectable="0">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <method name="get_duration"
              c:identifier="gst_validate_media_descriptor_get_duration">
        <return-value transfer-ownership="none">
          <type name="Gst.ClockTime" c:type="GstClockTime"/>
        </return-value>
        <parameters>
      ...
      <method name="get_pads"
              c:identifier="gst_validate_media_descriptor_get_pads"
              introspectable="0">
        <return-value>
          <type name="GLib.List" c:type="GList*">
            <type name="gpointer" c:type="gpointer"/>
      ...
      <method name="get_seekable"
              c:identifier="gst_validate_media_descriptor_get_seekable">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="has_frame_info"
              c:identifier="gst_validate_media_descriptor_has_frame_info">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <field name="filenode">
        <type name="MediaFileNode" c:type="GstValidateMediaFileNode*"/>
      </field>
      <field name="lock">
        <type name="GLib.Mutex" c:type="GMutex"/>
      </field>
      <field name="priv">
        <type name="MediaDescriptorPrivate"
              c:type="GstValidateMediaDescriptorPrivate*"/>
      </field>
    </class>
    <record name="MediaDescriptorClass"
            c:type="GstValidateMediaDescriptorClass"
            glib:is-gtype-struct-for="MediaDescriptor">
      <field name="parent">
        <type name="Gst.ObjectClass" c:type="GstObjectClass"/>
      </field>
    </record>
    <class name="MediaDescriptorParser"
           c:symbol-prefix="media_descriptor_parser"
           c:type="GstValidateMediaDescriptorParser"
           parent="MediaDescriptor"
           glib:type-name="GstValidateMediaDescriptorParser"
           glib:get-type="gst_validate_media_descriptor_parser_get_type"
           glib:type-struct="MediaDescriptorParserClass">
      <implements name="Reporter"/>
      <constructor name="new"
                   c:identifier="gst_validate_media_descriptor_parser_new"
                   throws="1">
        <return-value transfer-ownership="none">
          <type name="MediaDescriptorParser"
                c:type="GstValidateMediaDescriptorParser*"/>
        </return-value>
        <parameters>
          <parameter name="runner" transfer-ownership="none">
      ...
      <constructor name="new_from_xml"
                   c:identifier="gst_validate_media_descriptor_parser_new_from_xml"
                   throws="1">
        <return-value transfer-ownership="none">
          <type name="MediaDescriptorParser"
                c:type="GstValidateMediaDescriptorParser*"/>
      ...
      <method name="add_stream"
              c:identifier="gst_validate_media_descriptor_parser_add_stream">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="add_taglist"
              c:identifier="gst_validate_media_descriptor_parser_add_taglist">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="all_stream_found"
              c:identifier="gst_validate_media_descriptor_parser_all_stream_found">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="all_tags_found"
              c:identifier="gst_validate_media_descriptor_parser_all_tags_found">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_xml_path"
              c:identifier="gst_validate_media_descriptor_parser_get_xml_path">
        <return-value transfer-ownership="full">
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
      ...
      <field name="priv">
        <type name="MediaDescriptorParserPrivate"
              c:type="GstValidateMediaDescriptorParserPrivate*"/>
      </field>
    </class>
    <record name="MediaDescriptorParserClass"
            c:type="GstValidateMediaDescriptorParserClass"
            glib:is-gtype-struct-for="MediaDescriptorParser">
      <field name="parent">
        <type name="MediaDescriptorClass"
              c:type="GstValidateMediaDescriptorClass"/>
      </field>
    </record>
    <record name="MediaDescriptorParserPrivate"
            c:type="GstValidateMediaDescriptorParserPrivate"
            disguised="1">
    </record>
    <record name="MediaDescriptorPrivate"
            c:type="GstValidateMediaDescriptorPrivate"
            disguised="1">
    </record>
    <class name="MediaDescriptorWriter"
           c:symbol-prefix="media_descriptor_writer"
           c:type="GstValidateMediaDescriptorWriter"
           parent="MediaDescriptor"
           glib:type-name="GstValidateMediaDescriptorWriter"
           glib:get-type="gst_validate_media_descriptor_writer_get_type"
           glib:type-struct="MediaDescriptorWriterClass">
      <implements name="Reporter"/>
      <constructor name="new"
                   c:identifier="gst_validate_media_descriptor_writer_new">
        <return-value transfer-ownership="none">
          <type name="MediaDescriptorWriter"
                c:type="GstValidateMediaDescriptorWriter*"/>
        </return-value>
        <parameters>
          <parameter name="runner" transfer-ownership="none">
      ...
      <constructor name="new_discover"
                   c:identifier="gst_validate_media_descriptor_writer_new_discover"
                   throws="1">
        <return-value transfer-ownership="none">
          <type name="MediaDescriptorWriter"
                c:type="GstValidateMediaDescriptorWriter*"/>
        ...
        <parameters>
          ...
          <parameter name="handle_g_logs" transfer-ownership="none">
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="add_frame"
              c:identifier="gst_validate_media_descriptor_writer_add_frame">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="add_pad"
              c:identifier="gst_validate_media_descriptor_writer_add_pad">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="add_taglist"
              c:identifier="gst_validate_media_descriptor_writer_add_taglist">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="add_tags"
              c:identifier="gst_validate_media_descriptor_writer_add_tags">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="detects_frames"
              c:identifier="gst_validate_media_descriptor_writer_detects_frames">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_duration"
              c:identifier="gst_validate_media_descriptor_writer_get_duration">
        <return-value transfer-ownership="none">
          <type name="Gst.ClockTime" c:type="GstClockTime"/>
        </return-value>
        <parameters>
      ...
      <method name="get_seekable"
              c:identifier="gst_validate_media_descriptor_writer_get_seekable">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_xml_path"
              c:identifier="gst_validate_media_descriptor_writer_get_xml_path">
        <return-value transfer-ownership="full">
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
      ...
      <method name="serialize"
              c:identifier="gst_validate_media_descriptor_writer_serialize">
        <return-value transfer-ownership="full">
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
      ...
      <method name="write"
              c:identifier="gst_validate_media_descriptor_writer_write">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <field name="priv">
        <type name="MediaDescriptorWriterPrivate"
              c:type="GstValidateMediaDescriptorWriterPrivate*"/>
      </field>
    </class>
    <record name="MediaDescriptorWriterClass"
            c:type="GstValidateMediaDescriptorWriterClass"
            glib:is-gtype-struct-for="MediaDescriptorWriter">
      <field name="parent">
        <type name="MediaDescriptorClass"
              c:type="GstValidateMediaDescriptorClass"/>
      </field>
    </record>
    <record name="MediaDescriptorWriterPrivate"
            c:type="GstValidateMediaDescriptorWriterPrivate"
            disguised="1">
    </record>
    <record name="MediaFileNode" c:type="GstValidateMediaFileNode">
      ...
      <field name="tags" writable="1">
        <type name="MediaTagsNode" c:type="GstValidateMediaTagsNode*"/>
      </field>
      ...
      <field name="frame_detection" writable="1">
        <type name="gboolean" c:type="gboolean"/>
      </field>
      ...
      <field name="str_open" writable="1">
        <type name="utf8" c:type="gchar*"/>
      </field>
      <field name="str_close" writable="1">
        <type name="utf8" c:type="gchar*"/>
      </field>
    </record>
    <record name="MediaFrameNode" c:type="GstValidateMediaFrameNode">
      <field name="id" writable="1">
        <type name="guint64" c:type="guint64"/>
      </field>
      ...
      <field name="running_time" writable="1">
        <type name="Gst.ClockTime" c:type="GstClockTime"/>
      </field>
      <field name="is_keyframe" writable="1">
        <type name="gboolean" c:type="gboolean"/>
      </field>
...
Stores extracted information about a media</doc>
    ...
    <record name="MediaStreamNode" c:type="GstValidateMediaStreamNode">
      ...
      <field name="padname" writable="1">
        <type name="utf8" c:type="gchar*"/>
      </field>
      <field name="pad" writable="1">
        <type name="Gst.Pad" c:type="GstPad*"/>
      </field>
      <field name="cframe" writable="1">
        <type name="GLib.List" c:type="GList*">
          <type name="gpointer" c:type="gpointer"/>
        </type>
      </field>
    ...
    <record name="MediaTagNode" c:type="GstValidateMediaTagNode">
      <field name="taglist" writable="1">
        <type name="Gst.TagList" c:type="GstTagList*"/>
      </field>
    ...
    <record name="MediaTagsNode" c:type="GstValidateMediaTagsNode">
      <field name="tags" writable="1">
        <type name="GLib.List" c:type="GList*">
          <type name="gpointer" c:type="gpointer"/>
        </type>
...
Class that wraps a #GObject for Validate checks</doc>
      ...
      <virtual-method name="get_element" invoker="get_element">
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The GstElement associated with @monitor</doc>
          <type name="Gst.Element" c:type="GstElement*"/>
        </return-value>
        <parameters>
    ...
    <class name="Override"
      ...
      <virtual-method name="can_attach"
                      invoker="can_attach"
                      introspectable="0">
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
...
Class that wraps a #GstPad for Validate checks</doc>
      ...
      <field name="event_full_func">
        <type name="Gst.PadEventFullFunction"
      ...
      <field name="pending_seek_accurate_time" readable="0" private="1">
        <type name="Gst.ClockTime" c:type="GstClockTime"/>
      </field>
...
equations in the action structure.</doc>
      <return-value transfer-ownership="none">
        <doc xml:space="preserve">%TRUE if the action could be prepared and is ready to be run
         , %FALSE otherwise</doc>
        <type name="gboolean" c:type="gboolean"/>
      </return-value>
      <parameters>
    ...
    <interface name="Reporter"
      ...
      <virtual-method name="get_pipeline" invoker="get_pipeline">
        <return-value transfer-ownership="full" nullable="1">
          <doc xml:space="preserve">The #GstPipeline</doc>
          <type name="Gst.Pipeline" c:type="GstPipeline*"/>
        </return-value>
        <parameters>
          <instance-parameter name="reporter" transfer-ownership="none">
            <doc xml:space="preserve">The reporter to get the pipeline from</doc>
            <type name="Reporter" c:type="GstValidateReporter*"/>
          </instance-parameter>
        </parameters>
      </virtual-method>
      ...
      <method name="get_pipeline"
              c:identifier="gst_validate_reporter_get_pipeline">
        <return-value transfer-ownership="full" nullable="1">
          <doc xml:space="preserve">The #GstPipeline</doc>
          <type name="Gst.Pipeline" c:type="GstPipeline*"/>
        </return-value>
...
The caller should unref each report once it is done with them.</doc>
      ...
      <method name="get_runner"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The runner</doc>
          <type name="Runner" c:type="GstValidateRunner*"/>
        </return-value>
        <parameters>
          <instance-parameter name="reporter" transfer-ownership="none">
            <doc xml:space="preserve">The reporter to get the runner from</doc>
            <type name="Reporter" c:type="GstValidateReporter*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="purge_reports"
              c:identifier="gst_validate_reporter_purge_reports">
        <doc xml:space="preserve">Remove all the #GstValidateReport from @reporter. This should be called
...
Class that manages a Validate test run for some pipeline</doc>
      ...
      <method name="get_reports"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">all the reports</doc>
          <type name="GLib.List" c:type="GList*">
            <type name="Report"/>
          </type>
        </return-value>
        <parameters>
          <instance-parameter name="runner" transfer-ownership="none">
            <doc xml:space="preserve">The #GstValidateRunner</doc>
            <type name="Runner" c:type="GstValidateRunner*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="get_reports_count"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">The number of reports present in the runner.</doc>
          <type name="guint" c:type="guint"/>
        </return-value>
        <parameters>
          <instance-parameter name="runner" transfer-ownership="none">
            <doc xml:space="preserve">The $GstValidateRunner to get the number of reports from</doc>
            <type name="Runner" c:type="GstValidateRunner*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="printf" c:identifier="gst_validate_runner_printf">
        <doc xml:space="preserve">Prints all the reports on the terminal or on wherever is set
...
For more information you should have a look at #gst_event_new_seek</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the seek could be executed, %FALSE otherwise</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
...
value to a GstClockTime.</doc>
    ...
    <function name="filenode_free" c:identifier="gst_validate_filenode_free">
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        <parameter name="filenode" transfer-ownership="none">
          <type name="MediaFileNode" c:type="GstValidateMediaFileNode*"/>
        </parameter>
      </parameters>
    </function>
...
function.</doc>
    ...
    <function name="media_descriptors_compare"
              c:identifier="gst_validate_media_descriptors_compare">
      <return-value transfer-ownership="none">
        <type name="gboolean" c:type="gboolean"/>
      </return-value>
    ...
    <function name="media_info_load"
              c:identifier="gst_validate_media_info_load"
              moved-to="MediaInfo.load"
              introspectable="0"
              throws="1">
      <return-value>
        <type name="MediaInfo" c:type="GstValidateMediaInfo*"/>
    ...
    <function name="override_registry_get"
              c:identifier="gst_validate_override_registry_get"
              moved-to="OverrideRegistry.get"
              introspectable="0">
      <return-value>
        <type name="OverrideRegistry" c:type="GstValidateOverrideRegistry*"/>
      </return-value>
...
if it had a higher rank</doc>
      ...
      <parameters>
        ...
        <parameter name="flags" transfer-ownership="none">
          <doc xml:space="preserve">The #GstValidateActionTypeFlags to set on the new action type</doc>
          <type name="ActionTypeFlags" c:type="GstValidateActionTypeFlags"/>
        </parameter>
      </parameters>
    </function>
...
You can also use #GST_VALIDATE_REPORT instead.</doc>
      ...
      <parameters>
        <parameter name="reporter" transfer-ownership="none">
          <doc xml:space="preserve">The source of the new report</doc>
          <type name="Reporter" c:type="GstValidateReporter*"/>
        </parameter>
        <parameter name="issue_id" transfer-ownership="none">
    ...
    <function name="structs_parse_from_gfile"
              c:identifier="gst_validate_structs_parse_from_gfile"
              introspectable="0">
      <return-value>
        <type name="GLib.List" c:type="GList*">
          <type name="gpointer" c:type="gpointer"/>
    ...
    <function name="tag_node_compare"
              c:identifier="gst_validate_tag_node_compare">
      <return-value transfer-ownership="none">
        <type name="gboolean" c:type="gboolean"/>
      </return-value>
      <parameters>
        <parameter name="tnode" transfer-ownership="none">
          <type name="MediaTagNode" c:type="GstValidateMediaTagNode*"/>
        </parameter>
    ...
    <function name="utils_parse_expression"
      ...
      <parameters>
        ...
        <parameter name="variable_func" transfer-ownership="none" closure="2">
          <type name="ParseVariableFunc"
                c:type="GstValidateParseVariableFunc"/>
        </parameter>
        <parameter name="user_data"
                   transfer-ownership="none"
                   nullable="1"
