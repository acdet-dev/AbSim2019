...
<repository version="1.2"
  ...
  <namespace name="Uhm"
             version="0.0"
             shared-library="libuhttpmock-0.0-0.dll"
...
&lt;/programlisting&gt;&lt;/informalexample&gt;</doc>
      ...
      <method name="compare_messages_remove_filter"
              ...
              version="0.5.0">
        <doc xml:space="preserve">Remove a #UhmServer:compare-messages filter function installed previously by
...
It is an error to call this function with an invalid @filter_id.</doc>
        ...
        <parameters>
          ...
          <parameter name="filter_id" transfer-ownership="none">
            <doc xml:space="preserve">filter ID returned by the filter addition function</doc>
...
If #UhmServer:enable-online is %FALSE, this will shut down the mock server (as if uhm_server_stop() had been called).</doc>
      ...
      <method name="filter_ignore_parameter_values"
              ...
              version="0.5.0">
        <doc xml:space="preserve">Install a #UhmServer:compare-messages filter function which will override the
...
used. This may change in future.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">opaque filter ID used with
