...
<repository version="1.2"
  ...
  <namespace name="EBook"
             version="1.2"
             shared-library="libebook-contacts-1.2-2.dll,libedata-book-1.2-25.dll,libebook-1.2-16.dll,libedataserver-1.2-21.dll"
...
from an XML document.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">A %NULL-terminated array of pointers to
