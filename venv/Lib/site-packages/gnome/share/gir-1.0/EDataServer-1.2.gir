...
<repository version="1.2"
  ...
  <namespace name="EDataServer"
             version="1.2"
             shared-library="libedataserver-1.2-21.dll,libcamel-1.2-54.dll"
...
If an error occurs, the function sets @error and returns %FALSE.</doc>
        ...
        <parameters>
          <instance-parameter name="client" transfer-ownership="none">
            <doc xml:space="preserve">an #EClient
If an error occurs, the function sets @error and returns %FALSE.</doc>
            <type name="Client" c:type="EClient*"/>
          </instance-parameter>
          <parameter name="result" transfer-ownership="none">
...
type of #EClient.</doc-deprecated>
      ...
      <glib:signal name="opened"
                   ...
                   deprecated="1"
                   deprecated-version="3.8">
        <doc-deprecated xml:space="preserve">This signal is no longer emitted.</doc-deprecated>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
then it should provide it on its own.</doc>
      ...
      <constructor name="new_string"
                   ...
                   version="3.18">
        <doc xml:space="preserve">Creates a new instance of an #ENamedParamters, with initial content being
...
different authentication methods can use different names.</doc>
    ...
    <constant name="SOURCE_CREDENTIAL_SSL_TRUST"
              ...
              version="3.16">
      <doc xml:space="preserve">A name of the named parameter used for SSL trust in credentials,
used to authenticate users with e_source_invoke_authenticate_sync()
and e_source_invoke_authenticate(). The named parameter is optional.
...
If an error occurs, the function will set @error and return %FALSE.</doc>
      ...
      <virtual-method name="invoke_authenticate_impl" throws="1">
        ...
        <parameters>
          ...
          <parameter name="dbus_source" transfer-ownership="none">
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
...
If an error occurs, the function sets @error and returns %FALSE.</doc>
        ...
        <parameters>
          ...
          <parameter name="out_credentials" transfer-ownership="none">
...
The returned string should be freed with g_free() when no longer needed.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly-allocated copy of #ESourceMailSignature:mime-type</doc>
          <type name="utf8" c:type="gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="extension" transfer-ownership="none">
...
values for the program.</doc>
      ...
      <method name="get_ssl_trust"
              ...
              version="3.8">
        <doc xml:space="preserve">Returns an SSL certificate trust for the @extension.
...
and e_source_webdav_verify_ssl_trust().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">an SSL certificate trust for the @extension</doc>
          <type name="utf8" c:type="const gchar*"/>
        </return-value>
        <parameters>
          <instance-parameter name="extension" transfer-ownership="none">
...
@uri is ignored.)</doc>
      ...
      <method name="set_ssl_trust"
              ...
              version="3.8">
        <doc xml:space="preserve">Sets the SSL certificate trust. See e_source_webdav_get_ssl_trust()
...
a temporary reject, which means the user will be asked again.</doc>
      ...
      <method name="verify_ssl_trust"
        ...
        <doc xml:space="preserve">Verifies SSL trust for the given @host and @cert, as previously stored in the @extension
...
also @objects itself.</doc>
    ...
    <function name="util_get_cp_prefix" c:identifier="e_util_get_cp_prefix">
      <return-value transfer-ownership="none">
        <type name="utf8" c:type="const gchar*"/>
      </return-value>
    </function>
    <function name="util_get_localedir" c:identifier="e_util_get_localedir">
      <return-value transfer-ownership="none">
        <type name="utf8" c:type="const gchar*"/>
      </return-value>
    </function>
    <function name="util_get_prefix" c:identifier="e_util_get_prefix">
      <return-value transfer-ownership="none">
        <type name="utf8" c:type="const gchar*"/>
      </return-value>
    </function>
...
reused after a thread has terminated, though.</doc>
    ...
    <function name="util_replace_prefix" c:identifier="e_util_replace_prefix">
      <return-value transfer-ownership="full">
        <type name="utf8" c:type="gchar*"/>
      </return-value>
      <parameters>
        <parameter name="configure_time_prefix" transfer-ownership="none">
          <type name="utf8" c:type="const gchar*"/>
        </parameter>
        <parameter name="runtime_prefix" transfer-ownership="none">
          <type name="utf8" c:type="const gchar*"/>
        </parameter>
        <parameter name="configure_time_path" transfer-ownership="none">
          <type name="utf8" c:type="const gchar*"/>
        </parameter>
      </parameters>
    </function>
...
decomposed for comparison, and case is ignored.</doc>
    ...
    <function name="util_win32_initialize"
              c:identifier="e_util_win32_initialize">
      <doc xml:space="preserve">Initializes win32 environment. This might be called in main().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
    </function>
...
no longer needed.</doc>
      ...
      <parameters>
        ...
        <parameter name="out_certificate_pem"
                   ...
                   caller-allocates="0"
                   transfer-ownership="full">
          <doc xml:space="preserve">(allow-none): optional return location
  ...
  with an SSL error</doc>
        ...
        <parameter name="out_certificate_errors"
                   ...
                   caller-allocates="0"
                   transfer-ownership="full">
          <doc xml:space="preserve">(allow-none): optional #GTlsCertificateFlags,
  with certificate error flags when the operation failed with SSL error</doc>
        ...
        <parameter name="out_discovered_sources"
                   ...
                   caller-allocates="0"
                   transfer-ownership="full">
          <doc xml:space="preserve">(element-type EWebDAVDiscoveredSource): a #GSList
  of all discovered sources</doc>
        ...
        <parameter name="out_calendar_user_addresses"
                   ...
                   caller-allocates="0"
                   transfer-ownership="full">
          <doc xml:space="preserve">(allow-none): (element-type gchar *): a #GSList of
