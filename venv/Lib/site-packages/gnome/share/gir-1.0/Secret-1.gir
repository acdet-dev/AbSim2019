...
<repository version="1.2"
  ...
  <namespace name="Secret"
             version="1"
             shared-library="libsecret-1-0.dll"
...
Items that are locked will not have their secrets loaded.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">whether the operation succeded or not</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <parameter name="result" transfer-ownership="none">
...
secret_item_get_secret().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">whether the secret item succesfully loaded or not</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
