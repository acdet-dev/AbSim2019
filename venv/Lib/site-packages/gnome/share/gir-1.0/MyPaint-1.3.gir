...
<repository version="1.2"
  ...
  <namespace name="MyPaint"
             version="1.3"
             shared-library="libmypaint-1-3-0.dll"
             c:identifier-prefixes="MyPaint"
             c:symbol-prefixes="mypaint_">
    <record name="Brush" c:type="MyPaintBrush" disguised="1">
      <doc xml:space="preserve">The MyPaint brush engine class.</doc>
      ...
      <method name="get_base_value"
        ...
        <doc xml:space="preserve">Get the base value of a brush setting.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="get_inputs_used_n"
        ...
        <doc xml:space="preserve">Returns how many inputs are used for the dynamics of a #MyPaintBrushSetting</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="get_mapping_n" c:identifier="mypaint_brush_get_mapping_n">
        <doc xml:space="preserve">Get the number of points used for the dynamics mapping between a #MyPaintBrushInput and #MyPaintBrushSetting.</doc>
        <return-value transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
      ...
      <method name="get_mapping_point"
        ...
        <doc xml:space="preserve">Get a X,Y point of a dynamics mapping.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="x"
            ...
            <doc xml:space="preserve">Location to return the X value</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
          <parameter name="y"
                     direction="out"
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">Location to return the Y value</doc>
            <type name="gfloat" c:type="float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_state" c:identifier="mypaint_brush_get_state">
        <doc xml:space="preserve">Get an internal brush engine state.
Normally used for debugging, but can be used to implement record &amp; replay functionality.</doc>
      ...
      <method name="get_total_stroke_painting_time"
        ...
        <doc xml:space="preserve">Return the total amount of painting time for the current stroke.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="is_constant" c:identifier="mypaint_brush_is_constant">
        <doc xml:space="preserve">Returns TRUE if the brush has no dynamics for the given #MyPaintBrushSetting</doc>
        <return-value transfer-ownership="none">
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="new_stroke" c:identifier="mypaint_brush_new_stroke">
        <doc xml:space="preserve">Start a new stroke.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="ref" c:identifier="mypaint_brush_ref" introspectable="0">
        <doc xml:space="preserve">Increase the reference count.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="reset" c:identifier="mypaint_brush_reset">
        <doc xml:space="preserve">Reset the current brush engine state.
...
Note that the reset request is queued and changes in state will only happen on next stroke_to()</doc>
      ...
      <method name="set_base_value"
        ...
        <doc xml:space="preserve">Set the base value of a brush setting.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_mapping_n" c:identifier="mypaint_brush_set_mapping_n">
        <doc xml:space="preserve">Set the number of points used for the dynamics mapping between a #MyPaintBrushInput and #MyPaintBrushSetting.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_mapping_point"
        ...
        <doc xml:space="preserve">Set a X,Y point of a dynamics mapping.
The index must be within the number of points set using mypaint_brush_set_mapping_n()</doc>
      ...
      <method name="set_print_inputs"
        ...
        <doc xml:space="preserve">Enable/Disable printing of brush engine inputs on stderr. Intended for debugging only.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_state" c:identifier="mypaint_brush_set_state">
        <doc xml:space="preserve">Set an internal brush engine state.
Normally used for debugging, but can be used to implement record &amp; replay functionality.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="stroke_to" c:identifier="mypaint_brush_stroke_to">
        <doc xml:space="preserve">Should be called once for each motion event.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">non-0 if the stroke is finished or empty, else 0.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
          ...
          <parameter name="dtime" transfer-ownership="none">
            <doc xml:space="preserve">Time since last motion event, in seconds.</doc>
            <type name="gdouble" c:type="double"/>
          </parameter>
        </parameters>
      </method>
      <method name="unref"
              ...
              introspectable="0">
        <doc xml:space="preserve">Decrease the reference count. Will be freed when it hits 0.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <function name="new" c:identifier="mypaint_brush_new" introspectable="0">
        <doc xml:space="preserve">Create a new MyPaint brush engine instance.
Initial reference count is 1. Release references using mypaint_brush_unref()</doc>
    ...
    <record name="FixedTiledSurface"
            ...
            disguised="1">
      <doc xml:space="preserve">Simple #MyPaintTiledSurface subclass that implements a fixed sized #MyPaintSurface.
...
how to implement a tiled surface subclass.</doc>
      ...
      <function name="new"
                c:identifier="mypaint_fixed_tiled_surface_new"
                introspectable="0">
        <return-value>
          <type name="FixedTiledSurface" c:type="MyPaintFixedTiledSurface*"/>
        </return-value>
    ...
    <record name="Rectangle" c:type="MyPaintRectangle">
      ...
      <method name="copy"
              c:identifier="mypaint_rectangle_copy"
              introspectable="0">
        <return-value>
    ...
    <record name="Surface" c:type="MyPaintSurface">
      <doc xml:space="preserve">Abstract surface type for the MyPaint brush engine. The surface interface
lets the brush engine specify dabs to render, and to pick color.</doc>
      ...
      <method name="draw_dab" c:identifier="mypaint_surface_draw_dab">
        <doc xml:space="preserve">Draw a dab onto the surface.</doc>
        <return-value transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
      ...
      <method name="end_atomic" c:identifier="mypaint_surface_end_atomic">
        ...
        <parameters>
          ...
          <parameter name="roi"
                     ...
                     optional="1"
                     allow-none="1">
            <doc xml:space="preserve">Place to put invalidated rectangle</doc>
            <type name="Rectangle" c:type="MyPaintRectangle*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <method name="init"
              ...
              introspectable="0">
        <doc xml:space="preserve">Initialize the surface. The reference count will be set to 1.
Note: Only intended to be called from subclasses of #MyPaintSurface</doc>
      ...
      <method name="unref"
              ...
              introspectable="0">
        <doc xml:space="preserve">Decrease the reference count.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <record name="TileRequest" c:type="MyPaintTileRequest">
      ...
      <method name="init" c:identifier="mypaint_tile_request_init">
        <doc xml:space="preserve">Initialize a request for use with mypaint_tiled_surface_tile_request_start()
and mypaint_tiled_surface_tile_request_end()</doc>
    ...
    <record name="TiledSurface" c:type="MyPaintTiledSurface">
      <doc xml:space="preserve">Interface and convenience class for implementing a #MyPaintSurface backed by a tile store.

The size of the surface is infinite, and consumers need just implement two vfuncs.</doc>
      ...
      <method name="begin_atomic"
              ...
              introspectable="0">
        <doc xml:space="preserve">Implementation of #MyPaintSurface::being_atomic vfunc
...
Application code should only use mypaint_surface_being_atomic()</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="destroy"
              ...
              introspectable="0">
        <doc xml:space="preserve">Deallocate resources set up by mypaint_tiled_surface_init()
...
Note: Only intended to be called from subclasses of #MyPaintTiledSurface</doc>
      ...
      <method name="end_atomic"
              ...
              introspectable="0">
        <doc xml:space="preserve">Implementation of #MyPaintSurface::end_atomic vfunc
Note: Only intended to be used from #MyPaintTiledSurface subclasses, which should chain up to this
...
Application code should only use mypaint_surface_end_atomic().</doc>
      ...
      <method name="init"
              ...
              introspectable="0">
        <doc xml:space="preserve">Initialize the surface, passing in implementations of the tile backend.
Note: Only intended to be called from subclasses of #MyPaintTiledSurface</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <method name="set_symmetry_state"
        ...
        <doc xml:space="preserve">Enable/Disable symmetric brush painting across an X axis.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="active" transfer-ownership="none">
            <doc xml:space="preserve">TRUE to enable, FALSE to disable.</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
          <parameter name="center_x" transfer-ownership="none">
            <doc xml:space="preserve">X axis to mirror events across.</doc>
            <type name="gfloat" c:type="float"/>
          </parameter>
        </parameters>
      </method>
      <method name="tile_request_end"
        ...
        <doc xml:space="preserve">Put a (potentially modified) tile back into the underlying tile store.

Consumers must *always* call mypaint_tiled_surface_tile_request_start() with the same
request to start the transaction before calling this function.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="tile_request_start"
        ...
        <doc xml:space="preserve">Fetch a tile out from the underlying tile store.
...
request to complete the transaction.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <callback name="TiledSurfaceAreaChanged"
              c:type="MyPaintTiledSurfaceAreaChanged">
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="bb_x" transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </parameter>
        <parameter name="bb_y" transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </parameter>
        <parameter name="bb_w" transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </parameter>
        <parameter name="bb_h" transfer-ownership="none">
          <type name="gint" c:type="int"/>
        </parameter>
      </parameters>
    </callback>
