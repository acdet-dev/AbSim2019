...
<repository version="1.2"
  ...
  <namespace name="Mash"
             version="0.2"
             shared-library="libmash-0.2-0.dll"
    ...
    <class name="Data"
      ...
      <doc xml:space="preserve">The #MashData structure contains only private data.</doc>
      <constructor name="new" c:identifier="mash_data_new">
        <doc xml:space="preserve">Constructs a new #MashData instance. The object initially has
...
called. To load data into the object, call mash_data_load().</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #MashData.</doc>
      ...
      <method name="get_extents" c:identifier="mash_data_get_extents">
        <doc xml:space="preserve">Gets the bounding cuboid of the vertices in @self. The cuboid is
...
cheap to call this function.</doc>
        ...
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">A #MashData instance</doc>
            <type name="Data" c:type="MashData*"/>
          </instance-parameter>
          <parameter name="min_vertex" transfer-ownership="none">
            <doc xml:space="preserve">A location to return the minimum vertex</doc>
            <type name="Clutter.Vertex" c:type="ClutterVertex*"/>
          </parameter>
          <parameter name="max_vertex" transfer-ownership="none">
            <doc xml:space="preserve">A location to return the maximum vertex</doc>
            <type name="Clutter.Vertex" c:type="ClutterVertex*"/>
          </parameter>
        </parameters>
      </method>
      <method name="load" c:identifier="mash_data_load" throws="1">
        <doc xml:space="preserve">Loads the data from the file called @filename into @self. The
...
will be set to a GError instance.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the load succeeded or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">The #MashData instance</doc>
            <type name="Data" c:type="MashData*"/>
          </instance-parameter>
          <parameter name="flags" transfer-ownership="none">
            <doc xml:space="preserve">Flags used to specify load-time modifications to the data</doc>
            <type name="DataFlags" c:type="MashDataFlags"/>
          </parameter>
          <parameter name="filename" transfer-ownership="none">
            <doc xml:space="preserve">The name of a file to load</doc>
            <type name="utf8" c:type="const gchar*"/>
          </parameter>
        </parameters>
      </method>
      <method name="render" c:identifier="mash_data_render">
        <doc xml:space="preserve">Renders the data contained in the model to the Clutter
...
the paint method of the model.</doc>
    ...
    <record name="DataClass"
      ...
      <doc xml:space="preserve">The #MashDataClass structure contains only private data.</doc>
      <field name="parent_class" readable="0" private="1">
        <type name="GObject.ObjectClass" c:type="GObjectClass"/>
      </field>
    </record>
    <enumeration name="DataError" c:type="MashDataError">
      <doc xml:space="preserve">Error enumeration for #MashData</doc>
      <member name="unknown_format"
              value="0"
              c:identifier="MASH_DATA_ERROR_UNKNOWN_FORMAT">
        <doc xml:space="preserve">The file has an unknown format.</doc>
      </member>
      <member name="unknown" value="1" c:identifier="MASH_DATA_ERROR_UNKNOWN">
        <doc xml:space="preserve">The underlying library reported an error.</doc>
      </member>
      <member name="missing_property"
              value="2"
              c:identifier="MASH_DATA_ERROR_MISSING_PROPERTY">
        <doc xml:space="preserve">A property that is needed
 ...
 will happen if the file does not contain the x, y and z properties.</doc>
      ...
      <member name="invalid" value="3" c:identifier="MASH_DATA_ERROR_INVALID">
        <doc xml:space="preserve">The file is not valid.</doc>
      </member>
      <member name="unsupported"
              value="4"
              c:identifier="MASH_DATA_ERROR_UNSUPPORTED">
        <doc xml:space="preserve">The file is not supported
 ...
 vertices.</doc>
    ...
    <enumeration name="DataFlags" c:type="MashDataFlags">
      <doc xml:space="preserve">Flags used for modifying the data as it is loaded. These can be
...
pass the %MASH_DATA_NEGATE_Y flag.</doc>
      ...
      <member name="negate_x" value="1" c:identifier="MASH_DATA_NEGATE_X">
        <doc xml:space="preserve">Negate the X axis</doc>
      </member>
      <member name="negate_y" value="2" c:identifier="MASH_DATA_NEGATE_Y">
        <doc xml:space="preserve">Negate the Y axis</doc>
      </member>
      <member name="negate_z" value="4" c:identifier="MASH_DATA_NEGATE_Z">
        <doc xml:space="preserve">Negate the Z axis</doc>
      </member>
    </enumeration>
    <class name="DataLoader"
      ...
      <doc xml:space="preserve">The #MashDataLoader structure contains only private data.</doc>
      ...
      <virtual-method name="load" invoker="load" throws="1">
        <doc xml:space="preserve">Obtains the loaded data after calling mash_data_loader_load().
This function is not usually called by applications.</doc>
        ...
        <parameters>
          <instance-parameter name="data_loader" transfer-ownership="none">
            <doc xml:space="preserve">The #MashDataLoader instance</doc>
            <type name="DataLoader" c:type="MashDataLoader*"/>
          </instance-parameter>
          <parameter name="flags" transfer-ownership="none">
            <type name="DataFlags" c:type="MashDataFlags"/>
...
This function is not usually called by applications.</doc>
    ...
    <record name="DataLoaderData" c:type="MashDataLoaderData">
      <doc xml:space="preserve">The #MashDataLoaderData structure contains the loaded data.</doc>
    ...
    <class name="DirectionalLight"
      ...
      <doc xml:space="preserve">The #MashDirectionalLight structure contains only private data.</doc>
      ...
      <constructor name="new" c:identifier="mash_directional_light_new">
        <doc xml:space="preserve">Constructs a new directional light actor.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the new light.</doc>
    ...
    <class name="Light"
      ...
      <doc xml:space="preserve">The #MashLight structure contains only private data.</doc>
      <implements name="Atk.ImplementorIface"/>
      <implements name="Clutter.Animatable"/>
      <implements name="Clutter.Container"/>
      <implements name="Clutter.Scriptable"/>
      <virtual-method name="generate_shader" invoker="generate_shader">
        <doc xml:space="preserve">This function is used to generate the shader code required to
...
implementation so that it can declare the built-in uniforms.</doc>
        ...
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">A #MashLight</doc>
            <type name="Light" c:type="MashLight*"/>
          </instance-parameter>
          <parameter name="uniform_source" transfer-ownership="none">
            <doc xml:space="preserve">A location to append uniforms declarations to</doc>
            <type name="GLib.String" c:type="GString*"/>
          </parameter>
          <parameter name="main_source" transfer-ownership="none">
            <doc xml:space="preserve">A location to append lighting algorithm snippets to</doc>
            <type name="GLib.String" c:type="GString*"/>
          </parameter>
        </parameters>
      </virtual-method>
      <virtual-method name="update_uniforms" invoker="update_uniforms">
        <doc xml:space="preserve">This function is used by #MashLightSet to implement the lights. It
...
in mash_light_append_shader().</doc>
        ...
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The #MashLight that needs updating</doc>
            <type name="Light" c:type="MashLight*"/>
          </instance-parameter>
          <parameter name="program" transfer-ownership="none">
            <doc xml:space="preserve">A #CoglProgram containing the uniforms</doc>
            <type name="Cogl.Handle" c:type="CoglHandle"/>
          </parameter>
        </parameters>
      </virtual-method>
      <method name="append_shader" c:identifier="mash_light_append_shader">
        <doc xml:space="preserve">This is a convenience intended to be used within
...
‘positiong00000002’.</doc>
        ...
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The #MashLight which is generating the shader</doc>
            <type name="Light" c:type="MashLight*"/>
          </instance-parameter>
          <parameter name="shader_source" transfer-ownership="none">
            <doc xml:space="preserve">The string to append to</doc>
            <type name="GLib.String" c:type="GString*"/>
          </parameter>
          <parameter name="snippet" transfer-ownership="none">
            <doc xml:space="preserve">A snippet of GLSL</doc>
...
implementation so that it can declare the built-in uniforms.</doc>
      ...
      <method name="get_ambient" c:identifier="mash_light_get_ambient">
        <doc xml:space="preserve">Retrieves the ‘ambient’ color emitted by the light.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The #MashLight to query</doc>
            <type name="Light" c:type="MashLight*"/>
          </instance-parameter>
          <parameter name="ambient" transfer-ownership="none">
            <doc xml:space="preserve">A return location for the color</doc>
            <type name="Clutter.Color" c:type="ClutterColor*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_diffuse" c:identifier="mash_light_get_diffuse">
        <doc xml:space="preserve">Retrieves the ‘diffuse’ color emitted by the light.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="get_modelview_matrix"
        ...
        <doc xml:space="preserve">Gets the modelview matrix for the light including all of the
...
position.</doc>
        ...
        <parameters>
          ...
          <parameter name="matrix" transfer-ownership="none">
            <doc xml:space="preserve">The return location for the matrix</doc>
            <type name="Cogl.Matrix" c:type="CoglMatrix*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_specular" c:identifier="mash_light_get_specular">
        <doc xml:space="preserve">Retrieves the ‘specular’ color emitted by the light.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
mash_light_append_shader().</doc>
        ...
        <parameters>
          ...
          <parameter name="program" transfer-ownership="none">
            <doc xml:space="preserve">The program passed in from mash_light_update_uniforms().</doc>
            <type name="Cogl.Handle" c:type="CoglHandle"/>
          </parameter>
      ...
      <method name="set_ambient" c:identifier="mash_light_set_ambient">
        <doc xml:space="preserve">Sets the ‘ambient’ color emitted by the light. If the light reaches
...
used to give an approximation of the effect.</doc>
        ...
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The #MashLight to modify</doc>
            <type name="Light" c:type="MashLight*"/>
          </instance-parameter>
          <parameter name="ambient" transfer-ownership="none">
            <doc xml:space="preserve">The new color value</doc>
            <type name="Clutter.Color" c:type="const ClutterColor*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_diffuse" c:identifier="mash_light_set_diffuse">
        <doc xml:space="preserve">Sets the ‘diffuse’ color emitted by the light. The diffuse color is
...
it won't change direction for non-uniform scaling transformations.</doc>
        ...
        <parameters>
          ...
          <parameter name="uniform_location" transfer-ownership="none">
            <doc xml:space="preserve">The location of the uniform</doc>
            <type name="gint" c:type="int"/>
          </parameter>
          <parameter name="direction_in" transfer-ownership="none">
            <doc xml:space="preserve">The untransformed direction uniform</doc>
            <type name="gfloat" c:type="const float*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_specular" c:identifier="mash_light_set_specular">
        <doc xml:space="preserve">Sets the ‘specular’ color emitted by the light. The specular color
...
in mash_light_append_shader().</doc>
    ...
    <class name="LightSet"
      ...
      <doc xml:space="preserve">The #MashLightSet structure contains only private data.</doc>
      <constructor name="new" c:identifier="mash_light_set_new">
        <doc xml:space="preserve">Constructs a new #MashLightSet.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #MashLightSet.</doc>
          <type name="LightSet" c:type="MashLightSet*"/>
        </return-value>
      </constructor>
      <method name="add_light" c:identifier="mash_light_set_add_light">
        <doc xml:space="preserve">This adds a light to the set. Lights need to be added to the light
...
hierarchy in order to be useful.</doc>
        ...
        <parameters>
          <instance-parameter name="light_set" transfer-ownership="none">
            <doc xml:space="preserve">A #MashLightSet instance</doc>
            <type name="LightSet" c:type="MashLightSet*"/>
          </instance-parameter>
          <parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">A #MashLight</doc>
      ...
      <method name="begin_paint"
              ...
              version="0.2"
              introspectable="0">
        <doc xml:space="preserve">This function should only be needed by custom actors that wish to
...
a light set is passed to mash_model_set_light_set().</doc>
        <return-value>
          <doc xml:space="preserve">a CoglProgram to use for rendering.</doc>
          <type name="Cogl.Handle" c:type="CoglHandle"/>
        </return-value>
        <parameters>
          <instance-parameter name="light_set" transfer-ownership="none">
          ...
          <parameter name="material" transfer-ownership="none">
            <doc xml:space="preserve">The material that will be used to paint</doc>
            <type name="Cogl.Handle" c:type="CoglHandle"/>
          </parameter>
        </parameters>
      </method>
      <method name="remove_light" c:identifier="mash_light_set_remove_light">
        <doc xml:space="preserve">Removes a light from the set.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
    ...
    <record name="LightSetClass"
      ...
      <doc xml:space="preserve">The #MashLightSetClass structure contains only private data.</doc>
      <field name="parent_class" readable="0" private="1">
        <type name="GObject.ObjectClass" c:type="GObjectClass"/>
      </field>
    </record>
    ...
    <class name="Model"
      ...
      <doc xml:space="preserve">The #MashModel structure contains only private data.</doc>
      <implements name="Atk.ImplementorIface"/>
      <implements name="Clutter.Animatable"/>
      <implements name="Clutter.Container"/>
      <implements name="Clutter.Scriptable"/>
      <constructor name="new" c:identifier="mash_model_new">
        <doc xml:space="preserve">Constructs a new #MashModel. Nothing will be rendered by the
model until a #MashData is attached using
mash_model_set_data().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a new #MashModel.</doc>
          <type name="Clutter.Actor" c:type="ClutterActor*"/>
        </return-value>
      </constructor>
...
you will need to modify the material.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a new #MashModel or %NULL if the load failed.</doc>
          <type name="Clutter.Actor" c:type="ClutterActor*"/>
        </return-value>
        <parameters>
          <parameter name="flags" transfer-ownership="none">
      ...
      <method name="get_data"
              ...
              introspectable="0">
        <doc xml:space="preserve">Gets the model data that will be used to render the actor.</doc>
        <return-value>
          <doc xml:space="preserve">A pointer to a #MashData instance or %NULL if
no data has been set yet.</doc>
          <type name="Data" c:type="MashData*"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
            <doc xml:space="preserve">A #MashModel instance</doc>
      ...
      <method name="get_fit_to_allocation"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">whether the actor will try to scale the model to fit
within the allocation.</doc>
      ...
      <method name="get_light_set"
              ...
              introspectable="0">
        <return-value>
          <doc xml:space="preserve">the #MashLightSet previously set with
mash_model_set_light_set().</doc>
      ...
      <method name="get_material"
              ...
              introspectable="0">
        <doc xml:space="preserve">Gets the material that will be used to render the model. The
material can be modified to affect the appearence of the model. By
default the material will be solid white.</doc>
        <return-value>
          <doc xml:space="preserve">a handle to the Cogl material used by the model.</doc>
          <type name="Cogl.Handle" c:type="CoglHandle"/>
        </return-value>
        <parameters>
          <instance-parameter name="self" transfer-ownership="none">
      ...
      <method name="set_data" c:identifier="mash_model_set_data">
        <doc xml:space="preserve">Replaces the data used by the actor with @data. A reference is
...
g_object_unref().</doc>
        ...
        <parameters>
          ...
          <parameter name="data" transfer-ownership="none">
            <doc xml:space="preserve">The new #MashData</doc>
            <type name="Data" c:type="MashData*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_fit_to_allocation"
        ...
        <doc xml:space="preserve">This sets whether the actor should scale the model to fit the
...
The default value is %TRUE.</doc>
      ...
      <method name="set_light_set"
              ...
              version="0.2">
        <doc xml:space="preserve">This sets the #MashLightSet that will be used to render the
...
--&gt;s that will affect the appearance of the model.</doc>
      ...
      <method name="set_material" c:identifier="mash_model_set_material">
        <doc xml:space="preserve">Replaces the material that will be used to render the model with
...
repeatedly change the program on the material during paint.</doc>
        ...
        <parameters>
          ...
          <parameter name="material" transfer-ownership="none">
            <doc xml:space="preserve">A handle to a Cogl material</doc>
            <type name="Cogl.Handle" c:type="CoglHandle"/>
          </parameter>
        </parameters>
      </method>
    ...
    <record name="ModelClass"
      ...
      <doc xml:space="preserve">The #MashModelClass structure contains only private data.</doc>
      <field name="parent_class" readable="0" private="1">
        <type name="Clutter.ActorClass" c:type="ClutterActorClass"/>
      </field>
    </record>
    ...
    <class name="PointLight"
      ...
      <doc xml:space="preserve">The #MashLightClass structure contains only private data.</doc>
      <implements name="Atk.ImplementorIface"/>
      <implements name="Clutter.Animatable"/>
      <implements name="Clutter.Container"/>
      <implements name="Clutter.Scriptable"/>
      <constructor name="new" c:identifier="mash_point_light_new">
        <doc xml:space="preserve">Constructs a new #MashPointLight.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the new light.</doc>
          <type name="Clutter.Actor" c:type="ClutterActor*"/>
        </return-value>
      ...
      <method name="get_constant_attenuation"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the constant light attenuation value.</doc>
          <type name="gfloat" c:type="gfloat"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The light to query</doc>
      ...
      <method name="get_linear_attenuation"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the linear light attenuation value.</doc>
          <type name="gfloat" c:type="gfloat"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
      ...
      <method name="get_quadratic_attenuation"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the quadratic light attenuation value.</doc>
          <type name="gfloat" c:type="gfloat"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
      ...
      <method name="set_constant_attenuation"
        ...
        <doc xml:space="preserve">Sets the constant attenuation value on a light. The light intensity
...
light to appear dimmer.</doc>
        ...
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
            <doc xml:space="preserve">The light to modify</doc>
            <type name="PointLight" c:type="MashPointLight*"/>
          </instance-parameter>
      ...
      <method name="set_linear_attenuation"
        ...
        <doc xml:space="preserve">Sets the linear attenuation value on a light. The light intensity
...
as the vertex moves away from the light.</doc>
      ...
      <method name="set_quadratic_attenuation"
        ...
        <doc xml:space="preserve">Sets the quadratic attenuation value on a light. The light
...
intensity to dim sharply as the vertex moves away from the light.</doc>
    ...
    <record name="PointLightClass"
      ...
      <doc xml:space="preserve">The #MashPointLightClass structure contains only private data.</doc>
      <field name="parent_class" readable="0" private="1">
        <type name="LightClass" c:type="MashLightClass"/>
      </field>
    </record>
    ...
    <class name="SpotLight"
      ...
      <doc xml:space="preserve">The #MashSpotLight structure contains only private data.</doc>
      <implements name="Atk.ImplementorIface"/>
      <implements name="Clutter.Animatable"/>
      <implements name="Clutter.Container"/>
      <implements name="Clutter.Scriptable"/>
      <constructor name="new" c:identifier="mash_spot_light_new">
        <doc xml:space="preserve">Constructs a new #MashSpotLight.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the new light.</doc>
          <type name="Clutter.Actor" c:type="ClutterActor*"/>
        </return-value>
      ...
      <method name="get_spot_cutoff"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the spot cut off value</doc>
          <type name="gfloat" c:type="gfloat"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
      ...
      <method name="get_spot_exponent"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the spot exponent value</doc>
          <type name="gfloat" c:type="gfloat"/>
        </return-value>
        <parameters>
          <instance-parameter name="light" transfer-ownership="none">
      ...
      <method name="set_spot_cutoff"
        ...
        <doc xml:space="preserve">Sets the spot cut off value on a light. This is an angle in degrees
...
light. It should be within the range 0° to 90°</doc>
      ...
      <method name="set_spot_exponent"
        ...
        <doc xml:space="preserve">Sets the spot exponent value on a light. The light intensity is
...
exponent value makes the cone of the light appear smaller.</doc>
    ...
    <record name="SpotLightClass"
      ...
      <doc xml:space="preserve">The #MashSpotLightClass structure contains only private data.</doc>
      <field name="parent_class" readable="0" private="1">
