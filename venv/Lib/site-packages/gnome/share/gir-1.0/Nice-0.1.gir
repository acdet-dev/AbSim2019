...
(invalid stream or duplicate name).</doc>
      ...
      <property name="force-relay" writable="1" transfer-ownership="none">
        <type name="gboolean" c:type="gboolean"/>
      </property>
    ...
    <constant name="CANDIDATE_TYPE_PREF_RELAYED_UDP"
              value="30"
              c:type="NICE_CANDIDATE_TYPE_PREF_RELAYED_UDP">
      <type name="gint" c:type="gint"/>
    </constant>
