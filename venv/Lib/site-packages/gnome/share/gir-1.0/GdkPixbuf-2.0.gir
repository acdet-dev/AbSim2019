...
<repository version="1.2"
  ...
  <namespace name="GdkPixbuf"
    ...
    <alias name="PixbufAnimationIter_autoptr"
           c:type="GdkPixbufAnimationIter_autoptr">
      <type name="gpointer" c:type="gpointer"/>
    </alias>
    <alias name="PixbufAnimation_autoptr" c:type="GdkPixbufAnimation_autoptr">
      <type name="gpointer" c:type="gpointer"/>
    </alias>
    <alias name="PixbufLoader_autoptr" c:type="GdkPixbufLoader_autoptr">
      <type name="gpointer" c:type="gpointer"/>
    </alias>
    <alias name="PixbufSimpleAnim_autoptr"
           c:type="GdkPixbufSimpleAnim_autoptr">
      <type name="gpointer" c:type="gpointer"/>
    </alias>
    <alias name="Pixbuf_autoptr" c:type="GdkPixbuf_autoptr">
      <type name="gpointer" c:type="gpointer"/>
    </alias>
...
"0.8.2" for example.</doc>
    ...
    <constant name="PIXBUF_VERSION" value="2.36.6" c:type="GDK_PIXBUF_VERSION">
