...
<repository version="1.2"
  ...
  <namespace name="GES"
             version="1.0"
             shared-library="libges-1.0-0.dll"
...
if the @layer refuses to add the clip.</doc>
        ...
        <parameters>
          ...
          <parameter name="clip" transfer-ownership="full">
...
by the @timeline.</doc>
        ...
        <parameters>
          ...
          <parameter name="layer" transfer-ownership="full">
...
the in-point of @self according</doc>
      ...
      <virtual-method name="set_parent" invoker="set_parent">
        <doc xml:space="preserve">Sets the parent of @self to @parent. The object's reference count will
...
by #GESUriClipAsset-s.</doc>
    ...
    <constant name="VERSION_MINOR" value="12" c:type="GES_VERSION_MINOR">
      <type name="gint" c:type="gint"/>
    </constant>
