...
<repository version="1.2"
  ...
  <namespace name="Soup"
             version="2.4"
             shared-library="libsoup-2.4-1.dll"
...
MIME type for POSTing HTML form data.</doc>
    ...
    <constant name="LOGGER_MAX_BODY_SIZE"
              ...
              version="2.56">
      <doc xml:space="preserve">Alias for the #SoupLogger:max-body-size property, qv.</doc>
      <type name="utf8" c:type="gchar*"/>
    </constant>
    <class name="Logger"
...
the level passed to soup_logger_new().)</doc>
      ...
      <property name="max-body-size"
                ...
                writable="1"
                transfer-ownership="none">
        <doc xml:space="preserve">If #SoupLogger:level is %SOUP_LOGGER_LOG_BODY, this gives
...
&lt;/programlisting&gt;&lt;/informalexample&gt;</doc>
    ...
    <constant name="MAJOR_VERSION"
              ...
              version="2.42">
      <doc xml:space="preserve">Like soup_get_major_version(), but from the headers used at
...
behavior.</doc>
  ...
  message finishes. Since 2.50</doc>
      ...
      <member name="do_not_use_auth_cache"
        ...
        <doc xml:space="preserve">The #SoupAuthManager should not use
...
as a keepalive message. If set to 0 the keepalive message is disabled.</doc>
      ...
      <method name="set_max_incoming_payload_size"
              ...
              version="2.56">
        <doc xml:space="preserve">Sets the maximum payload size allowed for incoming packets. It
...
disabled.</doc>
      ...
      <property name="max-incoming-payload-size"
                ...
                construct="1"
                transfer-ownership="none">
        <doc xml:space="preserve">The maximum payload size for incoming packets the protocol expects
...
watch in, or %NULL for the default context</doc>
    ...
    <function name="check_version"
              ...
              version="2.42">
      <doc xml:space="preserve">Like SOUP_CHECK_VERSION, but the check for soup_check_version is
