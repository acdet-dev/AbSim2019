...
<repository version="1.2"
  ...
  <namespace name="GMime"
             version="2.6"
             shared-library="libgmime-2.6-0.dll"
...
#GMIME_DIGEST_ALGO_DEFAULT if unspecified.</doc>
      ...
      <method name="get_email" c:identifier="g_mime_certificate_get_email">
        <doc xml:space="preserve">Get the certificate's email.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the certificate's email or %NULL if unspecified.</doc>
      ...
      <method name="get_name" c:identifier="g_mime_certificate_get_name">
        <doc xml:space="preserve">Get the certificate's name.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the certificate's name or %NULL if unspecified.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="cert" transfer-ownership="none">
...
#GMIME_PUBKEY_ALGO_DEFAULT if unspecified.</doc>
      ...
      <method name="set_email" c:identifier="g_mime_certificate_set_email">
        <doc xml:space="preserve">Set the certificate's email.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_name" c:identifier="g_mime_certificate_set_name">
        <doc xml:space="preserve">Set the certificate's name.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_trust" c:identifier="g_mime_certificate_set_trust">
        ...
        <parameters>
          ...
          <parameter name="trust" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeCertificateTrust value</doc>
            <type name="CertificateTrust" c:type="GMimeCertificateTrust"/>
          </parameter>
        </parameters>
      </method>
...
index.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if an #GMimeCertificate was removed or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="list" transfer-ownership="none">
    ...
    <enumeration name="CertificateTrust" c:type="GMimeCertificateTrust">
      <doc xml:space="preserve">The trust value of a certificate.</doc>
      <member name="none"
              value="0"
              c:identifier="GMIME_CERTIFICATE_TRUST_NONE">
        <doc xml:space="preserve">No trust assigned.</doc>
      </member>
      <member name="never"
              value="1"
              c:identifier="GMIME_CERTIFICATE_TRUST_NEVER">
        <doc xml:space="preserve">Never trust this certificate.</doc>
      </member>
      <member name="undefined"
              value="2"
              c:identifier="GMIME_CERTIFICATE_TRUST_UNDEFINED">
        <doc xml:space="preserve">Undefined trust for this certificate.</doc>
      </member>
      <member name="marginal"
              value="3"
              c:identifier="GMIME_CERTIFICATE_TRUST_MARGINAL">
        <doc xml:space="preserve">Trust this certificate maginally.</doc>
      </member>
      <member name="fully"
              value="4"
              c:identifier="GMIME_CERTIFICATE_TRUST_FULLY">
        <doc xml:space="preserve">Trust this certificate fully.</doc>
      </member>
      <member name="ultimate"
              value="5"
              c:identifier="GMIME_CERTIFICATE_TRUST_ULTIMATE">
        <doc xml:space="preserve">Trust this certificate ultimately.</doc>
      </member>
    </enumeration>
    <record name="Charset" c:type="GMimeCharset">
      ...
      <method name="best_name" c:identifier="g_mime_charset_best_name">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a pointer to a string containing the best charset name that
...
limiting what charsets our @charset-&gt;mask can match.</doc>
      ...
      <function name="best" c:identifier="g_mime_charset_best">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the charset name best suited for the input text or %NULL if
...
charset-&gt;lang mapping. Everything else will return %NULL.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a language code that is specific to @charset, or %NULL on
fail.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
      ...
      <constructor name="new_from_string"
        ...
        <parameters>
          <parameter name="str" transfer-ownership="none">
            <doc xml:space="preserve">Content-Disposition field value or %NULL</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
...
will be in UTF-8.</doc>
      ...
      <method name="get_params"
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the list of #GMimeParam's set on @disposition.</doc>
...
UTF-8.</doc>
      ...
      <method name="set_params"
        ...
        <doc xml:space="preserve">Sets the Content-Disposition's parameter list.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="params" transfer-ownership="none">
            <doc xml:space="preserve">a list of #GMimeParam objects</doc>
      ...
      <method name="to_string"
        ...
        <doc xml:space="preserve">Allocates a string buffer containing the Content-Disposition header
represented by the disposition object @disposition.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a string containing the disposition header</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="disposition" transfer-ownership="none">
          ...
          <parameter name="fold" transfer-ownership="none">
            <doc xml:space="preserve">fold header if needed</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      ...
      <field name="param_hash">
        <doc xml:space="preserve">parameter hash table keyed by param name</doc>
      ...
      <field name="priv">
        <doc xml:space="preserve">private fields</doc>
        <type name="gpointer" c:type="gpointer"/>
      </field>
    ...
    <class name="ContentType"
      ...
      <constructor name="new" c:identifier="g_mime_content_type_new">
        ...
        <parameters>
          <parameter name="type" transfer-ownership="none">
            <doc xml:space="preserve">MIME type (or %NULL for "text")</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="subtype" transfer-ownership="none">
            <doc xml:space="preserve">MIME subtype (or %NULL for "plain")</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
      <constructor name="new_from_string"
        ...
        <doc xml:space="preserve">Constructs a new Content-Type object based on the input string.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GMimeContentType object based on the input string.</doc>
          <type name="ContentType" c:type="GMimeContentType*"/>
        </return-value>
        <parameters>
          <parameter name="str" transfer-ownership="none">
...
UTF-8.</doc>
        ...
        <parameters>
          <instance-parameter name="mime_type" transfer-ownership="none">
            <doc xml:space="preserve">MIME Content-Type</doc>
            <type name="ContentType" c:type="GMimeContentType*"/>
          </instance-parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">parameter name (aka attribute)</doc>
      ...
      <method name="set_params" c:identifier="g_mime_content_type_set_params">
        <doc xml:space="preserve">Sets the Content-Type's parameter list.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
content-type in the format: type/subtype.</doc>
      ...
      <field name="param_hash">
        <doc xml:space="preserve">parameter hash keyed by param name</doc>
        <type name="GLib.HashTable" c:type="GHashTable*">
          <type name="gpointer" c:type="gpointer"/>
          <type name="gpointer" c:type="gpointer"/>
        </type>
    ...
    <class name="CryptoContext"
      ...
      <virtual-method name="decrypt" invoker="decrypt" throws="1">
        <doc xml:space="preserve">Decrypts the ciphertext input stream and writes the resulting
...
on error.</doc>
      ...
      <virtual-method name="decrypt_session"
                      ...
                      throws="1">
        <doc xml:space="preserve">Decrypts the ciphertext input stream using a specific session key
...
on error.</doc>
        ...
        <parameters>
          ...
          <parameter name="session_key" transfer-ownership="none">
            <doc xml:space="preserve">session key to use</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="istream" transfer-ownership="none">
            <doc xml:space="preserve">input/ciphertext stream</doc>
...
writes the resulting ciphertext to the output stream.</doc>
        ...
        <parameters>
          ...
          <parameter name="userid" transfer-ownership="none">
            <doc xml:space="preserve">key id (or email address) to use when signing (assuming @sign is %TRUE)</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="digest" transfer-ownership="none">
            <doc xml:space="preserve">digest algorithm to use when signing</doc>
            <type name="DigestAlgo" c:type="GMimeDigestAlgo"/>
          </parameter>
          <parameter name="recipients" transfer-ownership="none">
            <doc xml:space="preserve">an array of recipient key ids
...
the key/certificate database controlled by @ctx.</doc>
        ...
        <parameters>
          ...
          <parameter name="keys" transfer-ownership="none">
            <doc xml:space="preserve">an array of key ids</doc>
            <array name="GLib.PtrArray" c:type="GPtrArray*">
              <type name="utf8"/>
            </array>
          </parameter>
      ...
      <virtual-method name="get_retrieve_session_key"
        ...
        <doc xml:space="preserve">Gets whether or not the @ctx is configured to retrieve a session
key during decryption (see g_mime_decrypt_result_get_session_key()).</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the @ctx is configured to retrieve a session key
...
into the key/certificate database controlled by @ctx.</doc>
      ...
      <virtual-method name="set_retrieve_session_key"
                      ...
                      throws="1">
        <doc xml:space="preserve">Configures whether @ctx should produce a session key during future
...
g_mime_decrypt_result_get_session_key()).</doc>
        ...
        <parameters>
          ...
          <parameter name="retrieve_session_key" transfer-ownership="none">
            <doc xml:space="preserve">whether to retrieve session keys during decryption</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </virtual-method>
      <virtual-method name="sign" invoker="sign" throws="1">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the #GMimeDigestAlgo used on success (useful if @digest is
specified as #GMIME_DIGEST_ALGO_DEFAULT) or %-1 on fail.</doc>
        ...
        <parameters>
          ...
          <parameter name="digest" transfer-ownership="none">
            <doc xml:space="preserve">digest algorithm to use</doc>
            <type name="DigestAlgo" c:type="GMimeDigestAlgo"/>
          </parameter>
          <parameter name="istream" transfer-ownership="none">
      ...
      <virtual-method name="verify" invoker="verify" throws="1">
        <doc xml:space="preserve">Verifies the signature. If @istream is a clearsigned stream,
...
the status of each signature or %NULL on error.</doc>
        ...
        <parameters>
          ...
          <parameter name="digest" transfer-ownership="none">
            <doc xml:space="preserve">digest algorithm used, if known</doc>
            <type name="DigestAlgo" c:type="GMimeDigestAlgo"/>
          </parameter>
          <parameter name="istream" transfer-ownership="none">
            <doc xml:space="preserve">input stream</doc>
          ...
          <parameter name="sigstream" transfer-ownership="none">
            <doc xml:space="preserve">optional detached-signature stream</doc>
            <type name="Stream" c:type="GMimeStream*"/>
          </parameter>
        </parameters>
      </virtual-method>
...
@stream.</doc>
    ...
    <class name="DecryptResult"
      ...
      <method name="get_session_key"
        ...
        <doc xml:space="preserve">Get the session_key used for this decryption, if the underlying
...
g_mime_crypto_context_set_retrieve_session_key().</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the session_key digest algorithm used, or NULL if no
...
stream was not signed.</doc>
      ...
      <method name="set_session_key"
        ...
        <doc xml:space="preserve">Set the session_key to be returned by this decryption result.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="session_key" transfer-ownership="none">
            <doc xml:space="preserve">a pointer to a null-terminated string representing the session key</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
    ...
    <constant name="ENABLE_RFC2047_WORKAROUNDS"
      ...
      <doc xml:space="preserve">Initialization flag to enable workarounds for badly formed rfc2047
encoded-words.</doc>
      <type name="gint" c:type="gint"/>
    </constant>
    <constant name="ENABLE_USE_ONLY_USER_CHARSETS"
              ...
              version="2.6.16">
      <doc xml:space="preserve">Initialization flag that hints to the rfc2047 encoder to use only
...
html entities.</doc>
    ...
    <constant name="FILTER_HTML_PRE" value="1" c:type="GMIME_FILTER_HTML_PRE">
      <doc xml:space="preserve">Wrap stream in &amp;lt;pre&amp;gt; tags.</doc>
      <type name="gint" c:type="gint"/>
    </constant>
    <class name="Filter"
...
previous ones</doc>
  ...
  pointer to output buffer</doc>
      ...
      <field name="outreal">
        <doc xml:space="preserve">real malloc'd buffer</doc>
        <array zero-terminated="0" c:type="char*">
          <type name="guint8"/>
        </array>
      </field>
      <field name="outbuf">
        <doc xml:space="preserve">first
  writable position allowed (outreal + outpre)</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="outptr">
        <doc xml:space="preserve">current writale position</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="outsize">
        <doc xml:space="preserve">current bytes in @outbuf</doc>
        <type name="gsize" c:type="size_t"/>
      </field>
      <field name="outpre">
        <doc xml:space="preserve">current prespace of @outbuf</doc>
        <type name="gsize" c:type="size_t"/>
      </field>
      <field name="backbuf">
        <doc xml:space="preserve">backup
  buffer</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="backsize">
        <doc xml:space="preserve">backup buffer size</doc>
        <type name="gsize" c:type="size_t"/>
      </field>
      <field name="backlen">
        <doc xml:space="preserve">number of bytes backed-up in @backbuf</doc>
        <type name="gsize" c:type="size_t"/>
      </field>
    </class>
...
use for the content passed through the filter.</doc>
    ...
    <class name="FilterCRLF"
      ...
      <doc xml:space="preserve">A filter to convert between line-ending formats and encode/decode
lines beginning with a '.'.</doc>
      <constructor name="new" c:identifier="g_mime_filter_crlf_new">
        <doc xml:space="preserve">Creates a new #GMimeFilterCRLF filter.
...
beginning of a line will be decoded into a single '.'.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new #GMimeFilterCRLF filter.</doc>
          <type name="Filter" c:type="GMimeFilter*"/>
        </return-value>
        <parameters>
          <parameter name="encode" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE if the filter should encode or %FALSE otherwise</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
          <parameter name="dots" transfer-ownership="none">
            <doc xml:space="preserve">encode/decode dots (as for SMTP)</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </constructor>
      ...
      <field name="encode">
        <doc xml:space="preserve">encoding vs decoding line endings/dots</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="dots">
        <doc xml:space="preserve">%TRUE if dot-stuffing should be performed or %FALSE otherwise</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="saw_cr">
        <doc xml:space="preserve">%TRUE if the previous char was a CR</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="saw_lf">
        <doc xml:space="preserve">%TRUE if the previous char was a LF</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="saw_dot">
        <doc xml:space="preserve">%TRUE if the previous char was a period</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
    </class>
...
plain UTF-8 text stream into an html stream.</doc>
    ...
    <class name="FilterMd5"
      ...
      <doc xml:space="preserve">A filter for calculating the MD5 checksum of a stream.</doc>
      <constructor name="new" c:identifier="g_mime_filter_md5_new">
        <doc xml:space="preserve">Creates a new Md5 filter.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a new Md5 filter.</doc>
          <type name="Filter" c:type="GMimeFilter*"/>
        </return-value>
      </constructor>
      <method name="get_digest" c:identifier="g_mime_filter_md5_get_digest">
        <doc xml:space="preserve">Outputs the md5 digest into @digest.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="md5" transfer-ownership="none">
            <doc xml:space="preserve">md5 filter object</doc>
            <type name="FilterMd5" c:type="GMimeFilterMd5*"/>
          </instance-parameter>
          <parameter name="digest" transfer-ownership="none">
            <doc xml:space="preserve">output buffer of at least 16 bytes</doc>
            <type name="guint8" c:type="unsigned char"/>
          </parameter>
        </parameters>
      </method>
...
or the proper Windows-CP125# charset.</doc>
    ...
    <class name="GpgContext"
      ...
      <constructor name="new"
        ...
        <parameters>
          <parameter name="request_passwd" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimePasswordRequestFunc</doc>
            <type name="PasswordRequestFunc"
                  c:type="GMimePasswordRequestFunc"/>
          </parameter>
          <parameter name="path" transfer-ownership="none">
            <doc xml:space="preserve">path to gpg binary or %NULL for the default</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </constructor>
      <method name="get_always_trust"
        ...
        <doc xml:space="preserve">Gets whther or not gpg should always trust keys when encrypting.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if gpg should always trust keys when encrypting or
%FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeGpgContext</doc>
      ...
      <method name="get_auto_key_retrieve"
        ...
        <doc xml:space="preserve">Gets whether or not gpg should auto-retrieve keys from a keyserver
when verifying signatures.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if gpg should auto-retrieve keys from a keyserver or
%FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_use_agent"
        ...
        <doc xml:space="preserve">Gets whether or not gpg should attempt to use the gpg-agent when
requesting credentials.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the gpg-agent should be used when requesting
credentials or %FALSE otherwise.</doc>
      ...
      <method name="set_always_trust"
        ...
        <doc xml:space="preserve">Sets whether or not gpg should always trust keys when encrypting.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="always_trust" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE if gpg should always trust keys when encrypting</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_auto_key_retrieve"
        ...
        <doc xml:space="preserve">Sets whether or not gpg should auto-retrieve keys from a keyserver
when verifying signatures.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="auto_key_retrieve" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE if gpg should auto-retrieve keys from a keys server</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_use_agent"
        ...
        <doc xml:space="preserve">Sets whether or not gpg should attempt to use the gpg-agent when
requesting credentials.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="use_agent" transfer-ownership="none">
            <doc xml:space="preserve">use agent flag</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
      <field name="parent_object">
        <doc xml:space="preserve">parent #GMimeCryptoContext</doc>
        <type name="CryptoContext" c:type="GMimeCryptoContext"/>
      </field>
      <field name="auto_key_retrieve">
        <doc xml:space="preserve">%TRUE if gpg should automatically retrieve unknown keys from the web</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="always_trust">
        <doc xml:space="preserve">%TRUE if keys should always be trusted</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="use_agent">
        <doc xml:space="preserve">%TRUE if gpg should use the gpg-agent for requesting passphrases</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="path">
        <doc xml:space="preserve">path to gpg</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="retrieve_session_key">
        <doc xml:space="preserve">%TRUE if session keys should be retrieved when decrypting</doc>
        <type name="gboolean" c:type="gboolean"/>
      </field>
      <field name="version">
        <doc xml:space="preserve">The GnuPG version.</doc>
        <type name="gint" c:type="int"/>
      </field>
    </class>
    ...
    <record name="Header" c:type="GMimeHeader" disguised="1">
      <doc xml:space="preserve">A message/rfc822 header.</doc>
    </record>
    <callback name="HeaderForeachFunc" c:type="GMimeHeaderForeachFunc">
      <doc xml:space="preserve">Function signature for the callback to g_mime_header_list_foreach().</doc>
      <return-value transfer-ownership="none">
        <type name="none" c:type="void"/>
      </return-value>
      <parameters>
        ...
        <parameter name="value" transfer-ownership="none">
          <doc xml:space="preserve">The field value.</doc>
          <type name="utf8" c:type="const char*"/>
        </parameter>
    ...
    <record name="HeaderIter" c:type="GMimeHeaderIter">
      <doc xml:space="preserve">A message or mime-part header iterator. All members should be
considered private.</doc>
      ...
      <field name="version" writable="1">
        <doc xml:space="preserve">the version of @hdrlist when initialized</doc>
        <type name="guint32" c:type="guint32"/>
      </field>
      <method name="copy"
              c:identifier="g_mime_header_iter_copy"
              introspectable="0">
        <doc xml:space="preserve">Creates a dynamically allocated header iterator as a copy of
@iter. You must free this iter with g_mime_header_iter_free().</doc>
        ...
        <parameters>
          <instance-parameter name="iter" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeHeaderIter</doc>
            <type name="HeaderIter" c:type="GMimeHeaderIter*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="copy_to" c:identifier="g_mime_header_iter_copy_to">
        <doc xml:space="preserve">Copies @src to @dest.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="equal" c:identifier="g_mime_header_iter_equal">
        <doc xml:space="preserve">Check that @iter1 and @iter2 reference the same header.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @iter1 and @iter2 refer to the same header or
%FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="first" c:identifier="g_mime_header_iter_first">
        <doc xml:space="preserve">Updates @iter to point to the first header.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="free" c:identifier="g_mime_header_iter_free">
        <doc xml:space="preserve">Frees a dynamically-allocated #GMimeHeaderIter as created by
g_mime_header_iter_new() or g_mime_header_iter_copy().</doc>
      ...
      <method name="get_name" c:identifier="g_mime_header_iter_get_name">
        <doc xml:space="preserve">Gets the current header's name.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="get_value" c:identifier="g_mime_header_iter_get_value">
        <doc xml:space="preserve">Gets the current header's value.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the header's raw, unprocessed value or %NULL if invalid.
...
g_mime_utils_header_decode_text() before displaying to the user.</doc>
      ...
      <method name="is_valid" c:identifier="g_mime_header_iter_is_valid">
        <doc xml:space="preserve">Checks if a #GMimeHeaderIter is valid. An iterator may become
invalid if the #GMimeHeaderList that the iterator refers to
changes.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if @iter is still valid or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="iter" transfer-ownership="none">
      ...
      <method name="last" c:identifier="g_mime_header_iter_last">
        <doc xml:space="preserve">Updates @iter to point to the last header.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE on success or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <method name="next" c:identifier="g_mime_header_iter_next">
        <doc xml:space="preserve">Advances to the next header.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE on success or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <method name="prev" c:identifier="g_mime_header_iter_prev">
        <doc xml:space="preserve">Advances to the previous header.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE on success or %FALSE otherwise.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
      ...
      <method name="remove" c:identifier="g_mime_header_iter_remove">
        <doc xml:space="preserve">Removes the current header and advances to the next header.
...
become invalid regardless of whether or not other headers remain.</doc>
      ...
      <method name="set_value" c:identifier="g_mime_header_iter_set_value">
        <doc xml:space="preserve">Sets the current header's value to the new value.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%TRUE if the value was set or %FALSE otherwise (indicates
invalid iter).
...
g_mime_utils_header_encode_text().</doc>
        ...
        <parameters>
          ...
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">new header value</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <function name="new"
                ...
                introspectable="0">
        <doc xml:space="preserve">Dynamically allocates a #GMimeHeaderIter on the heap. This is
...
g_mime_header_iter_free().</doc>
        <return-value>
          <doc xml:space="preserve">a newly-allocated #GMimeHeaderIter.</doc>
          <type name="HeaderIter" c:type="GMimeHeaderIter*"/>
        </return-value>
      </function>
    </record>
    <record name="HeaderList" c:type="GMimeHeaderList" disguised="1">
...
g_mime_utils_header_encode_text().</doc>
      ...
      <method name="destroy" c:identifier="g_mime_header_list_destroy">
        <doc xml:space="preserve">Destroy the header list.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="foreach" c:identifier="g_mime_header_list_foreach">
        <doc xml:space="preserve">Calls @func for each header name/value pair.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="func"
                     ...
                     scope="call"
                     closure="1">
            <doc xml:space="preserve">function to be called for each header.</doc>
          ...
          <parameter name="user_data"
                     ...
                     nullable="1"
                     allow-none="1">
            <doc xml:space="preserve">User data to be passed to the func.</doc>
            <type name="gpointer" c:type="gpointer"/>
          </parameter>
        </parameters>
      </method>
      <method name="get" c:identifier="g_mime_header_list_get">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the value of the header requested.
...
g_mime_utils_header_decode_text() before displaying to the user.</doc>
      ...
      <method name="get_iter" c:identifier="g_mime_header_list_get_iter">
        <doc xml:space="preserve">Initializes an iterator for traversing @headers.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a %TRUE if successful or %FALSE if there are no headers to
traverse.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
      ...
      <method name="get_stream" c:identifier="g_mime_header_list_get_stream">
        <doc xml:space="preserve">Gets the raw stream representing @headers.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a #GMimeStream if set or %NULL otherwise.</doc>
          <type name="Stream" c:type="GMimeStream*"/>
        </return-value>
        <parameters>
          <instance-parameter name="headers" transfer-ownership="none">
...
g_mime_utils_header_encode_text().</doc>
      ...
      <method name="register_writer"
              ...
              introspectable="0">
        <doc xml:space="preserve">Changes the function used to write @name headers to @writer (or the
...
g_mime_utils_header_encode_text().</doc>
      ...
      <method name="set_stream" c:identifier="g_mime_header_list_set_stream">
        <doc xml:space="preserve">Set the raw header stream.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
g_mime_header_list_register_writer().</doc>
    ...
    <class name="InternetAddress"
      ...
      <method name="get_name" c:identifier="internet_address_get_name">
        ...
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the name of the mailbox or group in a form suitable for
...
in @list.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a string containing the list of addresses in rfc822 format
...
Note: The @name string should be in UTF-8.</doc>
      ...
      <field name="addr">
        <doc xml:space="preserve">address string</doc>
        <type name="utf8" c:type="char*"/>
      </field>
    </class>
...
no (%FALSE).</doc>
      ...
      <method name="add_recipient" c:identifier="g_mime_message_add_recipient">
        <doc xml:space="preserve">Add a recipient of a chosen type to the MIME message.
...
Note: The @name (and @addr) strings should be in UTF-8.</doc>
        ...
        <parameters>
          ...
          <parameter name="type" transfer-ownership="none">
            <doc xml:space="preserve">A #GMimeRecipientType</doc>
            <type name="RecipientType" c:type="GMimeRecipientType"/>
          </parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">The recipient's name (or %NULL)</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="addr" transfer-ownership="none">
            <doc xml:space="preserve">The recipient's address</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
...
recommended that you traverse the MIME structure yourself.</doc>
      ...
      <method name="get_date" c:identifier="g_mime_message_get_date">
        <doc xml:space="preserve">Stores the date in time_t format in @date. If @tz_offset is
...
@tz_offset.</doc>
        ...
        <parameters>
          ...
          <parameter name="date"
                     ...
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">pointer to a date in time_t</doc>
            <type name="glong" c:type="time_t*"/>
          </parameter>
          <parameter name="tz_offset"
                     ...
                     caller-allocates="0"
                     transfer-ownership="full">
            <doc xml:space="preserve">pointer to timezone offset (in +/- hours)</doc>
            <type name="gint" c:type="int*"/>
          </parameter>
        </parameters>
      </method>
      <method name="get_date_as_string"
        ...
        <doc xml:space="preserve">Gets the message's sent-date in string format.</doc>
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a newly allocated string containing the Date header value.</doc>
          <type name="utf8" c:type="char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="message" transfer-ownership="none">
      ...
      <method name="get_recipients"
        ...
        <doc xml:space="preserve">Gets a list of recipients of the specified @type from the @message.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a list of recipients of the specified
@type from the @message.</doc>
      ...
      <method name="get_reply_to" c:identifier="g_mime_message_get_reply_to">
        <doc xml:space="preserve">Gets the Reply-To address from @message.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the sender's Reply-To address in a form suitable for
...
returned string will be in UTF-8.</doc>
      ...
      <method name="get_sender" c:identifier="g_mime_message_get_sender">
        <doc xml:space="preserve">Gets the email address of the sender from @message.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the sender's name and address of the @message in a form
...
sets @nparts to the number of messages returned or %NULL on fail.</doc>
      ...
      <method name="set_date" c:identifier="g_mime_message_set_date">
        ...
        <parameters>
          ...
          <parameter name="tz_offset" transfer-ownership="none">
            <doc xml:space="preserve">timezone offset (in +/- hours)</doc>
            <type name="gint" c:type="int"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_date_as_string"
        ...
        <doc xml:space="preserve">Sets the sent-date of the message.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
      ...
      <method name="set_reply_to" c:identifier="g_mime_message_set_reply_to">
        <doc xml:space="preserve">Set the sender's Reply-To address on the @message.
...
construct and encode this value.</doc>
        ...
        <parameters>
          ...
          <parameter name="reply_to" transfer-ownership="none">
            <doc xml:space="preserve">The Reply-To address</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_sender" c:identifier="g_mime_message_set_sender">
        <doc xml:space="preserve">Set the sender's name and address on the MIME Message.
...
construct and encode this value.</doc>
        ...
        <parameters>
          ...
          <parameter name="sender" transfer-ownership="none">
            <doc xml:space="preserve">The name and address of the sender</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
...
Note: The @subject string should be in UTF-8.</doc>
      ...
      <field name="recipients">
        <doc xml:space="preserve">hash table of recipients using recipient header name as the hash key</doc>
        <type name="InternetAddressList" c:type="InternetAddressList**"/>
      </field>
      ...
      <field name="reply_to">
        <doc xml:space="preserve">Reply-To string</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="subject">
        <doc xml:space="preserve">Subject string</doc>
      ...
      <field name="from">
        <doc xml:space="preserve">From string</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="date">
...
and returned.</doc>
      ...
      <method name="get_postface" c:identifier="g_mime_multipart_get_postface">
        <doc xml:space="preserve">Gets the postface on the multipart.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a pointer to the postface string on the multipart.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="multipart" transfer-ownership="none">
      ...
      <method name="get_preface" c:identifier="g_mime_multipart_get_preface">
        <doc xml:space="preserve">Gets the preface on the multipart.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a pointer to the preface string on the multipart.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
          <instance-parameter name="multipart" transfer-ownership="none">
...
%NULL, then a boundary will be auto-generated for you.</doc>
      ...
      <method name="set_postface" c:identifier="g_mime_multipart_set_postface">
        <doc xml:space="preserve">Sets the postface on the multipart.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="postface" transfer-ownership="none">
            <doc xml:space="preserve">postface</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="set_preface" c:identifier="g_mime_multipart_set_preface">
        <doc xml:space="preserve">Sets the preface on the multipart.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="preface" transfer-ownership="none">
            <doc xml:space="preserve">preface</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      ...
      <field name="preface">
        <doc xml:space="preserve">multipart preface</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      <field name="postface">
        <doc xml:space="preserve">multipart postface</doc>
        <type name="utf8" c:type="char*"/>
      </field>
    </class>
...
@err to provide information as to why the failure occured.</doc>
        ...
        <parameters>
          <instance-parameter name="mpe" transfer-ownership="none">
            <doc xml:space="preserve">multipart/encrypted object</doc>
            <type name="MultipartEncrypted" c:type="GMimeMultipartEncrypted*"/>
          </instance-parameter>
          <parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">decryption context</doc>
            <type name="CryptoContext" c:type="GMimeCryptoContext*"/>
          </parameter>
          <parameter name="result" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeDecryptionResult</doc>
            <type name="DecryptResult" c:type="GMimeDecryptResult**"/>
          </parameter>
        </parameters>
      </method>
...
@err to provide information as to why the failure occured.</doc>
      ...
      <method name="encrypt"
              ...
              throws="1">
        <doc xml:space="preserve">Attempts to encrypt (and conditionally sign) the @content MIME part
...
encrypted part of the multipart/encrypted object @mpe.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%0 on success or %-1 on fail. If the encryption fails, an
...
failure occured.</doc>
        ...
        <parameters>
          ...
          <parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">encryption context</doc>
            <type name="CryptoContext" c:type="GMimeCryptoContext*"/>
          </parameter>
          <parameter name="sign" transfer-ownership="none">
...
the multipart/signed object @mps.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">%0 on success or %-1 on fail. If the signing fails, an
exception will be set on @err to provide information as to why the
failure occured.</doc>
          <type name="gint" c:type="int"/>
        </return-value>
        <parameters>
          <instance-parameter name="mps" transfer-ownership="none">
            <doc xml:space="preserve">multipart/signed object</doc>
            <type name="MultipartSigned" c:type="GMimeMultipartSigned*"/>
          </instance-parameter>
          <parameter name="content" transfer-ownership="none">
          ...
          <parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">encryption crypto context</doc>
            <type name="CryptoContext" c:type="GMimeCryptoContext*"/>
          </parameter>
          <parameter name="userid" transfer-ownership="none">
          ...
          <parameter name="digest" transfer-ownership="none">
            <doc xml:space="preserve">preferred digest algorithm</doc>
            <type name="DigestAlgo" c:type="GMimeDigestAlgo"/>
          </parameter>
        </parameters>
      </method>
...
subtype.</doc>
      ...
      <virtual-method name="append_header" invoker="append_header">
        <doc xml:space="preserve">Appends a raw, unprocessed header to the MIME object.
...
provided.</doc>
      ...
      <virtual-method name="get_header" invoker="get_header">
        <doc xml:space="preserve">Gets the raw, unprocessed value of the first header with the specified name.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the raw, unprocessed value of the requested header if it
...
Note: The returned string will not be suitable for display.</doc>
      ...
      <virtual-method name="prepend_header" invoker="prepend_header">
        <doc xml:space="preserve">Prepends a raw, unprocessed header to the MIME object.
...
serializes it to the Content-Type header field.</doc>
      ...
      <virtual-method name="set_header" invoker="set_header">
        <doc xml:space="preserve">Sets an arbitrary raw, unprocessed header on the MIME object.
...
and g_mime_multipart_foreach().</doc>
    ...
    <record name="Param" c:type="GMimeParam">
      <doc xml:space="preserve">A parameter name/value pair as used for some Content header fields.</doc>
      <field name="next" writable="1">
        <doc xml:space="preserve">Pointer to the next param.</doc>
        <type name="Param" c:type="GMimeParam*"/>
      </field>
      ...
      <method name="append"
              ...
              introspectable="0">
        <doc xml:space="preserve">Appends a new parameter with name @name and value @value to the
parameter list @params.</doc>
        <return-value>
          <doc xml:space="preserve">a param list with the new param of name @name and value
@value appended to the list of params @params.</doc>
          <type name="Param" c:type="GMimeParam*"/>
        </return-value>
        <parameters>
          <instance-parameter name="params" transfer-ownership="none">
            <doc xml:space="preserve">param list</doc>
            <type name="Param" c:type="GMimeParam*"/>
          </instance-parameter>
          <parameter name="name" transfer-ownership="none">
            <doc xml:space="preserve">new param name</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
          <parameter name="value" transfer-ownership="none">
            <doc xml:space="preserve">new param value</doc>
            <type name="utf8" c:type="const char*"/>
          </parameter>
        </parameters>
      </method>
      <method name="append_param"
              ...
              introspectable="0">
        <doc xml:space="preserve">Appends @param to the param list @params.</doc>
        <return-value>
          <doc xml:space="preserve">a param list with the new param @param appended to the list
of params @params.</doc>
        ...
        <parameters>
          ...
          <parameter name="param" transfer-ownership="none">
            <doc xml:space="preserve">param to append</doc>
            <type name="Param" c:type="GMimeParam*"/>
          </parameter>
        </parameters>
      </method>
      <method name="destroy" c:identifier="g_mime_param_destroy">
        <doc xml:space="preserve">Releases all memory used by this mime param back to the Operating
System.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <instance-parameter name="param" transfer-ownership="none">
            <doc xml:space="preserve">Mime param list to destroy</doc>
            <type name="Param" c:type="GMimeParam*"/>
          </instance-parameter>
        </parameters>
      </method>
      ...
      <method name="next" c:identifier="g_mime_param_next">
        <doc xml:space="preserve">Gets the next #GMimeParam node in the list.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the next #GMimeParam node in the list.</doc>
          <type name="Param" c:type="const GMimeParam*"/>
        </return-value>
        <parameters>
          <instance-parameter name="param" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeParam node</doc>
            <type name="Param" c:type="const GMimeParam*"/>
          </instance-parameter>
        </parameters>
      </method>
      <method name="write_to_string"
        ...
        <doc xml:space="preserve">Assumes the output string contains only the Content-* header and
...
Writes the params out to the string @string.</doc>
        ...
        <parameters>
          <instance-parameter name="param" transfer-ownership="none">
            <doc xml:space="preserve">MIME Param list</doc>
            <type name="Param" c:type="const GMimeParam*"/>
          </instance-parameter>
          <parameter name="fold" transfer-ownership="none">
            <doc xml:space="preserve">specifies whether or not to fold headers</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
          <parameter name="str" transfer-ownership="none">
      ...
      <function name="new" c:identifier="g_mime_param_new" introspectable="0">
        <doc xml:space="preserve">Creates a new #GMimeParam node with name @name and value @value.</doc>
        <return-value>
          <doc xml:space="preserve">a new paramter structure.</doc>
          <type name="Param" c:type="GMimeParam*"/>
        </return-value>
        <parameters>
          <parameter name="name" transfer-ownership="none">
      ...
      <function name="new_from_string"
                ...
                introspectable="0">
        <doc xml:space="preserve">Creates a parameter list based on the input string.</doc>
        <return-value>
          <doc xml:space="preserve">a #GMimeParam structure based on @string.</doc>
          <type name="Param" c:type="GMimeParam*"/>
        </return-value>
        <parameters>
          <parameter name="str" transfer-ownership="none">
...
determining the offset of the end of the message.</doc>
      ...
      <method name="get_scan_from" c:identifier="g_mime_parser_get_scan_from">
        <doc xml:space="preserve">Gets whether or not @parser is set to scan mbox-style From-lines.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">whether or not @parser is set to scan mbox-style
From-lines.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
...
By default, this feature is disabled.</doc>
      ...
      <method name="set_scan_from" c:identifier="g_mime_parser_set_scan_from">
        <doc xml:space="preserve">Sets whether or not @parser should scan mbox-style From-lines.
...
By default, this feature is disabled.</doc>
        ...
        <parameters>
          ...
          <parameter name="scan_from" transfer-ownership="none">
            <doc xml:space="preserve">%TRUE to scan From-lines or %FALSE otherwise</doc>
            <type name="gboolean" c:type="gboolean"/>
          </parameter>
        </parameters>
      </method>
...
text/plain.</doc>
      ...
      <virtual-method name="set_content_object" invoker="set_content_object">
        <doc xml:space="preserve">Sets the content object on the mime part.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
...
return %FALSE if the mime part does not contain a Content-MD5.</doc>
    ...
    <record name="PartIter" c:type="GMimePartIter" disguised="1">
...
prompt the user for a password for a given key.</doc>
    ...
    <class name="Pkcs7Context"
      ...
      <method name="get_always_trust"
        ...
        <doc xml:space="preserve">Gets the @always_trust flag on the pkcs7 context.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the @always_trust flag on the pkcs7 context.</doc>
          <type name="gboolean" c:type="gboolean"/>
        </return-value>
        <parameters>
          <instance-parameter name="ctx" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimePkcs7Context</doc>
      ...
      <method name="set_always_trust"
        ...
        <doc xml:space="preserve">Sets the @always_trust flag on the pkcs7 context which is used for
encryption.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
      ...
      <field name="priv">
        <doc xml:space="preserve">private context data</doc>
    ...
    <enumeration name="RecipientType" c:type="GMimeRecipientType">
      <doc xml:space="preserve">A message recipient type.</doc>
...
fields.</doc>
      <field name="next" writable="1">
        <doc xml:space="preserve">Pointer to the next reference.</doc>
        <type name="References" c:type="GMimeReferences*"/>
      </field>
      <field name="msgid" writable="1">
        <doc xml:space="preserve">Reference message-id.</doc>
        <type name="utf8" c:type="char*"/>
      </field>
      ...
      <method name="get_message_id"
        ...
        <doc xml:space="preserve">Gets the Message-Id reference from the #GMimeReferences node.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the Message-Id reference from the #GMimeReferences node.</doc>
          <type name="utf8" c:type="const char*"/>
        </return-value>
        <parameters>
      ...
      <method name="get_next" c:identifier="g_mime_references_get_next">
        <doc xml:space="preserve">Advances to the next reference node in the #GMimeReferences list.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">the next reference node in the #GMimeReferences list.</doc>
          <type name="References" c:type="const GMimeReferences*"/>
        </return-value>
        <parameters>
          <instance-parameter name="ref" transfer-ownership="none">
      ...
      <function name="append" c:identifier="g_mime_references_append">
        ...
        <parameters>
          <parameter name="refs" transfer-ownership="none">
            <doc xml:space="preserve">the address of a #GMimeReferences list</doc>
            <type name="References" c:type="GMimeReferences**"/>
          </parameter>
      ...
      <function name="clear" c:identifier="g_mime_references_clear">
        <doc xml:space="preserve">Clears the #GMimeReferences list and resets it to %NULL.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          <parameter name="refs" transfer-ownership="none">
            <doc xml:space="preserve">address of a #GMimeReferences list</doc>
            <type name="References" c:type="GMimeReferences**"/>
          </parameter>
        </parameters>
      </function>
...
headers defined in rfc822.</doc>
        <return-value>
          <doc xml:space="preserve">a list of referenced msg-ids.</doc>
          <type name="References" c:type="GMimeReferences*"/>
        </return-value>
        <parameters>
          <parameter name="text" transfer-ownership="none">
    ...
    <class name="Signature"
      ...
      <method name="get_errors" c:identifier="g_mime_signature_get_errors">
        <doc xml:space="preserve">Get the signature errors. If the #GMimeSignatureStatus returned from
g_mime_signature_get_status() is not #GMIME_SIGNATURE_STATUS_GOOD, then the
errors may provide a clue as to why.</doc>
        <return-value transfer-ownership="none">
          <doc xml:space="preserve">a bitfield of errors.</doc>
      ...
      <method name="get_status" c:identifier="g_mime_signature_get_status">
        <doc xml:space="preserve">Get the signature status.</doc>
        <return-value transfer-ownership="none">
      ...
      <method name="set_errors" c:identifier="g_mime_signature_set_errors">
        <doc xml:space="preserve">Set the errors on the signature.</doc>
        <return-value transfer-ownership="none">
          <type name="none" c:type="void"/>
        </return-value>
        <parameters>
          ...
          <parameter name="errors" transfer-ownership="none">
            <doc xml:space="preserve">a #GMimeSignatureError</doc>
            <type name="SignatureError" c:type="GMimeSignatureError"/>
          </parameter>
        </parameters>
      </method>
      ...
      <field name="errors">
        <doc xml:space="preserve">A bitfield of #GMimeSignatureError values.</doc>
        <type name="SignatureError" c:type="GMimeSignatureError"/>
      </field>
      <field name="cert">
    ...
    <bitfield name="SignatureError" c:type="GMimeSignatureError">
      <doc xml:space="preserve">Possible errors that a #GMimeSignature could have.</doc>
...
index.</doc>
      ...
      <field name="array">
        <doc xml:space="preserve">An array of #GMimeSignature objects.</doc>
        <array name="GLib.PtrArray" c:type="GPtrArray*">
          <type name="gpointer" c:type="gpointer"/>
        </array>
      </field>
    ...
    <enumeration name="SignatureStatus" c:type="GMimeSignatureStatus">
      <doc xml:space="preserve">A value representing the signature status for a particular
#GMimeSignature.</doc>
      <member name="good" value="0" c:identifier="GMIME_SIGNATURE_STATUS_GOOD">
        <doc xml:space="preserve">Good signature.</doc>
      </member>
      <member name="error"
              value="1"
      ...
      <member name="bad" value="2" c:identifier="GMIME_SIGNATURE_STATUS_BAD">
        <doc xml:space="preserve">Bad signature.</doc>
      </member>
    </enumeration>
    <class name="Stream"
...
and @end.</doc>
      ...
      <field name="super_stream" readable="0" private="1">
        <doc xml:space="preserve">parent stream if this is a substream</doc>
        <type name="Stream" c:type="GMimeStream*"/>
      </field>
      <field name="position" readable="0" private="1">
        <doc xml:space="preserve">the current stream position</doc>
        <type name="gint64" c:type="gint64"/>
      </field>
      <field name="bound_start" readable="0" private="1">
        <doc xml:space="preserve">start boundary of the stream</doc>
        <type name="gint64" c:type="gint64"/>
      </field>
      <field name="bound_end" readable="0" private="1">
        <doc xml:space="preserve">end boundary of the stream</doc>
        <type name="gint64" c:type="gint64"/>
      </field>
    </class>
    ...
    <enumeration name="StreamBufferMode" c:type="GMimeStreamBufferMode">
      ...
      <member name="cache_read"
        ...
        <doc xml:space="preserve">Cache all reads.</doc>
      </member>
...
passed in.</doc>
      ...
      <constructor name="new_for_path"
        ...
        <return-value transfer-ownership="full">
          <doc xml:space="preserve">a stream using for reading and/or writing to the specified
...
appropriate errno value.</doc>
    ...
    <function name="iconv_init" c:identifier="g_mime_iconv_init">
      <doc xml:space="preserve">Initialize GMime's iconv cache. This *MUST* be called before any
...
errno value.</doc>
    ...
    <function name="iconv_shutdown" c:identifier="g_mime_iconv_shutdown">
      <doc xml:space="preserve">Frees internal iconv caches created in g_mime_iconv_init().
...
@str converted to the user's locale charset.</doc>
    ...
    <function name="init" c:identifier="g_mime_init">
      <doc xml:space="preserve">Initializes GMime.
...
well.</doc>
      ...
      <parameters>
        <parameter name="flags" transfer-ownership="none">
          <doc xml:space="preserve">initialization flags</doc>
          <type name="guint32" c:type="guint32"/>
        </parameter>
      </parameters>
    </function>
    ...
    <function name="set_user_charsets" c:identifier="g_mime_set_user_charsets">
      <doc xml:space="preserve">Set a list of charsets for GMime to use as a hint for encoding and
...
(e.g. most preferred first, least preferred last).</doc>
      ...
      <parameters>
        <parameter name="charsets" transfer-ownership="none">
          <doc xml:space="preserve">an array of user-preferred charsets</doc>
          <type name="utf8" c:type="const char**"/>
        </parameter>
      </parameters>
    </function>
    <function name="shutdown" c:identifier="g_mime_shutdown">
      <doc xml:space="preserve">Frees internally allocated tables created in g_mime_init(). Also
calls g_mime_charset_map_shutdown() and g_mime_iconv_shutdown().</doc>
    ...
    <function name="user_charsets" c:identifier="g_mime_user_charsets">
      <doc xml:space="preserve">Get the list of user-preferred charsets set with
...
of the timezone offset will be stored.</doc>
    ...
    <function name="utils_header_decode_phrase"
      ...
      <doc xml:space="preserve">Decodes an rfc2047 encoded 'phrase' header.
...
header.</doc>
    ...
    <function name="utils_header_decode_text"
      ...
      <doc xml:space="preserve">Decodes an rfc2047 encoded 'text' header.
...
headers like "Subject".</doc>
    ...
    <function name="utils_header_fold" c:identifier="g_mime_utils_header_fold">
      ...
      <return-value transfer-ownership="full">
        <doc xml:space="preserve">an allocated string containing the folded header.
...
by @format and the following arguments.</doc>
      ...
      <parameters>
        <parameter name="format" transfer-ownership="none">
          <doc xml:space="preserve">string format</doc>
          <type name="utf8" c:type="const char*"/>
        </parameter>
        <parameter name="..." transfer-ownership="none">
          <doc xml:space="preserve">arguments</doc>
